...
final class MarkdownSnippetFormatter
{
    ...
    public function __construct(\ECSPrefix202301\Symfony\Component\Filesystem\Filesystem $fileSystem, FixerFileProcessor $fixerFileProcessor, SniffFileProcessor $sniffFileProcessor, CurrentParentFilePathProvider $currentParentFilePathProvider)
    {
