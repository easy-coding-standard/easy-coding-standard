...
final class SnippetFormatterApplication
{
     ...
     * @param string $kind
     */
    private function processFileInfoWithPattern(\ECSPrefix20210515\Symplify\SmartFileSystem\SmartFileInfo $phpFileInfo, $snippetPattern, $kind)
    {
        $snippetPattern = (string) $snippetPattern;
        $kind = (string) $kind;
