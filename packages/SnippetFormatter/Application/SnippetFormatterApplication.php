...
use ECSPrefix20210725\Symplify\ConsoleColorDiff\Console\Formatter\ColorConsoleDiffFormatter;
...
final class SnippetFormatterApplication
{
     ...
     */
    private function processFileInfoWithPattern(\ECSPrefix20210725\Symplify\SmartFileSystem\SmartFileInfo $phpFileInfo, string $snippetPattern, string $kind, \Symplify\EasyCodingStandard\ValueObject\Configuration $configuration) : array
    {
