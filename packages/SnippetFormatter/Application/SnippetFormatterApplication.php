...
use ECSPrefix20211111\Symplify\ConsoleColorDiff\Console\Formatter\ColorConsoleDiffFormatter;
...
final class SnippetFormatterApplication
{
    ...
    public function processFileInfosWithSnippetPattern(\Symplify\EasyCodingStandard\ValueObject\Configuration $configuration, array $fileInfos, string $snippetPattern, string $kind) : int
    {
        ...
        if ($fileCount === 0) {
            ...
            return \ECSPrefix20211111\Symfony\Component\Console\Command\Command::SUCCESS;
        }
     ...
     */
    private function processFileInfoWithPattern(\ECSPrefix20211111\Symplify\SmartFileSystem\SmartFileInfo $phpFileInfo, string $snippetPattern, string $kind, \Symplify\EasyCodingStandard\ValueObject\Configuration $configuration) : array
    {
