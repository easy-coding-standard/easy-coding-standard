...
final class SnippetFormatterApplication
{
    ...
    public function processFileInfosWithSnippetPattern(\Symplify\EasyCodingStandard\Configuration\Configuration $configuration, array $fileInfos, string $snippetPattern, string $kind) : int
    {
        ...
        if ($fileCount === 0) {
            ...
            return \ECSPrefix20210602\Symplify\PackageBuilder\Console\ShellCode::SUCCESS;
        }
     ...
     * @return void
     */
    private function processFileInfoWithPattern(\ECSPrefix20210602\Symplify\SmartFileSystem\SmartFileInfo $phpFileInfo, string $snippetPattern, string $kind)
    {
