...
final class SnippetFormatterApplication
{
     ...
     * @return void
     */
    private function processFileInfoWithPattern(\ECSPrefix20210607\Symplify\SmartFileSystem\SmartFileInfo $phpFileInfo, string $snippetPattern, string $kind)
    {
