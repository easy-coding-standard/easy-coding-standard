...
final class SnippetFormatterApplication
{
     ...
     * @return void
     */
    private function processFileInfoWithPattern(\ECSPrefix20210521\Symplify\SmartFileSystem\SmartFileInfo $phpFileInfo, string $snippetPattern, string $kind)
    {
