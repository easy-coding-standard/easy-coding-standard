...
final class SnippetFormatterApplication
{
     ...
     * @return void
     */
    private function processFileInfoWithPattern(\ECSPrefix20210610\Symplify\SmartFileSystem\SmartFileInfo $phpFileInfo, string $snippetPattern, string $kind)
    {
