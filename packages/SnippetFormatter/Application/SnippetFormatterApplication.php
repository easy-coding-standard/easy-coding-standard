...
use ECSPrefix20220108\Symplify\ConsoleColorDiff\Console\Formatter\ColorConsoleDiffFormatter;
...
final class SnippetFormatterApplication
{
    ...
    public function __construct(\Symplify\EasyCodingStandard\SnippetFormatter\Reporter\SnippetReporter $snippetReporter, \Symplify\EasyCodingStandard\SnippetFormatter\Formatter\SnippetFormatter $snippetFormatter, \ECSPrefix20220108\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem, \ECSPrefix20220108\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle, \Symplify\EasyCodingStandard\Reporter\ProcessedFileReporter $processedFileReporter, \PhpCsFixer\Differ\DifferInterface $differ, \ECSPrefix20220108\Symplify\ConsoleColorDiff\Console\Formatter\ColorConsoleDiffFormatter $colorConsoleDiffFormatter)
    {
    ...
    public function processFileInfosWithSnippetPattern(\Symplify\EasyCodingStandard\ValueObject\Configuration $configuration, array $fileInfos, string $snippetPattern, string $kind) : int
    {
        ...
        if ($fileCount === 0) {
            ...
            return \ECSPrefix20220108\Symfony\Component\Console\Command\Command::SUCCESS;
        }
     ...
     */
    private function processFileInfoWithPattern(\ECSPrefix20220108\Symplify\SmartFileSystem\SmartFileInfo $phpFileInfo, string $snippetPattern, string $kind, \Symplify\EasyCodingStandard\ValueObject\Configuration $configuration) : array
    {
