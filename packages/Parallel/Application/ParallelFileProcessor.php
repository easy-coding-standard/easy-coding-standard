...
use ECSPrefix20210804\React\ChildProcess\Process;
...
final class ParallelFileProcessor
{
    ...
    public function __construct(\ECSPrefix20210804\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \Symplify\EasyCodingStandard\Parallel\Command\WorkerCommandLineFactory $workerCommandLineFactory)
    {
    ...
    public function analyse(\Symplify\EasyCodingStandard\Parallel\ValueObject\Schedule $schedule, string $mainScript, \Closure $postFileCallback, $projectConfigFile, \ECSPrefix20210804\Symfony\Component\Console\Input\InputInterface $input) : array
    {
        ...
        for ($i = 0; $i < $numberOfProcesses; ++$i) {
            ...
            $childProcess = new \ECSPrefix20210804\React\ChildProcess\Process($workerCommandLine);
            ...
            $processStdInEncoder = new \ECSPrefix20210804\Clue\React\NDJson\Encoder($childProcess->stdin);
