...
use ECSPrefix20210919\React\ChildProcess\Process;
...
final class ParallelFileProcessor
{
    ...
    public function __construct(\ECSPrefix20210919\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \Symplify\EasyCodingStandard\Parallel\Command\WorkerCommandLineFactory $workerCommandLineFactory)
    {
     ...
     * @return mixed[]
     */
    public function analyse(\Symplify\EasyCodingStandard\Parallel\ValueObject\Schedule $schedule, string $mainScript, \Closure $postFileCallback, ?string $projectConfigFile, \ECSPrefix20210919\Symfony\Component\Console\Input\InputInterface $input) : array
    {
        ...
        for ($i = 0; $i < $numberOfProcesses; ++$i) {
            ...
            $childProcess = new \ECSPrefix20210919\React\ChildProcess\Process($workerCommandLine);
            ...
            $processStdInEncoder = new \ECSPrefix20210919\Clue\React\NDJson\Encoder($childProcess->stdin);
            ...
            $processStdOutDecoder = new \ECSPrefix20210919\Clue\React\NDJson\Decoder($childProcess->stdout, \true, 512, 0, 4 * 1024 * 1024);
            ...
            $childProcess->on(\Symplify\EasyCodingStandard\Parallel\ValueObject\ReactEvent::EXIT, static function ($exitCode) use(&$systemErrors, $stdErrStreamBuffer) : void {
                if ($exitCode === \ECSPrefix20210919\Symfony\Component\Console\Command\Command::SUCCESS) {
                    return;
                }
