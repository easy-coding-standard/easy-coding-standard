...
use ECSPrefix20210618\React\ChildProcess\Process;
...
final class ParallelFileProcessor
{
     ...
     */
    public function analyse(\Symplify\EasyCodingStandard\Parallel\ValueObject\Schedule $schedule, string $mainScript, bool $onlyFiles, $postFileCallback, $projectConfigFile, \ECSPrefix20210618\Symfony\Component\Console\Input\InputInterface $input) : array
    {
        ...
        for ($i = 0; $i < $numberOfProcesses; ++$i) {
            ...
            $childProcess = new \ECSPrefix20210618\React\ChildProcess\Process($command);
            $childProcess->start($streamSelectLoop);
            $processStdInEncoder = new \ECSPrefix20210618\Clue\React\NDJson\Encoder($childProcess->stdin);
            $processStdInEncoder->on('error', $handleError);
            $processStdOutDecoder = new \ECSPrefix20210618\Clue\React\NDJson\Decoder($childProcess->stdout, \true, 512, 0, 4 * 1024 * 1024);
     ...
     * @param string|null $projectConfigFile
     */
    private function getWorkerCommand(string $mainScript, $projectConfigFile, \ECSPrefix20210618\Symfony\Component\Console\Input\InputInterface $input) : string
    {
