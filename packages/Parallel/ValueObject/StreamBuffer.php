...
use ECSPrefix20210619\React\Stream\ReadableStreamInterface;
/**
...
final class StreamBuffer
{
     ...
     */
    private $buffer = '';
    public function __construct(\ECSPrefix20210619\React\Stream\ReadableStreamInterface $readableStream)
    {
