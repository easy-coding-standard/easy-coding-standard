...
use ECSPrefix20210622\React\Stream\ReadableStreamInterface;
/**
...
final class StreamBuffer
{
     ...
     */
    private $buffer = '';
    public function __construct(\ECSPrefix20210622\React\Stream\ReadableStreamInterface $readableStream)
    {
