...
use ECSPrefix20210618\React\Stream\ReadableStreamInterface;
/**
...
final class StreamBuffer
{
     ...
     */
    private $buffer = '';
    public function __construct(\ECSPrefix20210618\React\Stream\ReadableStreamInterface $readableStream)
    {
        $readableStream->on('data', function (string $chunk) {
            $this->buffer .= $chunk;
        });
    }
