...
final class WorkerCommandLineFactory
{
    ...
    public function create(string $mainScript, ?string $projectConfigFile, \ECSPrefix20211120\Symfony\Component\Console\Input\InputInterface $input, string $identifier, int $port) : string
    {
        ...
        foreach ($args as $arg) {
            // skip command name
            $checkCommandName = \ECSPrefix20211120\Symplify\PackageBuilder\Console\Command\CommandNaming::classToName(\Symplify\EasyCodingStandard\Console\Command\CheckCommand::class);
            if ($arg === $checkCommandName) {
                break;
            }
            $processCommandArray[] = \escapeshellarg($arg);
        }
        $processCommandArray[] = \ECSPrefix20211120\Symplify\PackageBuilder\Console\Command\CommandNaming::classToName(\Symplify\EasyCodingStandard\Console\Command\WorkerCommand::class);
     ...
     * @return string[]
     */
    private function createProcessCommandOptions(\ECSPrefix20211120\Symfony\Component\Console\Input\InputInterface $input, array $checkCommandOptionNames) : array
    {
    ...
    private function shouldSkipOption(\ECSPrefix20211120\Symfony\Component\Console\Input\InputInterface $input, string $optionName) : bool
    {
