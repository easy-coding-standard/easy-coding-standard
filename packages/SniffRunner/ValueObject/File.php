...
final class File extends \PHP_CodeSniffer\Files\File
{
    ...
    public function __construct(string $path, string $content, \PHP_CodeSniffer\Fixer $fixer, \ECSPrefix20220216\Symplify\Skipper\Skipper\Skipper $skipper, \Symplify\EasyCodingStandard\SniffRunner\DataCollector\SniffMetadataCollector $sniffMetadataCollector, \Symplify\EasyCodingStandard\Console\Style\EasyCodingStandardStyle $easyCodingStandardStyle)
    {
    ...
    public function process() : void
    {
        ...
        if (!$currentFileInfo instanceof \ECSPrefix20220216\Symplify\SmartFileSystem\SmartFileInfo) {
     ...
     */
    public function processWithTokenListenersAndFileInfo(array $tokenListeners, \ECSPrefix20220216\Symplify\SmartFileSystem\SmartFileInfo $fileInfo) : void
    {
