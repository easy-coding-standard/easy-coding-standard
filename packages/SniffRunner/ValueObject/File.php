...
final class File extends BaseFile
{
     ...
     */
    const REPORT_WARNINGS_SNIFFS = [PropertyDeclarationSniff::class, MethodDeclarationSniff::class];
     ...
     * @return void
     */
    public function processWithTokenListenersAndFileInfo(array $tokenListeners, SmartFileInfo $fileInfo)
    {
     ...
     * @return void
     */
    private function reportActiveSniffClass(Sniff $sniff)
    {
