...
final class SniffFileProcessor implements FileProcessorInterface
{
     ...
     * @param Sniff[] $sniffs
     */
    public function __construct(Fixer $fixer, FileFactory $fileFactory, DifferInterface $differ, SniffMetadataCollector $sniffMetadataCollector, \ECSPrefix202307\Symfony\Component\Filesystem\Filesystem $filesystem, FileDiffFactory $fileDiffFactory, array $sniffs)
    {
        $this->fixer = $fixer;
