...
use ECSPrefix202302\Nette\Utils\FileSystem;
...
final class SniffFileProcessor implements FileProcessorInterface
{
     ...
     * @param Sniff[] $sniffs
     */
    public function __construct(Fixer $fixer, FileFactory $fileFactory, DifferInterface $differ, SniffMetadataCollector $sniffMetadataCollector, \ECSPrefix202302\Symfony\Component\Filesystem\Filesystem $filesystem, FileDiffFactory $fileDiffFactory, PrivatesAccessor $privatesAccessor, array $sniffs)
    {
        $this->fixer = $fixer;
