...
use ECSPrefix20220308\Nette\Utils\Random;
...
final class FileCacheStorage
{
    ...
    public function __construct(string $directory, \ECSPrefix20220308\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    public function save(string $key, string $variableKey, $data) : void
    {
        ...
        $tmpPath = \sprintf('%s/%s.tmp', $this->directory, \ECSPrefix20220308\Nette\Utils\Random::generate());
