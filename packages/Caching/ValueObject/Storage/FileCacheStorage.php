...
final class FileCacheStorage
{
    ...
    public function __construct(string $directory, \ECSPrefix20220220\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    public function save(string $key, string $variableKey, $data) : void
    {
        ...
        $tmpPath = \sprintf('%s/%s.tmp', $this->directory, \ECSPrefix20220220\Nette\Utils\Random::generate());
