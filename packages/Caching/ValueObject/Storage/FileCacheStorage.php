...
use ECSPrefix20210802\Nette\Utils\Random;
...
final class FileCacheStorage
{
    ...
    public function __construct(string $directory, \ECSPrefix20210802\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    public function save(string $key, string $variableKey, $data)
    {
        ...
        $tmpPath = \sprintf('%s/%s.tmp', $this->directory, \ECSPrefix20210802\Nette\Utils\Random::generate());
