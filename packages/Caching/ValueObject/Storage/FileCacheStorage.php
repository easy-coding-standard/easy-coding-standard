...
use ECSPrefix20220215\Nette\Utils\Random;
...
final class FileCacheStorage
{
    ...
    public function __construct(string $directory, \ECSPrefix20220215\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    public function save(string $key, string $variableKey, $data) : void
    {
        ...
        $tmpPath = \sprintf('%s/%s.tmp', $this->directory, \ECSPrefix20220215\Nette\Utils\Random::generate());
