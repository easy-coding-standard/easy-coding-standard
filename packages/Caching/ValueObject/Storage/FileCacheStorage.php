...
use ECSPrefix20210823\Nette\Utils\Random;
...
final class FileCacheStorage
{
    ...
    public function __construct(string $directory, \ECSPrefix20210823\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    public function save(string $key, string $variableKey, $data) : void
    {
        ...
        $tmpPath = \sprintf('%s/%s.tmp', $this->directory, \ECSPrefix20210823\Nette\Utils\Random::generate());
