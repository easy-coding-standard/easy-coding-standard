...
final class ChangedFilesDetector
{
     ...
     * @return void
     */
    public function addFileInfo(\ECSPrefix20210629\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo)
    {
     ...
     * @return void
     */
    public function invalidateFileInfo(\ECSPrefix20210629\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo)
    {
        $cacheKey = $this->fileInfoToKey($smartFileInfo);
        $this->cache->clean($cacheKey);
    }
    public function hasFileInfoChanged(\ECSPrefix20210629\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : bool
    {
    ...
    private function fileInfoToKey(\ECSPrefix20210629\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : string
    {
