...
final class ChangedFilesDetector
{
    ...
    public function addFileInfo(\ECSPrefix20220525\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
    ...
    public function invalidateFileInfo(\ECSPrefix20220525\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
        $cacheKey = $this->fileInfoToKey($smartFileInfo);
        $this->cache->clean($cacheKey);
    }
    public function hasFileInfoChanged(\ECSPrefix20220525\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : bool
    {
    ...
    private function fileInfoToKey(\ECSPrefix20220525\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : string
    {
