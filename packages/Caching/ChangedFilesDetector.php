...
final class ChangedFilesDetector
{
    ...
    public function addFileInfo(\ECSPrefix20211104\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
    ...
    public function invalidateFileInfo(\ECSPrefix20211104\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
        $cacheKey = $this->fileInfoToKey($smartFileInfo);
        $this->cache->clean($cacheKey);
    }
    public function hasFileInfoChanged(\ECSPrefix20211104\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : bool
    {
    ...
    private function fileInfoToKey(\ECSPrefix20211104\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : string
    {
