...
use ECSPrefix20220125\Symfony\Component\Config\FileLocator;
use ECSPrefix20220125\Symfony\Component\Config\Loader\LoaderInterface;
use ECSPrefix20220125\Symfony\Component\Config\Loader\LoaderResolver;
use ECSPrefix20220125\Symfony\Component\DependencyInjection\ContainerBuilder;
use ECSPrefix20220125\Symfony\Component\DependencyInjection\Loader\GlobFileLoader;
use Symplify\EasyCodingStandard\Exception\Configuration\FileNotFoundException;
use ECSPrefix20220125\Symplify\PackageBuilder\DependencyInjection\FileLoader\ParameterMergingPhpFileLoader;
...
final class FileHashComputer
{
    ...
    private function createLoader(string $filePath, \ECSPrefix20220125\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : \ECSPrefix20220125\Symfony\Component\Config\Loader\LoaderInterface
    {
        $fileLocator = new \ECSPrefix20220125\Symfony\Component\Config\FileLocator([\dirname($filePath)]);
        $loaders = [new \ECSPrefix20220125\Symfony\Component\DependencyInjection\Loader\GlobFileLoader($containerBuilder, $fileLocator), new \ECSPrefix20220125\Symplify\PackageBuilder\DependencyInjection\FileLoader\ParameterMergingPhpFileLoader($containerBuilder, $fileLocator)];
        $loaderResolver = new \ECSPrefix20220125\Symfony\Component\Config\Loader\LoaderResolver($loaders);
