...
final class ChangedFilesDetector
{
     ...
     */
    private $cache;
    public function __construct(\Symplify\EasyCodingStandard\ChangedFilesDetector\FileHashComputer $fileHashComputer, \ECSPrefix20210602\Nette\Caching\Cache $cache)
    {
     ...
     * @return void
     */
    public function addFileInfo(\ECSPrefix20210602\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo)
    {
        $cacheKey = $this->fileInfoToKey($smartFileInfo);
        $currentValue = $this->fileHashComputer->compute($smartFileInfo->getRealPath());
        $this->cache->save($cacheKey, $currentValue, [\ECSPrefix20210602\Nette\Caching\Cache::TAGS => [self::CHANGED_FILES_CACHE_TAG]]);
    }
    /**
     * @return void
     */
    public function invalidateFileInfo(\ECSPrefix20210602\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo)
    {
        $cacheKey = $this->fileInfoToKey($smartFileInfo);
        $this->cache->remove($cacheKey);
    }
    public function hasFileInfoChanged(\ECSPrefix20210602\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : bool
    {
    ...
    public function clearCache()
    {
        ...
        $this->cache->clean([\ECSPrefix20210602\Nette\Caching\Cache::TAGS => [self::CHANGED_FILES_CACHE_TAG]]);
    }
    /**
    ...
    private function fileInfoToKey(\ECSPrefix20210602\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : string
    {
