...
use ECSPrefix20210511\Symfony\Component\DependencyInjection\Loader\GlobFileLoader;
...
final class FileHashComputer
{
    ...
    public function computeConfig($filePath)
    {
        ...
        $containerBuilder = new \ECSPrefix20210511\Symfony\Component\DependencyInjection\ContainerBuilder();
     ...
     */
    private function createLoader($filePath, \ECSPrefix20210511\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder)
    {
        $filePath = (string) $filePath;
        $fileLocator = new \ECSPrefix20210511\Symfony\Component\Config\FileLocator([\dirname($filePath)]);
        $loaders = [new \ECSPrefix20210511\Symfony\Component\DependencyInjection\Loader\GlobFileLoader($containerBuilder, $fileLocator), new \Symplify\PackageBuilder\DependencyInjection\FileLoader\ParameterMergingPhpFileLoader($containerBuilder, $fileLocator)];
