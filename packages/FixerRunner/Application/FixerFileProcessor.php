...
use ECSPrefix20220530\Symplify\Skipper\Skipper\Skipper;
...
final class FixerFileProcessor implements \Symplify\EasyCodingStandard\Contract\Application\FileProcessorInterface
{
     ...
     */
    public function processFile(\ECSPrefix20220530\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, \Symplify\EasyCodingStandard\ValueObject\Configuration $configuration) : array
    {
    ...
    public function processFileToString(\ECSPrefix20220530\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : string
    {
        $tokens = $this->fileToTokensParser->parseFromFilePath($smartFileInfo->getRealPath());
        $appliedFixers = [];
        foreach ($this->fixers as $fixer) {
     ...
     */
    private function processTokensByFixer(\ECSPrefix20220530\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, \PhpCsFixer\Tokenizer\Tokens $tokens, \PhpCsFixer\Fixer\FixerInterface $fixer) : bool
    {
     ...
     * @param Tokens<Token> $tokens
     */
    private function shouldSkip(\ECSPrefix20220530\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, \PhpCsFixer\Fixer\FixerInterface $fixer, \PhpCsFixer\Tokenizer\Tokens $tokens) : bool
    {
