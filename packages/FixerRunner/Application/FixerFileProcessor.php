...
use ECSPrefix202308\Nette\Utils\FileSystem;
...
final class FixerFileProcessor implements FileProcessorInterface
{
     ...
     */
    public function __construct(FileToTokensParser $fileToTokensParser, Skipper $skipper, DifferInterface $differ, EasyCodingStandardStyle $easyCodingStandardStyle, \ECSPrefix202308\Symfony\Component\Filesystem\Filesystem $filesystem, FileDiffFactory $fileDiffFactory, array $fixers)
    {
