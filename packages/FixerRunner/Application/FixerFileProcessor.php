...
use ECSPrefix20210517\Symplify\Skipper\Skipper\Skipper;
...
final class FixerFileProcessor implements \Symplify\EasyCodingStandard\Contract\Application\FileProcessorInterface
{
     ...
     * @return void
     */
    private function processTokensByFixer(\ECSPrefix20210517\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, \PhpCsFixer\Tokenizer\Tokens $tokens, \PhpCsFixer\Fixer\FixerInterface $fixer)
    {
     ...
     * @return bool
     */
    private function shouldSkip(\ECSPrefix20210517\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, \PhpCsFixer\Fixer\FixerInterface $fixer, \PhpCsFixer\Tokenizer\Tokens $tokens)
    {
     ...
     * @return bool
     */
    private function shouldSkipForMarkdownHeredocCheck(\PhpCsFixer\Fixer\FixerInterface $fixer)
    {
