...
final class ConfigurationFileTest extends AbstractKernelTestCase
{
    ...
    {
        $this->bootKernelWithConfigs(EasyCodingStandardKernel::class, [__DIR__ . '/ConfigurationFileSource/empty-config.php']);
    ...
    {
        $this->bootKernelWithConfigs(EasyCodingStandardKernel::class, [__DIR__ . '/ConfigurationFileSource/include-another-config.php']);
        $fixerFileProcessor = $this->getService(FixerFileProcessor::class);
