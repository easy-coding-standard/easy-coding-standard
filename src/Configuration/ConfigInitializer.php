...
final class ConfigInitializer
{
     ...
     */
    private $filesystem;
    public function __construct(FileProcessorCollector $fileProcessorCollector, SymfonyStyle $symfonyStyle, \Symplify\EasyCodingStandard\Configuration\InitPathsResolver $initPathsResolver, \ECSPrefix202505\Symfony\Component\Filesystem\Filesystem $filesystem)
    {
     ...
     * @return mixed[]|string
     */
    private function fillPreparedSets(string $projectDirectory, string $templateFileContents)
    {
        $templateFileContents = $this->fillPaths($projectDirectory, $templateFileContents);
