...
final class ConfigInitializer
{
     ...
     */
    private $filesystem;
    public function __construct(FileProcessorCollector $fileProcessorCollector, SymfonyStyle $symfonyStyle, \Symplify\EasyCodingStandard\Configuration\InitPathsResolver $initPathsResolver, \ECSPrefix202301\Symfony\Component\Filesystem\Filesystem $filesystem)
    {
    ...
    public function createConfig(string $projectDirectory) : void
    {
        ...
        if ($doesConfigExist) {
            $this->symfonyStyle->warning('Register rules or sets in your "ecs.php" config');
            return;
        }
