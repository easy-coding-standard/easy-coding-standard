...
final class ConfigurationFactory
{
     ...
     */
    public function createFromInput(\ECSPrefix20211127\Symfony\Component\Console\Input\InputInterface $input) : \Symplify\EasyCodingStandard\ValueObject\Configuration
    {
    ...
    private function canShowProgressBar(\ECSPrefix20211127\Symfony\Component\Console\Input\InputInterface $input) : bool
    {
     ...
     * @return string[]
     */
    private function resolvePaths(\ECSPrefix20211127\Symfony\Component\Console\Input\InputInterface $input) : array
    {
        /** @var string[] $paths */
