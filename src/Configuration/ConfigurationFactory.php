...
final class ConfigurationFactory
{
     ...
     */
    public function createFromInput(\ECSPrefix20220205\Symfony\Component\Console\Input\InputInterface $input) : \Symplify\EasyCodingStandard\ValueObject\Configuration
    {
    ...
    private function canShowProgressBar(\ECSPrefix20220205\Symfony\Component\Console\Input\InputInterface $input) : bool
    {
     ...
     * @return string[]
     */
    private function resolvePaths(\ECSPrefix20220205\Symfony\Component\Console\Input\InputInterface $input) : array
    {
        /** @var string[] $paths */
