...
final class ConfigurationFactory
{
     ...
     */
    public function createFromInput(\ECSPrefix20210712\Symfony\Component\Console\Input\InputInterface $input) : \Symplify\EasyCodingStandard\ValueObject\Configuration
    {
    ...
    private function canShowProgressBar(\ECSPrefix20210712\Symfony\Component\Console\Input\InputInterface $input) : bool
    {
     ...
     * @return string[]
     */
    private function resolvePaths(\ECSPrefix20210712\Symfony\Component\Console\Input\InputInterface $input) : array
    {
        /** @var string[] $paths */
