...
use ECSPrefix202405\Nette\Utils\FileSystem;
...
final class FixerFileProcessor implements FileProcessorInterface
{
     ...
     */
    public function __construct(FileToTokensParser $fileToTokensParser, Skipper $skipper, DifferInterface $differ, EasyCodingStandardStyle $easyCodingStandardStyle, \ECSPrefix202405\Symfony\Component\Filesystem\Filesystem $filesystem, FileDiffFactory $fileDiffFactory, array $fixers)
    {
