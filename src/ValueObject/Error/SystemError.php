...
use ECSPrefix20211206\Symplify\EasyParallel\Contract\SerializableInterface;
final class SystemError implements \ECSPrefix20211206\Symplify\EasyParallel\Contract\SerializableInterface
{
    /**
     * @var int
     */
     ...
     * @param mixed[] $json
     */
    public static function decode($json) : \ECSPrefix20211206\Symplify\EasyParallel\Contract\SerializableInterface
    {
