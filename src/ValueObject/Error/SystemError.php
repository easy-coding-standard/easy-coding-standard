...
use ECSPrefix20220211\Symplify\EasyParallel\Contract\SerializableInterface;
final class SystemError implements \ECSPrefix20220211\Symplify\EasyParallel\Contract\SerializableInterface
{
    /**
     * @var int
     */
     ...
     * @return $this
     */
    public static function decode(array $json) : \ECSPrefix20220211\Symplify\EasyParallel\Contract\SerializableInterface
    {
