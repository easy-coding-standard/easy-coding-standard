...
final class FileDiff
{
     ...
     */
    public function __construct(\ECSPrefix20210612\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, string $diff, string $consoleFormattedDiff, array $appliedCheckers)
    {
