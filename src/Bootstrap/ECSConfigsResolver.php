...
use ECSPrefix20210515\Symplify\SetConfigResolver\SetAwareConfigResolver;
...
final class ECSConfigsResolver
{
    ...
    public function __construct()
    {
        ...
        $this->setAwareConfigResolver = new \ECSPrefix20210515\Symplify\SetConfigResolver\SetAwareConfigResolver($easyCodingStandardSetProvider);
    }
    /**
    ...
    public function resolveFromInput(\ECSPrefix20210515\Symfony\Component\Console\Input\InputInterface $input)
    {
        ...
        return new \ECSPrefix20210515\Symplify\SetConfigResolver\ValueObject\Bootstrap\BootstrapConfigs($mainConfigFileInfo, $configFileInfos);
    }
}
