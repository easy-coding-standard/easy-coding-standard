...
use ECSPrefix20210802\Symplify\PackageBuilder\DependencyInjection\CompilerPass\AutowireInterfacesCompilerPass;
final class EasyCodingStandardBundle extends \ECSPrefix20210802\Symfony\Component\HttpKernel\Bundle\Bundle
{
    /**
    ...
    public function build($containerBuilder)
    {
        ...
        // autowire
        $containerBuilder->addCompilerPass(new \ECSPrefix20210802\Symplify\PackageBuilder\DependencyInjection\CompilerPass\AutowireInterfacesCompilerPass([\PhpCsFixer\Fixer\FixerInterface::class, \PHP_CodeSniffer\Sniffs\Sniff::class, \Symplify\EasyCodingStandard\Contract\Console\Output\OutputFormatterInterface::class]));
        // exceptions
