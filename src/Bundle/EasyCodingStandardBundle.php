...
use ECSPrefix20210929\Symplify\PackageBuilder\DependencyInjection\CompilerPass\AutowireInterfacesCompilerPass;
final class EasyCodingStandardBundle extends \ECSPrefix20210929\Symfony\Component\HttpKernel\Bundle\Bundle
{
    /**
    ...
    public function build($containerBuilder) : void
    {
        ...
        // autowire
        $containerBuilder->addCompilerPass(new \ECSPrefix20210929\Symplify\PackageBuilder\DependencyInjection\CompilerPass\AutowireInterfacesCompilerPass([\PhpCsFixer\Fixer\FixerInterface::class, \PHP_CodeSniffer\Sniffs\Sniff::class, \Symplify\EasyCodingStandard\Contract\Console\Output\OutputFormatterInterface::class]));
        // exceptions
