...
use ECSPrefix20211020\Symplify\PackageBuilder\DependencyInjection\CompilerPass\AutowireInterfacesCompilerPass;
final class EasyCodingStandardBundle extends \ECSPrefix20211020\Symfony\Component\HttpKernel\Bundle\Bundle
{
    /**
    ...
    public function build($containerBuilder) : void
    {
        ...
        // autowire
        $containerBuilder->addCompilerPass(new \ECSPrefix20211020\Symplify\PackageBuilder\DependencyInjection\CompilerPass\AutowireInterfacesCompilerPass([\PhpCsFixer\Fixer\FixerInterface::class, \PHP_CodeSniffer\Sniffs\Sniff::class, \Symplify\EasyCodingStandard\Contract\Console\Output\OutputFormatterInterface::class]));
        // exceptions
