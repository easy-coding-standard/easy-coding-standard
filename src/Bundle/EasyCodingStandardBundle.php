...
use ECSPrefix20210515\Symplify\PackageBuilder\DependencyInjection\CompilerPass\AutowireInterfacesCompilerPass;
final class EasyCodingStandardBundle extends \ECSPrefix20210515\Symfony\Component\HttpKernel\Bundle\Bundle
{
    /**
    ...
    public function build(\ECSPrefix20210515\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder)
    {
        ...
        // autowire
        $containerBuilder->addCompilerPass(new \ECSPrefix20210515\Symplify\PackageBuilder\DependencyInjection\CompilerPass\AutowireInterfacesCompilerPass([\PhpCsFixer\Fixer\FixerInterface::class, \PHP_CodeSniffer\Sniffs\Sniff::class, \Symplify\EasyCodingStandard\Contract\Console\Output\OutputFormatterInterface::class]));
        // exceptions
