...
use ECSPrefix20210524\Symplify\PackageBuilder\DependencyInjection\CompilerPass\AutowireInterfacesCompilerPass;
final class EasyCodingStandardBundle extends \ECSPrefix20210524\Symfony\Component\HttpKernel\Bundle\Bundle
{
    /**
    ...
    public function build(\ECSPrefix20210524\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder)
    {
        ...
        // autowire
        $containerBuilder->addCompilerPass(new \ECSPrefix20210524\Symplify\PackageBuilder\DependencyInjection\CompilerPass\AutowireInterfacesCompilerPass([\PhpCsFixer\Fixer\FixerInterface::class, \PHP_CodeSniffer\Sniffs\Sniff::class, \Symplify\EasyCodingStandard\Contract\Console\Output\OutputFormatterInterface::class]));
        // exceptions
