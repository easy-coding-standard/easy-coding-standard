...
final class SourceFinder
{
    ...
    public function __construct(\ECSPrefix20210517\Symplify\SmartFileSystem\Finder\FinderSanitizer $finderSanitizer, \ECSPrefix20210517\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \Symplify\EasyCodingStandard\Git\GitDiffProvider $gitDiffProvider)
    {
    ...
    public function find(array $source, $doesMatchGitDiff = \false)
    {
        ...
        foreach ($source as $singleSource) {
            if (\is_file($singleSource)) {
                $fileInfos[] = new \ECSPrefix20210517\Symplify\SmartFileSystem\SmartFileInfo($singleSource);
            } else {
