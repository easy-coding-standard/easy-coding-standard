...
final class SourceFinder
{
    ...
    /**
     * @var \ECSPrefix202301\Symplify\SmartFileSystem\Finder\FinderSanitizer
     */
    ...
    private function processDirectory(string $directory): array
    {
        ...
        $finder = Finder::create()->files()->name($normalizedFileExtensions)->in($directory)->exclude('vendor')->size(
            '> 0'
        )->sortByName();
