...
final class ExitCodeResolver
{
    public function resolve(\Symplify\EasyCodingStandard\ValueObject\Error\ErrorAndDiffResult $errorAndDiffResult, \Symplify\EasyCodingStandard\ValueObject\Configuration $configuration) : int
    {
        ...
        if ($configuration->isFixer()) {
            return $errorAndDiffResult->getErrorCount() === 0 ? \ECSPrefix20220403\Symfony\Component\Console\Command\Command::SUCCESS : \ECSPrefix20220403\Symfony\Component\Console\Command\Command::FAILURE;
        }
        return $errorAndDiffResult->getErrorCount() !== 0 || $errorAndDiffResult->getFileDiffsCount() !== 0 ? \ECSPrefix20220403\Symfony\Component\Console\Command\Command::FAILURE : \ECSPrefix20220403\Symfony\Component\Console\Command\Command::SUCCESS;
    }
}
