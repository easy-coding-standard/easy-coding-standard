...
final class JsonOutputFormatter implements \Symplify\EasyCodingStandard\Contract\Console\Output\OutputFormatterInterface
{
    ...
    public function report($errorAndDiffResult, $configuration) : int
    {
        ...
        return $errorCount === 0 ? \ECSPrefix20211206\Symfony\Component\Console\Command\Command::SUCCESS : \ECSPrefix20211206\Symfony\Component\Console\Command\Command::FAILURE;
    }
    ...
    public function createJsonContent($errorAndDiffResult) : string
    {
        ...
        return \ECSPrefix20211206\Nette\Utils\Json::encode($errorsArrayJson, \ECSPrefix20211206\Nette\Utils\Json::PRETTY);
    }
    /**
     * @return mixed[]
     */
