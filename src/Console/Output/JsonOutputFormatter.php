...
final class JsonOutputFormatter implements \Symplify\EasyCodingStandard\Contract\Console\Output\OutputFormatterInterface
{
    ...
    public function report($errorAndDiffResult, $configuration) : int
    {
        ...
        return $errorCount === 0 ? \ECSPrefix20211119\Symfony\Component\Console\Command\Command::SUCCESS : \ECSPrefix20211119\Symfony\Component\Console\Command\Command::FAILURE;
    }
    ...
    public function createJsonContent($errorAndDiffResult) : string
    {
        ...
        return \ECSPrefix20211119\Nette\Utils\Json::encode($errorsArray, \ECSPrefix20211119\Nette\Utils\Json::PRETTY);
    }
    /**
     * @return mixed[]
     */
