...
final class JsonOutputFormatter implements \Symplify\EasyCodingStandard\Contract\Console\Output\OutputFormatterInterface
{
    ...
    public function report($errorAndDiffResult, $configuration) : int
    {
        ...
        return $errorCount === 0 ? \ECSPrefix20210801\Symplify\PackageBuilder\Console\ShellCode::SUCCESS : \ECSPrefix20210801\Symplify\PackageBuilder\Console\ShellCode::ERROR;
    }
    ...
    public function createJsonContent($errorAndDiffResult) : string
    {
        ...
        return \ECSPrefix20210801\Nette\Utils\Json::encode($errorsArray, \ECSPrefix20210801\Nette\Utils\Json::PRETTY);
    }
    /**
     * @return mixed[]
     */
