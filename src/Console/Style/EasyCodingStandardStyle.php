...
use ECSPrefix20211127\Symplify\PackageBuilder\Reflection\PrivatesCaller;
final class EasyCodingStandardStyle extends \ECSPrefix20211127\Symfony\Component\Console\Style\SymfonyStyle
{
    /**
     ...
     */
    private $terminal;
    public function __construct(\ECSPrefix20211127\Symfony\Component\Console\Input\InputInterface $input, \ECSPrefix20211127\Symfony\Component\Console\Output\OutputInterface $output, \ECSPrefix20211127\Symfony\Component\Console\Terminal $terminal)
    {
    ...
    {
        $privatesAccessor = new \ECSPrefix20211127\Symplify\PackageBuilder\Reflection\PrivatesAccessor();
        $progressBar = $privatesAccessor->getPrivateProperty($this, 'progressBar');
        $privatesCaller = new \ECSPrefix20211127\Symplify\PackageBuilder\Reflection\PrivatesCaller();
