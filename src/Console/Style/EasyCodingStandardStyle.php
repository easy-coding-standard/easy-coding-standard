...
use ECSPrefix20210611\Symplify\PackageBuilder\Reflection\PrivatesCaller;
final class EasyCodingStandardStyle extends \ECSPrefix20210611\Symfony\Component\Console\Style\SymfonyStyle
{
    /**
    ...
    {
        $privatesAccessor = new \ECSPrefix20210611\Symplify\PackageBuilder\Reflection\PrivatesAccessor();
        $progressBar = $privatesAccessor->getPrivateProperty($this, 'progressBar');
        $privatesCaller = new \ECSPrefix20210611\Symplify\PackageBuilder\Reflection\PrivatesCaller();
