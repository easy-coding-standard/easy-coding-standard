...
final class EasyCodingStandardStyle extends \ECSPrefix20210619\Symfony\Component\Console\Style\SymfonyStyle
{
     ...
     */
    private $terminal;
    public function __construct(\ECSPrefix20210619\Symfony\Component\Console\Input\InputInterface $input, \ECSPrefix20210619\Symfony\Component\Console\Output\OutputInterface $output, \ECSPrefix20210619\Symfony\Component\Console\Terminal $terminal)
    {
    ...
    {
        $privatesAccessor = new \ECSPrefix20210619\Symplify\PackageBuilder\Reflection\PrivatesAccessor();
        $progressBar = $privatesAccessor->getPrivateProperty($this, 'progressBar');
        $privatesCaller = new \ECSPrefix20210619\Symplify\PackageBuilder\Reflection\PrivatesCaller();
