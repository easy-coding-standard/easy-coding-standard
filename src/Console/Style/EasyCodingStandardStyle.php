...
use ECSPrefix20220103\Symplify\PackageBuilder\Reflection\PrivatesCaller;
final class EasyCodingStandardStyle extends \ECSPrefix20220103\Symfony\Component\Console\Style\SymfonyStyle
{
    /**
     ...
     */
    private $terminal;
    public function __construct(\ECSPrefix20220103\Symfony\Component\Console\Input\InputInterface $input, \ECSPrefix20220103\Symfony\Component\Console\Output\OutputInterface $output, \ECSPrefix20220103\Symfony\Component\Console\Terminal $terminal)
    {
    ...
    {
        $privatesAccessor = new \ECSPrefix20220103\Symplify\PackageBuilder\Reflection\PrivatesAccessor();
        $progressBar = $privatesAccessor->getPrivateProperty($this, 'progressBar');
        $privatesCaller = new \ECSPrefix20220103\Symplify\PackageBuilder\Reflection\PrivatesCaller();
