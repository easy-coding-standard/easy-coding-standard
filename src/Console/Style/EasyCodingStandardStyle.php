...
use ECSPrefix20220511\Symfony\Component\Console\Helper\ProgressBar;
...
use ECSPrefix20220511\Symplify\PackageBuilder\Reflection\PrivatesCaller;
final class EasyCodingStandardStyle extends \ECSPrefix20220511\Symfony\Component\Console\Style\SymfonyStyle
{
    /**
     ...
     */
    private $terminal;
    public function __construct(\ECSPrefix20220511\Symfony\Component\Console\Input\InputInterface $input, \ECSPrefix20220511\Symfony\Component\Console\Output\OutputInterface $output, \ECSPrefix20220511\Symfony\Component\Console\Terminal $terminal)
    {
    ...
    {
        $privatesAccessor = new \ECSPrefix20220511\Symplify\PackageBuilder\Reflection\PrivatesAccessor();
        $progressBar = $privatesAccessor->getPrivatePropertyOfClass($this, 'progressBar', \ECSPrefix20220511\Symfony\Component\Console\Helper\ProgressBar::class);
        $privatesCaller = new \ECSPrefix20220511\Symplify\PackageBuilder\Reflection\PrivatesCaller();
