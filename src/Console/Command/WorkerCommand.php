...
use ECSPrefix20210804\Clue\React\NDJson\Decoder;
use ECSPrefix20210804\Clue\React\NDJson\Encoder;
use ECSPrefix20210804\React\EventLoop\StreamSelectLoop;
        ...
        $decoder->on(\Symplify\EasyCodingStandard\Parallel\ValueObject\ReactEvent::DATA, function (array $json) use($stdOutEncoder, $configuration) : void {
            ...
            if ($action === \Symplify\EasyCodingStandard\Parallel\ValueObject\Action::CHECK) {
                ...
                foreach ($filePaths as $filePath) {
                    try {
                        $smartFileInfo = new \ECSPrefix20210804\Symplify\SmartFileSystem\SmartFileInfo($filePath);
