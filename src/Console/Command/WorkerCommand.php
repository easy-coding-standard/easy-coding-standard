...
use ECSPrefix20210823\Clue\React\NDJson\Decoder;
use ECSPrefix20210823\Clue\React\NDJson\Encoder;
use ECSPrefix20210823\React\EventLoop\StreamSelectLoop;
use ECSPrefix20210823\React\Stream\ReadableResourceStream;
use ECSPrefix20210823\React\Stream\WritableResourceStream;
...
use ECSPrefix20210823\Symplify\PackageBuilder\Yaml\ParametersMerger;
...
final class WorkerCommand extends \Symplify\EasyCodingStandard\Console\Command\AbstractCheckCommand
{
    ...
    public function __construct(\Symplify\EasyCodingStandard\Application\SingleFileProcessor $singleFileProcessor, \ECSPrefix20210823\Symplify\PackageBuilder\Yaml\ParametersMerger $parametersMerger)
    {
    ...
    protected function execute($input, $output) : int
    {
        ...
        $streamSelectLoop = new \ECSPrefix20210823\React\EventLoop\StreamSelectLoop();
        $stdOutEncoder = new \ECSPrefix20210823\Clue\React\NDJson\Encoder(new \ECSPrefix20210823\React\Stream\WritableResourceStream(\STDOUT, $streamSelectLoop));
        ...
        $decoder = new \ECSPrefix20210823\Clue\React\NDJson\Decoder(new \ECSPrefix20210823\React\Stream\ReadableResourceStream(\STDIN, $streamSelectLoop), \true);
        $decoder->on(\Symplify\EasyCodingStandard\Parallel\ValueObject\ReactEvent::DATA, function (array $json) use($stdOutEncoder, $configuration) : void {
            ...
            if ($action === \Symplify\EasyCodingStandard\Parallel\ValueObject\Action::CHECK) {
                ...
                foreach ($filePaths as $filePath) {
                    try {
                        $smartFileInfo = new \ECSPrefix20210823\Symplify\SmartFileSystem\SmartFileInfo($filePath);
