...
use ECSPrefix20220124\React\EventLoop\StreamSelectLoop;
use ECSPrefix20220124\React\Socket\ConnectionInterface;
...
final class WorkerCommand extends \Symplify\EasyCodingStandard\Console\Command\AbstractCheckCommand
{
    ...
    protected function execute(\ECSPrefix20220124\Symfony\Component\Console\Input\InputInterface $input, \ECSPrefix20220124\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        $promise->then(function (\ECSPrefix20220124\React\Socket\ConnectionInterface $connection) use($parallelIdentifier, $configuration) : void {
            $inDecoder = new \ECSPrefix20220124\Clue\React\NDJson\Decoder($connection, \true, 512, \JSON_INVALID_UTF8_IGNORE);
            $outEncoder = new \ECSPrefix20220124\Clue\React\NDJson\Encoder($connection, \JSON_INVALID_UTF8_IGNORE);
            // handshake?
            $outEncoder->write([\ECSPrefix20220124\Symplify\EasyParallel\Enum\ReactCommand::ACTION => \ECSPrefix20220124\Symplify\EasyParallel\Enum\Action::HELLO, \ECSPrefix20220124\Symplify\EasyParallel\Enum\ReactCommand::IDENTIFIER => $parallelIdentifier]);
