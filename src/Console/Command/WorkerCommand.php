...
use ECSPrefix20210811\Clue\React\NDJson\Decoder;
...
final class WorkerCommand extends \Symplify\EasyCodingStandard\Console\Command\AbstractCheckCommand
{
    ...
    protected function execute($input, $output) : int
    {
        ...
        $streamSelectLoop = new \ECSPrefix20210811\React\EventLoop\StreamSelectLoop();
        $stdOutEncoder = new \ECSPrefix20210811\Clue\React\NDJson\Encoder(new \ECSPrefix20210811\React\Stream\WritableResourceStream(\STDOUT, $streamSelectLoop));
        ...
        $decoder = new \ECSPrefix20210811\Clue\React\NDJson\Decoder(new \ECSPrefix20210811\React\Stream\ReadableResourceStream(\STDIN, $streamSelectLoop), \true);
