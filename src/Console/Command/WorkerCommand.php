...
use ECSPrefix20210618\Clue\React\NDJson\Decoder;
use ECSPrefix20210618\Clue\React\NDJson\Encoder;
use ECSPrefix20210618\React\EventLoop\StreamSelectLoop;
use ECSPrefix20210618\React\Stream\ReadableResourceStream;
use ECSPrefix20210618\React\Stream\WritableResourceStream;
 ...
 */
final class WorkerCommand extends \ECSPrefix20210618\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    protected function configure()
    {
        ...
        $this->addArgument(\Symplify\EasyCodingStandard\ValueObject\Option::PATHS, \ECSPrefix20210618\Symfony\Component\Console\Input\InputArgument::OPTIONAL | \ECSPrefix20210618\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Paths with source code to run analysis on');
    }
    protected function execute(\ECSPrefix20210618\Symfony\Component\Console\Input\InputInterface $input, \ECSPrefix20210618\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        $streamSelectLoop = new \ECSPrefix20210618\React\EventLoop\StreamSelectLoop();
        $stdOutEncoder = new \ECSPrefix20210618\Clue\React\NDJson\Encoder(new \ECSPrefix20210618\React\Stream\WritableResourceStream(\STDOUT, $streamSelectLoop));
        ...
        $decoder = new \ECSPrefix20210618\Clue\React\NDJson\Decoder(new \ECSPrefix20210618\React\Stream\ReadableResourceStream(\STDIN, $streamSelectLoop), \true);
        $decoder->on('data', static function (array $json) use($singleFileProcessor, $stdOutEncoder) {
            ...
            if ($action === 'analyse') {
                ...
                foreach ($filePaths as $filePath) {
                    try {
                        $singleFileProcessor->processFileInfo(new \ECSPrefix20210618\Symplify\SmartFileSystem\SmartFileInfo($filePath));
