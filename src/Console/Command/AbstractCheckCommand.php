...
use ECSPrefix202301\Symfony\Contracts\Service\Attribute\Required;
...
abstract class AbstractCheckCommand extends AbstractSymplifyCommand
{
     ...
     * @required
     */
    public function autowireAbstractCheckCommand(ConfigurationFactory $configurationFactory, EasyCodingStandardApplication $easyCodingStandardApplication, EasyCodingStandardStyle $easyCodingStandardStyle) : void
    {
