...
final class ShowCommand extends \ECSPrefix20210524\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    protected function execute(\ECSPrefix20210524\Symfony\Component\Console\Input\InputInterface $input, \ECSPrefix20210524\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        if (!$this->loadedCheckersGuard->areSomeCheckerRegistered()) {
            ...
            return \ECSPrefix20210524\Symplify\PackageBuilder\Console\ShellCode::ERROR;
        }
        ...
        return \ECSPrefix20210524\Symplify\PackageBuilder\Console\ShellCode::SUCCESS;
    }
}
