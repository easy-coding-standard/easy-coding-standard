...
final class ShowCommand extends \ECSPrefix20210705\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    protected function execute(\ECSPrefix20210705\Symfony\Component\Console\Input\InputInterface $input, \ECSPrefix20210705\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        if (!$this->loadedCheckersGuard->areSomeCheckersRegistered()) {
            ...
            return \ECSPrefix20210705\Symplify\PackageBuilder\Console\ShellCode::ERROR;
        }
