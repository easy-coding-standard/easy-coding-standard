...
use ECSPrefix20220611\Composer\XdebugHandler\XdebugHandler;
...
use ECSPrefix20220611\Symplify\PackageBuilder\Console\Command\CommandNaming;
final class EasyCodingStandardConsoleApplication extends Application
{
    ...
    public function doRun(InputInterface $input, OutputInterface $output) : int
    {
        ...
        if (!$isXdebugAllowed && !\defined('ECSPrefix20220611\\PHPUNIT_COMPOSER_INSTALL')) {
