...
use ECSPrefix20220612\Composer\XdebugHandler\XdebugHandler;
...
use ECSPrefix20220612\Symplify\PackageBuilder\Console\Command\CommandNaming;
final class EasyCodingStandardConsoleApplication extends Application
{
    ...
    public function doRun(InputInterface $input, OutputInterface $output) : int
    {
        ...
        if (!$isXdebugAllowed && !\defined('ECSPrefix20220612\\PHPUNIT_COMPOSER_INSTALL')) {
