...
use ECSPrefix202301\Composer\XdebugHandler\XdebugHandler;
...
final class EasyCodingStandardConsoleApplication extends Application
{
    ...
    public function doRun(InputInterface $input, OutputInterface $output): int
    {
        ...
        if (! $isXdebugAllowed && ! \defined('ECSPrefix202301\\PHPUNIT_COMPOSER_INSTALL')) {
    ...
    private function addExtraOptions(InputDefinition $inputDefinition): void
    {
        $inputDefinition->addOption(
            new InputOption(Option::XDEBUG, null, InputOption::VALUE_NONE, 'Allow running xdebug')
        );
        $inputDefinition->addOption(
            new InputOption(Option::DEBUG, null, InputOption::VALUE_NONE, 'Run in debug mode (alias for "-vvv")')
        );
    }
}
