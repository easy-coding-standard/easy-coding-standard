...
final class ConstantReflectionSetFactory
{
    ...
    public function createSetsFromClass($setClassName)
    {
        ...
        foreach ($constants as $name => $setPath) {
            ...
            $setName = \ECSPrefix20210511\Nette\Utils\Strings::replace($setName, self::REMOVE_DASH_BEFORE_NUMBER_REGEX, '$1$2');
    ...
    private function constantToDashes($string)
    {
        ...
        return \ECSPrefix20210511\Nette\Utils\Strings::replace($string, self::UNDERSCORE_REGEX, '-');
    }
}
