...
final class AppliedCheckersCollector
{
     ...
     * @return void
     */
    public function addFileInfoAndChecker(\ECSPrefix20210526\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, string $checker)
    {
     ...
     * @return class-string[]
     */
    public function getAppliedCheckersPerFileInfo(\ECSPrefix20210526\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : array
    {
     ...
     * @return void
     */
    private function ensureFileHasAppliedCheckers(\ECSPrefix20210526\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo)
    {
