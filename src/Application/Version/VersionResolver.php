...
final class VersionResolver
{
     ...
     * @var string
     */
    public const PACKAGE_VERSION = '0e2cb6f7cf09184727366a5461a30c3e37724df0';
    /**
     * @var string
     */
    public const RELEASE_DATE = '2021-08-11 17:47:09';
    public static function resolvePackageVersion() : string
    {
        $process = new \ECSPrefix20210811\Symfony\Component\Process\Process(['git', 'log', '--pretty="%H"', '-n1', 'HEAD'], __DIR__);
        if ($process->run() !== \ECSPrefix20210811\Symfony\Component\Console\Command\Command::SUCCESS) {
