...
final class StaticVersionResolver
{
     ...
     * @var string
     */
    public const PACKAGE_VERSION = '1bc2ca86613da4d86198d3ca33a2d76805daf568';
    /**
     * @var string
     */
    public const RELEASE_DATE = '2022-06-02 13:16:39';
    /**
     * @var int
     */
    ...
    public static function resolvePackageVersion() : string
    {
        ...
        if ($tagExecResultCode !== self::SUCCESS_CODE) {
            throw new \Symplify\EasyCodingStandard\Exception\VersionException('Ensure to run compile from composer git repository clone and that git binary is available.');
        }
        if ($tagExecOutput !== []) {
            $tag = $tagExecOutput[0];
            if ($tag !== '') {
