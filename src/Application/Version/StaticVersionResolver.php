...
final class StaticVersionResolver
{
     ...
     * @var string
     */
    public const PACKAGE_VERSION = '41f4366bc190f645c11a6e36667e7d4ecf9ce789';
    /**
     * @var string
     */
    public const RELEASE_DATE = '2022-04-14 23:28:34';
    ...
    {
        $process = new \ECSPrefix20220414\Symfony\Component\Process\Process(['git', 'log', '-n1', '--pretty=%ci', 'HEAD'], __DIR__);
        if ($process->run() !== \ECSPrefix20220414\Symfony\Component\Console\Command\Command::SUCCESS) {
            throw new \Symplify\EasyCodingStandard\Exception\VersionException('You must ensure to run compile from composer git repository clone and that git binary is available.');
        }
