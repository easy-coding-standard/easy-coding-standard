...
use ECSPrefix20211223\Symplify\EasyParallel\CpuCoreCountProvider;
use ECSPrefix20211223\Symplify\EasyParallel\FileSystem\FilePathNormalizer;
use ECSPrefix20211223\Symplify\EasyParallel\ScheduleFactory;
...
final class EasyCodingStandardApplication
{
     ...
     */
    public function run(\Symplify\EasyCodingStandard\ValueObject\Configuration $configuration, \ECSPrefix20211223\Symfony\Component\Console\Input\InputInterface $input) : array
    {
