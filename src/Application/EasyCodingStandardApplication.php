...
final class EasyCodingStandardApplication
{
     ...
     */
    public function run(\Symplify\EasyCodingStandard\ValueObject\Configuration $configuration, \ECSPrefix20211106\Symfony\Component\Console\Input\InputInterface $input) : array
    {
