...
final class ConfigFormatConverter
{
    ...
    public function __construct(\ConfigTransformer20210601\Symplify\ConfigTransformer\ConfigLoader $configLoader, \ConfigTransformer20210601\Symplify\ConfigTransformer\DumperFactory $dumperFactory, \ConfigTransformer20210601\Symplify\ConfigTransformer\DumperFomatter\YamlDumpFormatter $yamlDumpFormatter, \ConfigTransformer20210601\Symplify\PhpConfigPrinter\YamlToPhpConverter $yamlToPhpConverter, \ConfigTransformer20210601\Symplify\PhpConfigPrinter\Provider\CurrentFilePathProvider $currentFilePathProvider, \ConfigTransformer20210601\Symplify\ConfigTransformer\Collector\XmlImportCollector $xmlImportCollector, \ConfigTransformer20210601\Symplify\ConfigTransformer\DependencyInjection\ContainerBuilderCleaner $containerBuilderCleaner)
    {
    ...
    public function convert(\ConfigTransformer20210601\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : string
    {
        ...
        if ($smartFileInfo->getSuffix() === \ConfigTransformer20210601\Symplify\ConfigTransformer\ValueObject\Format::YAML) {
        ...
        if ($smartFileInfo->getSuffix() === \ConfigTransformer20210601\Symplify\ConfigTransformer\ValueObject\Format::XML) {
