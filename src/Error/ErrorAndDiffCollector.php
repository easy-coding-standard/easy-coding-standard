...
final class ErrorAndDiffCollector
{
     ...
     * @return void
     */
    public function addErrorMessage(\ECSPrefix20210618\Symplify\SmartFileSystem\SmartFileInfo $fileInfo, int $line, string $message, string $sourceClass)
    {
     ...
     * @return void
     */
    public function addSystemErrorMessage(\ECSPrefix20210618\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, int $line, string $message)
    {
     ...
     * @return void
     */
    public function addDiffForFileInfo(\ECSPrefix20210618\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, string $diff, array $appliedCheckers)
    {
        $this->changedFilesDetector->invalidateFileInfo($smartFileInfo);
    ...
    private function ensureIsFixerOrChecker(string $sourceClass)
    {
        ...
        if (\strpos($sourceClass, '.') !== \false) {
            $sourceClass = (string) \ECSPrefix20210618\Nette\Utils\Strings::before($sourceClass, '.', 1);
        }
