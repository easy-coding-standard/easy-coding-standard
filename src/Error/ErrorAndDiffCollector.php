...
final class ErrorAndDiffCollector
{
     ...
     * @return void
     */
    public function addErrorMessage(\ECSPrefix20210523\Symplify\SmartFileSystem\SmartFileInfo $fileInfo, int $line, string $message, string $sourceClass)
    {
     ...
     * @return void
     */
    public function addSystemErrorMessage(\ECSPrefix20210523\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, int $line, string $message)
    {
     ...
     * @return void
     */
    public function addDiffForFileInfo(\ECSPrefix20210523\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, string $diff, array $appliedCheckers)
    {
        $this->changedFilesDetector->invalidateFileInfo($smartFileInfo);
    ...
    private function ensureIsFixerOrChecker(string $sourceClass)
    {
        ...
        if (\ECSPrefix20210523\Nette\Utils\Strings::contains($sourceClass, '.')) {
            $sourceClass = (string) \ECSPrefix20210523\Nette\Utils\Strings::before($sourceClass, '.', 1);
        }
