...
use ECSPrefix20220613\Symplify\EasyParallel\ValueObject\EasyParallelConfig;
use ECSPrefix20220613\Symplify\PackageBuilder\DependencyInjection\CompilerPass\AutowireInterfacesCompilerPass;
use ECSPrefix20220613\Symplify\PackageBuilder\ValueObject\ConsoleColorDiffConfig;
use ECSPrefix20220613\Symplify\Skipper\ValueObject\SkipperConfig;
...
final class EasyCodingStandardKernel extends AbstractSymplifyKernel
{
     ...
     */
    public function createFromConfigs(array $configFiles) : \ECSPrefix20220613\Psr\Container\ContainerInterface
    {
