...
use ECSPrefix20220521\Symplify\EasyParallel\ValueObject\EasyParallelConfig;
use ECSPrefix20220521\Symplify\PackageBuilder\DependencyInjection\CompilerPass\AutowireInterfacesCompilerPass;
use ECSPrefix20220521\Symplify\PackageBuilder\ValueObject\ConsoleColorDiffConfig;
use ECSPrefix20220521\Symplify\Skipper\ValueObject\SkipperConfig;
use ECSPrefix20220521\Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel;
final class EasyCodingStandardKernel extends \ECSPrefix20220521\Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    /**
    ...
    public function createFromConfigs(array $configFiles) : \ECSPrefix20220521\Psr\Container\ContainerInterface
    {
        ...
        $configFiles[] = \ECSPrefix20220521\Symplify\PackageBuilder\ValueObject\ConsoleColorDiffConfig::FILE_PATH;
        $configFiles[] = \ECSPrefix20220521\Symplify\Skipper\ValueObject\SkipperConfig::FILE_PATH;
        ...
        $configFiles[] = \ECSPrefix20220521\Symplify\EasyParallel\ValueObject\EasyParallelConfig::FILE_PATH;
    ...
    private function createCompilerPasses() : array
    {
        ...
        // autowire
        $compilerPasses[] = new \ECSPrefix20220521\Symplify\PackageBuilder\DependencyInjection\CompilerPass\AutowireInterfacesCompilerPass([\PhpCsFixer\Fixer\FixerInterface::class, \PHP_CodeSniffer\Sniffs\Sniff::class, \Symplify\EasyCodingStandard\Contract\Console\Output\OutputFormatterInterface::class]);
