...
use ECSPrefix20220117\Symplify\ConsoleColorDiff\ValueObject\ConsoleColorDiffConfig;
...
use ECSPrefix20220117\Symplify\EasyParallel\ValueObject\EasyParallelConfig;
use ECSPrefix20220117\Symplify\PackageBuilder\DependencyInjection\CompilerPass\AutowireInterfacesCompilerPass;
use ECSPrefix20220117\Symplify\Skipper\ValueObject\SkipperConfig;
use ECSPrefix20220117\Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel;
final class EasyCodingStandardKernel extends \ECSPrefix20220117\Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    /**
    ...
    public function createFromConfigs(array $configFiles) : \ECSPrefix20220117\Psr\Container\ContainerInterface
    {
        ...
        $configFiles[] = \ECSPrefix20220117\Symplify\ConsoleColorDiff\ValueObject\ConsoleColorDiffConfig::FILE_PATH;
        $configFiles[] = \ECSPrefix20220117\Symplify\Skipper\ValueObject\SkipperConfig::FILE_PATH;
        ...
        $configFiles[] = \ECSPrefix20220117\Symplify\EasyParallel\ValueObject\EasyParallelConfig::FILE_PATH;
    ...
    private function createCompilerPasses() : array
    {
        ...
        // autowire
        $compilerPasses[] = new \ECSPrefix20220117\Symplify\PackageBuilder\DependencyInjection\CompilerPass\AutowireInterfacesCompilerPass([\PhpCsFixer\Fixer\FixerInterface::class, \PHP_CodeSniffer\Sniffs\Sniff::class, \Symplify\EasyCodingStandard\Contract\Console\Output\OutputFormatterInterface::class]);
