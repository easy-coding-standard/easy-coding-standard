...
final class MemoryLimitter
{
    ...
    public function adjust(\Symplify\EasyCodingStandard\ValueObject\Configuration $configuration) : void
    {
        ...
        if ($memorySetResult === \false) {
            ...
            throw new \Symplify\EasyCodingStandard\Exception\Configuration\InitializationException($errorMessage);
        }
    }
    private function validateMemoryLimitFormat(string $memoryLimit) : void
    {
        $memoryLimitFormatMatch = \ECSPrefix20220220\Nette\Utils\Strings::match($memoryLimit, self::VALID_MEMORY_LIMIT_REGEX);
