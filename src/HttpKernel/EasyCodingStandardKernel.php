...
use ECSPrefix20210706\Symplify\ConsoleColorDiff\Bundle\ConsoleColorDiffBundle;
...
final class EasyCodingStandardKernel extends \ECSPrefix20210706\Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    /**
     * @return mixed[]
     */
    ...
    {
        return [new \Symplify\EasyCodingStandard\Bundle\EasyCodingStandardBundle(), new \Symplify\CodingStandard\Bundle\SymplifyCodingStandardBundle(), new \ECSPrefix20210706\Symplify\ConsoleColorDiff\Bundle\ConsoleColorDiffBundle(), new \ECSPrefix20210706\Symplify\SymplifyKernel\Bundle\SymplifyKernelBundle(), new \ECSPrefix20210706\Symplify\Skipper\Bundle\SkipperBundle()];
    }
     ...
     * @return void
     */
    protected function prepareContainer(\ECSPrefix20210706\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder)
    {
     ...
     */
    protected function getContainerLoader(\ECSPrefix20210706\Symfony\Component\DependencyInjection\ContainerInterface $container) : \ECSPrefix20210706\Symfony\Component\Config\Loader\DelegatingLoader
    {
