...
use ECSPrefix20210728\Nette\Utils\FileSystem;
...
use ECSPrefix20210728\Symplify\ConsoleColorDiff\Bundle\ConsoleColorDiffBundle;
 ...
 */
final class EasyCodingStandardKernel extends \ECSPrefix20210728\Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    /**
     * @return mixed[]
     */
    ...
    {
        return [new \Symplify\EasyCodingStandard\Bundle\EasyCodingStandardBundle(), new \Symplify\CodingStandard\Bundle\SymplifyCodingStandardBundle(), new \ECSPrefix20210728\Symplify\ConsoleColorDiff\Bundle\ConsoleColorDiffBundle(), new \ECSPrefix20210728\Symplify\SymplifyKernel\Bundle\SymplifyKernelBundle(), new \ECSPrefix20210728\Symplify\Skipper\Bundle\SkipperBundle()];
    }
    ...
    public function boot()
    {
        ...
        \ECSPrefix20210728\Nette\Utils\FileSystem::delete($cacheDir);
        \ECSPrefix20210728\Nette\Utils\FileSystem::createDir($cacheDir);
        parent::boot();
    }
    /**
     ...
     */
    protected function getContainerLoader($container) : \ECSPrefix20210728\Symfony\Component\Config\Loader\DelegatingLoader
    {
