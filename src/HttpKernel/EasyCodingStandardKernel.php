...
use ECSPrefix20210601\Symplify\ConsoleColorDiff\Bundle\ConsoleColorDiffBundle;
...
use ECSPrefix20210601\Symplify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle;
...
final class EasyCodingStandardKernel extends \ECSPrefix20210601\Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    /**
     * @return mixed[]
     */
    ...
    {
        $bundles = [new \Symplify\EasyCodingStandard\Bundle\EasyCodingStandardBundle(), new \Symplify\CodingStandard\Bundle\SymplifyCodingStandardBundle(), new \ECSPrefix20210601\Symplify\ConsoleColorDiff\Bundle\ConsoleColorDiffBundle(), new \ECSPrefix20210601\Symplify\SymplifyKernel\Bundle\SymplifyKernelBundle(), new \ECSPrefix20210601\Symplify\Skipper\Bundle\SkipperBundle()];
        if ($this->environment === 'test') {
            $bundles[] = new \ECSPrefix20210601\Symplify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle();
        }
        return $bundles;
    }
    /**
     * @return void
     */
    protected function build(\ECSPrefix20210601\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder)
    {
     ...
     */
    protected function getContainerLoader(\ECSPrefix20210601\Symfony\Component\DependencyInjection\ContainerInterface $container) : \ECSPrefix20210601\Symfony\Component\Config\Loader\DelegatingLoader
    {
