...
use ECSPrefix20211007\Nette\Utils\FileSystem;
...
use ECSPrefix20211007\Symplify\ConsoleColorDiff\Bundle\ConsoleColorDiffBundle;
 ...
 */
final class EasyCodingStandardKernel extends \ECSPrefix20211007\Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    /**
    ...
    {
        return [new \Symplify\EasyCodingStandard\Bundle\EasyCodingStandardBundle(), new \Symplify\CodingStandard\Bundle\SymplifyCodingStandardBundle(), new \ECSPrefix20211007\Symplify\ConsoleColorDiff\Bundle\ConsoleColorDiffBundle(), new \ECSPrefix20211007\Symplify\SymplifyKernel\Bundle\SymplifyKernelBundle(), new \ECSPrefix20211007\Symplify\Skipper\Bundle\SkipperBundle()];
    }
    ...
    public function boot() : void
    {
        ...
        try {
            \ECSPrefix20211007\Nette\Utils\FileSystem::delete($cacheDir);
            \ECSPrefix20211007\Nette\Utils\FileSystem::createDir($cacheDir);
     ...
     */
    protected function getContainerLoader($container) : \ECSPrefix20211007\Symfony\Component\Config\Loader\DelegatingLoader
    {
