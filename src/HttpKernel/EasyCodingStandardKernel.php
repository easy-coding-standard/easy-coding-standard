...
use ECSPrefix20210910\Nette\Utils\FileSystem;
...
use ECSPrefix20210910\Symplify\ConsoleColorDiff\Bundle\ConsoleColorDiffBundle;
 ...
 */
final class EasyCodingStandardKernel extends \ECSPrefix20210910\Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    /**
    ...
    {
        return [new \Symplify\EasyCodingStandard\Bundle\EasyCodingStandardBundle(), new \Symplify\CodingStandard\Bundle\SymplifyCodingStandardBundle(), new \ECSPrefix20210910\Symplify\ConsoleColorDiff\Bundle\ConsoleColorDiffBundle(), new \ECSPrefix20210910\Symplify\SymplifyKernel\Bundle\SymplifyKernelBundle(), new \ECSPrefix20210910\Symplify\Skipper\Bundle\SkipperBundle()];
    }
    ...
    public function boot() : void
    {
        ...
        \ECSPrefix20210910\Nette\Utils\FileSystem::delete($cacheDir);
        \ECSPrefix20210910\Nette\Utils\FileSystem::createDir($cacheDir);
        parent::boot();
    }
    /**
     ...
     */
    protected function getContainerLoader($container) : \ECSPrefix20210910\Symfony\Component\Config\Loader\DelegatingLoader
    {
