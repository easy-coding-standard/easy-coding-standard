...
use ECSPrefix20210713\Nette\Utils\FileSystem;
...
use ECSPrefix20210713\Symplify\ConsoleColorDiff\Bundle\ConsoleColorDiffBundle;
 ...
 */
final class EasyCodingStandardKernel extends \ECSPrefix20210713\Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    /**
     * @return mixed[]
     */
    ...
    {
        return [new \Symplify\EasyCodingStandard\Bundle\EasyCodingStandardBundle(), new \Symplify\CodingStandard\Bundle\SymplifyCodingStandardBundle(), new \ECSPrefix20210713\Symplify\ConsoleColorDiff\Bundle\ConsoleColorDiffBundle(), new \ECSPrefix20210713\Symplify\SymplifyKernel\Bundle\SymplifyKernelBundle(), new \ECSPrefix20210713\Symplify\Skipper\Bundle\SkipperBundle()];
    }
    ...
    public function boot()
    {
        ...
        \ECSPrefix20210713\Nette\Utils\FileSystem::delete($cacheDir);
        \ECSPrefix20210713\Nette\Utils\FileSystem::createDir($cacheDir);
        parent::boot();
    }
    /**
     ...
     */
    protected function getContainerLoader($container) : \ECSPrefix20210713\Symfony\Component\Config\Loader\DelegatingLoader
    {
