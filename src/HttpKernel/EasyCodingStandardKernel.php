...
use ECSPrefix20210831\Nette\Utils\FileSystem;
...
use ECSPrefix20210831\Symplify\ConsoleColorDiff\Bundle\ConsoleColorDiffBundle;
 ...
 */
final class EasyCodingStandardKernel extends \ECSPrefix20210831\Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    /**
    ...
    {
        return [new \Symplify\EasyCodingStandard\Bundle\EasyCodingStandardBundle(), new \Symplify\CodingStandard\Bundle\SymplifyCodingStandardBundle(), new \ECSPrefix20210831\Symplify\ConsoleColorDiff\Bundle\ConsoleColorDiffBundle(), new \ECSPrefix20210831\Symplify\SymplifyKernel\Bundle\SymplifyKernelBundle(), new \ECSPrefix20210831\Symplify\Skipper\Bundle\SkipperBundle()];
    }
    ...
    public function boot() : void
    {
        ...
        \ECSPrefix20210831\Nette\Utils\FileSystem::delete($cacheDir);
        \ECSPrefix20210831\Nette\Utils\FileSystem::createDir($cacheDir);
        parent::boot();
    }
    /**
     ...
     */
    protected function getContainerLoader($container) : \ECSPrefix20210831\Symfony\Component\Config\Loader\DelegatingLoader
    {
