...
final class SwitchFormatCommand extends \ConfigTransformer20210601\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    ...
    protected function configure()
    {
        ...
        $this->addOption(\ConfigTransformer20210601\Symplify\ConfigTransformer\ValueObject\Option::INPUT_FORMAT, 'i', \ConfigTransformer20210601\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Config format to input');
        $this->addOption(\ConfigTransformer20210601\Symplify\ConfigTransformer\ValueObject\Option::OUTPUT_FORMAT, 'o', \ConfigTransformer20210601\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Config format to output', \ConfigTransformer20210601\Symplify\ConfigTransformer\ValueObject\Format::PHP);
    ...
    protected function execute(\ConfigTransformer20210601\Symfony\Component\Console\Input\InputInterface $input, \ConfigTransformer20210601\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        $successMessage = \sprintf('Processed %d file(s) from "%s" to "%s" format', \count($fileInfos), $this->configuration->getInputFormat(), $this->configuration->getOutputFormat());
