...
use ECSPrefix202307\Illuminate\Container\RewindableGenerator;
...
final class NewContainerFactory
{
    ...
    public function create(array $configFiles = []) : Container
    {
        ...
        $ecsConfig->singleton(OutputFormatterCollector::class, static function (Container $container) : OutputFormatterCollector {
        ...
        $ecsConfig->singleton(FixerFileProcessor::class, function (Container $container) : FixerFileProcessor {
            ...
            return new FixerFileProcessor($container->make(FileToTokensParser::class), $container->make(Skipper::class), $container->make(DifferInterface::class), $container->make(EasyCodingStandardStyle::class), $container->make(Filesystem::class), $container->make(FileDiffFactory::class), $fixers);
        });
        $ecsConfig->singleton(SniffFileProcessor::class, function (Container $container) : SniffFileProcessor {
            ...
            return new SniffFileProcessor($container->make(Fixer::class), $container->make(FileFactory::class), $container->make(DifferInterface::class), $container->make(SniffMetadataCollector::class), $container->make(Filesystem::class), $container->make(FileDiffFactory::class), $sniffs);
        });
