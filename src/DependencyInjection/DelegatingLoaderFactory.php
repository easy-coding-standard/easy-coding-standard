...
use ECSPrefix20210514\Symfony\Component\Config\FileLocator as SimpleFileLocator;
use ECSPrefix20210514\Symfony\Component\Config\Loader\DelegatingLoader;
use ECSPrefix20210514\Symfony\Component\Config\Loader\GlobFileLoader;
use ECSPrefix20210514\Symfony\Component\Config\Loader\LoaderResolver;
...
final class DelegatingLoaderFactory
{
     ...
     */
    public function createFromContainerBuilderAndKernel(\ECSPrefix20210514\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, \ECSPrefix20210514\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $kernelFileLocator = new \ECSPrefix20210514\Symfony\Component\HttpKernel\Config\FileLocator($kernel);
     ...
     * @return \Symfony\Component\Config\Loader\DelegatingLoader
     */
    public function createContainerBuilderAndConfig(\ECSPrefix20210514\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, $config)
    {
        $config = (string) $config;
        $directory = \dirname($config);
        $fileLocator = new \ECSPrefix20210514\Symfony\Component\Config\FileLocator($directory);
