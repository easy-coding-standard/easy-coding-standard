...
use ECSPrefix20220523\Nette\Utils\FileSystem;
...
{
    public function createFromFromInput(\ECSPrefix20220523\Symfony\Component\Console\Input\InputInterface $input) : \ECSPrefix20220523\Symfony\Component\DependencyInjection\ContainerInterface
    {
     ...
     */
    private function reportOldContainerConfiguratorConfig(array $inputConfigFiles, \ECSPrefix20220523\Symfony\Component\DependencyInjection\ContainerInterface $container) : void
    {
        foreach ($inputConfigFiles as $inputConfigFile) {
            // warning about old syntax before ECSConfig
            $fileContents = \ECSPrefix20220523\Nette\Utils\FileSystem::read($inputConfigFile);
            if (\strpos($fileContents, 'ContainerConfigurator $containerConfigurator') === \false) {
                continue;
            }
            /** @var SymfonyStyle $symfonyStyle */
            $symfonyStyle = $container->get(\ECSPrefix20220523\Symfony\Component\Console\Style\SymfonyStyle::class);
