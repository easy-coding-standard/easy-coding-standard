...
use ECSPrefix20220521\Nette\Utils\FileSystem;
...
{
    public function createFromFromInput(\ECSPrefix20220521\Symfony\Component\Console\Input\InputInterface $input) : \ECSPrefix20220521\Symfony\Component\DependencyInjection\ContainerInterface
    {
     ...
     */
    private function reportOldContainerConfiguratorConfig(array $inputConfigFiles, \ECSPrefix20220521\Symfony\Component\DependencyInjection\ContainerInterface $container) : void
    {
        foreach ($inputConfigFiles as $inputConfigFile) {
            // warning about old syntax before ECSConfig
            $fileContents = \ECSPrefix20220521\Nette\Utils\FileSystem::read($inputConfigFile);
