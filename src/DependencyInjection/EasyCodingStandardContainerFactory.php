...
final class EasyCodingStandardContainerFactory
{
     ...
     */
    public function createFromFromInput(\ECSPrefix20210516\Symfony\Component\Console\Input\InputInterface $input)
    {
     ...
     * @return \Symfony\Component\DependencyInjection\ContainerInterface
     */
    public function createFromFromBootstrapConfigs(\ECSPrefix20210516\Symplify\SetConfigResolver\ValueObject\Bootstrap\BootstrapConfigs $bootstrapConfigs)
    {
        $environment = 'prod' . \random_int(1, 100000);
        $easyCodingStandardKernel = new \Symplify\EasyCodingStandard\HttpKernel\EasyCodingStandardKernel($environment, \ECSPrefix20210516\Symplify\PackageBuilder\Console\Input\StaticInputDetector::isDebug());
