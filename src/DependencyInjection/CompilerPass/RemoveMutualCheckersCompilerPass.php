...
final class RemoveMutualCheckersCompilerPass implements \ECSPrefix20210822\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    /**
    ...
    private const DUPLICATED_CHECKER_GROUPS = [
        ...
        [\PhpCsFixer\Fixer\Strict\StrictComparisonFixer::class, 'ECSPrefix20210822\\SlevomatCodingStandard\\Sniffs\\Operators\\DisallowEqualOperatorsSniff'],
        [\PhpCsFixer\Fixer\ClassNotation\VisibilityRequiredFixer::class, 'ECSPrefix20210822\\SlevomatCodingStandard\\Sniffs\\Classes\\ClassConstantVisibilitySniff'],
        ...
        [\PhpCsFixer\Fixer\Import\SingleImportPerStatementFixer::class, 'ECSPrefix20210822\\SlevomatCodingStandard\\Sniffs\\Namespaces\\DisallowGroupUseSniff'],
        [\PhpCsFixer\Fixer\Import\SingleImportPerStatementFixer::class, 'ECSPrefix20210822\\SlevomatCodingStandard\\Sniffs\\Namespaces\\MultipleUsesPerLineSniff'],
        [\PhpCsFixer\Fixer\Phpdoc\PhpdocScalarFixer::class, 'ECSPrefix20210822\\SlevomatCodingStandard\\Sniffs\\TypeHints\\LongTypeHintsSniff'],
        [\PhpCsFixer\Fixer\Import\OrderedImportsFixer::class, 'ECSPrefix20210822\\SlevomatCodingStandard\\Sniffs\\Namespaces\\AlphabeticallySortedUsesSniff'],
        [\PhpCsFixer\Fixer\Import\NoUnusedImportsFixer::class, 'ECSPrefix20210822\\SlevomatCodingStandard\\Sniffs\\Namespaces\\UnusedUsesSniff'],
        [\PhpCsFixer\Fixer\ControlStructure\TrailingCommaInMultilineFixer::class, 'ECSPrefix20210822\\SlevomatCodingStandard\\Sniffs\\Arrays\\TrailingArrayCommaSniff'],
        [\PhpCsFixer\Fixer\ControlStructure\NoUnneededControlParenthesesFixer::class, 'ECSPrefix20210822\\SlevomatCodingStandard\\Sniffs\\ControlStructures\\LanguageConstructWithParenthesesSniff'],
        [\PhpCsFixer\Fixer\FunctionNotation\ReturnTypeDeclarationFixer::class, 'ECSPrefix20210822\\SlevomatCodingStandard\\Sniffs\\TypeHints\\ReturnTypeHintSpacingSniff'],
        [\PhpCsFixer\Fixer\FunctionNotation\FunctionTypehintSpaceFixer::class, 'ECSPrefix20210822\\SlevomatCodingStandard\\Sniffs\\TypeHints\\ParameterTypeHintSpacingSniff'],
        ...
        [\PhpCsFixer\Fixer\Phpdoc\GeneralPhpdocAnnotationRemoveFixer::class, 'ECSPrefix20210822\\SlevomatCodingStandard\\Sniffs\\Commenting\\ForbiddenAnnotationsSniff'],
        ...
        [\PHP_CodeSniffer\Standards\Generic\Sniffs\CodeAnalysis\AssignmentInConditionSniff::class, 'ECSPrefix20210822\\SlevomatCodingStandard\\Sniffs\\ControlStructures\\AssignmentInConditionSniff'],
