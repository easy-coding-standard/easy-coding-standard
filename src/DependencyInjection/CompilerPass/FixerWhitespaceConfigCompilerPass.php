...
final class FixerWhitespaceConfigCompilerPass implements \ECSPrefix20211216\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    public function process(\ECSPrefix20211216\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : void
    {
        ...
        foreach ($definitions as $definition) {
            ...
            $definition->addMethodCall('setWhitespacesConfig', [new \ECSPrefix20211216\Symfony\Component\DependencyInjection\Reference(\PhpCsFixer\WhitespacesFixerConfig::class)]);
        }
    }
}
