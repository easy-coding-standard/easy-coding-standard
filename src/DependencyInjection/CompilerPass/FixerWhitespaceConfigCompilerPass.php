...
final class FixerWhitespaceConfigCompilerPass implements \ECSPrefix20220216\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    public function process(\ECSPrefix20220216\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : void
    {
        ...
        foreach ($definitions as $definition) {
            ...
            $definition->addMethodCall('setWhitespacesConfig', [new \ECSPrefix20220216\Symfony\Component\DependencyInjection\Reference(\PhpCsFixer\WhitespacesFixerConfig::class)]);
        }
    }
}
