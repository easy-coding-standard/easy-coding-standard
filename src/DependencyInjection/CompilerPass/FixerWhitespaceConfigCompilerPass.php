...
final class FixerWhitespaceConfigCompilerPass implements \ECSPrefix20210508\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    /**
     * @return void
     */
    public function process(\ECSPrefix20210508\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder)
    {
        ...
        foreach ($definitions as $definition) {
            ...
            $definition->addMethodCall('setWhitespacesConfig', [new \ECSPrefix20210508\Symfony\Component\DependencyInjection\Reference(\PhpCsFixer\WhitespacesFixerConfig::class)]);
        }
    }
}
