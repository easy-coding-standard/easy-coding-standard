...
final class DeprecationReporter
{
    ...
    public function reportDeprecatedSets(\ECSPrefix20220523\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, \ECSPrefix20220523\Symfony\Component\Console\Input\InputInterface $input) : void
    {
     ...
     */
    private function reportFoundSets(array $setNames, \ECSPrefix20220523\Symfony\Component\DependencyInjection\ContainerInterface $container) : void
    {
     ...
     * @return string[]
     */
    private function findDeprecatedSets(\ECSPrefix20220523\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : array
    {
        $deprecatedSets = [];
        foreach ($containerBuilder->getResources() as $resource) {
            if (!$resource instanceof \ECSPrefix20220523\Symfony\Component\Config\Resource\FileResource) {
                continue;
            }
