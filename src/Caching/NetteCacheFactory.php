...
use ECSPrefix20210511\Nette\Caching\Storages\FileStorage;
use ECSPrefix20210511\Nette\Caching\Storages\SQLiteJournal;
...
final class NetteCacheFactory
{
    ...
    public function create()
    {
        ...
        $sqlLiteJournal = new \ECSPrefix20210511\Nette\Caching\Storages\SQLiteJournal($cacheDirectory . '/_tags_journal');
        $fileStorage = new \ECSPrefix20210511\Nette\Caching\Storages\FileStorage($cacheDirectory, $sqlLiteJournal);
        // namespace is unique per project
        $namespace = \md5(\getcwd());
        return new \ECSPrefix20210511\Nette\Caching\Cache($fileStorage, $namespace);
    }
}
