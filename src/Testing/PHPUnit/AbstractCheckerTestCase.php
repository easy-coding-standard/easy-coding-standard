...
use ECSPrefix20210801\Symplify\PackageBuilder\Testing\AbstractKernelTestCase;
...
abstract class AbstractCheckerTestCase extends \ECSPrefix20210801\Symplify\PackageBuilder\Testing\AbstractKernelTestCase implements \Symplify\EasyCodingStandard\Testing\Contract\ConfigAwareInterface
{
    /**
     * @var string[]
     */
    ...
    {
        $staticFixtureSplitter = new \ECSPrefix20210801\Symplify\EasyTesting\StaticFixtureSplitter();
     ...
     * @return void
     */
    private function doTestWrongToFixedFile(\ECSPrefix20210801\Symplify\SmartFileSystem\SmartFileInfo $wrongFileInfo, string $fixedFile, \ECSPrefix20210801\Symplify\SmartFileSystem\SmartFileInfo $fixtureFileInfo)
    {
        $this->ensureSomeCheckersAreRegistered();
        if ($this->fixerFileProcessor->getCheckers() !== []) {
     ...
     * @return void
     */
    private function assertStringEqualsWithFileLocation(string $file, string $processedFileContent, \ECSPrefix20210801\Symplify\SmartFileSystem\SmartFileInfo $fixtureFileInfo)
    {
    ...
    private function getValidatedConfigs() : array
    {
        ...
        $fileSystemGuard = new \ECSPrefix20210801\Symplify\SmartFileSystem\FileSystemGuard();
