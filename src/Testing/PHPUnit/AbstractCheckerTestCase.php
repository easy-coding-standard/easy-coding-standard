...
abstract class AbstractCheckerTestCase extends \PHPUnit\Framework\TestCase implements \Symplify\EasyCodingStandard\Testing\Contract\ConfigAwareInterface
{
    ...
    protected function doTestFileInfo(\ECSPrefix20211223\Symplify\SmartFileSystem\SmartFileInfo $fileInfo) : void
    {
        $staticFixtureSplitter = new \ECSPrefix20211223\Symplify\EasyTesting\StaticFixtureSplitter();
     ...
     */
    protected function doTestCorrectFileInfo(\ECSPrefix20211223\Symplify\SmartFileSystem\SmartFileInfo $fileInfo) : void
    {
    ...
    protected function doTestFileInfoWithErrorCountOf(\ECSPrefix20211223\Symplify\SmartFileSystem\SmartFileInfo $wrongFileInfo, int $expectedErrorCount) : void
    {
        $this->ensureSomeCheckersAreRegistered();
    ...
    private function doTestWrongToFixedFile(\ECSPrefix20211223\Symplify\SmartFileSystem\SmartFileInfo $wrongFileInfo, string $fixedFile, \ECSPrefix20211223\Symplify\SmartFileSystem\SmartFileInfo $fixtureFileInfo) : void
    {
        $this->ensureSomeCheckersAreRegistered();
        if ($this->fixerFileProcessor->getCheckers() !== []) {
    ...
    private function assertStringEqualsWithFileLocation(string $file, string $processedFileContent, \ECSPrefix20211223\Symplify\SmartFileSystem\SmartFileInfo $fixtureFileInfo) : void
    {
    ...
    private function getValidatedConfigs() : array
    {
        ...
        $fileSystemGuard = new \ECSPrefix20211223\Symplify\SmartFileSystem\FileSystemGuard();
     ...
     */
    private function bootContainerWithConfigs(array $configs) : \ECSPrefix20211223\Symfony\Component\DependencyInjection\ContainerInterface
    {
        \ECSPrefix20211223\Webmozart\Assert\Assert::allString($configs);
        \ECSPrefix20211223\Webmozart\Assert\Assert::allFile($configs);
