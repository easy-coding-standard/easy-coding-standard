...
use ECSPrefix20210629\Symplify\EasyTesting\StaticFixtureSplitter;
use ECSPrefix20210629\Symplify\PackageBuilder\Testing\AbstractKernelTestCase;
...
abstract class AbstractCheckerTestCase extends \ECSPrefix20210629\Symplify\PackageBuilder\Testing\AbstractKernelTestCase implements \Symplify\EasyCodingStandard\Testing\Contract\ConfigAwareInterface
{
    /**
     * @var string[]
     */
     ...
     * @return void
     */
    protected function doTestFileInfo(\ECSPrefix20210629\Symplify\SmartFileSystem\SmartFileInfo $fileInfo)
    {
        $staticFixtureSplitter = new \ECSPrefix20210629\Symplify\EasyTesting\StaticFixtureSplitter();
     ...
     * @return void
     */
    protected function doTestCorrectFileInfo(\ECSPrefix20210629\Symplify\SmartFileSystem\SmartFileInfo $fileInfo)
    {
     ...
     * @return void
     */
    protected function doTestFileInfoWithErrorCountOf(\ECSPrefix20210629\Symplify\SmartFileSystem\SmartFileInfo $wrongFileInfo, int $expectedErrorCount)
    {
        $this->ensureSomeCheckersAreRegistered();
     ...
     * @return void
     */
    private function doTestWrongToFixedFile(\ECSPrefix20210629\Symplify\SmartFileSystem\SmartFileInfo $wrongFileInfo, string $fixedFile, \ECSPrefix20210629\Symplify\SmartFileSystem\SmartFileInfo $fixtureFileInfo)
    {
        $this->ensureSomeCheckersAreRegistered();
        if ($this->fixerFileProcessor->getCheckers() !== []) {
     ...
     * @return void
     */
    private function assertStringEqualsWithFileLocation(string $file, string $processedFileContent, \ECSPrefix20210629\Symplify\SmartFileSystem\SmartFileInfo $fixtureFileInfo)
    {
    ...
    private function getValidatedConfigs() : array
    {
        ...
        $fileSystemGuard = new \ECSPrefix20210629\Symplify\SmartFileSystem\FileSystemGuard();
