...
abstract class AbstractCheckerTestCase extends \PHPUnit\Framework\TestCase implements \Symplify\EasyCodingStandard\Testing\Contract\ConfigAwareInterface
{
    ...
    {
        $staticFixtureSplitter = new \ECSPrefix20211025\Symplify\EasyTesting\StaticFixtureSplitter();
    ...
    private function doTestWrongToFixedFile(\ECSPrefix20211025\Symplify\SmartFileSystem\SmartFileInfo $wrongFileInfo, string $fixedFile, \ECSPrefix20211025\Symplify\SmartFileSystem\SmartFileInfo $fixtureFileInfo) : void
    {
        $this->ensureSomeCheckersAreRegistered();
        if ($this->fixerFileProcessor->getCheckers() !== []) {
    ...
    private function assertStringEqualsWithFileLocation(string $file, string $processedFileContent, \ECSPrefix20211025\Symplify\SmartFileSystem\SmartFileInfo $fixtureFileInfo) : void
    {
    ...
    private function getValidatedConfigs() : array
    {
        ...
        $fileSystemGuard = new \ECSPrefix20211025\Symplify\SmartFileSystem\FileSystemGuard();
     ...
     */
    private function bootContainerWithConfigs(array $configs) : \ECSPrefix20211025\Symfony\Component\DependencyInjection\ContainerInterface
    {
        $configsHash = '';
