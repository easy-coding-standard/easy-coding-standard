...
abstract class AbstractCheckerTestCase extends \PHPUnit\Framework\TestCase implements \Symplify\EasyCodingStandard\Testing\Contract\ConfigAwareInterface
{
    ...
    protected function doTestFileInfo(\ECSPrefix20220416\Symplify\SmartFileSystem\SmartFileInfo $fileInfo) : void
    {
        $staticFixtureSplitter = new \ECSPrefix20220416\Symplify\EasyTesting\StaticFixtureSplitter();
     ...
     */
    protected function doTestCorrectFileInfo(\ECSPrefix20220416\Symplify\SmartFileSystem\SmartFileInfo $fileInfo) : void
    {
    ...
    protected function doTestFileInfoWithErrorCountOf(\ECSPrefix20220416\Symplify\SmartFileSystem\SmartFileInfo $wrongFileInfo, int $expectedErrorCount) : void
    {
        $this->ensureSomeCheckersAreRegistered();
    ...
    private function doTestWrongToFixedFile(\ECSPrefix20220416\Symplify\SmartFileSystem\SmartFileInfo $wrongFileInfo, string $fixedFile, \ECSPrefix20220416\Symplify\SmartFileSystem\SmartFileInfo $fixtureFileInfo) : void
    {
        $this->ensureSomeCheckersAreRegistered();
        if ($this->fixerFileProcessor->getCheckers() !== []) {
    ...
    private function assertStringEqualsWithFileLocation(string $file, string $processedFileContent, \ECSPrefix20220416\Symplify\SmartFileSystem\SmartFileInfo $fixtureFileInfo) : void
    {
    ...
    private function getValidatedConfigs() : array
    {
        ...
        $fileSystemGuard = new \ECSPrefix20220416\Symplify\SmartFileSystem\FileSystemGuard();
     ...
     */
    private function bootContainerWithConfigs(array $configs) : \ECSPrefix20220416\Symfony\Component\DependencyInjection\ContainerInterface
    {
        \ECSPrefix20220416\Webmozart\Assert\Assert::allString($configs);
        \ECSPrefix20220416\Webmozart\Assert\Assert::allFile($configs);
