...
abstract class AbstractCheckerTestCase extends \PHPUnit\Framework\TestCase implements \Symplify\EasyCodingStandard\Testing\Contract\ConfigAwareInterface
{
    ...
    protected function doTestFileInfo(\ECSPrefix20220521\Symplify\SmartFileSystem\SmartFileInfo $fileInfo) : void
    {
        $staticFixtureSplitter = new \ECSPrefix20220521\Symplify\EasyTesting\StaticFixtureSplitter();
     ...
     */
    protected function doTestCorrectFileInfo(\ECSPrefix20220521\Symplify\SmartFileSystem\SmartFileInfo $fileInfo) : void
    {
    ...
    protected function doTestFileInfoWithErrorCountOf(\ECSPrefix20220521\Symplify\SmartFileSystem\SmartFileInfo $wrongFileInfo, int $expectedErrorCount) : void
    {
        $this->ensureSomeCheckersAreRegistered();
    ...
    private function doTestWrongToFixedFile(\ECSPrefix20220521\Symplify\SmartFileSystem\SmartFileInfo $wrongFileInfo, string $fixedFile, \ECSPrefix20220521\Symplify\SmartFileSystem\SmartFileInfo $fixtureFileInfo) : void
    {
        $this->ensureSomeCheckersAreRegistered();
        if ($this->fixerFileProcessor->getCheckers() !== []) {
    ...
    private function assertStringEqualsWithFileLocation(string $file, string $processedFileContent, \ECSPrefix20220521\Symplify\SmartFileSystem\SmartFileInfo $fixtureFileInfo) : void
    {
    ...
    private function getValidatedConfigs() : array
    {
        ...
        $fileSystemGuard = new \ECSPrefix20220521\Symplify\SmartFileSystem\FileSystemGuard();
     ...
     */
    private function bootContainerWithConfigs(array $configs) : \ECSPrefix20220521\Symfony\Component\DependencyInjection\ContainerInterface
    {
        \ECSPrefix20220521\Webmozart\Assert\Assert::allString($configs);
        \ECSPrefix20220521\Webmozart\Assert\Assert::allFile($configs);
