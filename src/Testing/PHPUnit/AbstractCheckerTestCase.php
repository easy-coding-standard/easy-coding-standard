...
abstract class AbstractCheckerTestCase extends \PHPUnit\Framework\TestCase implements \Symplify\EasyCodingStandard\Testing\Contract\ConfigAwareInterface
{
    ...
    protected function doTestFileInfo(\ECSPrefix20220131\Symplify\SmartFileSystem\SmartFileInfo $fileInfo) : void
    {
        $staticFixtureSplitter = new \ECSPrefix20220131\Symplify\EasyTesting\StaticFixtureSplitter();
     ...
     */
    protected function doTestCorrectFileInfo(\ECSPrefix20220131\Symplify\SmartFileSystem\SmartFileInfo $fileInfo) : void
    {
    ...
    protected function doTestFileInfoWithErrorCountOf(\ECSPrefix20220131\Symplify\SmartFileSystem\SmartFileInfo $wrongFileInfo, int $expectedErrorCount) : void
    {
        $this->ensureSomeCheckersAreRegistered();
    ...
    private function doTestWrongToFixedFile(\ECSPrefix20220131\Symplify\SmartFileSystem\SmartFileInfo $wrongFileInfo, string $fixedFile, \ECSPrefix20220131\Symplify\SmartFileSystem\SmartFileInfo $fixtureFileInfo) : void
    {
        $this->ensureSomeCheckersAreRegistered();
        if ($this->fixerFileProcessor->getCheckers() !== []) {
    ...
    private function assertStringEqualsWithFileLocation(string $file, string $processedFileContent, \ECSPrefix20220131\Symplify\SmartFileSystem\SmartFileInfo $fixtureFileInfo) : void
    {
    ...
    private function getValidatedConfigs() : array
    {
        ...
        $fileSystemGuard = new \ECSPrefix20220131\Symplify\SmartFileSystem\FileSystemGuard();
     ...
     */
    private function bootContainerWithConfigs(array $configs) : \ECSPrefix20220131\Symfony\Component\DependencyInjection\ContainerInterface
    {
        \ECSPrefix20220131\Webmozart\Assert\Assert::allString($configs);
        \ECSPrefix20220131\Webmozart\Assert\Assert::allFile($configs);
