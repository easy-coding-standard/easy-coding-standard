...
abstract class AbstractCheckerTestCase extends \PHPUnit\Framework\TestCase implements \Symplify\EasyCodingStandard\Testing\Contract\ConfigAwareInterface
{
    ...
    {
        $staticFixtureSplitter = new \ECSPrefix20210804\Symplify\EasyTesting\StaticFixtureSplitter();
    ...
    private function doTestWrongToFixedFile(\ECSPrefix20210804\Symplify\SmartFileSystem\SmartFileInfo $wrongFileInfo, string $fixedFile, \ECSPrefix20210804\Symplify\SmartFileSystem\SmartFileInfo $fixtureFileInfo) : void
    {
        $this->ensureSomeCheckersAreRegistered();
        if ($this->fixerFileProcessor->getCheckers() !== []) {
    ...
    private function assertStringEqualsWithFileLocation(string $file, string $processedFileContent, \ECSPrefix20210804\Symplify\SmartFileSystem\SmartFileInfo $fixtureFileInfo) : void
    {
