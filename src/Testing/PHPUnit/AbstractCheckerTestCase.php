...
abstract class AbstractCheckerTestCase extends \Symplify\EasyCodingStandard\Testing\PHPUnit\AbstractTestCase implements ConfigAwareInterface
{
     ...
     * @var string[]
     */
    private const POSSIBLE_CODE_SNIFFER_AUTOLOAD_PATHS = [__DIR__ . '/../../../../../vendor/phpcsstandards/php_codesniffer/autoload.php', __DIR__ . '/../../../../vendor/phpcsstandards/php_codesniffer/autoload.php'];
    /**
