...
use ECSPrefix20210606\Symplify\PackageBuilder\Testing\AbstractKernelTestCase;
...
abstract class AbstractCheckerTestCase extends \ECSPrefix20210606\Symplify\PackageBuilder\Testing\AbstractKernelTestCase implements \Symplify\EasyCodingStandard\Testing\Contract\ConfigAwareInterface
{
    /**
     * @var string[]
     */
     ...
     * @return void
     */
    protected function doTestFileInfo(\ECSPrefix20210606\Symplify\SmartFileSystem\SmartFileInfo $fileInfo)
    {
        $staticFixtureSplitter = new \ECSPrefix20210606\Symplify\EasyTesting\StaticFixtureSplitter();
     ...
     * @return void
     */
    protected function doTestCorrectFileInfo(\ECSPrefix20210606\Symplify\SmartFileSystem\SmartFileInfo $fileInfo)
    {
        $this->errorAndDiffCollector->resetCounters();
     ...
     * @return void
     */
    protected function doTestFileInfoWithErrorCountOf(\ECSPrefix20210606\Symplify\SmartFileSystem\SmartFileInfo $wrongFileInfo, int $expectedErrorCount)
    {
        $this->ensureSomeCheckersAreRegistered();
        $this->errorAndDiffCollector->resetCounters();
     ...
     * @return void
     */
    private function doTestWrongToFixedFile(\ECSPrefix20210606\Symplify\SmartFileSystem\SmartFileInfo $wrongFileInfo, string $fixedFile, \ECSPrefix20210606\Symplify\SmartFileSystem\SmartFileInfo $fixtureFileInfo)
    {
     ...
     * @return void
     */
    private function assertStringEqualsWithFileLocation(string $file, string $processedFileContent, \ECSPrefix20210606\Symplify\SmartFileSystem\SmartFileInfo $fixtureFileInfo)
    {
    ...
    private function getValidatedConfigs() : array
    {
        ...
        $fileSystemGuard = new \ECSPrefix20210606\Symplify\SmartFileSystem\FileSystemGuard();
