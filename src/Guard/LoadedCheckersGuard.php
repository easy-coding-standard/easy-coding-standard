...
final class LoadedCheckersGuard
{
    ...
    public function __construct(\Symplify\EasyCodingStandard\Application\FileProcessorCollector $fileProcessorCollector, \ECSPrefix20220308\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle)
    {
