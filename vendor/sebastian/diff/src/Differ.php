...
use function substr;
use ECSPrefix202206\SebastianBergmann\Diff\Output\DiffOutputBuilderInterface;
use ECSPrefix202206\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder;
final class Differ
{
    public const OLD = 0;
