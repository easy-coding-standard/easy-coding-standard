...
final class Differ
{
    ...
    {
        if ($outputBuilder instanceof \ECSPrefix20210507\SebastianBergmann\Diff\Output\DiffOutputBuilderInterface) {
            $this->outputBuilder = $outputBuilder;
        } elseif (null === $outputBuilder) {
            $this->outputBuilder = new \ECSPrefix20210507\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder();
            ...
            // @deprecated
            $this->outputBuilder = new \ECSPrefix20210507\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder($outputBuilder);
        } else {
