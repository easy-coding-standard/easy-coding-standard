...
use function substr;
use ECSPrefix202609\SebastianBergmann\Diff\Output\DiffOutputBuilderInterface;
final class Differ
{
    /**
     * @var int
    ...
    private function detectUnmatchedLineEndings(array $diff): bool
    {
        ...
        // two-way compare
        if (array_any($newLineBreaks, static function (bool $set, string $break) use ($oldLineBreaks) {
            return !isset($oldLineBreaks[$break]);
        })) {
            return \true;
        }
        $found = \false;
