 ...
 */
namespace ECSPrefix20210804\SebastianBergmann\ObjectEnumerator;
...
class Enumerator
{
    ...
    public function enumerate($variable)
    {
        if (!\is_array($variable) && !\is_object($variable)) {
            throw new \ECSPrefix20210804\SebastianBergmann\ObjectEnumerator\InvalidArgumentException();
        }
        if (isset(\func_get_args()[1])) {
            if (!\func_get_args()[1] instanceof \ECSPrefix20210804\SebastianBergmann\RecursionContext\Context) {
                throw new \ECSPrefix20210804\SebastianBergmann\ObjectEnumerator\InvalidArgumentException();
            }
        ...
        if (\is_array($variable)) {
            ...
            $objects[] = $variable;
            $reflector = new \ECSPrefix20210804\SebastianBergmann\ObjectReflector\ObjectReflector();
