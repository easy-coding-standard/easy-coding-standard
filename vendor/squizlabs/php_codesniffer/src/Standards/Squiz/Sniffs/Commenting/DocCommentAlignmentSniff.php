...
class DocCommentAlignmentSniff implements Sniff
{
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        $ignore = [\T_CLASS => \true, \T_INTERFACE => \true, \T_ENUM => \true, \T_ENUM_CASE => \true, \T_FUNCTION => \true, \T_PUBLIC => \true, \T_PRIVATE => \true, \T_PROTECTED => \true, \T_STATIC => \true, \T_ABSTRACT => \true, \T_FINAL => \true, \T_PROPERTY => \true, \T_OBJECT => \true, \T_PROTOTYPE => \true, \T_VAR => \true, \T_READONLY => \true];
