...
class DisallowTabIndentSniff implements Sniff
{
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        $checkTokens = [\T_WHITESPACE => \true, \T_INLINE_HTML => \true, \T_DOC_COMMENT_WHITESPACE => \true, \T_DOC_COMMENT_STRING => \true, \T_COMMENT => \true, \T_END_HEREDOC => \true, \T_END_NOWDOC => \true, \T_YIELD_FROM => \true];
