...
class Config
{
    ...
    {
        if (\defined('ECSPrefix202303\\PHP_CODESNIFFER_IN_TESTS') === \true) {
    ...
    public function restoreDefaults()
    {
        ...
        if (\defined('ECSPrefix202303\\PHP_CODESNIFFER_IN_TESTS') === \false) {
            ...
            default:
                if (\substr($arg, 0, 7) === 'sniffs=') {
                    ...
                    if (\substr($arg, 0, 8) === 'exclude=') {
                        ...
                        if (\defined('ECSPrefix202303\\PHP_CODESNIFFER_IN_TESTS') === \false && \substr($arg, 0, 6) === 'cache=') {
