...
class File
{
    ...
    public function getMemberProperties($stackPtr)
    {
        ...
        $valid = [\T_STATIC => \T_STATIC, \T_VAR => \T_VAR, \T_READONLY => \T_READONLY, \T_FINAL => \T_FINAL];
        ...
        //end if
        return ['scope' => $scope, 'scope_specified' => $scopeSpecified, 'set_scope' => $setScope, 'is_static' => $isStatic, 'is_readonly' => $isReadonly, 'is_final' => $isFinal, 'type' => $type, 'type_token' => $typeToken, 'type_end_token' => $typeEndToken, 'nullable_type' => $nullableType];
    }
