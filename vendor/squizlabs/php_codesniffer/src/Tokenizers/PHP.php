                                ...
                                if ($this->tokens[$i]['code'] === \T_BITWISE_OR || $this->tokens[$i]['code'] === \T_BITWISE_AND || $this->tokens[$i]['code'] === \T_CLOSE_PARENTHESIS) {
                                    ...
                                    */
                                    ...
                                    for ($x = $i - 1; $x >= 0; $x--) {
                                        ...
                                        if ($suspectedType === 'property or parameter' && (isset(Tokens::$scopeModifiers[$this->tokens[$x]['code']]) === \true || $this->tokens[$x]['code'] === \T_VAR || $this->tokens[$x]['code'] === \T_STATIC || $this->tokens[$x]['code'] === \T_READONLY || $this->tokens[$x]['code'] === \T_FINAL)) {
