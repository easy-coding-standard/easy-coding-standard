...
abstract class Tokenizer
{
    ...
    private function createPositionMap()
    {
        ...
        $tokensWithTabs = [\T_WHITESPACE => \true, \T_COMMENT => \true, \T_DOC_COMMENT => \true, \T_DOC_COMMENT_WHITESPACE => \true, \T_DOC_COMMENT_STRING => \true, \T_CONSTANT_ENCAPSED_STRING => \true, \T_DOUBLE_QUOTED_STRING => \true, \T_START_HEREDOC => \true, \T_START_NOWDOC => \true, \T_HEREDOC => \true, \T_NOWDOC => \true, \T_END_HEREDOC => \true, \T_END_NOWDOC => \true, \T_INLINE_HTML => \true, \T_YIELD_FROM => \true];
