...
if (\class_exists('ECSPrefix202507\\PHPUnit_Framework_TestSuite') === \true && \class_exists('ECSPrefix202507\\PHPUnit\\Framework\\TestSuite') === \false) {
    \class_alias('ECSPrefix202507\\PHPUnit_Framework_TestSuite', 'PHPUnit' . '\\Framework\\TestSuite');
}
if (\class_exists('ECSPrefix202507\\PHPUnit_Framework_TestCase') === \true && \class_exists('ECSPrefix202507\\PHPUnit\\Framework\\TestCase') === \false) {
    \class_alias('ECSPrefix202507\\PHPUnit_Framework_TestCase', 'PHPUnit' . '\\Framework\\TestCase');
}
if (\class_exists('ECSPrefix202507\\PHPUnit_TextUI_TestRunner') === \true && \class_exists('ECSPrefix202507\\PHPUnit\\TextUI\\TestRunner') === \false) {
    \class_alias('ECSPrefix202507\\PHPUnit_TextUI_TestRunner', 'PHPUnit' . '\\TextUI\\TestRunner');
}
if (\class_exists('ECSPrefix202507\\PHPUnit_Framework_TestResult') === \true && \class_exists('ECSPrefix202507\\PHPUnit\\Framework\\TestResult') === \false) {
    \class_alias('ECSPrefix202507\\PHPUnit_Framework_TestResult', 'PHPUnit' . '\\Framework\\TestResult');
}
/**
...
function printPHPCodeSnifferTestOutput()
{
    ...
    if (empty($GLOBALS['PHP_CODESNIFFER_SNIFF_CASE_FILES']) === \false) {
        $files = \call_user_func_array('ECSPrefix202507\\array_merge', $GLOBALS['PHP_CODESNIFFER_SNIFF_CASE_FILES']);
