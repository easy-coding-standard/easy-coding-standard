...
class ContextSensitiveKeywordsTest extends AbstractMethodUnitTest
{
    ...
    {
        $tokens = self::$phpcsFile->getTokens();
        $token = $this->getTargetToken($testMarker, Tokens::$contextSensitiveKeywords + [\T_ANON_CLASS, \T_MATCH_DEFAULT, \T_PARENT, \T_SELF, \T_STRING, \T_NULL, \T_FALSE, \T_TRUE]);
