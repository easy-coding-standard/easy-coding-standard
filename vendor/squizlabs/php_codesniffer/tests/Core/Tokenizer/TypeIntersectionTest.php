...
class TypeIntersectionTest extends AbstractMethodUnitTest
{
    ...
    {
        return [['/* testBitwiseAnd1 */'], ['/* testBitwiseAnd2 */'], ['/* testBitwiseAndPropertyDefaultValue */'], ['/* testBitwiseAndParamDefaultValue */'], ['/* testBitwiseAnd3 */'], ['/* testBitwiseAnd4 */'], ['/* testBitwiseAnd5 */'], ['/* testBitwiseAndClosureParamDefault */'], ['/* testBitwiseAndArrowParamDefault */'], ['/* testBitwiseAndArrowExpression */'], ['/* testBitwiseAndInArrayKey */'], ['/* testBitwiseAndInArrayValue */'], ['/* testBitwiseAndInShortArrayKey */'], ['/* testBitwiseAndInShortArrayValue */'], ['/* testBitwiseAndNonArrowFnFunctionCall */'], ['/* testBitwiseAnd6 */'], ['/* testLiveCoding */']];
    }
    //end dataBitwiseAnd()
    /**
