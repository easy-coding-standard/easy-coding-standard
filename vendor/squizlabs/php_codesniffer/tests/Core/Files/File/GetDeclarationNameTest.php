...
final class GetDeclarationNameTest extends AbstractMethodUnitTest
{
    ...
    {
        return ['closure' => ['testMarker' => '/* testClosure */', 'targetType' => \T_CLOSURE], 'anon-class-with-parentheses' => ['testMarker' => '/* testAnonClassWithParens */', 'targetType' => \T_ANON_CLASS], 'anon-class-with-parentheses-2' => ['testMarker' => '/* testAnonClassWithParens2 */', 'targetType' => \T_ANON_CLASS], 'anon-class-without-parentheses' => ['testMarker' => '/* testAnonClassWithoutParens */', 'targetType' => \T_ANON_CLASS], 'anon-class-extends-without-parentheses' => ['testMarker' => '/* testAnonClassExtendsWithoutParens */', 'targetType' => \T_ANON_CLASS]];
    }
