...
final class FindStartOfStatementTest extends AbstractMethodUnitTest
{
    ...
    public static function dataFindStartInsideClosedScopeNestedWithinMatch()
    {
        return [
            ...
            'Closure function keyword should be start of closure - closure keyword' => ['testMarker' => '/* test437ClosureDeclaration */', 'target' => \T_CLOSURE, 'expectedTarget' => \T_CLOSURE],
            'Open curly is a statement/expression opener - open curly' => ['testMarker' => '/* test437ClosureDeclaration */', 'target' => \T_OPEN_CURLY_BRACKET, 'expectedTarget' => \T_OPEN_CURLY_BRACKET],
            'Echo should be start for expression - echo keyword' => ['testMarker' => '/* test437EchoNestedWithinClosureWithinMatch */', 'target' => \T_ECHO, 'expectedTarget' => \T_ECHO],
            'Echo should be start for expression - variable' => ['testMarker' => '/* test437EchoNestedWithinClosureWithinMatch */', 'target' => \T_VARIABLE, 'expectedTarget' => \T_ECHO],
            'Echo should be start for expression - comma' => ['testMarker' => '/* test437EchoNestedWithinClosureWithinMatch */', 'target' => \T_COMMA, 'expectedTarget' => \T_ECHO],
            // These were not working correctly and would previously return the close curly of the match expression.
            'First token after comma in echo expression should be start for expression - text string' => ['testMarker' => '/* test437EchoNestedWithinClosureWithinMatch */', 'target' => \T_CONSTANT_ENCAPSED_STRING, 'expectedTarget' => \T_CONSTANT_ENCAPSED_STRING],
            'First token after comma in echo expression - PHP_EOL constant' => ['testMarker' => '/* test437EchoNestedWithinClosureWithinMatch */', 'target' => \T_STRING, 'expectedTarget' => \T_STRING],
            'First token after comma in echo expression - semicolon' => ['testMarker' => '/* test437EchoNestedWithinClosureWithinMatch */', 'target' => \T_SEMICOLON, 'expectedTarget' => \T_STRING],
        ];
    }
