...
use ECSPrefix202504\PHPUnit\Framework\TestCase;
/**
 * Tests for the \PHP_CodeSniffer\Util\Common::getSniffCode() method.
 *
...
final class GetSniffCodeTest extends TestCase
{
    ...
    {
        return ['Unqualified class name' => ['ClassName'], 'Fully qualified class name, not enough parts' => ['ECSPrefix202504\\Fully\\Qualified\\ClassName'], 'Fully qualified class name, doesn\'t end on Sniff or UnitTest' => ['ECSPrefix202504\\Fully\\Sniffs\\Qualified\\ClassName']];
    }
    ...
    public static function dataGetSniffCode()
    {
        return [
            ...
            'Sniff in external standard without namespace prefix' => ['fqnClass' => 'ECSPrefix202504\\MyStandard\\Sniffs\\PHP\\MyNameSniff', 'expected' => 'MyStandard.PHP.MyName'],
            'Test in external standard without namespace prefix' => ['fqnClass' => 'ECSPrefix202504\\MyStandard\\Tests\\PHP\\MyNameUnitTest', 'expected' => 'MyStandard.PHP.MyName'],
            'Sniff in external standard with namespace prefix' => ['fqnClass' => 'ECSPrefix202504\\Vendor\\Package\\MyStandard\\Sniffs\\Category\\AnalyzeMeSniff', 'expected' => 'MyStandard.Category.AnalyzeMe'],
            'Test in external standard with namespace prefix' => ['fqnClass' => 'ECSPrefix202504\\Vendor\\Package\\MyStandard\\Tests\\Category\\AnalyzeMeUnitTest', 'expected' => 'MyStandard.Category.AnalyzeMe'],
            /*
             ...
             */
            'Fully qualified class name, ends on Sniff, but isn\'t' => ['fqnClass' => 'ECSPrefix202504\\Fully\\Sniffs\\AbstractSomethingSniff', 'expected' => '.Sniffs.AbstractSomething'],
            'Sniff provided via file include and doesn\'t comply with naming conventions [1]' => ['fqnClass' => 'CheckMeSniff', 'expected' => '..CheckMe'],
            'Sniff provided via file include and doesn\'t comply with naming conventions [2]' => ['fqnClass' => 'ECSPrefix202504\\CompanyName\\CheckMeSniff', 'expected' => '.CompanyName.CheckMe'],
            'Sniff provided via file include and doesn\'t comply with naming conventions [3]' => ['fqnClass' => 'ECSPrefix202504\\CompanyName\\Sniffs\\CheckMeSniff', 'expected' => '.Sniffs.CheckMe'],
            'Sniff provided via file include and doesn\'t comply with naming conventions [4]' => ['fqnClass' => 'ECSPrefix202504\\CompanyName\\CustomSniffs\\Whatever\\CheckMeSniff', 'expected' => 'CompanyName.Whatever.CheckMe'],
            'Sniff provided via file include and doesn\'t comply with naming conventions [5]' => ['fqnClass' => 'ECSPrefix202504\\CompanyName\\Sniffs\\Category\\Sniff', 'expected' => 'CompanyName.Category.'],
            'Sniff provided via file include and doesn\'t comply with naming conventions [6]' => ['fqnClass' => 'ECSPrefix202504\\CompanyName\\Tests\\Category\\UnitTest', 'expected' => 'CompanyName.Category.'],
            'Sniff provided via file include and doesn\'t comply with naming conventions [7]' => ['fqnClass' => 'ECSPrefix202504\\Sniffs\\Category\\NamedSniff', 'expected' => '.Category.Named'],
        ];
    }
