...
class SetSniffPropertyTest extends TestCase
{
    ...
    {
        return ['Property allowed as explicitly declared' => ['SetPropertyAllowedAsDeclared'], 'Property allowed as sniff extends stdClass' => ['SetPropertyAllowedViaStdClass'], 'Property allowed as sniff has magic __set() method' => ['SetPropertyAllowedViaMagicMethod']];
    }
    ...
    {
        return ['Property value is not an array (boolean)' => [\false], 'Property value is not an array (string)' => ['a string'], 'Property value is an empty array' => [[]], 'Property value is an array without keys' => [['value', \false]], 'Property value is an array without the "scope" or "value" keys' => [['key1' => 'value', 'key2' => \false]], 'Property value is an array without the "scope" key' => [['key1' => 'value', 'value' => \true]], 'Property value is an array without the "value" key' => [['scope' => 'value', 'key2' => 1234]]];
    }
    ...
    {
        $exceptionClass = 'ECSPrefix202401\\PHPUnit\\Framework\\Error\\Deprecated';
