...
class GetMethodParametersTest extends AbstractMethodUnitTest
{
    ...
    {
        $expected = [];
        $expected[0] = ['name' => '$var1', 'content' => '$var1=self::CONSTANT', 'default' => 'self::CONSTANT', 'has_attributes' => \false, 'pass_by_reference' => \false, 'variable_length' => \false, 'type_hint' => '', 'nullable_type' => \false];
        $this->getMethodParametersTestHelper('/* ' . __FUNCTION__ . ' */', $expected);
    }
    ...
    {
        $expected = [];
        $expected[0] = ['name' => '$var1', 'content' => '$var1=1', 'default' => '1', 'has_attributes' => \false, 'pass_by_reference' => \false, 'variable_length' => \false, 'type_hint' => '', 'nullable_type' => \false];
        $expected[1] = ['name' => '$var2', 'content' => "\$var2='value'", 'default' => "'value'", 'has_attributes' => \false, 'pass_by_reference' => \false, 'variable_length' => \false, 'type_hint' => '', 'nullable_type' => \false];
        $this->getMethodParametersTestHelper('/* ' . __FUNCTION__ . ' */', $expected);
    }
    ...
    {
        $expected = [];
        $expected[0] = ['name' => '$var1', 'content' => '?namespace\\Name $var1', 'has_attributes' => \false, 'pass_by_reference' => \false, 'variable_length' => \false, 'type_hint' => 'ECSPrefix202401\\?namespace\\Name', 'nullable_type' => \true];
        $this->getMethodParametersTestHelper('/* ' . __FUNCTION__ . ' */', $expected);
    }
    ...
    {
        $expected = [];
        $expected[0] = ['name' => '$var', 'content' => 'MyClassA|\\Package\\MyClassB $var', 'has_attributes' => \false, 'pass_by_reference' => \false, 'variable_length' => \false, 'type_hint' => 'ECSPrefix202401\\MyClassA|\\Package\\MyClassB', 'nullable_type' => \false];
        $this->getMethodParametersTestHelper('/* ' . __FUNCTION__ . ' */', $expected);
    }
    ...
    {
        $expected = [];
        $expected[0] = ['name' => '$x', 'content' => 'public $x = 0.0', 'default' => '0.0', 'has_attributes' => \false, 'pass_by_reference' => \false, 'variable_length' => \false, 'type_hint' => '', 'nullable_type' => \false, 'property_visibility' => 'public', 'property_readonly' => \false];
        $expected[1] = ['name' => '$y', 'content' => 'protected $y = \'\'', 'default' => "''", 'has_attributes' => \false, 'pass_by_reference' => \false, 'variable_length' => \false, 'type_hint' => '', 'nullable_type' => \false, 'property_visibility' => 'protected', 'property_readonly' => \false];
        $expected[2] = ['name' => '$z', 'content' => 'private $z = null', 'default' => 'null', 'has_attributes' => \false, 'pass_by_reference' => \false, 'variable_length' => \false, 'type_hint' => '', 'nullable_type' => \false, 'property_visibility' => 'private', 'property_readonly' => \false];
        $this->getMethodParametersTestHelper('/* ' . __FUNCTION__ . ' */', $expected);
    }
    ...
    {
        $expected = [];
        $expected[0] = ['name' => '$x', 'content' => 'protected float|int $x', 'has_attributes' => \false, 'pass_by_reference' => \false, 'variable_length' => \false, 'type_hint' => 'float|int', 'nullable_type' => \false, 'property_visibility' => 'protected', 'property_readonly' => \false];
        $expected[1] = ['name' => '$y', 'content' => 'public ?string &$y = \'test\'', 'default' => "'test'", 'has_attributes' => \false, 'pass_by_reference' => \true, 'variable_length' => \false, 'type_hint' => '?string', 'nullable_type' => \true, 'property_visibility' => 'public', 'property_readonly' => \false];
        $expected[2] = ['name' => '$z', 'content' => 'private mixed $z', 'has_attributes' => \false, 'pass_by_reference' => \false, 'variable_length' => \false, 'type_hint' => 'mixed', 'nullable_type' => \false, 'property_visibility' => 'private', 'property_readonly' => \false];
        $this->getMethodParametersTestHelper('/* ' . __FUNCTION__ . ' */', $expected);
    }
    ...
    {
        $expected = [];
        $expected[0] = ['name' => '$promotedProp', 'content' => 'public int $promotedProp', 'has_attributes' => \false, 'pass_by_reference' => \false, 'variable_length' => \false, 'type_hint' => 'int', 'nullable_type' => \false, 'property_visibility' => 'public', 'property_readonly' => \false];
    ...
    {
        $expected = [];
        $expected[0] = ['name' => '$promotedProp', 'content' => 'public readonly ?int $promotedProp', 'has_attributes' => \false, 'pass_by_reference' => \false, 'variable_length' => \false, 'type_hint' => '?int', 'nullable_type' => \true, 'property_visibility' => 'public', 'property_readonly' => \true];
        $expected[1] = ['name' => '$promotedToo', 'content' => 'readonly private string|bool &$promotedToo', 'has_attributes' => \false, 'pass_by_reference' => \true, 'variable_length' => \false, 'type_hint' => 'string|bool', 'nullable_type' => \false, 'property_visibility' => 'private', 'property_readonly' => \true];
        $this->getMethodParametersTestHelper('/* ' . __FUNCTION__ . ' */', $expected);
    }
    ...
    {
        $expected = [];
        $expected[0] = ['name' => '$promotedProp', 'content' => 'readonly Foo&Bar $promotedProp', 'has_attributes' => \false, 'pass_by_reference' => \false, 'variable_length' => \false, 'type_hint' => 'Foo&Bar', 'nullable_type' => \false, 'property_visibility' => 'public', 'property_readonly' => \true];
        $expected[1] = ['name' => '$promotedToo', 'content' => 'readonly ?bool $promotedToo', 'has_attributes' => \false, 'pass_by_reference' => \false, 'variable_length' => \false, 'type_hint' => '?bool', 'nullable_type' => \true, 'property_visibility' => 'public', 'property_readonly' => \true];
        $this->getMethodParametersTestHelper('/* ' . __FUNCTION__ . ' */', $expected);
    }
    ...
    {
        $expected = [];
        $expected[0] = ['name' => '$x', 'content' => 'private $x', 'has_attributes' => \false, 'pass_by_reference' => \false, 'variable_length' => \false, 'type_hint' => '', 'nullable_type' => \false, 'property_visibility' => 'private', 'property_readonly' => \false];
        $this->getMethodParametersTestHelper('/* ' . __FUNCTION__ . ' */', $expected);
    }
    ...
    {
        $expected = [];
        $expected[0] = ['name' => '$y', 'content' => 'public callable $y', 'has_attributes' => \false, 'pass_by_reference' => \false, 'variable_length' => \false, 'type_hint' => 'callable', 'nullable_type' => \false, 'property_visibility' => 'public', 'property_readonly' => \false];
        $expected[1] = ['name' => '$x', 'content' => 'private ...$x', 'has_attributes' => \false, 'pass_by_reference' => \false, 'variable_length' => \true, 'type_hint' => '', 'nullable_type' => \false, 'property_visibility' => 'private', 'property_readonly' => \false];
        $this->getMethodParametersTestHelper('/* ' . __FUNCTION__ . ' */', $expected);
    }
    ...
    ?MyClass /*-*/ & /*-*/.../*-*/ $param /*-*/ = /*-*/ \'default value\' . /*-*/ \'second part\' // Trailing comment.', 'default' => '\'default value\' . /*-*/ \'second part\' // Trailing comment.', 'has_attributes' => \false, 'pass_by_reference' => \true, 'variable_length' => \true, 'type_hint' => '?MyClass', 'nullable_type' => \true];
        $this->getMethodParametersTestHelper('/* ' . __FUNCTION__ . ' */', $expected);
    }
    ...
    {
        $expected = [];
        $expected[0] = ['name' => '$constructorPropPromTypedParamSingleAttribute', 'content' => '#[\\MyExample\\MyAttribute] private string $constructorPropPromTypedParamSingleAttribute', 'has_attributes' => \true, 'pass_by_reference' => \false, 'variable_length' => \false, 'type_hint' => 'string', 'nullable_type' => \false, 'property_visibility' => 'private', 'property_readonly' => \false];
    ...
    {
        $expected = [];
        $expected[0] = ['name' => '$obj1', 'content' => 'Foo&Bar $obj1', 'has_attributes' => \false, 'pass_by_reference' => \false, 'variable_length' => \false, 'type_hint' => 'Foo&Bar', 'nullable_type' => \false];
        $expected[1] = ['name' => '$obj2', 'content' => 'Boo&Bar $obj2', 'has_attributes' => \false, 'pass_by_reference' => \false, 'variable_length' => \false, 'type_hint' => 'Boo&Bar', 'nullable_type' => \false];
        $this->getMethodParametersTestHelper('/* ' . __FUNCTION__ . ' */', $expected);
    }
    ...
    {
        $expected = [];
        $expected[0] = ['name' => '$paramA', 'content' => 'Boo&Bar &$paramA', 'has_attributes' => \false, 'pass_by_reference' => \true, 'variable_length' => \false, 'type_hint' => 'Boo&Bar', 'nullable_type' => \false];
        $expected[1] = ['name' => '$paramB', 'content' => 'Foo&Bar ...$paramB', 'has_attributes' => \false, 'pass_by_reference' => \false, 'variable_length' => \true, 'type_hint' => 'Foo&Bar', 'nullable_type' => \false];
        $this->getMethodParametersTestHelper('/* ' . __FUNCTION__ . ' */', $expected);
    }
    ...
    {
        $expected = [];
        $expected[0] = ['name' => '$var', 'content' => 'MyClassA&\\Package\\MyClassB&\\Package\\MyClassC $var', 'has_attributes' => \false, 'pass_by_reference' => \false, 'variable_length' => \false, 'type_hint' => 'ECSPrefix202401\\MyClassA&\\Package\\MyClassB&\\Package\\MyClassC', 'nullable_type' => \false];
        $this->getMethodParametersTestHelper('/* ' . __FUNCTION__ . ' */', $expected);
    }
    ...
    {
        $expected = [];
        $expected[0] = ['name' => '$numeric_string', 'content' => 'string&int $numeric_string', 'has_attributes' => \false, 'pass_by_reference' => \false, 'variable_length' => \false, 'type_hint' => 'string&int', 'nullable_type' => \false];
        $this->getMethodParametersTestHelper('/* ' . __FUNCTION__ . ' */', $expected);
    }
    ...
    {
        $expected = [];
        $expected[0] = ['name' => '$object', 'content' => '?Foo&Bar $object', 'has_attributes' => \false, 'pass_by_reference' => \false, 'variable_length' => \false, 'type_hint' => '?Foo&Bar', 'nullable_type' => \true];
        $this->getMethodParametersTestHelper('/* ' . __FUNCTION__ . ' */', $expected);
    }
    ...
    {
        $expected = [];
        $expected[0] = ['name' => '$var', 'content' => '?true $var = true', 'default' => 'true', 'has_attributes' => \false, 'pass_by_reference' => \false, 'variable_length' => \false, 'type_hint' => '?true', 'nullable_type' => \true];
        $this->getMethodParametersTestHelper('/* ' . __FUNCTION__ . ' */', $expected);
    }
    ...
    {
        $expected = [];
        $expected[0] = ['name' => '$var', 'content' => 'true|false $var = true', 'default' => 'true', 'has_attributes' => \false, 'pass_by_reference' => \false, 'variable_length' => \false, 'type_hint' => 'true|false', 'nullable_type' => \false];
        $this->getMethodParametersTestHelper('/* ' . __FUNCTION__ . ' */', $expected);
    }
    ...
    private function getMethodParametersTestHelper($commentString, $expected)
    {
        ...
        foreach ($found as $i => $param) {
            unset($found[$i]['token'], $found[$i]['reference_token'], $found[$i]['variadic_token'], $found[$i]['type_hint_token'], $found[$i]['type_hint_end_token'], $found[$i]['comma_token'], $found[$i]['default_token'], $found[$i]['default_equal_token'], $found[$i]['visibility_token'], $found[$i]['readonly_token']);
        }
