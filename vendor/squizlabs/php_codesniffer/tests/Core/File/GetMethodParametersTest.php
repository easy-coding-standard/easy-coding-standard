...
class GetMethodParametersTest extends \PHP_CodeSniffer\Tests\Core\AbstractMethodUnitTest
{
    ...
    {
        $expected = [];
        $expected[0] = ['name' => '$var1', 'content' => '?namespace\\Name $var1', 'has_attributes' => \false, 'pass_by_reference' => \false, 'variable_length' => \false, 'type_hint' => 'ECSPrefix20211104\\?namespace\\Name', 'nullable_type' => \true];
        $this->getMethodParametersTestHelper('/* ' . __FUNCTION__ . ' */', $expected);
    }
    ...
    {
        $expected = [];
        $expected[0] = ['name' => '$var', 'content' => 'MyClassA|\\Package\\MyClassB $var', 'has_attributes' => \false, 'pass_by_reference' => \false, 'variable_length' => \false, 'type_hint' => 'ECSPrefix20211104\\MyClassA|\\Package\\MyClassB', 'nullable_type' => \false];
        $this->getMethodParametersTestHelper('/* ' . __FUNCTION__ . ' */', $expected);
    }
