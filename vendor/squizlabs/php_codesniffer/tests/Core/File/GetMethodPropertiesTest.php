...
final class GetMethodPropertiesTest extends AbstractMethodUnitTest
{
    ...
    {
        // Offsets are relative to the T_FUNCTION token.
        $expected = ['scope' => 'public', 'scope_specified' => \false, 'return_type' => 'ECSPrefix202504\\MyNamespace\\MyClass', 'return_type_token' => 7, 'return_type_end_token' => 10, 'nullable_return_type' => \false, 'is_abstract' => \false, 'is_final' => \false, 'is_static' => \false, 'has_body' => \true];
        $this->getMethodPropertiesTestHelper('/* ' . __FUNCTION__ . ' */', $expected);
    }
    ...
    {
        // Offsets are relative to the T_FUNCTION token.
        $expected = ['scope' => 'public', 'scope_specified' => \false, 'return_type' => 'ECSPrefix202504\\MyNamespace\\MyClass\\Foo', 'return_type_token' => 7, 'return_type_end_token' => 23, 'nullable_return_type' => \false, 'is_abstract' => \false, 'is_final' => \false, 'is_static' => \false, 'has_body' => \true];
        $this->getMethodPropertiesTestHelper('/* ' . __FUNCTION__ . ' */', $expected);
    }
    ...
    {
        // Offsets are relative to the T_FUNCTION token.
        $expected = ['scope' => 'public', 'scope_specified' => \false, 'return_type' => 'ECSPrefix202504\\Sub\\Level\\MyClass', 'return_type_token' => 7, 'return_type_end_token' => 11, 'nullable_return_type' => \false, 'is_abstract' => \false, 'is_final' => \false, 'is_static' => \false, 'has_body' => \true];
        $this->getMethodPropertiesTestHelper('/* ' . __FUNCTION__ . ' */', $expected);
    }
