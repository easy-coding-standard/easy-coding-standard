...
class GetMethodPropertiesTest extends \PHP_CodeSniffer\Tests\Core\AbstractMethodUnitTest
{
    ...
    {
        $expected = ['scope' => 'public', 'scope_specified' => \false, 'return_type' => 'ECSPrefix20210626\\MyNamespace\\MyClass', 'nullable_return_type' => \false, 'is_abstract' => \false, 'is_final' => \false, 'is_static' => \false, 'has_body' => \true];
        $this->getMethodPropertiesTestHelper('/* ' . __FUNCTION__ . ' */', $expected);
    }
    ...
    {
        $expected = ['scope' => 'public', 'scope_specified' => \false, 'return_type' => 'ECSPrefix20210626\\MyNamespace\\MyClass\\Foo', 'nullable_return_type' => \false, 'is_abstract' => \false, 'is_final' => \false, 'is_static' => \false, 'has_body' => \true];
        $this->getMethodPropertiesTestHelper('/* ' . __FUNCTION__ . ' */', $expected);
    }
    ...
    {
        $expected = ['scope' => 'public', 'scope_specified' => \false, 'return_type' => 'ECSPrefix20210626\\?namespace\\Name', 'nullable_return_type' => \true, 'is_abstract' => \false, 'is_final' => \false, 'is_static' => \false, 'has_body' => \true];
        $this->getMethodPropertiesTestHelper('/* ' . __FUNCTION__ . ' */', $expected);
    }
    ...
    {
        $expected = ['scope' => 'public', 'scope_specified' => \false, 'return_type' => 'ECSPrefix20210626\\MyClassA|\\Package\\MyClassB', 'nullable_return_type' => \false, 'is_abstract' => \false, 'is_final' => \false, 'is_static' => \false, 'has_body' => \true];
        $this->getMethodPropertiesTestHelper('/* ' . __FUNCTION__ . ' */', $expected);
    }
