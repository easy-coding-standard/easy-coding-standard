...
final class IsReferenceTest extends AbstractMethodUnitTest
{
    ...
    {
        return ['Not ampersand token at all' => ['testMarker' => '/* testBitwiseAndA */', 'targetTokens' => [\T_STRING]], 'ampersand in intersection type' => ['testMarker' => '/* testIntersectionIsNotReference */', 'targetTokens' => [\T_TYPE_INTERSECTION]], 'ampersand in DNF type' => ['testMarker' => '/* testDNFTypeIsNotReference */', 'targetTokens' => [\T_TYPE_INTERSECTION]]];
    }
