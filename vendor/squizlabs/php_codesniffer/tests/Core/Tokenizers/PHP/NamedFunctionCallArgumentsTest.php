...
final class NamedFunctionCallArgumentsTest extends AbstractTokenizerTestCase
{
    ...
    public static function dataNamedFunctionCallArguments()
    {
        return [
            ...
            'PHP 8.4+: named arg in exit()' => ['testMarker' => '/* testPHP84Exit */', 'parameters' => ['status']],
            'PHP 8.4+: named arg in die()' => ['testMarker' => '/* testPHP84Die */', 'parameters' => ['status']],
            'PHP 8.4+: named arg in fully qualified exit()' => ['testMarker' => '/* testPHP84FullyQualifiedExit */', 'parameters' => ['status']],
            'PHP 8.4+: named arg in fully qualified die()' => ['testMarker' => '/* testPHP84FullyQualifiedDie */', 'parameters' => ['status']],
