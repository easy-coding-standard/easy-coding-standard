...
use ECSPrefix20220317\PHPUnit\TextUI\TestRunner;
use ECSPrefix20220317\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \ECSPrefix20220317\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \ECSPrefix20220317\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
