...
use ECSPrefix20210523\PHPUnit\TextUI\TestRunner;
use ECSPrefix20210523\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \ECSPrefix20210523\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \ECSPrefix20210523\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
