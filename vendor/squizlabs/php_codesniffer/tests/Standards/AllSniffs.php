...
use ECSPrefix20210622\PHPUnit\TextUI\TestRunner;
use ECSPrefix20210622\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \ECSPrefix20210622\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \ECSPrefix20210622\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
