...
use ECSPrefix20211206\PHPUnit\TextUI\TestRunner;
use ECSPrefix20211206\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \ECSPrefix20211206\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \ECSPrefix20211206\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
