...
use ECSPrefix20220521\PHPUnit\TextUI\TestRunner;
use ECSPrefix20220521\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \ECSPrefix20220521\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \ECSPrefix20220521\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
