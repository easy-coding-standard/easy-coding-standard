...
use ECSPrefix20210919\PHPUnit\TextUI\TestRunner;
use ECSPrefix20210919\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \ECSPrefix20210919\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \ECSPrefix20210919\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
