...
use ECSPrefix20210624\PHPUnit\TextUI\TestRunner;
use ECSPrefix20210624\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \ECSPrefix20210624\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \ECSPrefix20210624\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
