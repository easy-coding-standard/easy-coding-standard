...
use ECSPrefix20220215\PHPUnit\TextUI\TestRunner;
use ECSPrefix20220215\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \ECSPrefix20220215\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \ECSPrefix20220215\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
