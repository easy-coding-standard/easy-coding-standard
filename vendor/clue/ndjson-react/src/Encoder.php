 ...
 */
class Encoder extends \ECSPrefix20220516\Evenement\EventEmitter implements \ECSPrefix20220516\React\Stream\WritableStreamInterface
{
    private $output;
    private $options;
    private $depth;
     ...
     */
    public function __construct(\ECSPrefix20220516\React\Stream\WritableStreamInterface $output, $options = 0, $depth = 512)
    {
