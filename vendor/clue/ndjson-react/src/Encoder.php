 ...
 */
class Encoder extends \ECSPrefix20220117\Evenement\EventEmitter implements \ECSPrefix20220117\React\Stream\WritableStreamInterface
{
    private $output;
    private $options;
    private $depth;
     ...
     */
    public function __construct(\ECSPrefix20220117\React\Stream\WritableStreamInterface $output, $options = 0, $depth = 512)
    {
