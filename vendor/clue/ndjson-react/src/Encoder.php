 ...
 */
class Encoder extends \ECSPrefix20210727\Evenement\EventEmitter implements \ECSPrefix20210727\React\Stream\WritableStreamInterface
{
    private $output;
    private $options;
    private $depth;
     ...
     */
    public function __construct(\ECSPrefix20210727\React\Stream\WritableStreamInterface $output, $options = 0, $depth = 512)
    {
