 ...
 */
class Encoder extends \ECSPrefix20210827\Evenement\EventEmitter implements \ECSPrefix20210827\React\Stream\WritableStreamInterface
{
    private $output;
    private $options;
    private $depth;
     ...
     */
    public function __construct(\ECSPrefix20210827\React\Stream\WritableStreamInterface $output, $options = 0, $depth = 512)
    {
