 ...
 */
class Encoder extends \ECSPrefix20210801\Evenement\EventEmitter implements \ECSPrefix20210801\React\Stream\WritableStreamInterface
{
    private $output;
    private $options;
    private $depth;
     ...
     */
    public function __construct(\ECSPrefix20210801\React\Stream\WritableStreamInterface $output, $options = 0, $depth = 512)
    {
