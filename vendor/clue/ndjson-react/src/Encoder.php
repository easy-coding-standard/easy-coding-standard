 ...
 */
class Encoder extends \ECSPrefix20210823\Evenement\EventEmitter implements \ECSPrefix20210823\React\Stream\WritableStreamInterface
{
    private $output;
    private $options;
    private $depth;
     ...
     */
    public function __construct(\ECSPrefix20210823\React\Stream\WritableStreamInterface $output, $options = 0, $depth = 512)
    {
