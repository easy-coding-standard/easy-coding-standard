 ...
 */
class Encoder extends \ECSPrefix20210810\Evenement\EventEmitter implements \ECSPrefix20210810\React\Stream\WritableStreamInterface
{
    private $output;
    private $options;
    private $depth;
     ...
     */
    public function __construct(\ECSPrefix20210810\React\Stream\WritableStreamInterface $output, $options = 0, $depth = 512)
    {
