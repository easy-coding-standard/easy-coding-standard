 ...
 */
class Encoder extends \ECSPrefix20211030\Evenement\EventEmitter implements \ECSPrefix20211030\React\Stream\WritableStreamInterface
{
    private $output;
    private $options;
    private $depth;
     ...
     */
    public function __construct(\ECSPrefix20211030\React\Stream\WritableStreamInterface $output, $options = 0, $depth = 512)
    {
