 ...
 */
class Encoder extends \ECSPrefix20220524\Evenement\EventEmitter implements \ECSPrefix20220524\React\Stream\WritableStreamInterface
{
    private $output;
    private $options;
    private $depth;
     ...
     */
    public function __construct(\ECSPrefix20220524\React\Stream\WritableStreamInterface $output, $options = 0, $depth = 512)
    {
