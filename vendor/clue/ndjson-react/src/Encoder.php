 ...
 */
class Encoder extends \ECSPrefix20220530\Evenement\EventEmitter implements \ECSPrefix20220530\React\Stream\WritableStreamInterface
{
    private $output;
    private $options;
    private $depth;
     ...
     */
    public function __construct(\ECSPrefix20220530\React\Stream\WritableStreamInterface $output, $options = 0, $depth = 512)
    {
