 ...
 */
class Decoder extends \ECSPrefix20211223\Evenement\EventEmitter implements \ECSPrefix20211223\React\Stream\ReadableStreamInterface
{
    private $input;
    private $assoc;
    private $depth;
     ...
     */
    public function __construct(\ECSPrefix20211223\React\Stream\ReadableStreamInterface $input, $assoc = \false, $depth = 512, $options = 0, $maxlength = 65536)
    {
    ...
    public function pipe(\ECSPrefix20211223\React\Stream\WritableStreamInterface $dest, array $options = array())
    {
        \ECSPrefix20211223\React\Stream\Util::pipe($this, $dest, $options);
        return $dest;
    }
    /** @internal */
