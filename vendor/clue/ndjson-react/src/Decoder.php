 ...
 */
class Decoder extends \ECSPrefix20210819\Evenement\EventEmitter implements \ECSPrefix20210819\React\Stream\ReadableStreamInterface
{
    private $input;
    private $assoc;
    private $depth;
     ...
     */
    public function __construct(\ECSPrefix20210819\React\Stream\ReadableStreamInterface $input, $assoc = \false, $depth = 512, $options = 0, $maxlength = 65536)
    {
    ...
    {
        \ECSPrefix20210819\React\Stream\Util::pipe($this, $dest, $options);
        return $dest;
    }
    /** @internal */
