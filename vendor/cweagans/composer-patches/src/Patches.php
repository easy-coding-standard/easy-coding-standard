 ...
 */
namespace ECSPrefix20220509\cweagans\Composer;

use ECSPrefix20220509\Composer\Composer;
use ECSPrefix20220509\Composer\DependencyResolver\Operation\InstallOperation;
use ECSPrefix20220509\Composer\DependencyResolver\Operation\UninstallOperation;
use ECSPrefix20220509\Composer\DependencyResolver\Operation\UpdateOperation;
use ECSPrefix20220509\Composer\DependencyResolver\Operation\OperationInterface;
use ECSPrefix20220509\Composer\EventDispatcher\EventSubscriberInterface;
use ECSPrefix20220509\Composer\IO\IOInterface;
use ECSPrefix20220509\Composer\Package\AliasPackage;
use ECSPrefix20220509\Composer\Package\PackageInterface;
use ECSPrefix20220509\Composer\Plugin\PluginInterface;
use ECSPrefix20220509\Composer\Installer\PackageEvents;
use ECSPrefix20220509\Composer\Script\Event;
use ECSPrefix20220509\Composer\Script\ScriptEvents;
use ECSPrefix20220509\Composer\Installer\PackageEvent;
use ECSPrefix20220509\Composer\Util\ProcessExecutor;
use ECSPrefix20220509\Composer\Util\RemoteFilesystem;
use ECSPrefix20220509\Symfony\Component\Process\Process;
class Patches implements \ECSPrefix20220509\Composer\Plugin\PluginInterface, \ECSPrefix20220509\Composer\EventDispatcher\EventSubscriberInterface
{
    /**
     ...
     */
    public function activate(\ECSPrefix20220509\Composer\Composer $composer, \ECSPrefix20220509\Composer\IO\IOInterface $io)
    {
        $this->composer = $composer;
        $this->io = $io;
        $this->eventDispatcher = $composer->getEventDispatcher();
        $this->executor = new \ECSPrefix20220509\Composer\Util\ProcessExecutor($this->io);
        $this->patches = array();
    ...
    {
        return array(
            \ECSPrefix20220509\Composer\Script\ScriptEvents::PRE_INSTALL_CMD => array('checkPatches'),
            \ECSPrefix20220509\Composer\Script\ScriptEvents::PRE_UPDATE_CMD => array('checkPatches'),
            \ECSPrefix20220509\Composer\Installer\PackageEvents::PRE_PACKAGE_INSTALL => array('gatherPatches'),
            \ECSPrefix20220509\Composer\Installer\PackageEvents::PRE_PACKAGE_UPDATE => array('gatherPatches'),
            ...
            \ECSPrefix20220509\Composer\Installer\PackageEvents::POST_PACKAGE_INSTALL => array('postInstall', 10),
            \ECSPrefix20220509\Composer\Installer\PackageEvents::POST_PACKAGE_UPDATE => array('postInstall', 10),
        );
    }
    /**
     ...
     * @param Event $event
     */
    public function checkPatches(\ECSPrefix20220509\Composer\Script\Event $event)
    {
        ...
        try {
            ...
            $promises = array();
            foreach ($packages as $package) {
                if (!$package instanceof \ECSPrefix20220509\Composer\Package\AliasPackage) {
                    ...
                    if ($has_patches && !$has_applied_patches || !$has_patches && $has_applied_patches || $has_patches && $has_applied_patches && $tmp_patches[$package_name] !== $extra['patches_applied']) {
                        $uninstallOperation = new \ECSPrefix20220509\Composer\DependencyResolver\Operation\UninstallOperation($package, 'Removing package so it can be re-installed and re-patched.');
     ...
     */
    public function gatherPatches(\ECSPrefix20220509\Composer\Installer\PackageEvent $event)
    {
        // If we've already done this, then don't do it again.
        if (isset($this->patches['_patchesGathered'])) {
            $this->io->write('<info>Patches already gathered. Skipping</info>', TRUE, \ECSPrefix20220509\Composer\IO\IOInterface::VERBOSE);
            return;
        } elseif (!$this->isPatchingEnabled()) {
            $this->io->write('<info>Patching is disabled. Skipping.</info>', TRUE, \ECSPrefix20220509\Composer\IO\IOInterface::VERBOSE);
            return;
        }
        ...
        foreach ($operations as $operation) {
            if ($operation instanceof \ECSPrefix20220509\Composer\DependencyResolver\Operation\InstallOperation || $operation instanceof \ECSPrefix20220509\Composer\DependencyResolver\Operation\UpdateOperation) {
     ...
     * @throws \Exception
     */
    public function postInstall(\ECSPrefix20220509\Composer\Installer\PackageEvent $event)
    {
        ...
        // Set up a downloader.
        $downloader = new \ECSPrefix20220509\Composer\Util\RemoteFilesystem($this->io, $this->composer->getConfig());
        ...
        foreach ($this->patches[$package_name] as $description => $url) {
            ...
            try {
                $this->eventDispatcher->dispatch(NULL, new \ECSPrefix20220509\cweagans\Composer\PatchEvent(\ECSPrefix20220509\cweagans\Composer\PatchEvents::PRE_PATCH_APPLY, $package, $url, $description));
                $this->getAndApplyPatch($downloader, $install_path, $url, $package);
                $this->eventDispatcher->dispatch(NULL, new \ECSPrefix20220509\cweagans\Composer\PatchEvent(\ECSPrefix20220509\cweagans\Composer\PatchEvents::POST_PATCH_APPLY, $package, $url, $description));
     ...
     * @throws \Exception
     */
    protected function getPackageFromOperation(\ECSPrefix20220509\Composer\DependencyResolver\Operation\OperationInterface $operation)
    {
        if ($operation instanceof \ECSPrefix20220509\Composer\DependencyResolver\Operation\InstallOperation) {
            $package = $operation->getPackage();
        } elseif ($operation instanceof \ECSPrefix20220509\Composer\DependencyResolver\Operation\UpdateOperation) {
     ...
     * @throws \Exception
     */
    protected function getAndApplyPatch(\ECSPrefix20220509\Composer\Util\RemoteFilesystem $downloader, $install_path, $patch_url, \ECSPrefix20220509\Composer\Package\PackageInterface $package)
    {
        // Local patch file.
    ...
    protected function executeCommand($cmd)
    {
        ...
        if ($this->io->isVerbose()) {
            ...
            $output = function ($type, $data) use($io) {
                if ($type == \ECSPrefix20220509\Symfony\Component\Process\Process::ERR) {
     ...
     */
    public static function isPackagePatched(\ECSPrefix20220509\Composer\Package\PackageInterface $package)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\ECSPrefix20220509\Composer\Composer $composer, \ECSPrefix20220509\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\ECSPrefix20220509\Composer\Composer $composer, \ECSPrefix20220509\Composer\IO\IOInterface $io)
    {
    }
}
