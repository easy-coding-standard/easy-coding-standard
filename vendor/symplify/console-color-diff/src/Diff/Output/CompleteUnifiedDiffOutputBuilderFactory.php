...
use ECSPrefix20210511\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder;
...
final class CompleteUnifiedDiffOutputBuilderFactory
{
    ...
    {
        $unifiedDiffOutputBuilder = new \ECSPrefix20210511\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder('');
