...
use ECSPrefix20210510\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder;
...
final class CompleteUnifiedDiffOutputBuilderFactory
{
    ...
    {
        $unifiedDiffOutputBuilder = new \ECSPrefix20210510\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder('');
