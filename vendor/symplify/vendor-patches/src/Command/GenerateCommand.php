...
namespace ECSPrefix20220523\Symplify\VendorPatches\Command;
...
use ECSPrefix20220523\Symplify\PackageBuilder\Composer\VendorDirProvider;
...
use ECSPrefix20220523\Symplify\VendorPatches\Composer\ComposerPatchesConfigurationUpdater;
use ECSPrefix20220523\Symplify\VendorPatches\Console\GenerateCommandReporter;
use ECSPrefix20220523\Symplify\VendorPatches\Differ\PatchDiffer;
use ECSPrefix20220523\Symplify\VendorPatches\Finder\OldToNewFilesFinder;
use ECSPrefix20220523\Symplify\VendorPatches\PatchFileFactory;
final class GenerateCommand extends \ECSPrefix20220523\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    public function __construct(\ECSPrefix20220523\Symplify\VendorPatches\Finder\OldToNewFilesFinder $oldToNewFilesFinder, \ECSPrefix20220523\Symplify\VendorPatches\Differ\PatchDiffer $patchDiffer, \ECSPrefix20220523\Symplify\VendorPatches\Composer\ComposerPatchesConfigurationUpdater $composerPatchesConfigurationUpdater, \ECSPrefix20220523\Symplify\PackageBuilder\Composer\VendorDirProvider $vendorDirProvider, \ECSPrefix20220523\Symplify\VendorPatches\PatchFileFactory $patchFileFactory, \ECSPrefix20220523\Symplify\VendorPatches\Console\GenerateCommandReporter $generateCommandReporter)
    {
    ...
    {
        $this->setName(\ECSPrefix20220523\Symplify\PackageBuilder\Console\Command\CommandNaming::classToName(self::class));
