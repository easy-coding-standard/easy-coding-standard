...
namespace ECSPrefix20220527\Symplify\VendorPatches\Composer;
...
use ECSPrefix20220527\Symplify\VendorPatches\FileSystem\PathResolver;
/**
...
final class PackageNameResolver
{
    ...
    public function __construct(\ECSPrefix20220527\Symplify\SmartFileSystem\Json\JsonFileSystem $jsonFileSystem, \ECSPrefix20220527\Symplify\VendorPatches\FileSystem\PathResolver $pathResolver, \ECSPrefix20220527\Symplify\SmartFileSystem\FileSystemGuard $fileSystemGuard)
    {
        $this->jsonFileSystem = $jsonFileSystem;
        $this->pathResolver = $pathResolver;
        $this->fileSystemGuard = $fileSystemGuard;
    }
    public function resolveFromFileInfo(\ECSPrefix20220527\Symplify\SmartFileSystem\SmartFileInfo $vendorFile) : string
    {
    ...
    private function getPackageComposerJsonFilePath(\ECSPrefix20220527\Symplify\SmartFileSystem\SmartFileInfo $vendorFileInfo) : string
    {
