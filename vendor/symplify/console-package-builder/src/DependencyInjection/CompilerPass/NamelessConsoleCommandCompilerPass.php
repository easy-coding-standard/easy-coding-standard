 ...
 */
final class NamelessConsoleCommandCompilerPass implements \ECSPrefix20210509\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    /**
     * @return void
     */
    public function process(\ECSPrefix20210509\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder)
    {
        foreach ($containerBuilder->getDefinitions() as $definition) {
            ...
            if (!\is_a($definitionClass, \ECSPrefix20210509\Symfony\Component\Console\Command\Command::class, \true)) {
                continue;
            }
