...
final class JsonFileSystem
{
    ...
    {
        $filePath = (string) $filePath;
        $jsonContent = \ECSPrefix20210513\Nette\Utils\Json::encode($jsonArray, \ECSPrefix20210513\Nette\Utils\Json::PRETTY) . \PHP_EOL;
    ...
    public function mergeArrayToJsonFile($filePath, array $newJsonArray)
    {
        ...
        $newComposerJsonArray = \ECSPrefix20210513\Nette\Utils\Arrays::mergeTree($jsonArray, $newJsonArray);
