...
namespace ECSPrefix20210612\Symplify\SmartFileSystem\Json;
...
final class JsonFileSystem
{
    ...
    {
        $jsonContent = \ECSPrefix20210612\Nette\Utils\Json::encode($jsonArray, \ECSPrefix20210612\Nette\Utils\Json::PRETTY) . \PHP_EOL;
    ...
    public function mergeArrayToJsonFile(string $filePath, array $newJsonArray)
    {
        ...
        $newComposerJsonArray = \ECSPrefix20210612\Nette\Utils\Arrays::mergeTree($jsonArray, $newJsonArray);
