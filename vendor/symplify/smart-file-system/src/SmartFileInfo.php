 ...
 */
final class SmartFileInfo extends \ECSPrefix20210513\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\ECSPrefix20210513\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \ECSPrefix20210513\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    /**
     * @return string
     */
    ...
    public function endsWith($string)
    {
        ...
        return \ECSPrefix20210513\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
    /**
     * @param string $string
     * @return bool
    ...
    public function startsWith($partialPath)
    {
        ...
        return \ECSPrefix20210513\Nette\Utils\Strings::startsWith($this->getNormalizedRealPath(), $partialPath);
    }
    /**
     * @return string
     */
