 ...
 */
final class SmartFileSystem extends \ECSPrefix20210629\Symfony\Component\Filesystem\Filesystem
{
    /**
     * @var string
    ...
    public function readFile(string $filename) : string
    {
        ...
        if (!$source) {
            ...
            throw new \ECSPrefix20210629\Symfony\Component\Filesystem\Exception\IOException($message, 0, null, $filename);
        }
        return $source;
    }
    public function readFileToSmartFileInfo(string $filename) : \ECSPrefix20210629\Symplify\SmartFileSystem\SmartFileInfo
    {
        return new \ECSPrefix20210629\Symplify\SmartFileSystem\SmartFileInfo($filename);
    }
    /**
    ...
    private function getLastError() : string
    {
        ...
        return \ECSPrefix20210629\Nette\Utils\Strings::replace($message, self::BEFORE_COLLON_REGEX, '');
    }
}
