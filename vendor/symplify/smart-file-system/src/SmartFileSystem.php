 ...
 */
final class SmartFileSystem extends \ECSPrefix20210517\Symfony\Component\Filesystem\Filesystem
{
    /**
     * @var string
    ...
    public function readFile($filename)
    {
        ...
        if (!$source) {
            ...
            throw new \ECSPrefix20210517\Symfony\Component\Filesystem\Exception\IOException($message, 0, null, $filename);
        }
        return $source;
    }
    /**
