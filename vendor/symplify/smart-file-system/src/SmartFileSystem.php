 ...
 */
final class SmartFileSystem extends \ECSPrefix20210714\Symfony\Component\Filesystem\Filesystem
{
    /**
     * @var string
    ...
    public function readFile($filename) : string
    {
        ...
        if (!$source) {
            ...
            throw new \ECSPrefix20210714\Symfony\Component\Filesystem\Exception\IOException($message, 0, null, $filename);
        }
        return $source;
    }
    /**
     * @param string $filename
     */
    public function readFileToSmartFileInfo($filename) : \ECSPrefix20210714\Symplify\SmartFileSystem\SmartFileInfo
    {
        return new \ECSPrefix20210714\Symplify\SmartFileSystem\SmartFileInfo($filename);
    }
    /**
    ...
    private function getLastError() : string
    {
        ...
        return \ECSPrefix20210714\Nette\Utils\Strings::replace($message, self::BEFORE_COLLON_REGEX, '');
    }
}
