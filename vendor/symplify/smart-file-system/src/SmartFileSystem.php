 ...
 */
final class SmartFileSystem extends \ECSPrefix20210515\Symfony\Component\Filesystem\Filesystem
{
    /**
     * @var string
    ...
    public function readFile($filename)
    {
        ...
        if (!$source) {
            ...
            throw new \ECSPrefix20210515\Symfony\Component\Filesystem\Exception\IOException($message, 0, null, $filename);
        }
        return $source;
    }
    /**
    ...
    {
        $filename = (string) $filename;
        return new \ECSPrefix20210515\Symplify\SmartFileSystem\SmartFileInfo($filename);
    }
    /**
    ...
    private function getLastError()
    {
        ...
        return \ECSPrefix20210515\Nette\Utils\Strings::replace($message, self::BEFORE_COLLON_REGEX, '');
    }
}
