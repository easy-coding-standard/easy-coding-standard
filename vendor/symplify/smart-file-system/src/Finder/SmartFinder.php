...
final class SmartFinder
{
    ...
    public function __construct(\ConfigTransformer20210601\Symplify\SmartFileSystem\Finder\FinderSanitizer $finderSanitizer, \ConfigTransformer20210601\Symplify\SmartFileSystem\FileSystemFilter $fileSystemFilter)
    {
    ...
    public function find(array $directoriesOrFiles, string $name, array $excludedDirectories = []) : array
    {
        ...
        foreach ($files as $file) {
            $fileInfos[] = new \ConfigTransformer20210601\Symplify\SmartFileSystem\SmartFileInfo($file);
        }
        return $fileInfos;
    }
}
