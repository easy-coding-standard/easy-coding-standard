...
namespace ECSPrefix20210810\Symplify\SmartFileSystem\Normalizer;
...
final class PathNormalizer
{
    ...
    {
        $matches = \ECSPrefix20210810\Nette\Utils\Strings::match($originalPath, self::SCHEME_PATH_REGEX);
        if ($matches !== null) {
            [, $scheme, $path] = $matches;
        } else {
        ...
        $path = \ECSPrefix20210810\Nette\Utils\Strings::replace($normalizedPath, self::TWO_AND_MORE_SLASHES_REGEX, '/');
