...
namespace ECSPrefix20211203\Symplify\SmartFileSystem\Normalizer;
...
final class PathNormalizer
{
    ...
    public function normalizePath(string $originalPath) : string
    {
        ...
        $matches = \ECSPrefix20211203\Nette\Utils\Strings::match($originalPath, self::SCHEME_PATH_REGEX);
        if ($matches !== null) {
            [, $scheme, $path] = $matches;
        } else {
        ...
        $path = \ECSPrefix20211203\Nette\Utils\Strings::replace($normalizedPath, self::TWO_AND_MORE_SLASHES_REGEX, '/');
