...
namespace ECSPrefix20210804\Symplify\SmartFileSystem\Normalizer;
...
final class PathNormalizer
{
    ...
    public function normalizePath(string $originalPath, string $directorySeparator = \DIRECTORY_SEPARATOR) : string
    {
        ...
        $path = \ECSPrefix20210804\Nette\Utils\Strings::replace($normalizedPath, self::TWO_AND_MORE_SLASHES_REGEX, '/');
