...
final class FileSystemGuard
{
    ...
    public function ensureFileExists($file, $location)
    {
        ...
        throw new \ECSPrefix20210517\Symplify\SmartFileSystem\Exception\FileNotFoundException(\sprintf('File "%s" not found in "%s".', $file, $location));
    }
    /**
     * @return void
    ...
    public function ensureDirectoryExists($directory, $extraMessage = '')
    {
        ...
        throw new \ECSPrefix20210517\Symplify\SmartFileSystem\Exception\DirectoryNotFoundException($message);
    }
}
