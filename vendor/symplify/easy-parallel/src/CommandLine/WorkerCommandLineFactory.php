...
namespace ECSPrefix20211125\Symplify\EasyParallel\CommandLine;
...
use ECSPrefix20211125\Symplify\EasyParallel\Reflection\CommandFromReflectionFactory;
/**
...
final class WorkerCommandLineFactory
{
    ...
    {
        $this->commandFromReflectionFactory = new \ECSPrefix20211125\Symplify\EasyParallel\Reflection\CommandFromReflectionFactory();
    }
    /**
     * @param class-string<Command> $mainCommandClass
     */
    public function create(string $baseScript, string $mainCommandClass, string $workerCommandName, string $pathsOptionName, ?string $projectConfigFile, \ECSPrefix20211125\Symfony\Component\Console\Input\InputInterface $input, string $identifier, int $port) : string
    {
        ...
        if ($mainCommand->getName() === null) {
            ...
            throw new \ECSPrefix20211125\Symplify\EasyParallel\Exception\ParallelShouldNotHappenException($errorMessage);
        }
     ...
     * @return string[]
     */
    private function getCommandOptionNames(\ECSPrefix20211125\Symfony\Component\Console\Command\Command $command) : array
    {
     ...
     * @return string[]
     */
    private function mirrorCommandOptions(\ECSPrefix20211125\Symfony\Component\Console\Input\InputInterface $input, array $mainCommandOptionNames) : array
    {
    ...
    private function shouldSkipOption(\ECSPrefix20211125\Symfony\Component\Console\Input\InputInterface $input, string $optionName) : bool
    {
