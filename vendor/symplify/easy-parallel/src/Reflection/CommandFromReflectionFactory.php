...
namespace ECSPrefix20220511\Symplify\EasyParallel\Reflection;
...
final class CommandFromReflectionFactory
{
     ...
     */
    public function create(string $className) : \ECSPrefix20220511\Symfony\Component\Console\Command\Command
    {
