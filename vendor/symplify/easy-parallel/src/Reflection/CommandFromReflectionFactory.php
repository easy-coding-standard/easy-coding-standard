...
namespace ECSPrefix20220307\Symplify\EasyParallel\Reflection;
...
final class CommandFromReflectionFactory
{
     ...
     */
    public function create(string $className) : \ECSPrefix20220307\Symfony\Component\Console\Command\Command
    {
        ...
        if (!$parentClassReflection instanceof \ReflectionClass) {
            throw new \ECSPrefix20220307\Symplify\EasyParallel\Exception\ParallelShouldNotHappenException();
        }
