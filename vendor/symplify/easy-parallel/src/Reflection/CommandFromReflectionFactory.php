...
namespace ECSPrefix20220512\Symplify\EasyParallel\Reflection;
...
final class CommandFromReflectionFactory
{
     ...
     */
    public function create(string $className) : \ECSPrefix20220512\Symfony\Component\Console\Command\Command
    {
