...
namespace ECSPrefix20220414\Symplify\EasyParallel\Reflection;
...
final class CommandFromReflectionFactory
{
     ...
     */
    public function create(string $className) : \ECSPrefix20220414\Symfony\Component\Console\Command\Command
    {
