...
namespace ECSPrefix20220521\Symplify\EasyParallel\Reflection;
...
final class CommandFromReflectionFactory
{
     ...
     */
    public function create(string $className) : \ECSPrefix20220521\Symfony\Component\Console\Command\Command
    {
