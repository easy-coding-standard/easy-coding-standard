...
namespace ECSPrefix20220531\Symplify\EasyParallel\Reflection;
...
final class CommandFromReflectionFactory
{
     ...
     */
    public function create(string $className) : \ECSPrefix20220531\Symfony\Component\Console\Command\Command
    {
