...
namespace ECSPrefix20220513\Symplify\EasyParallel\Reflection;
...
final class CommandFromReflectionFactory
{
     ...
     */
    public function create(string $className) : \ECSPrefix20220513\Symfony\Component\Console\Command\Command
    {
