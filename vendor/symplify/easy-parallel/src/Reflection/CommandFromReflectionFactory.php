...
namespace ECSPrefix20220520\Symplify\EasyParallel\Reflection;
...
final class CommandFromReflectionFactory
{
     ...
     */
    public function create(string $className) : \ECSPrefix20220520\Symfony\Component\Console\Command\Command
    {
