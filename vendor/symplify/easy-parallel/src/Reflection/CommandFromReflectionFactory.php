...
namespace ECSPrefix20220418\Symplify\EasyParallel\Reflection;
...
final class CommandFromReflectionFactory
{
     ...
     */
    public function create(string $className) : \ECSPrefix20220418\Symfony\Component\Console\Command\Command
    {
