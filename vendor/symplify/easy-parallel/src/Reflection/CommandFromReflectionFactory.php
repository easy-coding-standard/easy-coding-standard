...
namespace ECSPrefix20220417\Symplify\EasyParallel\Reflection;
...
final class CommandFromReflectionFactory
{
     ...
     */
    public function create(string $className) : \ECSPrefix20220417\Symfony\Component\Console\Command\Command
    {
