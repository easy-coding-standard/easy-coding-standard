...
namespace ECSPrefix20220601\Symplify\EasyParallel\Reflection;
...
final class CommandFromReflectionFactory
{
     ...
     */
    public function create(string $className) : \ECSPrefix20220601\Symfony\Component\Console\Command\Command
    {
