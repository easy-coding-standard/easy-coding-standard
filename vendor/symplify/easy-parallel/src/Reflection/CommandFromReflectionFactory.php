...
namespace ECSPrefix20220606\Symplify\EasyParallel\Reflection;
...
final class CommandFromReflectionFactory
{
     ...
     */
    public function create(string $className) : \ECSPrefix20220606\Symfony\Component\Console\Command\Command
    {
