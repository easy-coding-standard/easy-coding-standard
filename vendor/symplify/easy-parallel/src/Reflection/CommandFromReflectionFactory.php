...
namespace ECSPrefix20220605\Symplify\EasyParallel\Reflection;
...
final class CommandFromReflectionFactory
{
     ...
     */
    public function create(string $className) : \ECSPrefix20220605\Symfony\Component\Console\Command\Command
    {
