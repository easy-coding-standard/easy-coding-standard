...
namespace ECSPrefix202305\Symplify\EasyParallel\ValueObject;

use ECSPrefix202305\Clue\React\NDJson\Decoder;
use ECSPrefix202305\Clue\React\NDJson\Encoder;
use Exception;
use ECSPrefix202305\React\ChildProcess\Process;
use ECSPrefix202305\React\EventLoop\LoopInterface;
use ECSPrefix202305\React\EventLoop\TimerInterface;
use ECSPrefix202305\Symplify\EasyParallel\Enum\Action;
use ECSPrefix202305\Symplify\EasyParallel\Enum\Content;
use ECSPrefix202305\Symplify\EasyParallel\Enum\ReactCommand;
use ECSPrefix202305\Symplify\EasyParallel\Enum\ReactEvent;
use ECSPrefix202305\Symplify\EasyParallel\Exception\ParallelShouldNotHappenException;
use Throwable;
/**
