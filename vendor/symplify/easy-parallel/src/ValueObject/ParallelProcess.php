...
namespace ECSPrefix202508\Symplify\EasyParallel\ValueObject;

use ECSPrefix202508\Clue\React\NDJson\Decoder;
use ECSPrefix202508\Clue\React\NDJson\Encoder;
use Exception;
use ECSPrefix202508\React\ChildProcess\Process;
use ECSPrefix202508\React\EventLoop\LoopInterface;
use ECSPrefix202508\React\EventLoop\TimerInterface;
use ECSPrefix202508\Symplify\EasyParallel\Enum\Action;
use ECSPrefix202508\Symplify\EasyParallel\Enum\Content;
use ECSPrefix202508\Symplify\EasyParallel\Enum\ReactCommand;
use ECSPrefix202508\Symplify\EasyParallel\Enum\ReactEvent;
use ECSPrefix202508\Symplify\EasyParallel\Exception\ParallelShouldNotHappenException;
use Throwable;
/**
