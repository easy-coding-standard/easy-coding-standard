...
namespace ECSPrefix202301\Symplify\EasyParallel\ValueObject;

use ECSPrefix202301\Clue\React\NDJson\Decoder;
use ECSPrefix202301\Clue\React\NDJson\Encoder;
use Exception;
use ECSPrefix202301\React\ChildProcess\Process;
use ECSPrefix202301\React\EventLoop\LoopInterface;
use ECSPrefix202301\React\EventLoop\TimerInterface;
use ECSPrefix202301\Symplify\EasyParallel\Enum\Action;
use ECSPrefix202301\Symplify\EasyParallel\Enum\Content;
use ECSPrefix202301\Symplify\EasyParallel\Enum\ReactCommand;
use ECSPrefix202301\Symplify\EasyParallel\Enum\ReactEvent;
use ECSPrefix202301\Symplify\EasyParallel\Exception\ParallelShouldNotHappenException;
use Throwable;
/**
...
{
    /**
     * @var \ECSPrefix202301\React\ChildProcess\Process
     */
    private $process;
    /**
     * @var \ECSPrefix202301\Clue\React\NDJson\Encoder
     */
    private $encoder;
    /**
     * @var resource|null
    ...
    private $onError;
    /**
     * @var \ECSPrefix202301\React\EventLoop\TimerInterface|null
     */
    private $timer;
    /**
     * @var string
    ...
    private $command;
    /**
     * @var \ECSPrefix202301\React\EventLoop\LoopInterface
     */
    private $loop;
    /**
     * @var int
