...
namespace ECSPrefix202504\Symplify\EasyParallel\ValueObject;

use ECSPrefix202504\Clue\React\NDJson\Decoder;
use ECSPrefix202504\Clue\React\NDJson\Encoder;
use Exception;
use ECSPrefix202504\React\ChildProcess\Process;
use ECSPrefix202504\React\EventLoop\LoopInterface;
use ECSPrefix202504\React\EventLoop\TimerInterface;
use ECSPrefix202504\Symplify\EasyParallel\Enum\Action;
use ECSPrefix202504\Symplify\EasyParallel\Enum\Content;
use ECSPrefix202504\Symplify\EasyParallel\Enum\ReactCommand;
use ECSPrefix202504\Symplify\EasyParallel\Enum\ReactEvent;
use ECSPrefix202504\Symplify\EasyParallel\Exception\ParallelShouldNotHappenException;
use Throwable;
/**
