...
namespace ECSPrefix202401\Symplify\EasyParallel\ValueObject;

use ECSPrefix202401\Clue\React\NDJson\Decoder;
use ECSPrefix202401\Clue\React\NDJson\Encoder;
use Exception;
use ECSPrefix202401\React\ChildProcess\Process;
use ECSPrefix202401\React\EventLoop\LoopInterface;
use ECSPrefix202401\React\EventLoop\TimerInterface;
use ECSPrefix202401\Symplify\EasyParallel\Enum\Action;
use ECSPrefix202401\Symplify\EasyParallel\Enum\Content;
use ECSPrefix202401\Symplify\EasyParallel\Enum\ReactCommand;
use ECSPrefix202401\Symplify\EasyParallel\Enum\ReactEvent;
use ECSPrefix202401\Symplify\EasyParallel\Exception\ParallelShouldNotHappenException;
use Throwable;
/**
