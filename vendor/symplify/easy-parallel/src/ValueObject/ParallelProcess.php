...
namespace ECSPrefix202406\Symplify\EasyParallel\ValueObject;

use ECSPrefix202406\Clue\React\NDJson\Decoder;
use ECSPrefix202406\Clue\React\NDJson\Encoder;
use Exception;
use ECSPrefix202406\React\ChildProcess\Process;
use ECSPrefix202406\React\EventLoop\LoopInterface;
use ECSPrefix202406\React\EventLoop\TimerInterface;
use ECSPrefix202406\Symplify\EasyParallel\Enum\Action;
use ECSPrefix202406\Symplify\EasyParallel\Enum\Content;
use ECSPrefix202406\Symplify\EasyParallel\Enum\ReactCommand;
use ECSPrefix202406\Symplify\EasyParallel\Enum\ReactEvent;
use ECSPrefix202406\Symplify\EasyParallel\Exception\ParallelShouldNotHappenException;
use Throwable;
/**
