...
namespace ECSPrefix202412\Symplify\EasyParallel\ValueObject;

use ECSPrefix202412\Clue\React\NDJson\Decoder;
use ECSPrefix202412\Clue\React\NDJson\Encoder;
use Exception;
use ECSPrefix202412\React\ChildProcess\Process;
use ECSPrefix202412\React\EventLoop\LoopInterface;
use ECSPrefix202412\React\EventLoop\TimerInterface;
use ECSPrefix202412\Symplify\EasyParallel\Enum\Action;
use ECSPrefix202412\Symplify\EasyParallel\Enum\Content;
use ECSPrefix202412\Symplify\EasyParallel\Enum\ReactCommand;
use ECSPrefix202412\Symplify\EasyParallel\Enum\ReactEvent;
use ECSPrefix202412\Symplify\EasyParallel\Exception\ParallelShouldNotHappenException;
use Throwable;
/**
