...
namespace ECSPrefix202505\Symplify\EasyParallel\ValueObject;

use ECSPrefix202505\Clue\React\NDJson\Decoder;
use ECSPrefix202505\Clue\React\NDJson\Encoder;
use Exception;
use ECSPrefix202505\React\ChildProcess\Process;
use ECSPrefix202505\React\EventLoop\LoopInterface;
use ECSPrefix202505\React\EventLoop\TimerInterface;
use ECSPrefix202505\Symplify\EasyParallel\Enum\Action;
use ECSPrefix202505\Symplify\EasyParallel\Enum\Content;
use ECSPrefix202505\Symplify\EasyParallel\Enum\ReactCommand;
use ECSPrefix202505\Symplify\EasyParallel\Enum\ReactEvent;
use ECSPrefix202505\Symplify\EasyParallel\Exception\ParallelShouldNotHappenException;
use Throwable;
/**
