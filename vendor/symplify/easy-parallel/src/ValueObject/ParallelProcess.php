...
namespace ECSPrefix202501\Symplify\EasyParallel\ValueObject;

use ECSPrefix202501\Clue\React\NDJson\Decoder;
use ECSPrefix202501\Clue\React\NDJson\Encoder;
use Exception;
use ECSPrefix202501\React\ChildProcess\Process;
use ECSPrefix202501\React\EventLoop\LoopInterface;
use ECSPrefix202501\React\EventLoop\TimerInterface;
use ECSPrefix202501\Symplify\EasyParallel\Enum\Action;
use ECSPrefix202501\Symplify\EasyParallel\Enum\Content;
use ECSPrefix202501\Symplify\EasyParallel\Enum\ReactCommand;
use ECSPrefix202501\Symplify\EasyParallel\Enum\ReactEvent;
use ECSPrefix202501\Symplify\EasyParallel\Exception\ParallelShouldNotHappenException;
use Throwable;
/**
