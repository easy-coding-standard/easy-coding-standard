...
namespace ECSPrefix202405\Symplify\EasyParallel\ValueObject;

use ECSPrefix202405\Clue\React\NDJson\Decoder;
use ECSPrefix202405\Clue\React\NDJson\Encoder;
use Exception;
use ECSPrefix202405\React\ChildProcess\Process;
use ECSPrefix202405\React\EventLoop\LoopInterface;
use ECSPrefix202405\React\EventLoop\TimerInterface;
use ECSPrefix202405\Symplify\EasyParallel\Enum\Action;
use ECSPrefix202405\Symplify\EasyParallel\Enum\Content;
use ECSPrefix202405\Symplify\EasyParallel\Enum\ReactCommand;
use ECSPrefix202405\Symplify\EasyParallel\Enum\ReactEvent;
use ECSPrefix202405\Symplify\EasyParallel\Exception\ParallelShouldNotHappenException;
use Throwable;
/**
