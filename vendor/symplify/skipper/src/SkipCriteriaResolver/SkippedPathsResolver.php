...
final class SkippedPathsResolver
{
    ...
    public function __construct(\ECSPrefix20210606\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \ECSPrefix20210606\Symplify\SmartFileSystem\Normalizer\PathNormalizer $pathNormalizer)
    {
    ...
    public function resolve() : array
    {
        ...
        foreach ($skip as $key => $value) {
            ...
            if (\ECSPrefix20210606\Nette\Utils\Strings::contains($value, '*')) {
                $this->skippedPaths[] = $this->pathNormalizer->normalizePath($value);
                continue;
            }
        }
