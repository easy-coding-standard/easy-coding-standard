...
final class SkippedPathsResolver
{
    ...
    public function __construct(\ECSPrefix20210515\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \ECSPrefix20210515\Symplify\SmartFileSystem\Normalizer\PathNormalizer $pathNormalizer)
    {
    ...
    public function resolve()
    {
        ...
        foreach ($skip as $key => $value) {
            ...
            if (\ECSPrefix20210515\Nette\Utils\Strings::contains($value, '*')) {
                $this->skippedPaths[] = $this->pathNormalizer->normalizePath($value);
                continue;
            }
        }
