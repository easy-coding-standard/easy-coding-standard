...
final class SkipSkipper
{
    ...
    public function __construct(\ECSPrefix20211204\Symplify\Skipper\Matcher\FileInfoMatcher $fileInfoMatcher)
    {
     ...
     */
    public function doesMatchSkip($checker, \ECSPrefix20211204\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, array $skippedClasses) : bool
    {
