...
final class Skipper
{
    ...
    {
        $fileInfo = new \ECSPrefix20220604\Symplify\SmartFileSystem\SmartFileInfo(__FILE__);
        return $this->shouldSkipElementAndFileInfo($element, $fileInfo);
    }
    public function shouldSkipFileInfo(\ECSPrefix20220604\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : bool
    {
     ...
     * @param string|object $element
     */
    public function shouldSkipElementAndFileInfo($element, \ECSPrefix20220604\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : bool
    {
