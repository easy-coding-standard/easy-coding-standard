...
final class Skipper
{
    ...
    {
        $fileInfo = new \ECSPrefix20220116\Symplify\SmartFileSystem\SmartFileInfo(__FILE__);
        return $this->shouldSkipElementAndFileInfo($element, $fileInfo);
    }
    public function shouldSkipFileInfo(\ECSPrefix20220116\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : bool
    {
     ...
     * @param object|string $element
     */
    public function shouldSkipElementAndFileInfo($element, \ECSPrefix20220116\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : bool
    {
