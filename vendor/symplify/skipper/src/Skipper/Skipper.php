...
final class Skipper
{
    ...
    {
        $fileInfo = new \ECSPrefix20210712\Symplify\SmartFileSystem\SmartFileInfo(__FILE__);
        return $this->shouldSkipElementAndFileInfo($element, $fileInfo);
    }
    public function shouldSkipFileInfo(\ECSPrefix20210712\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : bool
    {
     ...
     * @param string|object $element
     */
    public function shouldSkipElementAndFileInfo($element, \ECSPrefix20210712\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : bool
    {
