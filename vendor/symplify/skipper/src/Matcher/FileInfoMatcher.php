...
use ECSPrefix20211011\Symplify\Skipper\FileSystem\PathNormalizer;
...
final class FileInfoMatcher
{
    ...
    public function __construct(\ECSPrefix20211011\Symplify\Skipper\FileSystem\PathNormalizer $pathNormalizer)
    {
