...
namespace ECSPrefix20211007\Symplify\Skipper\Matcher;

use ECSPrefix20211007\Symplify\Skipper\FileSystem\PathNormalizer;
...
final class FileInfoMatcher
{
    ...
    public function __construct(\ECSPrefix20211007\Symplify\Skipper\FileSystem\PathNormalizer $pathNormalizer)
    {
     ...
     */
    public function doesFileInfoMatchPatterns(\ECSPrefix20211007\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, array $filePattern) : bool
    {
     ...
     */
    private function doesFileInfoMatchPattern(\ECSPrefix20211007\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, string $ignoredPath) : bool
    {
