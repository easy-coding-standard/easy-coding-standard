...
final class FileInfoMatcher
{
     ...
     * @return bool
     */
    public function doesFileInfoMatchPatterns(SmartFileInfo $smartFileInfo, array $filePattern)
    {
     ...
     * @return bool
     */
    private function doesFileInfoMatchPattern(SmartFileInfo $smartFileInfo, $ignoredPath)
    {
