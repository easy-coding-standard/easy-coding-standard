...
use ECSPrefix20220514\Symplify\Skipper\SkipCriteriaResolver\SkippedClassResolver;
use ECSPrefix20220514\Symplify\Skipper\Skipper\OnlySkipper;
use ECSPrefix20220514\Symplify\Skipper\Skipper\SkipSkipper;
use ECSPrefix20220514\Symplify\Skipper\ValueObject\Option;
use ECSPrefix20220514\Symplify\SmartFileSystem\SmartFileInfo;
final class ClassSkipVoter implements \ECSPrefix20220514\Symplify\Skipper\Contract\SkipVoterInterface
{
    /**
    ...
    public function __construct(\ECSPrefix20220514\Symplify\PackageBuilder\Reflection\ClassLikeExistenceChecker $classLikeExistenceChecker, \ECSPrefix20220514\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \ECSPrefix20220514\Symplify\Skipper\Skipper\SkipSkipper $skipSkipper, \ECSPrefix20220514\Symplify\Skipper\Skipper\OnlySkipper $onlySkipper, \ECSPrefix20220514\Symplify\Skipper\SkipCriteriaResolver\SkippedClassResolver $skippedClassResolver)
    {
    ...
    {
        $only = $this->parameterProvider->provideArrayParameter(\ECSPrefix20220514\Symplify\Skipper\ValueObject\Option::ONLY);
