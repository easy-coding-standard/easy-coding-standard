...
use ECSPrefix20210612\Symplify\Skipper\SkipCriteriaResolver\SkippedClassResolver;
use ECSPrefix20210612\Symplify\Skipper\Skipper\OnlySkipper;
use ECSPrefix20210612\Symplify\Skipper\Skipper\SkipSkipper;
...
final class ClassSkipVoter implements \ECSPrefix20210612\Symplify\Skipper\Contract\SkipVoterInterface
{
    ...
    {
        $only = $this->parameterProvider->provideArrayParameter(\ECSPrefix20210612\Symplify\Skipper\ValueObject\Option::ONLY);
