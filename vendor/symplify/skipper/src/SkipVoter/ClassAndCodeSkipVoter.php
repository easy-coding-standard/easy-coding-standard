...
use ECSPrefix20211211\Symplify\Skipper\SkipCriteriaResolver\SkippedClassAndCodesResolver;
use ECSPrefix20211211\Symplify\SmartFileSystem\SmartFileInfo;
/**
 * Matching class and code, e.g. App\Category\ArraySniff.SomeCode
 */
final class ClassAndCodeSkipVoter implements \ECSPrefix20211211\Symplify\Skipper\Contract\SkipVoterInterface
{
    /**
    ...
    public function __construct(\ECSPrefix20211211\Symplify\Skipper\SkipCriteriaResolver\SkippedClassAndCodesResolver $skippedClassAndCodesResolver, \ECSPrefix20211211\Symplify\Skipper\Matcher\FileInfoMatcher $fileInfoMatcher)
    {
