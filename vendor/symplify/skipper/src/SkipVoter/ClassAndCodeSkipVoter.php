...
use ECSPrefix20210920\Symplify\Skipper\SkipCriteriaResolver\SkippedClassAndCodesResolver;
use ECSPrefix20210920\Symplify\SmartFileSystem\SmartFileInfo;
/**
 * Matching class and code, e.g. App\Category\ArraySniff.SomeCode
 */
final class ClassAndCodeSkipVoter implements \ECSPrefix20210920\Symplify\Skipper\Contract\SkipVoterInterface
{
    /**
    ...
    public function __construct(\ECSPrefix20210920\Symplify\Skipper\SkipCriteriaResolver\SkippedClassAndCodesResolver $skippedClassAndCodesResolver, \ECSPrefix20210920\Symplify\Skipper\Matcher\FileInfoMatcher $fileInfoMatcher)
    {
