...
namespace ConfigTransformer20210601\Symplify\AutowireArrayParameter\DocBlock;
...
final class ParamTypeDocBlockResolver
{
    ...
    public function resolve(string $docBlock, string $parameterName)
    {
        foreach (self::ARRAY_REGEXES as $arrayRegexWithPlaceholder) {
            ...
            $result = \ConfigTransformer20210601\Nette\Utils\Strings::match($docBlock, $arrayRegex);
