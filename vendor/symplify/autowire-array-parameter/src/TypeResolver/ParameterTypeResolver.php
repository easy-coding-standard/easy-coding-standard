...
use ECSPrefix20210509\Nette\Utils\Reflection;
...
final class ParameterTypeResolver
{
    ...
    public function resolveParameterType($parameterName, \ReflectionMethod $reflectionMethod)
    {
        ...
        $resolvedClass = \ECSPrefix20210509\Nette\Utils\Reflection::expandClassName($resolvedType, $declaringReflectionClass);
