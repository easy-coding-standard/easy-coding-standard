...
namespace ECSPrefix20210612\Symplify\AutowireArrayParameter\TypeResolver;

use ECSPrefix20210612\Nette\Utils\Reflection;
...
final class ParameterTypeResolver
{
    ...
    public function resolveParameterType(string $parameterName, \ReflectionMethod $reflectionMethod)
    {
        ...
        $resolvedClass = \ECSPrefix20210612\Nette\Utils\Reflection::expandClassName($resolvedType, $declaringReflectionClass);
