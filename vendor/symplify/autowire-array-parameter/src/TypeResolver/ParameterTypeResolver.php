...
namespace ECSPrefix20210930\Symplify\AutowireArrayParameter\TypeResolver;

use ECSPrefix20210930\Nette\Utils\Reflection;
...
final class ParameterTypeResolver
{
    ...
    public function __construct(\ECSPrefix20210930\Symplify\AutowireArrayParameter\DocBlock\ParamTypeDocBlockResolver $paramTypeDocBlockResolver)
    {
    ...
    public function resolveParameterType(string $parameterName, \ReflectionMethod $reflectionMethod) : ?string
    {
        ...
        $resolvedClass = \ECSPrefix20210930\Nette\Utils\Reflection::expandClassName($resolvedType, $declaringReflectionClass);
