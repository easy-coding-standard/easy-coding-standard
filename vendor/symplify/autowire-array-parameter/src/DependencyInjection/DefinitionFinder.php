...
namespace ECSPrefix202207\Symplify\AutowireArrayParameter\DependencyInjection;
...
use ECSPrefix202207\Symplify\AutowireArrayParameter\Exception\DependencyInjection\DefinitionForTypeNotFoundException;
use Throwable;
/**
 * @api
