...
use ECSPrefix20210517\Symplify\AutowireArrayParameter\DocBlock\ParamTypeDocBlockResolver;
use ECSPrefix20210517\Symplify\AutowireArrayParameter\Skipper\ParameterSkipper;
use ECSPrefix20210517\Symplify\AutowireArrayParameter\TypeResolver\ParameterTypeResolver;
use ECSPrefix20210517\Symplify\PackageBuilder\DependencyInjection\DefinitionFinder;
/**
 * @inspiration https://github.com/nette/di/pull/178
 * @see \Symplify\AutowireArrayParameter\Tests\DependencyInjection\CompilerPass\AutowireArrayParameterCompilerPassTest
 */
final class AutowireArrayParameterCompilerPass implements \ECSPrefix20210517\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    /**
     ...
     * @noRector
     */
    private $excludedFatalClasses = ['ECSPrefix20210517\\Symfony\\Component\\Form\\FormExtensionInterface', 'ECSPrefix20210517\\Symfony\\Component\\Asset\\PackageInterface', 'ECSPrefix20210517\\Symfony\\Component\\Config\\Loader\\LoaderInterface', 'ECSPrefix20210517\\Symfony\\Component\\VarDumper\\Dumper\\ContextProvider\\ContextProviderInterface', 'ECSPrefix20210517\\EasyCorp\\Bundle\\EasyAdminBundle\\Form\\Type\\Configurator\\TypeConfiguratorInterface', 'ECSPrefix20210517\\Sonata\\CoreBundle\\Model\\Adapter\\AdapterInterface', 'ECSPrefix20210517\\Sonata\\Doctrine\\Adapter\\AdapterChain', 'ECSPrefix20210517\\Sonata\\Twig\\Extension\\TemplateExtension', 'ECSPrefix20210517\\Symfony\\Component\\HttpKernel\\KernelInterface'];
    /**
    ...
    {
        $this->definitionFinder = new \ECSPrefix20210517\Symplify\PackageBuilder\DependencyInjection\DefinitionFinder();
        $paramTypeDocBlockResolver = new \ECSPrefix20210517\Symplify\AutowireArrayParameter\DocBlock\ParamTypeDocBlockResolver();
        $this->parameterTypeResolver = new \ECSPrefix20210517\Symplify\AutowireArrayParameter\TypeResolver\ParameterTypeResolver($paramTypeDocBlockResolver);
        $this->parameterSkipper = new \ECSPrefix20210517\Symplify\AutowireArrayParameter\Skipper\ParameterSkipper($this->parameterTypeResolver, $excludedFatalClasses);
    }
    /**
     * @return void
     */
    ...
    private function shouldSkipDefinition(\ECSPrefix20210517\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, \ECSPrefix20210517\Symfony\Component\DependencyInjection\Definition $definition)
    {
        ...
        if (\ECSPrefix20210517\Nette\Utils\Strings::match($resolvedClassName, $excludedNamespacePattern)) {
            return \true;
        }
     ...
     * @return void
     */
    private function processParameters(\ECSPrefix20210517\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, \ReflectionMethod $reflectionMethod, \ECSPrefix20210517\Symfony\Component\DependencyInjection\Definition $definition)
    {
    ...
    private function createReferencesFromDefinitions(array $definitions)
    {
        ...
        foreach ($definitionOfTypeNames as $definitionOfTypeName) {
            $references[] = new \ECSPrefix20210517\Symfony\Component\DependencyInjection\Reference($definitionOfTypeName);
        }
        return $references;
    }
}
