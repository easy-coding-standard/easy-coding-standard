 ...
 */
final class AutowireArrayParameterCompilerPass implements \ECSPrefix20210511\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    /**
     ...
     * @noRector
     */
    private $excludedFatalClasses = ['ECSPrefix20210511\\Symfony\\Component\\Form\\FormExtensionInterface', 'ECSPrefix20210511\\Symfony\\Component\\Asset\\PackageInterface', 'ECSPrefix20210511\\Symfony\\Component\\Config\\Loader\\LoaderInterface', 'ECSPrefix20210511\\Symfony\\Component\\VarDumper\\Dumper\\ContextProvider\\ContextProviderInterface', 'ECSPrefix20210511\\EasyCorp\\Bundle\\EasyAdminBundle\\Form\\Type\\Configurator\\TypeConfiguratorInterface', 'ECSPrefix20210511\\Sonata\\CoreBundle\\Model\\Adapter\\AdapterInterface', 'ECSPrefix20210511\\Sonata\\Doctrine\\Adapter\\AdapterChain', 'ECSPrefix20210511\\Sonata\\Twig\\Extension\\TemplateExtension', 'ECSPrefix20210511\\Symfony\\Component\\HttpKernel\\KernelInterface'];
    /**
     ...
     * @return bool
     */
    private function shouldSkipDefinition(\ECSPrefix20210511\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, \ECSPrefix20210511\Symfony\Component\DependencyInjection\Definition $definition)
    {
        ...
        if (\ECSPrefix20210511\Nette\Utils\Strings::match($resolvedClassName, $excludedNamespacePattern)) {
            return \true;
        }
     ...
     * @return void
     */
    private function processParameters(\ECSPrefix20210511\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, \ReflectionMethod $reflectionMethod, \ECSPrefix20210511\Symfony\Component\DependencyInjection\Definition $definition)
    {
    ...
    private function createReferencesFromDefinitions(array $definitions)
    {
        ...
        foreach ($definitionOfTypeNames as $definitionOfTypeName) {
            $references[] = new \ECSPrefix20210511\Symfony\Component\DependencyInjection\Reference($definitionOfTypeName);
        }
        return $references;
    }
}
