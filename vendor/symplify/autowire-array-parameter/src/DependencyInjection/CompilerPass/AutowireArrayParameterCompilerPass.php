...
namespace ECSPrefix20210612\Symplify\AutowireArrayParameter\DependencyInjection\CompilerPass;
...
use ECSPrefix20210612\Symplify\AutowireArrayParameter\DocBlock\ParamTypeDocBlockResolver;
use ECSPrefix20210612\Symplify\AutowireArrayParameter\Skipper\ParameterSkipper;
use ECSPrefix20210612\Symplify\AutowireArrayParameter\TypeResolver\ParameterTypeResolver;
use ECSPrefix20210612\Symplify\PackageBuilder\DependencyInjection\DefinitionFinder;
/**
 * @inspiration https://github.com/nette/di/pull/178
 * @see \Symplify\AutowireArrayParameter\Tests\DependencyInjection\CompilerPass\AutowireArrayParameterCompilerPassTest
 */
final class AutowireArrayParameterCompilerPass implements \ECSPrefix20210612\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    /**
    ...
    {
        $this->definitionFinder = new \ECSPrefix20210612\Symplify\PackageBuilder\DependencyInjection\DefinitionFinder();
        $paramTypeDocBlockResolver = new \ECSPrefix20210612\Symplify\AutowireArrayParameter\DocBlock\ParamTypeDocBlockResolver();
        $this->parameterTypeResolver = new \ECSPrefix20210612\Symplify\AutowireArrayParameter\TypeResolver\ParameterTypeResolver($paramTypeDocBlockResolver);
        $this->parameterSkipper = new \ECSPrefix20210612\Symplify\AutowireArrayParameter\Skipper\ParameterSkipper($this->parameterTypeResolver, $excludedFatalClasses);
    }
    /**
     * @return void
     */
    ...
    private function shouldSkipDefinition(\ECSPrefix20210612\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, \ECSPrefix20210612\Symfony\Component\DependencyInjection\Definition $definition) : bool
    {
        ...
        if (\ECSPrefix20210612\Nette\Utils\Strings::match($resolvedClassName, $excludedNamespacePattern)) {
            return \true;
        }
     ...
     * @return void
     */
    private function processParameters(\ECSPrefix20210612\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, \ReflectionMethod $reflectionMethod, \ECSPrefix20210612\Symfony\Component\DependencyInjection\Definition $definition)
    {
    ...
    private function createReferencesFromDefinitions(array $definitions) : array
    {
        ...
        foreach ($definitionOfTypeNames as $definitionOfTypeName) {
            $references[] = new \ECSPrefix20210612\Symfony\Component\DependencyInjection\Reference($definitionOfTypeName);
        }
        return $references;
    }
}
