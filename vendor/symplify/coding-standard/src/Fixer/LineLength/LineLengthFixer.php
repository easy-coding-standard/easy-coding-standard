...
use ECSPrefix20220517\Symplify\PackageBuilder\ValueObject\MethodName;
 ...
 */
final class LineLengthFixer extends \Symplify\CodingStandard\Fixer\AbstractSymplifyFixer implements \ECSPrefix20220517\Symplify\RuleDocGenerator\Contract\ConfigurableRuleInterface, \PhpCsFixer\Fixer\ConfigurableFixerInterface, \ECSPrefix20220517\Symplify\RuleDocGenerator\Contract\DocumentedRuleInterface
{
    /**
     * @api
     * @var string
...
, [self::LINE_LENGTH => 40])]);
    ...
    private function processFunctionOrArray(\PhpCsFixer\Tokenizer\Tokens $tokens, int $position) : void
    {
        ...
        if ($this->standaloneLineConstructorParamFixer && $this->methodNameResolver->isMethodName($tokens, $position, \ECSPrefix20220517\Symplify\PackageBuilder\ValueObject\MethodName::CONSTRUCTOR)) {
            return;
        }
