...
CODE_SAMPLE
     ...
     * @return bool
     */
    private function shouldPrefixNewline(Tokens $tokens, $objectOperatorIndex)
    {
     ...
     * @return bool
     */
    private function isDoubleBracket(Tokens $tokens, $position)
    {
     ...
     * @return bool
     */
    private function isPreceededByOpenedCallInAnotherBracket(Tokens $tokens, $position)
    {
        $position = (int) $position;
     ...
     * @return bool
     */
    private function shouldBracketPrefix(Tokens $tokens, $position, $objectOperatorIndex)
    {
        $position = (int) $position;
        $objectOperatorIndex = (int) $objectOperatorIndex;
