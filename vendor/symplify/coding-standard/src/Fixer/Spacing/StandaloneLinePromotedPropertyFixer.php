...
use ECSPrefix20220513\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample;
 ...
 */
final class StandaloneLinePromotedPropertyFixer extends \Symplify\CodingStandard\Fixer\AbstractSymplifyFixer implements \ECSPrefix20220513\Symplify\RuleDocGenerator\Contract\DocumentedRuleInterface
{
    /**
     * @var string
     */
    ...
    public function fix(\SplFileInfo $fileInfo, \PhpCsFixer\Tokenizer\Tokens $tokens) : void
    {
        ...
        for ($position = \count($tokens) - 1; $position >= 0; --$position) {
            ...
            if (!$this->methodNameResolver->isMethodName($tokens, $position, \ECSPrefix20220513\Symplify\PackageBuilder\ValueObject\MethodName::CONSTRUCTOR)) {
                continue;
            }
    ...
    {
        return new \ECSPrefix20220513\Symplify\RuleDocGenerator\ValueObject\RuleDefinition(self::ERROR_MESSAGE, [new \ECSPrefix20220513\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
