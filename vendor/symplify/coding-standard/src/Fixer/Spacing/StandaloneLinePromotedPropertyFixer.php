...
use ECSPrefix20210903\Symplify\PackageBuilder\ValueObject\MethodName;
use ECSPrefix20210903\Symplify\RuleDocGenerator\Contract\DocumentedRuleInterface;
use ECSPrefix20210903\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample;
 ...
 */
final class StandaloneLinePromotedPropertyFixer extends \Symplify\CodingStandard\Fixer\AbstractSymplifyFixer implements \ECSPrefix20210903\Symplify\RuleDocGenerator\Contract\DocumentedRuleInterface
{
    /**
     * @var string
     */
    ...
    public function fix(\SplFileInfo $file, \PhpCsFixer\Tokenizer\Tokens $tokens) : void
    {
        ...
        for ($position = \count($tokens) - 1; $position >= 0; --$position) {
            ...
            if ($functionName !== \ECSPrefix20210903\Symplify\PackageBuilder\ValueObject\MethodName::CONSTRUCTOR) {
                continue;
            }
    ...
    {
        return new \ECSPrefix20210903\Symplify\RuleDocGenerator\ValueObject\RuleDefinition(self::ERROR_MESSAGE, [new \ECSPrefix20210903\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
