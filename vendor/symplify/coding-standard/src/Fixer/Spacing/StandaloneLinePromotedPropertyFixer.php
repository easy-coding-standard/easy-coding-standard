...
use ECSPrefix20211202\Symplify\PackageBuilder\ValueObject\MethodName;
 ...
 */
final class StandaloneLinePromotedPropertyFixer extends \Symplify\CodingStandard\Fixer\AbstractSymplifyFixer implements \ECSPrefix20211202\Symplify\RuleDocGenerator\Contract\DocumentedRuleInterface
{
    /**
     * @var string
     */
    ...
    public function fix(\SplFileInfo $fileInfo, \PhpCsFixer\Tokenizer\Tokens $tokens) : void
    {
        ...
        for ($position = \count($tokens) - 1; $position >= 0; --$position) {
            ...
            if ($functionName !== \ECSPrefix20211202\Symplify\PackageBuilder\ValueObject\MethodName::CONSTRUCTOR) {
                continue;
            }
