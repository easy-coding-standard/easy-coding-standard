 ...
 */
final class RemovePHPStormAnnotationFixer extends \Symplify\CodingStandard\Fixer\AbstractSymplifyFixer implements \ECSPrefix20211212\Symplify\RuleDocGenerator\Contract\DocumentedRuleInterface
{
    /**
    ...
    public function fix(\SplFileInfo $fileInfo, \PhpCsFixer\Tokenizer\Tokens $tokens) : void
    {
        ...
        foreach ($reversedTokens as $index => $token) {
            ...
            $cleanedDocContent = \ECSPrefix20211212\Nette\Utils\Strings::replace($originalDocContent, self::CREATED_BY_PHPSTORM_DOC_REGEX, '');
