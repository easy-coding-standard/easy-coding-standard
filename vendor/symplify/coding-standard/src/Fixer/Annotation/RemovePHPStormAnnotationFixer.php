 ...
 */
final class RemovePHPStormAnnotationFixer extends \Symplify\CodingStandard\Fixer\AbstractSymplifyFixer implements \ECSPrefix20210618\Symplify\RuleDocGenerator\Contract\DocumentedRuleInterface
{
    /**
    ...
    public function fix(\SplFileInfo $file, \PhpCsFixer\Tokenizer\Tokens $tokens)
    {
        ...
        foreach ($reversedTokens as $index => $token) {
            ...
            $cleanedDocContent = \ECSPrefix20210618\Nette\Utils\Strings::replace($originalDocContent, self::CREATED_BY_PHPSTORM_DOC_REGEX, '');
