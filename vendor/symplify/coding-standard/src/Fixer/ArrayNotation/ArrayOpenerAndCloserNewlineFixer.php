 ...
 */
final class ArrayOpenerAndCloserNewlineFixer extends \Symplify\CodingStandard\Fixer\AbstractSymplifyFixer implements \ECSPrefix20210516\Symplify\RuleDocGenerator\Contract\DocumentedRuleInterface
{
    /**
     * @var string
     */
...
CODE_SAMPLE
    ...
    private function handleArrayCloser(\PhpCsFixer\Tokenizer\Tokens $tokens, $arrayCloserPosition)
    {
        ...
        // already whitespace
        if (\ECSPrefix20210516\Nette\Utils\Strings::contains($previousCloserToken->getContent(), "\n")) {
            return;
        }
