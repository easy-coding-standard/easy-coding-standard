...
final class DoctrineAnnotationElementAnalyzer
{
    ...
    {
        // should be "("
        $isNextOpenParenthesis = $token->isType(\ECSPrefix20220307\Doctrine\Common\Annotations\DocLexer::T_OPEN_PARENTHESIS);
        ...
        return $nextToken->isType(\ECSPrefix20220307\Doctrine\Common\Annotations\DocLexer::T_AT);
    }
}
