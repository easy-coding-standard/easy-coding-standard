...
final class ChainMethodCallAnalyzer
{
     ...
     * @return bool
     */
    public function isPreceededByFuncCall(Tokens $tokens, $position)
    {
     ...
     * @return bool
     */
    public function isPartOfMethodCallOrArray(Tokens $tokens, $position)
    {
        $position = (int) $position;
     ...
     * @return bool
     */
    private function isBreakingChar(Token $currentToken)
    {
     ...
     * @return bool
     */
    private function shouldBreakOnBracket(Token $token)
    {
        if ($token->getContent() === ')') {
            --$this->bracketNesting;
            return false;
