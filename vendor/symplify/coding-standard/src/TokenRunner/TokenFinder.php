...
final class TokenFinder
{
     ...
     */
    public function getPreviousMeaningfulToken(Tokens $tokens, $position)
    {
        if (is_int($position)) {
     ...
     * @return \PhpCsFixer\Tokenizer\Token
     */
    private function findPreviousTokenByPosition(Tokens $tokens, $position)
    {
        $position = (int) $position;
     ...
     * @return \PhpCsFixer\Tokenizer\Token
     */
    private function findPreviousTokenByToken(Tokens $tokens, Token $positionToken)
    {
     ...
     * @return int
     */
    private function resolvePositionByToken(Tokens $tokens, Token $positionToken)
    {
