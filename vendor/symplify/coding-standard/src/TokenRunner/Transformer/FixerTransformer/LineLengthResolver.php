...
final class LineLengthResolver
{
     ...
     * @return int
     */
    public function getLengthFromStartEnd(Tokens $tokens, BlockInfo $blockInfo)
    {
        $lineLength = 0;
     ...
     * @return int
     */
    private function getLengthFromFunctionStartToEndOfArguments(BlockInfo $blockInfo, Tokens $tokens)
    {
        $length = 0;
     ...
     * @return int
     */
    private function getLengthFromEndOfArgumentToLineBreak(BlockInfo $blockInfo, Tokens $tokens)
    {
        $length = 0;
