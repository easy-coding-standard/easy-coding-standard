...
namespace ECSPrefix20220103\Symplify\PackageBuilder\Reflection;

use ReflectionProperty;
use ECSPrefix20220103\Symplify\PHPStanRules\Exception\ShouldNotHappenException;
/**
 * @api
...
final class PrivatesAccessor
{
    ...
    public function getPrivatePropertyOfClass($object, string $propertyName, string $valueClassName)
    {
        ...
        throw new \ECSPrefix20220103\Symplify\PHPStanRules\Exception\ShouldNotHappenException();
    }
    /**
     * @return mixed
     * @param object $object
    ...
    private function resolvePropertyReflection($object, string $propertyName) : \ReflectionProperty
    {
        ...
        if ($parentClass === \false) {
            ...
            throw new \ECSPrefix20220103\Symplify\PHPStanRules\Exception\ShouldNotHappenException($errorMessage);
        }
