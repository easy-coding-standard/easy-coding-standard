...
namespace ECSPrefix20220530\Symplify\PackageBuilder\Reflection;

use ReflectionProperty;
use ECSPrefix20220530\Symplify\PackageBuilder\Exception\InvalidPrivatePropertyTypeException;
use ECSPrefix20220530\Symplify\PackageBuilder\Exception\MissingPrivatePropertyException;
/**
 * @api
...
final class PrivatesAccessor
{
    ...
    public function getPrivatePropertyOfClass(object $object, string $propertyName, string $valueClassName) : object
    {
        ...
        throw new \ECSPrefix20220530\Symplify\PackageBuilder\Exception\InvalidPrivatePropertyTypeException($errorMessage);
    }
    /**
     * @return mixed
     */
    ...
    private function resolvePropertyReflection(object $object, string $propertyName) : \ReflectionProperty
    {
        ...
        throw new \ECSPrefix20220530\Symplify\PackageBuilder\Exception\MissingPrivatePropertyException($errorMessage);
    }
}
