...
use ECSPrefix202211\Symplify\PackageBuilder\Exception\InvalidPrivatePropertyTypeException;
use ECSPrefix202211\Symplify\PackageBuilder\Exception\MissingPrivatePropertyException;
/**
 * @api
