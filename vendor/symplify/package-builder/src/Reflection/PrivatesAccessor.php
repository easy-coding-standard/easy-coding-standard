...
namespace ECSPrefix20220305\Symplify\PackageBuilder\Reflection;

use ReflectionProperty;
use ECSPrefix20220305\Symplify\PackageBuilder\Exception\InvalidPrivatePropertyTypeException;
use ECSPrefix20220305\Symplify\PackageBuilder\Exception\MissingPrivatePropertyException;
/**
 * @api
...
final class PrivatesAccessor
{
    ...
    public function getPrivatePropertyOfClass($object, string $propertyName, string $valueClassName)
    {
        ...
        throw new \ECSPrefix20220305\Symplify\PackageBuilder\Exception\InvalidPrivatePropertyTypeException($errorMessage);
    }
    /**
     * @return mixed
     * @param object $object
    ...
    private function resolvePropertyReflection($object, string $propertyName) : \ReflectionProperty
    {
        ...
        throw new \ECSPrefix20220305\Symplify\PackageBuilder\Exception\MissingPrivatePropertyException($errorMessage);
    }
}
