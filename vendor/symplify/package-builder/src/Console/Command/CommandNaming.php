...
namespace ECSPrefix20210601\Symplify\PackageBuilder\Console\Command;
...
final class CommandNaming
{
     ...
     * - "SomeClass\SOMESuperCommand" → "some-super"
     */
    public function resolveFromCommand(\ECSPrefix20210601\Symfony\Component\Console\Command\Command $command) : string
    {
    ...
    public static function classToName(string $class) : string
    {
        ...
        $rawCommandName = \ECSPrefix20210601\Nette\Utils\Strings::substring($shortClassName, 0, -\strlen('Command'));
        // ECSCommand => ecs
        ...
        return \ECSPrefix20210601\Nette\Utils\Strings::replace($rawCommandName, self::BIG_LETTER_REGEX, function (array $matches) : string {
