...
namespace ECSPrefix20210515\Symplify\PackageBuilder\Console\Command;
...
final class CommandNaming
{
     ...
     * @return string
     */
    public function resolveFromCommand(\ECSPrefix20210515\Symfony\Component\Console\Command\Command $command)
    {
    ...
    public static function classToName($class)
    {
        ...
        $rawCommandName = \ECSPrefix20210515\Nette\Utils\Strings::substring($shortClassName, 0, -\strlen('Command'));
        // ECSCommand => ecs
        ...
        return \ECSPrefix20210515\Nette\Utils\Strings::replace($rawCommandName, self::BIG_LETTER_REGEX, function (array $matches) : string {
