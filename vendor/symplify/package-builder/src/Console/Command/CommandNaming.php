...
final class CommandNaming
{
     ...
     * - "SomeClass\SOMESuperCommand" → "some-super"
     */
    public function resolveFromCommand(\ECSPrefix20211002\Symfony\Component\Console\Command\Command $command) : string
    {
    ...
    public static function classToName(string $class) : string
    {
        ...
        $rawCommandName = \ECSPrefix20211002\Nette\Utils\Strings::substring($shortClassName, 0, -\strlen('Command'));
        // ECSCommand => ecs
        ...
        return \ECSPrefix20211002\Nette\Utils\Strings::replace($lowercasedRawCommandName, self::BIG_LETTER_REGEX, function (array $matches) : string {
