...
namespace ECSPrefix20210516\Symplify\PackageBuilder\Console\Command;
...
final class CommandNaming
{
     ...
     * @return string
     */
    public function resolveFromCommand(\ECSPrefix20210516\Symfony\Component\Console\Command\Command $command)
    {
    ...
    public static function classToName($class)
    {
        ...
        $rawCommandName = \ECSPrefix20210516\Nette\Utils\Strings::substring($shortClassName, 0, -\strlen('Command'));
        // ECSCommand => ecs
        ...
        return \ECSPrefix20210516\Nette\Utils\Strings::replace($rawCommandName, self::BIG_LETTER_REGEX, function (array $matches) : string {
