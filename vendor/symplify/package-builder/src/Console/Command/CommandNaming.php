...
namespace ECSPrefix20220602\Symplify\PackageBuilder\Console\Command;
...
final class CommandNaming
{
     ...
     * - "SomeClass\SOMESuperCommand" → "some-super"
     */
    public function resolveFromCommand(\ECSPrefix20220602\Symfony\Component\Console\Command\Command $command) : string
    {
    ...
    public static function classToName(string $class) : string
    {
        ...
        $rawCommandName = \ECSPrefix20220602\Nette\Utils\Strings::substring($shortClassName, 0, -\strlen('Command'));
        // ECSCommand => ecs
        ...
        return \ECSPrefix20220602\Nette\Utils\Strings::replace($lowercasedRawCommandName, self::BIG_LETTER_REGEX, function (array $matches) : string {
