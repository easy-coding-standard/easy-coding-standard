 ...
 */
abstract class AbstractKernelTestCase extends \ECSPrefix20210512\PHPUnit\Framework\TestCase
{
    /**
     * @var KernelInterface
     */
    ...
    protected function bootKernel($kernelClass)
    {
        ...
        if (!$kernel instanceof \ECSPrefix20210512\Symfony\Component\HttpKernel\KernelInterface) {
    ...
    protected function ensureKernelShutdown()
    {
        if (static::$kernel !== null) {
            ...
            if ($kernel !== null) {
                ...
                if ($container instanceof \ECSPrefix20210512\Symfony\Contracts\Service\ResetInterface) {
                    $container->reset();
                }
            }
        }
     ...
     * @return void
     */
    private function ensureIsConfigAwareKernel(\ECSPrefix20210512\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
     ...
     * @return \Symfony\Component\HttpKernel\KernelInterface
     */
    private function bootAndReturnKernel(\ECSPrefix20210512\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $kernel->boot();
        ...
        if (!$container instanceof \ECSPrefix20210512\Symfony\Component\DependencyInjection\ContainerInterface) {
            throw new \Symplify\SymplifyKernel\Exception\ShouldNotHappenException();
        }
        // has output? keep it silent out of tests
        if ($container->has(\ECSPrefix20210512\Symfony\Component\Console\Style\SymfonyStyle::class)) {
            $symfonyStyle = $container->get(\ECSPrefix20210512\Symfony\Component\Console\Style\SymfonyStyle::class);
            $symfonyStyle->setVerbosity(\ECSPrefix20210512\Symfony\Component\Console\Output\OutputInterface::VERBOSITY_QUIET);
        }
