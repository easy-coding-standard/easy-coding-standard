...
namespace ECSPrefix20210915\Symplify\PackageBuilder\Neon;

use ECSPrefix20210915\Nette\Neon\Encoder;
use ECSPrefix20210915\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \ECSPrefix20210915\Nette\Neon\Neon::encode($phpStanNeon, \ECSPrefix20210915\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \ECSPrefix20210915\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \ECSPrefix20210915\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \ECSPrefix20210915\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
