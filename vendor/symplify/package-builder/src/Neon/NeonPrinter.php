...
namespace ECSPrefix20220503\Symplify\PackageBuilder\Neon;

use ECSPrefix20220503\Nette\Neon\Encoder;
use ECSPrefix20220503\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \ECSPrefix20220503\Nette\Neon\Neon::encode($phpStanNeon, \ECSPrefix20220503\Nette\Neon\Encoder::BLOCK, '    ');
    ...
    {
        return \ECSPrefix20220503\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \ECSPrefix20220503\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
