...
namespace ECSPrefix20220317\Symplify\PackageBuilder\Neon;

use ECSPrefix20220317\Nette\Neon\Encoder;
use ECSPrefix20220317\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \ECSPrefix20220317\Nette\Neon\Neon::encode($phpStanNeon, \ECSPrefix20220317\Nette\Neon\Encoder::BLOCK, '    ');
    ...
    {
        return \ECSPrefix20220317\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \ECSPrefix20220317\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
