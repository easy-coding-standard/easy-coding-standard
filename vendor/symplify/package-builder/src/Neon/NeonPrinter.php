...
use ECSPrefix20210509\Nette\Neon\Encoder;
use ECSPrefix20210509\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \ECSPrefix20210509\Nette\Neon\Neon::encode($phpStanNeon, \ECSPrefix20210509\Nette\Neon\Encoder::BLOCK);
    ...
    private function replaceTabsWithSpaces($neonContent)
    {
        ...
        return \ECSPrefix20210509\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    /**
     * @param string $neonContent
     * @return string
    ...
    {
        $neonContent = (string) $neonContent;
        return \ECSPrefix20210509\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    /**
     * @param string $neonContent
     * @return string
    ...
    {
        $neonContent = (string) $neonContent;
        return \ECSPrefix20210509\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
