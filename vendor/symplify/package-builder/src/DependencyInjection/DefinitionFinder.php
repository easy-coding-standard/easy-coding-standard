...
final class DefinitionFinder
{
     ...
     * @param string $type
     */
    public function findAllByType(\ECSPrefix20210509\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, $type)
    {
        $type = (string) $type;
        $definitions = [];
     ...
     */
    public function getByType(\ECSPrefix20210509\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, $type)
    {
        $type = (string) $type;
     ...
     * @param string $type
     */
    private function getByTypeIfExists(\ECSPrefix20210509\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, $type)
    {
        $type = (string) $type;
        $containerBuilderDefinitions = $containerBuilder->getDefinitions();
        foreach ($containerBuilderDefinitions as $name => $definition) {
