...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = $this->getService(\ECSPrefix20210508\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\ECSPrefix20210508\Symfony\Component\Console\Application::class, $application);
    }
}
