...
use ECSPrefix20210705\Symplify\SmartFileSystem\FileSystemFilter;
use ECSPrefix20210705\Symplify\SmartFileSystem\FileSystemGuard;
use ECSPrefix20210705\Symplify\SmartFileSystem\Finder\FinderSanitizer;
use ECSPrefix20210705\Symplify\SmartFileSystem\Finder\SmartFinder;
...
return static function (\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) {
    ...
    // filesystem
    $services->set(\ECSPrefix20210705\Symplify\SmartFileSystem\Finder\FinderSanitizer::class);
    $services->set(\ECSPrefix20210705\Symplify\SmartFileSystem\SmartFileSystem::class);
    $services->set(\ECSPrefix20210705\Symplify\SmartFileSystem\Finder\SmartFinder::class);
    $services->set(\ECSPrefix20210705\Symplify\SmartFileSystem\FileSystemGuard::class);
    $services->set(\ECSPrefix20210705\Symplify\SmartFileSystem\FileSystemFilter::class);
