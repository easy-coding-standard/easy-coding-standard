...
namespace ECSPrefix20211210\Symplify\SymplifyKernel\Config\Loader;

use ECSPrefix20211210\Symfony\Component\Config\FileLocator;
use ECSPrefix20211210\Symfony\Component\Config\Loader\DelegatingLoader;
use ECSPrefix20211210\Symfony\Component\Config\Loader\GlobFileLoader;
...
final class ParameterMergingLoaderFactory implements \ECSPrefix20211210\Symplify\SymplifyKernel\Contract\Config\LoaderFactoryInterface
{
    ...
    public function create($containerBuilder, $currentWorkingDirectory) : \ECSPrefix20211210\Symfony\Component\Config\Loader\LoaderInterface
    {
        ...
        return new \ECSPrefix20211210\Symfony\Component\Config\Loader\DelegatingLoader($loaderResolver);
    }
}
