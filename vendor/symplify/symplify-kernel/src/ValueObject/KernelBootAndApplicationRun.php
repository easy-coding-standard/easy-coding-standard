...
namespace ECSPrefix202306\Symplify\SymplifyKernel\ValueObject;
...
use ECSPrefix202306\Symplify\PackageBuilder\Console\Input\StaticInputDetector;
...
use ECSPrefix202306\Symplify\SymplifyKernel\Exception\BootException;
use Throwable;
/**
 * @api
 */
