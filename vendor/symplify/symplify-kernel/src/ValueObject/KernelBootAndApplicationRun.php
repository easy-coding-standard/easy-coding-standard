...
namespace ECSPrefix202302\Symplify\SymplifyKernel\ValueObject;
...
use ECSPrefix202302\Symplify\PackageBuilder\Console\Input\StaticInputDetector;
...
use ECSPrefix202302\Symplify\SymplifyKernel\Exception\BootException;
use Throwable;
/**
 * @api
 */
