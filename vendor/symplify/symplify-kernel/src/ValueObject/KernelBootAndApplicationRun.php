...
namespace ECSPrefix202301\Symplify\SymplifyKernel\ValueObject;

use ECSPrefix202301\Symfony\Component\Console\Application;
use ECSPrefix202301\Symfony\Component\Console\Command\Command;
use ECSPrefix202301\Symfony\Component\HttpKernel\KernelInterface;
use ECSPrefix202301\Symplify\PackageBuilder\Console\Input\StaticInputDetector;
...
use ECSPrefix202301\Symplify\SymplifyKernel\Exception\BootException;
use Throwable;
/**
 * @api
 */
final class KernelBootAndApplicationRun
{
    ...
    /**
     * @return \ECSPrefix202301\Symfony\Component\HttpKernel\KernelInterface|\ECSPrefix202301\Symplify\SymplifyKernel\Contract\LightKernelInterface
     */
