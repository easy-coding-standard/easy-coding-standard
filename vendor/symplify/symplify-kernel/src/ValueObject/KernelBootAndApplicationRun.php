...
final class KernelBootAndApplicationRun
{
    ...
    private function booKernelAndRunApplication()
    {
        ...
        $application = $container->get(\ECSPrefix20210512\Symfony\Component\Console\Application::class);
     ...
     */
    private function setExtraConfigs(\ECSPrefix20210512\Symfony\Component\HttpKernel\KernelInterface $kernel, $kernelClass)
    {
        $kernelClass = (string) $kernelClass;
    ...
    {
        $kernelClass = (string) $kernelClass;
        if (!\is_a($kernelClass, \ECSPrefix20210512\Symfony\Component\HttpKernel\KernelInterface::class, \true)) {
            $message = \sprintf('Class "%s" must by type of "%s"', $kernelClass, \ECSPrefix20210512\Symfony\Component\HttpKernel\KernelInterface::class);
            throw new \Symplify\SymplifyKernel\Exception\BootException($message);
        }
