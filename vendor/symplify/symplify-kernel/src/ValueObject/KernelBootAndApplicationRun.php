...
namespace ECSPrefix20220403\Symplify\SymplifyKernel\ValueObject;
...
use ECSPrefix20220403\Symplify\PackageBuilder\Console\Input\StaticInputDetector;
...
use ECSPrefix20220403\Symplify\SymplifyKernel\Exception\BootException;
use Throwable;
/**
 * @api
 */
final class KernelBootAndApplicationRun
{
    ...
    public function run() : void
    {
        try {
            ...
            $symfonyStyleFactory = new \ECSPrefix20220403\Symplify\PackageBuilder\Console\Style\SymfonyStyleFactory();
            $symfonyStyle = $symfonyStyleFactory->create();
            $symfonyStyle->error($throwable->getMessage());
            exit(\ECSPrefix20220403\Symfony\Component\Console\Command\Command::FAILURE);
        }
    }
    /**
    ...
    private function createKernel()
    {
        ...
        return new $kernelClass($environment, \ECSPrefix20220403\Symplify\PackageBuilder\Console\Input\StaticInputDetector::isDebug());
    }
    private function booKernelAndRunApplication() : void
    {
        ...
        $application = $container->get(\ECSPrefix20220403\Symfony\Component\Console\Application::class);
    ...
    {
        if (\is_a($kernelClass, \ECSPrefix20220403\Symfony\Component\HttpKernel\KernelInterface::class, \true)) {
            return;
        }
        if (\is_a($kernelClass, \ECSPrefix20220403\Symplify\SymplifyKernel\Contract\LightKernelInterface::class, \true)) {
            return;
        ...
        $errorMessage = \sprintf('Class "%s" must by type of "%s" or "%s". "%s" given', $kernelClass, \ECSPrefix20220403\Symfony\Component\HttpKernel\KernelInterface::class, \ECSPrefix20220403\Symplify\SymplifyKernel\Contract\LightKernelInterface::class, $currentValueType);
        throw new \ECSPrefix20220403\Symplify\SymplifyKernel\Exception\BootException($errorMessage);
    }
}
