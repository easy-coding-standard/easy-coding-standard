...
namespace ECSPrefix20210804\Symplify\SymplifyKernel\Strings;

use ECSPrefix20210804\Nette\Utils\Strings;
use ECSPrefix20210804\Symplify\SymplifyKernel\Exception\HttpKernel\TooGenericKernelClassException;
...
final class KernelUniqueHasher
{
    ...
    {
        $this->stringsConverter = new \ECSPrefix20210804\Symplify\SymplifyKernel\Strings\StringsConverter();
    }
    public function hashKernelClass(string $kernelClass) : string
    {
        $this->ensureIsNotGenericKernelClass($kernelClass);
        $shortClassName = (string) \ECSPrefix20210804\Nette\Utils\Strings::after($kernelClass, '\\', -1);
    ...
    private function ensureIsNotGenericKernelClass(string $kernelClass)
    {
        ...
        $message = \sprintf('Instead of "%s", provide final Kernel class', \ECSPrefix20210804\Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel::class);
        throw new \ECSPrefix20210804\Symplify\SymplifyKernel\Exception\HttpKernel\TooGenericKernelClassException($message);
    }
}
