...
namespace ECSPrefix202209\Symplify\SymplifyKernel\HttpKernel;
...
use ECSPrefix202209\Symplify\SymplifyKernel\Contract\LightKernelInterface;
use ECSPrefix202209\Symplify\SymplifyKernel\Exception\ShouldNotHappenException;
use ECSPrefix202209\Symplify\SymplifyKernel\ValueObject\SymplifyKernelConfig;
/**
 * @api
 */
abstract class AbstractSymplifyKernel implements LightKernelInterface
{
    ...
    public function getContainer() : \ECSPrefix202209\Psr\Container\ContainerInterface
    {
