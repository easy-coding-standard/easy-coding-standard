...
namespace ECSPrefix20220610\Symplify\SymplifyKernel\HttpKernel;
...
use ECSPrefix20220610\Symplify\SymplifyKernel\Contract\LightKernelInterface;
use ECSPrefix20220610\Symplify\SymplifyKernel\Exception\ShouldNotHappenException;
use ECSPrefix20220610\Symplify\SymplifyKernel\ValueObject\SymplifyKernelConfig;
/**
 * @api
 */
abstract class AbstractSymplifyKernel implements LightKernelInterface
{
    ...
    public function getContainer() : \ECSPrefix20220610\Psr\Container\ContainerInterface
    {
