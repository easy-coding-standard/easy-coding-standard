...
namespace ECSPrefix20220611\Symplify\SymplifyKernel\HttpKernel;
...
use ECSPrefix20220611\Symplify\SymplifyKernel\Contract\LightKernelInterface;
use ECSPrefix20220611\Symplify\SymplifyKernel\Exception\ShouldNotHappenException;
use ECSPrefix20220611\Symplify\SymplifyKernel\ValueObject\SymplifyKernelConfig;
/**
 * @api
 */
abstract class AbstractSymplifyKernel implements LightKernelInterface
{
    ...
    public function getContainer() : \ECSPrefix20220611\Psr\Container\ContainerInterface
    {
