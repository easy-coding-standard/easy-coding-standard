...
namespace ECSPrefix20211031\Symplify\SymplifyKernel\Bundle;
...
final class SymplifyKernelBundle extends \ECSPrefix20211031\Symfony\Component\HttpKernel\Bundle\Bundle
{
    /**
    ...
    {
        $containerBuilder->addCompilerPass(new \ECSPrefix20211031\Symplify\AutowireArrayParameter\DependencyInjection\CompilerPass\AutowireArrayParameterCompilerPass());
    }
    ...
    {
        return new \ECSPrefix20211031\Symplify\SymplifyKernel\DependencyInjection\Extension\SymplifyKernelExtension();
    }
}
