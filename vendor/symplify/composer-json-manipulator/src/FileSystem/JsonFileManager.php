...
final class JsonFileManager
{
    ...
    public function loadFromFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo)
    {
        ...
        if (!isset($this->cachedJSONFiles[$realPath])) {
            $this->cachedJSONFiles[$realPath] = \ECSPrefix20210511\Nette\Utils\Json::decode($smartFileInfo->getContents(), \ECSPrefix20210511\Nette\Utils\Json::FORCE_ARRAY);
        }
    ...
    public function loadFromFilePath($filePath)
    {
        ...
        return \ECSPrefix20210511\Nette\Utils\Json::decode($fileContent, \ECSPrefix20210511\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     * @return string
    ...
    public function encodeJsonToFileContent(array $json)
    {
        ...
        $jsonContent = \ECSPrefix20210511\Nette\Utils\Json::encode($json, \ECSPrefix20210511\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
