...
namespace ECSPrefix20220220\Symplify\ComposerJsonManipulator\FileSystem;

use ECSPrefix20220220\Nette\Utils\Json;
use ECSPrefix20220220\Symplify\ComposerJsonManipulator\Json\JsonCleaner;
use ECSPrefix20220220\Symplify\ComposerJsonManipulator\Json\JsonInliner;
...
final class JsonFileManager
{
     ...
     */
    private $jsonInliner;
    public function __construct(\ECSPrefix20220220\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem, \ECSPrefix20220220\Symplify\ComposerJsonManipulator\Json\JsonCleaner $jsonCleaner, \ECSPrefix20220220\Symplify\ComposerJsonManipulator\Json\JsonInliner $jsonInliner)
    {
     ...
     * @return mixed[]
     */
    public function loadFromFileInfo(\ECSPrefix20220220\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : array
    {
        $realPath = $smartFileInfo->getRealPath();
        if (!isset($this->cachedJSONFiles[$realPath])) {
            $this->cachedJSONFiles[$realPath] = \ECSPrefix20220220\Nette\Utils\Json::decode($smartFileInfo->getContents(), \ECSPrefix20220220\Nette\Utils\Json::FORCE_ARRAY);
        }
     ...
     * @param mixed[] $json
     */
    public function printJsonToFileInfo(array $json, \ECSPrefix20220220\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : string
    {
    ...
    public function printComposerJsonToFilePath(\ECSPrefix20220220\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson, string $filePath) : string
    {
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \ECSPrefix20220220\Nette\Utils\Json::encode($json, \ECSPrefix20220220\Nette\Utils\Json::PRETTY) . \ECSPrefix20220220\Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
