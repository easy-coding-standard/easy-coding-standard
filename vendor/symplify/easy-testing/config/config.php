...
use ECSPrefix202301\Symplify\EasyTesting\Command\ValidateFixtureSkipNamingCommand;
...
return static function (ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->load('ECSPrefix202301\Symplify\EasyTesting\\', __DIR__ . '/../src')->exclude([__DIR__ . '/../src/DataProvider', __DIR__ . '/../src/Kernel', __DIR__ . '/../src/ValueObject']);
    // console
