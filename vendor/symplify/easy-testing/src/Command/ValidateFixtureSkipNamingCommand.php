...
namespace ECSPrefix20210612\Symplify\EasyTesting\Command;
...
use ECSPrefix20210612\Symplify\EasyTesting\Finder\FixtureFinder;
use ECSPrefix20210612\Symplify\EasyTesting\MissplacedSkipPrefixResolver;
use ECSPrefix20210612\Symplify\EasyTesting\ValueObject\Option;
...
final class ValidateFixtureSkipNamingCommand extends \ECSPrefix20210612\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    ...
    {
        $this->addArgument(\ECSPrefix20210612\Symplify\EasyTesting\ValueObject\Option::SOURCE, \ECSPrefix20210612\Symfony\Component\Console\Input\InputArgument::REQUIRED | \ECSPrefix20210612\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Paths to analyse');
    ...
    {
        $source = (array) $input->getArgument(\ECSPrefix20210612\Symplify\EasyTesting\ValueObject\Option::SOURCE);
