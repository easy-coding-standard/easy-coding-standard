...
namespace ECSPrefix20220501\Symplify\EasyTesting\Command;
...
use ECSPrefix20220501\Symplify\EasyTesting\Finder\FixtureFinder;
use ECSPrefix20220501\Symplify\EasyTesting\MissplacedSkipPrefixResolver;
use ECSPrefix20220501\Symplify\EasyTesting\ValueObject\Option;
use ECSPrefix20220501\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand;
final class ValidateFixtureSkipNamingCommand extends \ECSPrefix20220501\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    public function __construct(\ECSPrefix20220501\Symplify\EasyTesting\MissplacedSkipPrefixResolver $missplacedSkipPrefixResolver, \ECSPrefix20220501\Symplify\EasyTesting\Finder\FixtureFinder $fixtureFinder)
    {
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(\ECSPrefix20220501\Symplify\EasyTesting\ValueObject\Option::SOURCE, \ECSPrefix20220501\Symfony\Component\Console\Input\InputArgument::REQUIRED | \ECSPrefix20220501\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Paths to analyse');
    ...
    {
        $source = (array) $input->getArgument(\ECSPrefix20220501\Symplify\EasyTesting\ValueObject\Option::SOURCE);
