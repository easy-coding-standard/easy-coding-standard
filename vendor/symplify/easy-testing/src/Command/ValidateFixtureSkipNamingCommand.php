...
namespace ECSPrefix20210602\Symplify\EasyTesting\Command;
...
use ECSPrefix20210602\Symplify\EasyTesting\Finder\FixtureFinder;
use ECSPrefix20210602\Symplify\EasyTesting\MissplacedSkipPrefixResolver;
use ECSPrefix20210602\Symplify\EasyTesting\ValueObject\Option;
...
final class ValidateFixtureSkipNamingCommand extends \ECSPrefix20210602\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    public function __construct(\ECSPrefix20210602\Symplify\EasyTesting\MissplacedSkipPrefixResolver $missplacedSkipPrefixResolver, \ECSPrefix20210602\Symplify\EasyTesting\Finder\FixtureFinder $fixtureFinder)
    {
    ...
    {
        $this->addArgument(\ECSPrefix20210602\Symplify\EasyTesting\ValueObject\Option::SOURCE, \ECSPrefix20210602\Symfony\Component\Console\Input\InputArgument::REQUIRED | \ECSPrefix20210602\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Paths to analyse');
    ...
    {
        $source = (array) $input->getArgument(\ECSPrefix20210602\Symplify\EasyTesting\ValueObject\Option::SOURCE);
