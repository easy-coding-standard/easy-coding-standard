...
namespace ECSPrefix20220509\Symplify\EasyTesting\Command;
...
use ECSPrefix20220509\Symplify\EasyTesting\Finder\FixtureFinder;
use ECSPrefix20220509\Symplify\EasyTesting\MissplacedSkipPrefixResolver;
use ECSPrefix20220509\Symplify\EasyTesting\ValueObject\Option;
use ECSPrefix20220509\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand;
final class ValidateFixtureSkipNamingCommand extends \ECSPrefix20220509\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    public function __construct(\ECSPrefix20220509\Symplify\EasyTesting\MissplacedSkipPrefixResolver $missplacedSkipPrefixResolver, \ECSPrefix20220509\Symplify\EasyTesting\Finder\FixtureFinder $fixtureFinder)
    {
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(\ECSPrefix20220509\Symplify\EasyTesting\ValueObject\Option::SOURCE, \ECSPrefix20220509\Symfony\Component\Console\Input\InputArgument::REQUIRED | \ECSPrefix20220509\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Paths to analyse');
    ...
    {
        $source = (array) $input->getArgument(\ECSPrefix20220509\Symplify\EasyTesting\ValueObject\Option::SOURCE);
