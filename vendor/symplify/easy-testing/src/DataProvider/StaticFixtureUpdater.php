...
final class StaticFixtureUpdater
{
     ...
     */
    public static function updateFixtureContent(\ECSPrefix20210515\Symplify\SmartFileSystem\SmartFileInfo $originalFileInfo, $changedContent, \ECSPrefix20210515\Symplify\SmartFileSystem\SmartFileInfo $fixtureFileInfo)
    {
     ...
     */
    public static function updateExpectedFixtureContent($newOriginalContent, \ECSPrefix20210515\Symplify\SmartFileSystem\SmartFileInfo $expectedFixtureFileInfo)
    {
    ...
    {
        return new \ECSPrefix20210515\Symplify\SmartFileSystem\SmartFileSystem();
    }
    /**
     * @param string $changedContent
     * @return string
     */
    private static function resolveNewFixtureContent(\ECSPrefix20210515\Symplify\SmartFileSystem\SmartFileInfo $originalFileInfo, $changedContent)
    {
        $changedContent = (string) $changedContent;
