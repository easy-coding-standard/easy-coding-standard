...
final class StaticFixtureSplitter
{
     ...
     */
    public static function splitFileInfoToInputAndExpected(SmartFileInfo $smartFileInfo)
    {
     ...
     * @return string
     */
    private static function createTemporaryPathWithPrefix(SmartFileInfo $smartFileInfo, $prefix)
    {
        $prefix = (string) $prefix;
