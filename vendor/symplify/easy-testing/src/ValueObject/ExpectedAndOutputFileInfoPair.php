...
final class ExpectedAndOutputFileInfoPair
{
     ...
     */
    public function __construct(\ConfigTransformer20210601\Symplify\SmartFileSystem\SmartFileInfo $expectedFileInfo, $outputFileInfo)
    {
    ...
    {
        if (!$this->outputFileInfo instanceof \ConfigTransformer20210601\Symplify\SmartFileSystem\SmartFileInfo) {
