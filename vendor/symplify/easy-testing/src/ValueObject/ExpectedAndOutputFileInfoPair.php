...
final class ExpectedAndOutputFileInfoPair
{
    ...
    public function __construct(\ECSPrefix20211031\Symplify\SmartFileSystem\SmartFileInfo $expectedFileInfo, ?\ECSPrefix20211031\Symplify\SmartFileSystem\SmartFileInfo $outputFileInfo)
    {
    ...
    {
        if (!$this->outputFileInfo instanceof \ECSPrefix20211031\Symplify\SmartFileSystem\SmartFileInfo) {
