...
final class ExpectedAndOutputFileInfoPair
{
    ...
    public function __construct(\ECSPrefix20210819\Symplify\SmartFileSystem\SmartFileInfo $expectedFileInfo, ?\ECSPrefix20210819\Symplify\SmartFileSystem\SmartFileInfo $outputFileInfo)
    {
    ...
    {
        if (!$this->outputFileInfo instanceof \ECSPrefix20210819\Symplify\SmartFileSystem\SmartFileInfo) {
