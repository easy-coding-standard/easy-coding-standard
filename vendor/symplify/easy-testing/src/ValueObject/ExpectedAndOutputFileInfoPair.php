...
final class ExpectedAndOutputFileInfoPair
{
     ...
     */
    public function __construct(\ECSPrefix20210727\Symplify\SmartFileSystem\SmartFileInfo $expectedFileInfo, $outputFileInfo)
    {
    ...
    {
        if (!$this->outputFileInfo instanceof \ECSPrefix20210727\Symplify\SmartFileSystem\SmartFileInfo) {
