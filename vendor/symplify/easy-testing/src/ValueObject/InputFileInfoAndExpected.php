...
namespace ECSPrefix20220607\Symplify\EasyTesting\ValueObject;
...
final class InputFileInfoAndExpected
{
     ...
     */
    public function __construct(\ECSPrefix20220607\Symplify\SmartFileSystem\SmartFileInfo $inputFileInfo, $expected)
    {
