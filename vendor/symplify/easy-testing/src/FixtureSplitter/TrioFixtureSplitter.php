...
use ECSPrefix20210517\Symplify\EasyTesting\ValueObject\FixtureSplit\TrioContent;
use ECSPrefix20210517\Symplify\EasyTesting\ValueObject\SplitLine;
...
final class TrioFixtureSplitter
{
    public function splitFileInfo(\ECSPrefix20210517\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : \ECSPrefix20210517\Symplify\EasyTesting\ValueObject\FixtureSplit\TrioContent
    {
        ...
        return new \ECSPrefix20210517\Symplify\EasyTesting\ValueObject\FixtureSplit\TrioContent($parts[0], $parts[1], $parts[2]);
    }
    /**
     * @param mixed[] $parts
     * @return void
     */
    private function ensureHasThreeParts(array $parts, \ECSPrefix20210517\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo)
    {
        if (\count($parts) === 3) {
            return;
        }
