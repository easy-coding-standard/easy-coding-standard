...
use ECSPrefix20210514\Symplify\EasyTesting\ValueObject\Prefix;
...
final class MissplacedSkipPrefixResolver
{
    ...
    public function resolve(array $fixtureFileInfos)
    {
        ...
        foreach ($fixtureFileInfos as $fixtureFileInfo) {
            ...
            $hasSplitLine = (bool) \ECSPrefix20210514\Nette\Utils\Strings::match($fileContents, \ECSPrefix20210514\Symplify\EasyTesting\ValueObject\SplitLine::SPLIT_LINE_REGEX);
     ...
     * @return bool
     */
    private function hasNameSkipStart(\ECSPrefix20210514\Symplify\SmartFileSystem\SmartFileInfo $fixtureFileInfo)
    {
        return (bool) \ECSPrefix20210514\Nette\Utils\Strings::match($fixtureFileInfo->getBasenameWithoutSuffix(), \ECSPrefix20210514\Symplify\EasyTesting\ValueObject\Prefix::SKIP_PREFIX_REGEX);
    }
}
