...
use ECSPrefix20210825\Symplify\EasyTesting\ValueObject\Prefix;
...
final class MissplacedSkipPrefixResolver
{
    ...
    public function resolve(array $fixtureFileInfos) : array
    {
        ...
        foreach ($fixtureFileInfos as $fixtureFileInfo) {
            ...
            $hasSplitLine = (bool) \ECSPrefix20210825\Nette\Utils\Strings::match($fileContents, \ECSPrefix20210825\Symplify\EasyTesting\ValueObject\SplitLine::SPLIT_LINE_REGEX);
    ...
    private function hasNameSkipStart(\ECSPrefix20210825\Symplify\SmartFileSystem\SmartFileInfo $fixtureFileInfo) : bool
    {
        return (bool) \ECSPrefix20210825\Nette\Utils\Strings::match($fixtureFileInfo->getBasenameWithoutSuffix(), \ECSPrefix20210825\Symplify\EasyTesting\ValueObject\Prefix::SKIP_PREFIX_REGEX);
    }
}
