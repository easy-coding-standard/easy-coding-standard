...
final class MissplacedSkipPrefixResolver
{
    ...
    public function resolve(array $fixtureFileInfos)
    {
        ...
        foreach ($fixtureFileInfos as $fixtureFileInfo) {
            ...
            $hasSplitLine = (bool) \ECSPrefix20210510\Nette\Utils\Strings::match($fileContents, \Symplify\EasyTesting\ValueObject\SplitLine::SPLIT_LINE_REGEX);
    ...
    {
        return (bool) \ECSPrefix20210510\Nette\Utils\Strings::match($fixtureFileInfo->getBasenameWithoutSuffix(), \Symplify\EasyTesting\ValueObject\Prefix::SKIP_PREFIX_REGEX);
    }
}
