...
final class SetResolver
{
    ...
    public function detectFromName($setName)
    {
        ...
        if (!$set instanceof \ECSPrefix20210515\Symplify\SetConfigResolver\ValueObject\Set) {
    ...
    private function reportSetNotFound($setName)
    {
        ...
        throw new \ECSPrefix20210515\Symplify\SetConfigResolver\Exception\SetNotFoundException($message, $setName, $this->setProvider->provideSetNames());
    }
}
