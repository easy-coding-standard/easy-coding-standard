...
namespace ECSPrefix20210514\Symplify\SetConfigResolver\ValueObject\Bootstrap;
...
final class BootstrapConfigs
{
    ...
    {
        if (!$this->mainConfigFileInfo instanceof \ECSPrefix20210514\Symplify\SmartFileSystem\SmartFileInfo) {
