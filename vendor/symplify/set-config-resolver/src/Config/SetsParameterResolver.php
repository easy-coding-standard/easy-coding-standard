...
final class SetsParameterResolver
{
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo)
    {
        ...
        $phpFileLoader = new \ECSPrefix20210511\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \ECSPrefix20210511\Symfony\Component\Config\FileLocator());
