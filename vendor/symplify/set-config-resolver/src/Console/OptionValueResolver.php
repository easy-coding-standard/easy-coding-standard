...
namespace ECSPrefix20210517\Symplify\SetConfigResolver\Console;
...
final class OptionValueResolver
{
     ...
     * @return string|null
     */
    public function getOptionValue(\ECSPrefix20210517\Symfony\Component\Console\Input\InputInterface $input, array $optionNames)
    {
