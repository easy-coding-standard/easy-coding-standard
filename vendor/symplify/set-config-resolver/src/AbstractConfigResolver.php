...
use ECSPrefix20210516\Symplify\SetConfigResolver\Console\Option\OptionName;
use ECSPrefix20210516\Symplify\SetConfigResolver\Console\OptionValueResolver;
use ECSPrefix20210516\Symplify\SmartFileSystem\Exception\FileNotFoundException;
...
abstract class AbstractConfigResolver
{
    ...
    {
        $this->optionValueResolver = new \ECSPrefix20210516\Symplify\SetConfigResolver\Console\OptionValueResolver();
    }
    /**
    ...
    {
        $configValue = $this->optionValueResolver->getOptionValue($input, \ECSPrefix20210516\Symplify\SetConfigResolver\Console\Option\OptionName::CONFIG);
        if ($configValue !== null) {
            if (!\file_exists($configValue)) {
                $message = \sprintf('File "%s" was not found', $configValue);
                throw new \ECSPrefix20210516\Symplify\SmartFileSystem\Exception\FileNotFoundException($message);
            }
     ...
     * @return \Symplify\SmartFileSystem\SmartFileInfo|null
     */
    public function resolveFromInputWithFallback(\ECSPrefix20210516\Symfony\Component\Console\Input\InputInterface $input, array $fallbackFiles)
    {
    ...
    private function createFileInfo($configValue)
    {
        ...
        return new \ECSPrefix20210516\Symplify\SmartFileSystem\SmartFileInfo($configValue);
    }
}
