...
final class SetAwareConfigResolverTest extends \ECSPrefix20210509\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \ECSPrefix20210509\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \ECSPrefix20210509\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
