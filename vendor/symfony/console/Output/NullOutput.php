...
use ECSPrefix20211212\Symfony\Component\Console\Formatter\NullOutputFormatter;
 ...
 */
class NullOutput implements \ECSPrefix20211212\Symfony\Component\Console\Output\OutputInterface
{
    private $formatter;
    /**
     * {@inheritdoc}
    ...
    public function getFormatter() : \ECSPrefix20211212\Symfony\Component\Console\Formatter\OutputFormatterInterface
    {
        ...
        return $this->formatter = $this->formatter ?? new \ECSPrefix20211212\Symfony\Component\Console\Formatter\NullOutputFormatter();
    }
    /**
     * {@inheritdoc}
     */
