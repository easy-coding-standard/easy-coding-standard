 ...
 */
class ConsoleSectionOutput extends \ECSPrefix20210516\Symfony\Component\Console\Output\StreamOutput
{
    private $content = [];
    private $lines = 0;
    private $sections;
     ...
     */
    public function __construct($stream, array &$sections, $verbosity, $decorated, \ECSPrefix20210516\Symfony\Component\Console\Formatter\OutputFormatterInterface $formatter)
    {
    ...
    {
        $text = (string) $text;
        return \ECSPrefix20210516\Symfony\Component\Console\Helper\Helper::strlenWithoutDecoration($this->getFormatter(), \str_replace("\t", '        ', $text));
    }
}
