 ...
 */
class StreamOutput extends \ECSPrefix20211230\Symfony\Component\Console\Output\Output
{
    private $stream;
    /**
     ...
     */
    public function __construct($stream, int $verbosity = self::VERBOSITY_NORMAL, bool $decorated = null, \ECSPrefix20211230\Symfony\Component\Console\Formatter\OutputFormatterInterface $formatter = null)
    {
        if (!\is_resource($stream) || 'stream' !== \get_resource_type($stream)) {
            throw new \ECSPrefix20211230\Symfony\Component\Console\Exception\InvalidArgumentException('The StreamOutput class needs a stream as its first argument.');
        }
        $this->stream = $stream;
        if (null === $decorated) {
