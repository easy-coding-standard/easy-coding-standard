 ...
 */
class StreamOutput extends \ECSPrefix20210512\Symfony\Component\Console\Output\Output
{
    private $stream;
    /**
     ...
     */
    public function __construct($stream, $verbosity = self::VERBOSITY_NORMAL, $decorated = null, \ECSPrefix20210512\Symfony\Component\Console\Formatter\OutputFormatterInterface $formatter = null)
    {
        $verbosity = (int) $verbosity;
        if (!\is_resource($stream) || 'stream' !== \get_resource_type($stream)) {
            throw new \ECSPrefix20210512\Symfony\Component\Console\Exception\InvalidArgumentException('The StreamOutput class needs a stream as its first argument.');
        }
        $this->stream = $stream;
        if (null === $decorated) {
