 ...
 */
class FormatterHelper extends \ECSPrefix20210523\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false)
    {
        ...
        foreach ($messages as $message) {
            $message = \ECSPrefix20210523\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
