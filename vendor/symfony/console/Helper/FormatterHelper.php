 ...
 */
class FormatterHelper extends \ECSPrefix20210515\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, $style, $large = \false)
    {
        ...
        foreach ($messages as $message) {
            $message = \ECSPrefix20210515\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
