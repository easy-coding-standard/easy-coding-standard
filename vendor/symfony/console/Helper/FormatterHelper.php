 ...
 */
class FormatterHelper extends \ECSPrefix20220313\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false) : string
    {
        ...
        foreach ($messages as $message) {
            $message = \ECSPrefix20220313\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
