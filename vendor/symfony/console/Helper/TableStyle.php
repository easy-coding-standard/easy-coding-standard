...
class TableStyle
{
    ...
    {
        if (!$paddingChar) {
            throw new \ECSPrefix20211208\Symfony\Component\Console\Exception\LogicException('The padding char must not be empty.');
        }
    ...
    public function setPadType($padType)
    {
        if (!\in_array($padType, [\STR_PAD_LEFT, \STR_PAD_RIGHT, \STR_PAD_BOTH], \true)) {
            throw new \ECSPrefix20211208\Symfony\Component\Console\Exception\InvalidArgumentException('Invalid padding type. Expected one of (STR_PAD_LEFT, STR_PAD_RIGHT, STR_PAD_BOTH).');
        }
