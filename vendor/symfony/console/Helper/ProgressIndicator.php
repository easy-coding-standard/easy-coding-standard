...
class ProgressIndicator
{
     ...
     */
    public function __construct(\ECSPrefix20210612\Symfony\Component\Console\Output\OutputInterface $output, string $format = null, int $indicatorChangeInterval = 100, array $indicatorValues = null)
    {
        $this->output = $output;
        if (null === $format) {
        ...
        if (2 > \count($indicatorValues)) {
            throw new \ECSPrefix20210612\Symfony\Component\Console\Exception\InvalidArgumentException('Must have at least 2 indicator value characters.');
        }
    ...
    {
        if ($this->started) {
            throw new \ECSPrefix20210612\Symfony\Component\Console\Exception\LogicException('Progress indicator already started.');
        }
        $this->message = $message;
        $this->started = \true;
        $this->startTime = \time();
    ...
    {
        if (!$this->started) {
            throw new \ECSPrefix20210612\Symfony\Component\Console\Exception\LogicException('Progress indicator has not yet been started.');
        }
    ...
    private static function initPlaceholderFormatters() : array
    {
        return ['indicator' => function (self $indicator) {
            ...
            return \ECSPrefix20210612\Symfony\Component\Console\Helper\Helper::formatTime(\time() - $indicator->startTime);
        }, 'memory' => function () {
