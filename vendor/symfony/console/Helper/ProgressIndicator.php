...
class ProgressIndicator
{
     ...
     * @param string $format
     */
    public function __construct(\ECSPrefix20210515\Symfony\Component\Console\Output\OutputInterface $output, $format = null, $indicatorChangeInterval = 100, array $indicatorValues = null)
    {
        ...
        if (2 > \count($indicatorValues)) {
            throw new \ECSPrefix20210515\Symfony\Component\Console\Exception\InvalidArgumentException('Must have at least 2 indicator value characters.');
        }
    ...
    public function start($message)
    {
        ...
        if ($this->started) {
            throw new \ECSPrefix20210515\Symfony\Component\Console\Exception\LogicException('Progress indicator already started.');
        }
        $this->message = $message;
        $this->started = \true;
        $this->startTime = \time();
    ...
    {
        if (!$this->started) {
            throw new \ECSPrefix20210515\Symfony\Component\Console\Exception\LogicException('Progress indicator has not yet been started.');
        }
    ...
    private static function initPlaceholderFormatters()
    {
        return ['indicator' => function (self $indicator) {
            ...
            return \ECSPrefix20210515\Symfony\Component\Console\Helper\Helper::formatTime(\time() - $indicator->startTime);
        }, 'memory' => function () {
