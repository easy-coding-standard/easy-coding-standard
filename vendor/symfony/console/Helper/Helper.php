 ...
 */
abstract class Helper implements \ECSPrefix20211012\Symfony\Component\Console\Helper\HelperInterface
{
    ...
    public static function width($string) : int
    {
        ...
        if (\preg_match('//u', $string)) {
            return (new \ECSPrefix20211012\Symfony\Component\String\UnicodeString($string))->width(\false);
        }
    ...
    public static function length($string) : int
    {
        $string ?? ($string = '');
        if (\preg_match('//u', $string)) {
            return (new \ECSPrefix20211012\Symfony\Component\String\UnicodeString($string))->length();
        }
        if (\false === ($encoding = \mb_detect_encoding($string, null, \true))) {
            return \strlen($string);
        }
