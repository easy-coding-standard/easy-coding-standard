...
class Question
{
    ...
    public function setHidden(bool $hidden)
    {
        if ($this->autocompleterCallback) {
            throw new \ECSPrefix20220317\Symfony\Component\Console\Exception\LogicException('A hidden question cannot use the autocompleter.');
        }
        $this->hidden = $hidden;
        return $this;
    }
    ...
    public function setMaxAttempts(?int $attempts)
    {
        if (null !== $attempts && $attempts < 1) {
            throw new \ECSPrefix20220317\Symfony\Component\Console\Exception\InvalidArgumentException('Maximum number of attempts must be a positive value.');
        }
