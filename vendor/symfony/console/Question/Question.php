...
class Question
{
    ...
    public function setHidden($hidden)
    {
        if ($this->autocompleterCallback) {
            throw new \ECSPrefix20210515\Symfony\Component\Console\Exception\LogicException('A hidden question cannot use the autocompleter.');
        }
    ...
    public function setMaxAttempts($attempts)
    {
        if (null !== $attempts) {
            ...
            if ($attempts < 1) {
                throw new \ECSPrefix20210515\Symfony\Component\Console\Exception\InvalidArgumentException('Maximum number of attempts must be a positive value.');
            }
        }
