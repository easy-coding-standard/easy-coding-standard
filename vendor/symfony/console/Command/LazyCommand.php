 ...
 */
final class LazyCommand extends \ECSPrefix20220607\Symfony\Component\Console\Command\Command
{
    private $command;
    /**
     * @var bool|null
    ...
    public function setApplication(\ECSPrefix20220607\Symfony\Component\Console\Application $application = null) : void
    {
    ...
    public function setHelperSet(\ECSPrefix20220607\Symfony\Component\Console\Helper\HelperSet $helperSet) : void
    {
        if ($this->command instanceof parent) {
