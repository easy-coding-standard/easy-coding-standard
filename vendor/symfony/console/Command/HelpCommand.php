 ...
 */
class HelpCommand extends \ECSPrefix20211208\Symfony\Component\Console\Command\Command
{
    private $command;
    /**
     * {@inheritdoc}
    ...
    protected function configure()
    {
        ...
        $this->setName('help')->setDefinition([new \ECSPrefix20211208\Symfony\Component\Console\Input\InputArgument('command_name', \ECSPrefix20211208\Symfony\Component\Console\Input\InputArgument::OPTIONAL, 'The command name', 'help'), new \ECSPrefix20211208\Symfony\Component\Console\Input\InputOption('format', null, \ECSPrefix20211208\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'The output format (txt, xml, json, or md)', 'txt'), new \ECSPrefix20211208\Symfony\Component\Console\Input\InputOption('raw', null, \ECSPrefix20211208\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'To output raw command help')])->setDescription('Display help for a command')->setHelp(<<<'EOF'
