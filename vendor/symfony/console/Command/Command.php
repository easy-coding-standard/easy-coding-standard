 ...
 */
namespace ECSPrefix202303\Symfony\Component\Console\Command;

use ECSPrefix202303\Symfony\Component\Console\Application;
use ECSPrefix202303\Symfony\Component\Console\Attribute\AsCommand;
...
use ECSPrefix202303\Symfony\Component\Console\Exception\InvalidArgumentException;
use ECSPrefix202303\Symfony\Component\Console\Exception\LogicException;
use ECSPrefix202303\Symfony\Component\Console\Helper\HelperInterface;
...
class Command
{
    ...
    public static function getDefaultName() : ?string
    {
        ...
        \ECSPrefix202303\trigger_deprecation('symfony/console', '6.1', 'Relying on the static property "$defaultName" for setting a command name is deprecated. Add the "%s" attribute to the "%s" class instead.', AsCommand::class, static::class);
    ...
    public static function getDefaultDescription() : ?string
    {
        ...
        \ECSPrefix202303\trigger_deprecation('symfony/console', '6.1', 'Relying on the static property "$defaultDescription" for setting a command description is deprecated. Add the "%s" attribute to the "%s" class instead.', AsCommand::class, static::class);
    ...
    {
        if (1 > \func_num_args()) {
            \ECSPrefix202303\trigger_deprecation('symfony/console', '6.2', 'Calling "%s()" without any arguments is deprecated, pass null explicitly instead.', __METHOD__);
        }
    ...
    public function run(InputInterface $input, OutputInterface $output) : int
    {
        ...
        if (null !== $this->processTitle) {
            ...
            } elseif (\function_exists('ECSPrefix202303\\setproctitle')) {
