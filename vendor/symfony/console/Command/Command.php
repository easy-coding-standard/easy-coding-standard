 ...
 */
namespace ECSPrefix20210508\Symfony\Component\Console\Command;
...
class Command
{
    ...
    {
        $this->definition = new \ECSPrefix20210508\Symfony\Component\Console\Input\InputDefinition();
    ...
    {
        throw new \ECSPrefix20210508\Symfony\Component\Console\Exception\LogicException('You must override the execute() method in the concrete command class.');
    }
    /**
     ...
     */
    protected function interact(\ECSPrefix20210508\Symfony\Component\Console\Input\InputInterface $input, \ECSPrefix20210508\Symfony\Component\Console\Output\OutputInterface $output)
    {
    }
    /**
     ...
     */
    protected function initialize(\ECSPrefix20210508\Symfony\Component\Console\Input\InputInterface $input, \ECSPrefix20210508\Symfony\Component\Console\Output\OutputInterface $output)
    {
    }
    /**
     * Runs the command.
        ...
        if (null !== $this->processTitle) {
            if (\function_exists('cli_set_process_title')) {
                if (!@\cli_set_process_title($this->processTitle)) {
                    if ('Darwin' === \PHP_OS) {
                        $output->writeln('<comment>Running "cli_set_process_title" as an unprivileged user is not supported on MacOS.</comment>', \ECSPrefix20210508\Symfony\Component\Console\Output\OutputInterface::VERBOSITY_VERY_VERBOSE);
                    } else {
                        \cli_set_process_title($this->processTitle);
                    }
                }
            } elseif (\function_exists('ECSPrefix20210508\\setproctitle')) {
                setproctitle($this->processTitle);
            } elseif (\ECSPrefix20210508\Symfony\Component\Console\Output\OutputInterface::VERBOSITY_VERY_VERBOSE === $output->getVerbosity()) {
    ...
    public function mergeApplicationDefinition($mergeArgs = \true)
    {
        ...
        $this->fullDefinition = new \ECSPrefix20210508\Symfony\Component\Console\Input\InputDefinition();
    ...
    {
        if ($definition instanceof \ECSPrefix20210508\Symfony\Component\Console\Input\InputDefinition) {
    ...
    public function getNativeDefinition()
    {
        if (null === $this->definition) {
            throw new \ECSPrefix20210508\Symfony\Component\Console\Exception\LogicException(\sprintf('Command class "%s" is not correctly initialized. You probably forgot to call the parent constructor.', static::class));
        }
