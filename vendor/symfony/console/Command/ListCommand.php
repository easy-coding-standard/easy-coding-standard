 ...
 */
class ListCommand extends \ECSPrefix20211202\Symfony\Component\Console\Command\Command
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->setName('list')->setDefinition([new \ECSPrefix20211202\Symfony\Component\Console\Input\InputArgument('namespace', \ECSPrefix20211202\Symfony\Component\Console\Input\InputArgument::OPTIONAL, 'The namespace name'), new \ECSPrefix20211202\Symfony\Component\Console\Input\InputOption('raw', null, \ECSPrefix20211202\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'To output raw command list'), new \ECSPrefix20211202\Symfony\Component\Console\Input\InputOption('format', null, \ECSPrefix20211202\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'The output format (txt, xml, json, or md)', 'txt'), new \ECSPrefix20211202\Symfony\Component\Console\Input\InputOption('short', null, \ECSPrefix20211202\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'To skip describing commands\' arguments')])->setDescription('List commands')->setHelp(<<<'EOF'
