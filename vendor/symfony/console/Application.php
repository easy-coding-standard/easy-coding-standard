 ...
 */
namespace ECSPrefix202311\Symfony\Component\Console;

use ECSPrefix202311\Symfony\Component\Console\Command\Command;
use ECSPrefix202311\Symfony\Component\Console\Command\CompleteCommand;
use ECSPrefix202311\Symfony\Component\Console\Command\DumpCompletionCommand;
use ECSPrefix202311\Symfony\Component\Console\Command\HelpCommand;
use ECSPrefix202311\Symfony\Component\Console\Command\LazyCommand;
use ECSPrefix202311\Symfony\Component\Console\Command\ListCommand;
use ECSPrefix202311\Symfony\Component\Console\Command\SignalableCommandInterface;
use ECSPrefix202311\Symfony\Component\Console\CommandLoader\CommandLoaderInterface;
use ECSPrefix202311\Symfony\Component\Console\Completion\CompletionInput;
use ECSPrefix202311\Symfony\Component\Console\Completion\CompletionSuggestions;
use ECSPrefix202311\Symfony\Component\Console\Completion\Suggestion;
use ECSPrefix202311\Symfony\Component\Console\Event\ConsoleCommandEvent;
use ECSPrefix202311\Symfony\Component\Console\Event\ConsoleErrorEvent;
use ECSPrefix202311\Symfony\Component\Console\Event\ConsoleSignalEvent;
use ECSPrefix202311\Symfony\Component\Console\Event\ConsoleTerminateEvent;
use ECSPrefix202311\Symfony\Component\Console\Exception\CommandNotFoundException;
use ECSPrefix202311\Symfony\Component\Console\Exception\ExceptionInterface;
use ECSPrefix202311\Symfony\Component\Console\Exception\LogicException;
use ECSPrefix202311\Symfony\Component\Console\Exception\NamespaceNotFoundException;
use ECSPrefix202311\Symfony\Component\Console\Exception\RuntimeException;
use ECSPrefix202311\Symfony\Component\Console\Formatter\OutputFormatter;
use ECSPrefix202311\Symfony\Component\Console\Helper\DebugFormatterHelper;
use ECSPrefix202311\Symfony\Component\Console\Helper\DescriptorHelper;
use ECSPrefix202311\Symfony\Component\Console\Helper\FormatterHelper;
use ECSPrefix202311\Symfony\Component\Console\Helper\Helper;
use ECSPrefix202311\Symfony\Component\Console\Helper\HelperSet;
use ECSPrefix202311\Symfony\Component\Console\Helper\ProcessHelper;
use ECSPrefix202311\Symfony\Component\Console\Helper\QuestionHelper;
use ECSPrefix202311\Symfony\Component\Console\Input\ArgvInput;
use ECSPrefix202311\Symfony\Component\Console\Input\ArrayInput;
use ECSPrefix202311\Symfony\Component\Console\Input\InputArgument;
use ECSPrefix202311\Symfony\Component\Console\Input\InputAwareInterface;
use ECSPrefix202311\Symfony\Component\Console\Input\InputDefinition;
use ECSPrefix202311\Symfony\Component\Console\Input\InputInterface;
use ECSPrefix202311\Symfony\Component\Console\Input\InputOption;
use ECSPrefix202311\Symfony\Component\Console\Output\ConsoleOutput;
use ECSPrefix202311\Symfony\Component\Console\Output\ConsoleOutputInterface;
use ECSPrefix202311\Symfony\Component\Console\Output\OutputInterface;
use ECSPrefix202311\Symfony\Component\Console\SignalRegistry\SignalRegistry;
use ECSPrefix202311\Symfony\Component\Console\Style\SymfonyStyle;
use ECSPrefix202311\Symfony\Component\ErrorHandler\ErrorHandler;
use ECSPrefix202311\Symfony\Contracts\EventDispatcher\EventDispatcherInterface;
use ECSPrefix202311\Symfony\Contracts\Service\ResetInterface;
/**
                ...
                foreach ($this->signalsToDispatchEvent as $signal) {
                    ...
                    $this->signalRegistry->register($signal, function ($signal) use($event, $command, $commandSignals) {
                        ...
                        if (\in_array($signal, $commandSignals, \true)) {
                            ...
                            if (null === $exitCode) {
                                \ECSPrefix202311\trigger_deprecation('symfony/console', '6.3', 'Not returning an exit code from "%s::handleSignal()" is deprecated, return "false" to keep the command running or "0" to exit successfully.', \get_debug_type($command));
                                $exitCode = 0;
                            }
                        }
                        if (\false !== $exitCode) {
