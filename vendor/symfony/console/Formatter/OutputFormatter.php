 ...
 */
class OutputFormatter implements \ECSPrefix20210508\Symfony\Component\Console\Formatter\WrappableOutputFormatterInterface
{
    private $decorated;
    private $styles = [];
    private $styleStack;
    ...
    public function __construct($decorated = \false, array $styles = [])
    {
        ...
        $this->setStyle('comment', new \ECSPrefix20210508\Symfony\Component\Console\Formatter\OutputFormatterStyle('yellow'));
        $this->setStyle('question', new \ECSPrefix20210508\Symfony\Component\Console\Formatter\OutputFormatterStyle('black', 'cyan'));
        foreach ($styles as $name => $style) {
            $this->setStyle($name, $style);
        }
        $this->styleStack = new \ECSPrefix20210508\Symfony\Component\Console\Formatter\OutputFormatterStyleStack();
    }
    /**
     * {@inheritdoc}
     * @param bool $decorated
    ...
    private function createStyleFromString($string)
    {
        ...
        $style = new \ECSPrefix20210508\Symfony\Component\Console\Formatter\OutputFormatterStyle();
