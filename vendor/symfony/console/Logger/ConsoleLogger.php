 ...
 */
namespace ECSPrefix20210804\Symfony\Component\Console\Logger;
...
class ConsoleLogger extends \ECSPrefix20210804\Psr\Log\AbstractLogger
{
    ...
    public function __construct(\ECSPrefix20210804\Symfony\Component\Console\Output\OutputInterface $output, array $verbosityLevelMap = [], array $formatLevelMap = [])
    {
        $this->output = $output;
    ...
    public function log($level, $message, $context = [])
    {
        ...
        if (self::ERROR === $this->formatLevelMap[$level]) {
            if ($this->output instanceof \ECSPrefix20210804\Symfony\Component\Console\Output\ConsoleOutputInterface) {
