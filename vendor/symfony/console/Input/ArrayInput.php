...
use ECSPrefix20210517\Symfony\Component\Console\Exception\InvalidOptionException;
/**
 ...
 */
class ArrayInput extends \ECSPrefix20210517\Symfony\Component\Console\Input\Input
{
    private $parameters;
    public function __construct(array $parameters, \ECSPrefix20210517\Symfony\Component\Console\Input\InputDefinition $definition = null)
    {
    ...
    private function addLongOption(string $name, $value)
    {
        ...
        if (null === $value) {
            if ($option->isValueRequired()) {
                throw new \ECSPrefix20210517\Symfony\Component\Console\Exception\InvalidOptionException(\sprintf('The "--%s" option requires a value.', $name));
            }
