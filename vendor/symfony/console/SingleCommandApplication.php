 ...
 */
class SingleCommandApplication extends \ECSPrefix20210618\Symfony\Component\Console\Command\Command
{
    ...
    public function run($input = null, $output = null) : int
    {
        ...
        $application = new \ECSPrefix20210618\Symfony\Component\Console\Application($this->getName() ?: 'UNKNOWN', $this->version);
