 ...
 */
class SingleCommandApplication extends \ECSPrefix20211002\Symfony\Component\Console\Command\Command
{
    ...
    public function run($input = null, $output = null) : int
    {
        ...
        $application = new \ECSPrefix20211002\Symfony\Component\Console\Application($this->getName() ?: 'UNKNOWN', $this->version);
