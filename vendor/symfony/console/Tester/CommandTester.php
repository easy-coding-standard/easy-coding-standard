...
class CommandTester
{
    use TesterTrait;
    private $command;
    public function __construct(\ECSPrefix20211212\Symfony\Component\Console\Command\Command $command)
    {
    ...
    public function execute(array $input, array $options = []) : int
    {
        ...
        $this->input = new \ECSPrefix20211212\Symfony\Component\Console\Input\ArrayInput($input);
