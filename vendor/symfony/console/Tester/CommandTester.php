...
class CommandTester
{
    ...
    private $input;
    private $statusCode;
    public function __construct(\ECSPrefix20210511\Symfony\Component\Console\Command\Command $command)
    {
    ...
    public function execute(array $input, array $options = [])
    {
        ...
        $this->input = new \ECSPrefix20210511\Symfony\Component\Console\Input\ArrayInput($input);
