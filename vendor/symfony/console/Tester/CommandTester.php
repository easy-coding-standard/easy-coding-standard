...
class CommandTester
{
    ...
    private $input;
    private $statusCode;
    public function __construct(\ECSPrefix20211002\Symfony\Component\Console\Command\Command $command)
    {
    ...
    public function execute($input, $options = [])
    {
        ...
        $this->input = new \ECSPrefix20211002\Symfony\Component\Console\Input\ArrayInput($input);
