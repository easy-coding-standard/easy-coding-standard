...
use ECSPrefix20210517\Symfony\Component\Console\Output\StreamOutput;
/**
...
trait TesterTrait
{
    ...
    private function initOutput(array $options)
    {
        ...
        if (!$this->captureStreamsIndependently) {
            $this->output = new \ECSPrefix20210517\Symfony\Component\Console\Output\StreamOutput(\fopen('php://memory', 'w', \false));
