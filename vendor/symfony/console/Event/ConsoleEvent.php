 ...
 */
class ConsoleEvent extends \ECSPrefix20211212\Symfony\Contracts\EventDispatcher\Event
{
    protected $command;
    private $input;
    private $output;
    public function __construct(?\ECSPrefix20211212\Symfony\Component\Console\Command\Command $command, \ECSPrefix20211212\Symfony\Component\Console\Input\InputInterface $input, \ECSPrefix20211212\Symfony\Component\Console\Output\OutputInterface $output)
    {
     ...
     */
    public function getCommand() : ?\ECSPrefix20211212\Symfony\Component\Console\Command\Command
    {
        return $this->command;
    }
    /**
