 ...
 */
namespace ECSPrefix20210514\Symfony\Component\Console\DependencyInjection;

use ECSPrefix20210514\Symfony\Component\Console\Command\Command;
use ECSPrefix20210514\Symfony\Component\Console\CommandLoader\ContainerCommandLoader;
 ...
 */
class AddConsoleCommandPass implements \ECSPrefix20210514\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    ...
    public function process(\ECSPrefix20210514\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        ...
        foreach ($commandServices as $id => $tags) {
            ...
            if (isset($tags[0]['command'])) {
                ...
                if (!$r->isSubclassOf(\ECSPrefix20210514\Symfony\Component\Console\Command\Command::class)) {
                    throw new \ECSPrefix20210514\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException(\sprintf('The service "%s" tagged "%s" must be a subclass of "%s".', $id, $this->commandTag, \ECSPrefix20210514\Symfony\Component\Console\Command\Command::class));
                }
            ...
            $lazyCommandRefs[$id] = new \ECSPrefix20210514\Symfony\Component\DependencyInjection\TypedReference($id, $class);
            $aliases = [];
            foreach ($tags as $tag) {
