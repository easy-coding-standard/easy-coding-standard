 ...
 * @internal
 */
class XmlDescriptor extends \ECSPrefix20210515\Symfony\Component\Console\Descriptor\Descriptor
{
    /**
     * @return \DOMDocument
     */
    public function getInputDefinitionDocument(\ECSPrefix20210515\Symfony\Component\Console\Input\InputDefinition $definition)
    {
     ...
     * @return \DOMDocument
     */
    public function getCommandDocument(\ECSPrefix20210515\Symfony\Component\Console\Command\Command $command)
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
     ...
     * @return \DOMDocument
     */
    public function getApplicationDocument(\ECSPrefix20210515\Symfony\Component\Console\Application $application, $namespace = null)
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
        ...
        $description = new \ECSPrefix20210515\Symfony\Component\Console\Descriptor\ApplicationDescription($application, $namespace, \true);
        if ($namespace) {
     ...
     * @return \DOMDocument
     */
    private function getInputArgumentDocument(\ECSPrefix20210515\Symfony\Component\Console\Input\InputArgument $argument)
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
     ...
     * @return \DOMDocument
     */
    private function getInputOptionDocument(\ECSPrefix20210515\Symfony\Component\Console\Input\InputOption $option)
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
