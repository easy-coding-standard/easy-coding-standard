 ...
 * @internal
 */
class XmlDescriptor extends \ECSPrefix20220418\Symfony\Component\Console\Descriptor\Descriptor
{
    public function getInputDefinitionDocument(\ECSPrefix20220418\Symfony\Component\Console\Input\InputDefinition $definition) : \DOMDocument
    {
    ...
    public function getCommandDocument(\ECSPrefix20220418\Symfony\Component\Console\Command\Command $command, bool $short = \false) : \DOMDocument
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
    ...
    public function getApplicationDocument(\ECSPrefix20220418\Symfony\Component\Console\Application $application, string $namespace = null, bool $short = \false) : \DOMDocument
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
        ...
        $description = new \ECSPrefix20220418\Symfony\Component\Console\Descriptor\ApplicationDescription($application, $namespace, \true);
        if ($namespace) {
    ...
    private function getInputArgumentDocument(\ECSPrefix20220418\Symfony\Component\Console\Input\InputArgument $argument) : \DOMDocument
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
    ...
    private function getInputOptionDocument(\ECSPrefix20220418\Symfony\Component\Console\Input\InputOption $option) : \DOMDocument
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
