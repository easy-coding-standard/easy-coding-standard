 ...
 * @internal
 */
class XmlDescriptor extends \ECSPrefix20210711\Symfony\Component\Console\Descriptor\Descriptor
{
    /**
    ...
    public function getApplicationDocument($application, $namespace = null, $short = \false) : \DOMDocument
    {
        ...
        $description = new \ECSPrefix20210711\Symfony\Component\Console\Descriptor\ApplicationDescription($application, $namespace, \true);
        if ($namespace) {
    ...
    private function getInputArgumentDocument(\ECSPrefix20210711\Symfony\Component\Console\Input\InputArgument $argument) : \DOMDocument
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
    ...
    private function getInputOptionDocument(\ECSPrefix20210711\Symfony\Component\Console\Input\InputOption $option) : \DOMDocument
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
