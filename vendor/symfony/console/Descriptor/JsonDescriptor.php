 ...
 * @internal
 */
class JsonDescriptor extends \ECSPrefix20210508\Symfony\Component\Console\Descriptor\Descriptor
{
    /**
     * {@inheritdoc}
     */
    ...
    protected function describeApplication(\ECSPrefix20210508\Symfony\Component\Console\Application $application, array $options = [])
    {
        ...
        $description = new \ECSPrefix20210508\Symfony\Component\Console\Descriptor\ApplicationDescription($application, $describedNamespace, \true);
        $commands = [];
     ...
     * @return mixed[]
     */
    private function getInputArgumentData(\ECSPrefix20210508\Symfony\Component\Console\Input\InputArgument $argument)
    {
     ...
     * @return mixed[]
     */
    private function getInputOptionData(\ECSPrefix20210508\Symfony\Component\Console\Input\InputOption $option)
    {
     ...
     * @return mixed[]
     */
    private function getInputDefinitionData(\ECSPrefix20210508\Symfony\Component\Console\Input\InputDefinition $definition)
    {
        $inputArguments = [];
     ...
     * @return mixed[]
     */
    private function getCommandData(\ECSPrefix20210508\Symfony\Component\Console\Command\Command $command)
    {
