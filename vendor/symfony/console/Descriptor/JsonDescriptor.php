 ...
 * @internal
 */
class JsonDescriptor extends \ECSPrefix20211117\Symfony\Component\Console\Descriptor\Descriptor
{
    /**
     * {@inheritdoc}
    ...
    protected function describeApplication($application, $options = [])
    {
        ...
        $description = new \ECSPrefix20211117\Symfony\Component\Console\Descriptor\ApplicationDescription($application, $describedNamespace, \true);
        $commands = [];
    ...
    private function getInputArgumentData(\ECSPrefix20211117\Symfony\Component\Console\Input\InputArgument $argument) : array
    {
    ...
    private function getInputOptionData(\ECSPrefix20211117\Symfony\Component\Console\Input\InputOption $option, bool $negated = \false) : array
    {
    ...
    private function getInputDefinitionData(\ECSPrefix20211117\Symfony\Component\Console\Input\InputDefinition $definition) : array
    {
        $inputArguments = [];
    ...
    private function getCommandData(\ECSPrefix20211117\Symfony\Component\Console\Command\Command $command, bool $short = \false) : array
    {
