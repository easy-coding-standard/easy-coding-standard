 ...
 * @internal
 */
abstract class Descriptor implements \ECSPrefix20210710\Symfony\Component\Console\Descriptor\DescriptorInterface
{
    /**
     * @var OutputInterface
     */
    ...
    public function describe($output, $object, $options = [])
    {
        $this->output = $output;
        switch (\true) {
            case $object instanceof \ECSPrefix20210710\Symfony\Component\Console\Input\InputArgument:
                $this->describeInputArgument($object, $options);
                break;
            case $object instanceof \ECSPrefix20210710\Symfony\Component\Console\Input\InputOption:
                $this->describeInputOption($object, $options);
                break;
            case $object instanceof \ECSPrefix20210710\Symfony\Component\Console\Input\InputDefinition:
                $this->describeInputDefinition($object, $options);
                break;
            case $object instanceof \ECSPrefix20210710\Symfony\Component\Console\Command\Command:
                $this->describeCommand($object, $options);
                break;
            case $object instanceof \ECSPrefix20210710\Symfony\Component\Console\Application:
                $this->describeApplication($object, $options);
                break;
            default:
                throw new \ECSPrefix20210710\Symfony\Component\Console\Exception\InvalidArgumentException(\sprintf('Object of type "%s" is not describable.', \get_debug_type($object)));
        }
    }
    /**
    ...
    {
        $this->output->write($content, \false, $decorated ? \ECSPrefix20210710\Symfony\Component\Console\Output\OutputInterface::OUTPUT_NORMAL : \ECSPrefix20210710\Symfony\Component\Console\Output\OutputInterface::OUTPUT_RAW);
    }
    /**
