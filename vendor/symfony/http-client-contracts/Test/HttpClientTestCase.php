...
use ECSPrefix20210706\Symfony\Contracts\HttpClient\Exception\TimeoutExceptionInterface;
 ...
 */
abstract class HttpClientTestCase extends \ECSPrefix20210706\PHPUnit\Framework\TestCase
{
    /**
     * @return void
     */
    ...
    {
        \ECSPrefix20210706\Symfony\Contracts\HttpClient\Test\TestHttpServer::start();
    }
    protected abstract function getHttpClient(string $testCase) : \ECSPrefix20210706\Symfony\Contracts\HttpClient\HttpClientInterface;
    public function testGetRequest()
    {
        ...
        $this->expectException(\ECSPrefix20210706\Symfony\Contracts\HttpClient\Exception\TransportExceptionInterface::class);
        $response->getContent();
    }
    ...
    public function testClientError()
    {
        ...
        try {
            $response->getHeaders();
            $this->fail(\ECSPrefix20210706\Symfony\Contracts\HttpClient\Exception\ClientExceptionInterface::class . ' expected');
        } catch (\ECSPrefix20210706\Symfony\Contracts\HttpClient\Exception\ClientExceptionInterface $e) {
        }
        try {
            $response->getContent();
            $this->fail(\ECSPrefix20210706\Symfony\Contracts\HttpClient\Exception\ClientExceptionInterface::class . ' expected');
    ...
    public function testDnsError()
    {
        ...
        try {
            ...
            $this->fail(\ECSPrefix20210706\Symfony\Contracts\HttpClient\Exception\TransportExceptionInterface::class . ' expected');
        } catch (\ECSPrefix20210706\Symfony\Contracts\HttpClient\Exception\TransportExceptionInterface $e) {
            $this->addToAssertionCount(1);
        }
        try {
            $response->getStatusCode();
            $this->fail(\ECSPrefix20210706\Symfony\Contracts\HttpClient\Exception\TransportExceptionInterface::class . ' still expected');
        } catch (\ECSPrefix20210706\Symfony\Contracts\HttpClient\Exception\TransportExceptionInterface $e) {
            $this->addToAssertionCount(1);
        }
        $response = $client->request('GET', 'http://localhost:8057/301/bad-tld');
    ...
    public function testInvalidRedirect()
    {
        ...
        $this->assertNull($response->getInfo('redirect_url'));
        $this->expectException(\ECSPrefix20210706\Symfony\Contracts\HttpClient\Exception\RedirectionExceptionInterface::class);
        $response->getHeaders();
    }
    ...
    public function testMaxRedirects()
    {
        ...
        try {
            $response->getHeaders();
            $this->fail(\ECSPrefix20210706\Symfony\Contracts\HttpClient\Exception\RedirectionExceptionInterface::class . ' expected');
        } catch (\ECSPrefix20210706\Symfony\Contracts\HttpClient\Exception\RedirectionExceptionInterface $e) {
        }
        $this->assertSame(302, $response->getStatusCode());
    ...
    public function testTimeoutIsNotAFatalError()
    {
        ...
        try {
            $response->getContent();
            $this->fail(\ECSPrefix20210706\Symfony\Contracts\HttpClient\Exception\TimeoutExceptionInterface::class . ' expected');
        } catch (\ECSPrefix20210706\Symfony\Contracts\HttpClient\Exception\TimeoutExceptionInterface $e) {
        }
        for ($i = 0; $i < 10; ++$i) {
            try {
    ...
    {
        $p1 = \ECSPrefix20210706\Symfony\Contracts\HttpClient\Test\TestHttpServer::start(8067);
        $p2 = \ECSPrefix20210706\Symfony\Contracts\HttpClient\Test\TestHttpServer::start(8077);
        $client = $this->getHttpClient(__FUNCTION__);
