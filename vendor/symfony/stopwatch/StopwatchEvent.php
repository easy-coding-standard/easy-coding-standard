...
class StopwatchEvent
{
    ...
    public function stop()
    {
        ...
        $this->periods[] = new \ECSPrefix20220527\Symfony\Component\Stopwatch\StopwatchPeriod(\array_pop($this->started), $this->getNow(), $this->morePrecision);
        return $this;
    }
    /**
    ...
    public function getDuration()
    {
        ...
        for ($i = $left - 1; $i >= 0; --$i) {
            $periods[] = new \ECSPrefix20220527\Symfony\Component\Stopwatch\StopwatchPeriod($this->started[$i], $this->getNow(), $this->morePrecision);
        }
        $total = 0;
