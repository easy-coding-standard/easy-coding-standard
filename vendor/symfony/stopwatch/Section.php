...
class Section
{
     ...
     */
    public function startEvent(string $name, $category)
    {
        if (!isset($this->events[$name])) {
            $this->events[$name] = new \ECSPrefix20210608\Symfony\Component\Stopwatch\StopwatchEvent($this->origin ?: \microtime(\true) * 1000, $category, $this->morePrecision, $name);
        }
