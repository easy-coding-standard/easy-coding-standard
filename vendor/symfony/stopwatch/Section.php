...
class Section
{
     ...
     * Starts an event.
     */
    public function startEvent(string $name, ?string $category) : \ECSPrefix20220109\Symfony\Component\Stopwatch\StopwatchEvent
    {
        if (!isset($this->events[$name])) {
            $this->events[$name] = new \ECSPrefix20220109\Symfony\Component\Stopwatch\StopwatchEvent($this->origin ?: \microtime(\true) * 1000, $category, $this->morePrecision, $name);
        }
     ...
     */
    public function stopEvent(string $name) : \ECSPrefix20220109\Symfony\Component\Stopwatch\StopwatchEvent
    {
        if (!isset($this->events[$name])) {
