...
\class_exists(\ECSPrefix20220325\Symfony\Component\Stopwatch\Section::class);
/**
 * Stopwatch provides a way to profile code.
 *
 * @author Fabien Potencier <fabien@symfony.com>
 */
class Stopwatch implements \ECSPrefix20220325\Symfony\Contracts\Service\ResetInterface
{
    /**
     * @var bool
     */
     ...
     * Starts an event.
     */
    public function start(string $name, string $category = null) : \ECSPrefix20220325\Symfony\Component\Stopwatch\StopwatchEvent
    {
     ...
     * Stops an event.
     */
    public function stop(string $name) : \ECSPrefix20220325\Symfony\Component\Stopwatch\StopwatchEvent
    {
    ...
    {
        $this->sections = $this->activeSections = ['__root__' => new \ECSPrefix20220325\Symfony\Component\Stopwatch\Section(null, $this->morePrecision)];
    }
}
