...
use ECSPrefix20210830\Doctrine\Common\Persistence\Proxy as LegacyProxy;
use ECSPrefix20210830\Doctrine\Persistence\Proxy;
use ECSPrefix20210830\Mockery\MockInterface;
use ECSPrefix20210830\Phake\IMock;
use ECSPrefix20210830\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use ECSPrefix20210830\PHPUnit\Framework\MockObject\MockObject;
use ECSPrefix20210830\Prophecy\Prophecy\ProphecySubjectInterface;
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists(\ECSPrefix20210830\Symfony\Component\ErrorHandler\ErrorHandler::class);
        \class_exists(\ECSPrefix20210830\Psr\Log\LogLevel::class);
    ...
    public function checkAnnotations($refl, $class) : array
    {
        ...
        foreach ($parentAndOwnInterfaces + \class_uses($class, \false) as $use) {
            ...
            if (isset(self::$method[$use])) {
                if ($refl->isAbstract()) {
                    ...
                    if (!\strncmp($vendor, \str_replace('_', '\\', $use), $vendorLen) && 0 === \strpos($className, 'Symfony\\') && (!\class_exists(\ECSPrefix20210830\Composer\InstalledVersions::class) || 'symfony/symfony' !== \ECSPrefix20210830\Composer\InstalledVersions::getRootPackage()['name'])) {
        ...
        foreach ($refl->getMethods() as $method) {
            ...
            if ($finalOrInternal || $method->isConstructor() || \false === \strpos($doc, '@param') || \ECSPrefix20210830\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation::class === $class) {
                continue;
            }
