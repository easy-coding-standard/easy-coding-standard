...
use ECSPrefix20210918\Doctrine\Common\Persistence\Proxy as LegacyProxy;
use ECSPrefix20210918\Doctrine\Persistence\Proxy;
use ECSPrefix20210918\Mockery\MockInterface;
use ECSPrefix20210918\Phake\IMock;
use ECSPrefix20210918\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use ECSPrefix20210918\PHPUnit\Framework\MockObject\MockObject;
use ECSPrefix20210918\Prophecy\Prophecy\ProphecySubjectInterface;
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists(\ECSPrefix20210918\Symfony\Component\ErrorHandler\ErrorHandler::class);
        \class_exists(\ECSPrefix20210918\Psr\Log\LogLevel::class);
    ...
    public function checkAnnotations($refl, $class) : array
    {
        ...
        foreach ($parentAndOwnInterfaces + \class_uses($class, \false) as $use) {
            ...
            if (isset(self::$method[$use])) {
                if ($refl->isAbstract()) {
                    ...
                    if (!\strncmp($vendor, \str_replace('_', '\\', $use), $vendorLen) && 0 === \strpos($className, 'Symfony\\') && (!\class_exists(\ECSPrefix20210918\Composer\InstalledVersions::class) || 'symfony/symfony' !== \ECSPrefix20210918\Composer\InstalledVersions::getRootPackage()['name'])) {
        ...
        foreach ($refl->getMethods() as $method) {
            ...
            if ($finalOrInternal || $method->isConstructor() || \false === \strpos($doc, '@param') || \ECSPrefix20210918\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation::class === $class) {
                continue;
            }
