...
use ECSPrefix20210627\Doctrine\Common\Persistence\Proxy as LegacyProxy;
use ECSPrefix20210627\Doctrine\Persistence\Proxy;
use ECSPrefix20210627\Mockery\MockInterface;
use ECSPrefix20210627\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use ECSPrefix20210627\PHPUnit\Framework\MockObject\MockObject;
use ECSPrefix20210627\Prophecy\Prophecy\ProphecySubjectInterface;
...
class DebugClassLoader
{
    ...
    public static function enable()
    {
        ...
        \class_exists(\ECSPrefix20210627\Symfony\Component\ErrorHandler\ErrorHandler::class);
        \class_exists(\ECSPrefix20210627\Psr\Log\LogLevel::class);
    ...
    public function checkAnnotations(\ReflectionClass $refl, string $class) : array
    {
        ...
        foreach ($parentAndOwnInterfaces + \class_uses($class, \false) as $use) {
            ...
            if (isset(self::$method[$use])) {
                if ($refl->isAbstract()) {
                    ...
                    if (!\strncmp($vendor, \str_replace('_', '\\', $use), $vendorLen) && 0 === \strpos($className, 'Symfony\\') && (!\class_exists(\ECSPrefix20210627\Composer\InstalledVersions::class) || 'symfony/symfony' !== \ECSPrefix20210627\Composer\InstalledVersions::getRootPackage()['name'])) {
        ...
        foreach ($refl->getMethods() as $method) {
            ...
            if ($finalOrInternal || $method->isConstructor() || \false === \strpos($doc, '@param') || \ECSPrefix20210627\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation::class === $class) {
                continue;
            }
