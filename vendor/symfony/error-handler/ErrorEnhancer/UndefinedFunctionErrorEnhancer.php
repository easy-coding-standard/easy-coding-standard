...
use ECSPrefix20211002\Symfony\Component\ErrorHandler\Error\UndefinedFunctionError;
/**
 * @author Fabien Potencier <fabien@symfony.com>
 */
class UndefinedFunctionErrorEnhancer implements \ECSPrefix20211002\Symfony\Component\ErrorHandler\ErrorEnhancer\ErrorEnhancerInterface
{
    /**
     * {@inheritdoc}
    ...
    public function enhance($error) : ?\Throwable
    {
        ...
        return new \ECSPrefix20211002\Symfony\Component\ErrorHandler\Error\UndefinedFunctionError($message, $error);
    }
}
