...
use ECSPrefix20210508\Symfony\Component\ErrorHandler\Error\ClassNotFoundError;
use ECSPrefix20210508\Symfony\Component\ErrorHandler\Error\FatalError;
/**
 * @author Fabien Potencier <fabien@symfony.com>
 */
class ClassNotFoundErrorEnhancer implements \ECSPrefix20210508\Symfony\Component\ErrorHandler\ErrorEnhancer\ErrorEnhancerInterface
{
    /**
     * {@inheritdoc}
    ...
    public function enhance(\Throwable $error)
    {
        ...
        $message = !$error instanceof \ECSPrefix20210508\Symfony\Component\ErrorHandler\Error\FatalError ? $error->getMessage() : $error->getError()['message'];
        ...
        return new \ECSPrefix20210508\Symfony\Component\ErrorHandler\Error\ClassNotFoundError($message, $error);
    }
    /**
    ...
    private function getClassCandidates($class)
    {
        ...
        foreach ($functions as $function) {
            ...
            if ($function[0] instanceof \ECSPrefix20210508\Symfony\Component\ErrorHandler\DebugClassLoader) {
                $function = $function[0]->getClassLoader();
                if (!\is_array($function)) {
                    continue;
                }
            }
            if ($function[0] instanceof \ECSPrefix20210508\Composer\Autoload\ClassLoader) {
