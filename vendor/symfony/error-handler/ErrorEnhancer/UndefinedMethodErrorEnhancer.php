...
use ECSPrefix20210509\Symfony\Component\ErrorHandler\Error\UndefinedMethodError;
/**
 * @author Grégoire Pineau <lyrixx@lyrixx.info>
 */
class UndefinedMethodErrorEnhancer implements \ECSPrefix20210509\Symfony\Component\ErrorHandler\ErrorEnhancer\ErrorEnhancerInterface
{
    /**
     * {@inheritdoc}
    ...
    public function enhance(\Throwable $error)
    {
        ...
        if ('' === $methodName || !\class_exists($className) || null === ($methods = \get_class_methods($className))) {
            ...
            return new \ECSPrefix20210509\Symfony\Component\ErrorHandler\Error\UndefinedMethodError($message, $error);
        }
        $candidates = [];
