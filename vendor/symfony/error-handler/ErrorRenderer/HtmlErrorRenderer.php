 ...
 */
class HtmlErrorRenderer implements \ECSPrefix20210508\Symfony\Component\ErrorHandler\ErrorRenderer\ErrorRendererInterface
{
     ...
     */
    public function __construct($debug = \false, $charset = null, $fileLinkFormat = null, $projectDir = null, $outputBuffer = '', \ECSPrefix20210508\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    public function render(\Throwable $exception)
    {
        ...
        $exception = \ECSPrefix20210508\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($exception, null, $headers);
     ...
     * @return string
     */
    public function getBody(\ECSPrefix20210508\Symfony\Component\ErrorHandler\Exception\FlattenException $exception)
    {
     ...
     * @return \Closure
     */
    public static function getAndCleanOutputBuffer(\ECSPrefix20210508\Symfony\Component\HttpFoundation\RequestStack $requestStack)
    {
        return static function () use($requestStack) : string {
            ...
            \ECSPrefix20210508\Symfony\Component\HttpFoundation\Response::closeOutputBuffers($startObLevel + 1, \true);
            return \ob_get_clean();
        };
    }
    /**
