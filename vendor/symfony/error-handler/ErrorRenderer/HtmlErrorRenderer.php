 ...
 */
class HtmlErrorRenderer implements \ECSPrefix20211008\Symfony\Component\ErrorHandler\ErrorRenderer\ErrorRendererInterface
{
     ...
     */
    public function __construct($debug = \false, string $charset = null, $fileLinkFormat = null, string $projectDir = null, $outputBuffer = '', \ECSPrefix20211008\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    public function render($exception) : \ECSPrefix20211008\Symfony\Component\ErrorHandler\Exception\FlattenException
    {
        ...
        $exception = \ECSPrefix20211008\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($exception, null, $headers);
    ...
    public static function getAndCleanOutputBuffer($requestStack) : \Closure
    {
        return static function () use($requestStack) : string {
            ...
            \ECSPrefix20211008\Symfony\Component\HttpFoundation\Response::closeOutputBuffers($startObLevel + 1, \true);
            return \ob_get_clean();
        };
    }
    private function renderException(\ECSPrefix20211008\Symfony\Component\ErrorHandler\Exception\FlattenException $exception, string $debugTemplate = 'views/exception_full.html.php') : string
    {
        ...
        return $this->include($debugTemplate, ['exception' => $exception, 'exceptionMessage' => $exceptionMessage, 'statusText' => $statusText, 'statusCode' => $statusCode, 'logger' => $this->logger instanceof \ECSPrefix20211008\Symfony\Component\HttpKernel\Log\DebugLoggerInterface ? $this->logger : null, 'currentContent' => \is_string($this->outputBuffer) ? $this->outputBuffer : ($this->outputBuffer)()]);
    }
    /**
