 ...
 */
class HtmlErrorRenderer implements \ECSPrefix20210516\Symfony\Component\ErrorHandler\ErrorRenderer\ErrorRendererInterface
{
     ...
     */
    public function __construct($debug = \false, $charset = null, $fileLinkFormat = null, $projectDir = null, $outputBuffer = '', \ECSPrefix20210516\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    public function render(\Throwable $exception)
    {
        ...
        $exception = \ECSPrefix20210516\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($exception, null, $headers);
     ...
     * @return string
     */
    public function getBody(\ECSPrefix20210516\Symfony\Component\ErrorHandler\Exception\FlattenException $exception)
    {
     ...
     * @return \Closure
     */
    public static function isDebug(\ECSPrefix20210516\Symfony\Component\HttpFoundation\RequestStack $requestStack, $debug)
    {
        $debug = (bool) $debug;
     ...
     * @return \Closure
     */
    public static function getAndCleanOutputBuffer(\ECSPrefix20210516\Symfony\Component\HttpFoundation\RequestStack $requestStack)
    {
        return static function () use($requestStack) : string {
            ...
            \ECSPrefix20210516\Symfony\Component\HttpFoundation\Response::closeOutputBuffers($startObLevel + 1, \true);
            return \ob_get_clean();
        };
    }
    /**
     ...
     * @return string
     */
    private function renderException(\ECSPrefix20210516\Symfony\Component\ErrorHandler\Exception\FlattenException $exception, $debugTemplate = 'views/exception_full.html.php')
    {
        ...
        return $this->include($debugTemplate, ['exception' => $exception, 'exceptionMessage' => $exceptionMessage, 'statusText' => $statusText, 'statusCode' => $statusCode, 'logger' => $this->logger instanceof \ECSPrefix20210516\Symfony\Component\HttpKernel\Log\DebugLoggerInterface ? $this->logger : null, 'currentContent' => \is_string($this->outputBuffer) ? $this->outputBuffer : ($this->outputBuffer)()]);
    }
    /**
