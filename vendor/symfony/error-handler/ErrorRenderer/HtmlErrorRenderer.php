...
class HtmlErrorRenderer implements \ECSPrefix20210507\Symfony\Component\ErrorHandler\ErrorRenderer\ErrorRendererInterface
{
    ...
    public function render($exception)
    {
        ...
        $exception = \ECSPrefix20210507\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($exception, null, $headers);
    ...
    public static function getAndCleanOutputBuffer($requestStack)
    {
        return static function () use($requestStack) : string {
            ...
            \ECSPrefix20210507\Symfony\Component\HttpFoundation\Response::closeOutputBuffers($startObLevel + 1, \true);
            return \ob_get_clean();
        };
    }
    /**
    ...
    private function renderException($exception, $debugTemplate = 'views/exception_full.html.php')
    {
        ...
        return $this->include($debugTemplate, ['exception' => $exception, 'exceptionMessage' => $exceptionMessage, 'statusText' => $statusText, 'statusCode' => $statusCode, 'logger' => $this->logger instanceof \ECSPrefix20210507\Symfony\Component\HttpKernel\Log\DebugLoggerInterface ? $this->logger : null, 'currentContent' => \is_string($this->outputBuffer) ? $this->outputBuffer : ($this->outputBuffer)()]);
    }
    /**
