 ...
 */
namespace ECSPrefix20210517\Symfony\Component\ErrorHandler\ErrorRenderer;
...
use ECSPrefix20210517\Symfony\Component\Serializer\Exception\NotEncodableValueException;
use ECSPrefix20210517\Symfony\Component\Serializer\SerializerInterface;
/**
 * Formats an exception using Serializer for rendering.
 *
 * @author Nicolas Grekas <p@tchwork.com>
 */
class SerializerErrorRenderer implements \ECSPrefix20210517\Symfony\Component\ErrorHandler\ErrorRenderer\ErrorRendererInterface
{
    private $serializer;
    private $format;
     ...
     */
    public function __construct(\ECSPrefix20210517\Symfony\Component\Serializer\SerializerInterface $serializer, $format, \ECSPrefix20210517\Symfony\Component\ErrorHandler\ErrorRenderer\ErrorRendererInterface $fallbackErrorRenderer = null, $debug = \false)
    {
    ...
    public static function getPreferredFormat(\ECSPrefix20210517\Symfony\Component\HttpFoundation\RequestStack $requestStack)
    {
        return static function () use($requestStack) {
            if (!($request = $requestStack->getCurrentRequest())) {
                throw new \ECSPrefix20210517\Symfony\Component\Serializer\Exception\NotEncodableValueException();
            }
