...
use ECSPrefix202306\Symfony\Component\ErrorHandler\Error\OutOfMemoryError;
use ECSPrefix202306\Symfony\Component\ErrorHandler\ErrorEnhancer\ClassNotFoundErrorEnhancer;
use ECSPrefix202306\Symfony\Component\ErrorHandler\ErrorEnhancer\ErrorEnhancerInterface;
use ECSPrefix202306\Symfony\Component\ErrorHandler\ErrorEnhancer\UndefinedFunctionErrorEnhancer;
use ECSPrefix202306\Symfony\Component\ErrorHandler\ErrorEnhancer\UndefinedMethodErrorEnhancer;
use ECSPrefix202306\Symfony\Component\ErrorHandler\ErrorRenderer\CliErrorRenderer;
use ECSPrefix202306\Symfony\Component\ErrorHandler\ErrorRenderer\HtmlErrorRenderer;
...
class ErrorHandler
{
    ...
    /**
     * @var \Symfony\Component\ErrorHandler\BufferingLogger|null
     */
    ...
    {
        if (\E_WARNING === $type && '"' === $message[0] && \strpos($message, '" targeting switch is equivalent to "break') !== \false) {
            $type = \E_DEPRECATED;
        }
        ...
        if (!$throw && !($type & $level)) {
            ...
            if (\strpos($message, '@anonymous') !== \false) {
    ...
    public function handleException(\Throwable $exception) : void
    {
        ...
        if ($this->loggedErrors & $type) {
            if (\strpos($message = $exception->getMessage(), "@anonymous\x00") !== \false) {
    ...
    public static function handleFatalError(array $error = null) : void
    {
        ...
        if ($error && ($error['type'] &= \E_PARSE | \E_ERROR | \E_CORE_ERROR | \E_COMPILE_ERROR)) {
            ...
            if (\strncmp($error['message'], 'Allowed memory', \strlen('Allowed memory')) === 0 || \strncmp($error['message'], 'Out of memory', \strlen('Out of memory')) === 0) {
