...
foreach ($logs as $log) {
    if ($log['priority'] >= 400) {
        ...
        $severity = 0;
        if (($exception = $log['context']['exception'] ?? null) instanceof \ErrorException || $exception instanceof \ECSPrefix20210713\Symfony\Component\ErrorHandler\Exception\SilencedErrorContext) {
