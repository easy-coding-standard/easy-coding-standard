 ...
 */
namespace ECSPrefix202210\Symfony\Contracts\Service\Test;

use ECSPrefix202210\PHPUnit\Framework\TestCase;
use ECSPrefix202210\Psr\Container\ContainerInterface;
use ECSPrefix202210\Symfony\Contracts\Service\ServiceLocatorTrait;
abstract class ServiceLocatorTest extends TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\ECSPrefix202210\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\ECSPrefix202210\Psr\Container\ContainerExceptionInterface::class);
