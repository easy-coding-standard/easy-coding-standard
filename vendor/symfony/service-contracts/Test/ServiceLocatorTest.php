 ...
 */
namespace ECSPrefix202212\Symfony\Contracts\Service\Test;

use ECSPrefix202212\PHPUnit\Framework\TestCase;
...
abstract class ServiceLocatorTest extends TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\ECSPrefix202212\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\ECSPrefix202212\Psr\Container\ContainerExceptionInterface::class);
