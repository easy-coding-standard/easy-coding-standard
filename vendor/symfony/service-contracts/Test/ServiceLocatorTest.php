 ...
 */
namespace ECSPrefix20220607\Symfony\Contracts\Service\Test;
...
abstract class ServiceLocatorTest extends \ECSPrefix20220607\PHPUnit\Framework\TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\ECSPrefix20220607\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\ECSPrefix20220607\Psr\Container\ContainerExceptionInterface::class);
