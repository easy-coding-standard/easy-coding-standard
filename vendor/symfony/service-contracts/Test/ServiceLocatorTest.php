 ...
 */
namespace ECSPrefix202211\Symfony\Contracts\Service\Test;
...
abstract class ServiceLocatorTest extends TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\ECSPrefix202211\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\ECSPrefix202211\Psr\Container\ContainerExceptionInterface::class);
