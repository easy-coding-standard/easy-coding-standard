 ...
 */
namespace ECSPrefix202209\Symfony\Contracts\Service\Test;

use ECSPrefix202209\PHPUnit\Framework\TestCase;
use ECSPrefix202209\Psr\Container\ContainerInterface;
use ECSPrefix202209\Symfony\Contracts\Service\ServiceLocatorTrait;
abstract class ServiceLocatorTest extends TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\ECSPrefix202209\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\ECSPrefix202209\Psr\Container\ContainerExceptionInterface::class);
