 ...
 */
namespace ECSPrefix20211210\Symfony\Contracts\Service\Test;

use ECSPrefix20211210\PHPUnit\Framework\TestCase;
...
abstract class ServiceLocatorTest extends \ECSPrefix20211210\PHPUnit\Framework\TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\ECSPrefix20211210\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\ECSPrefix20211210\Psr\Container\ContainerExceptionInterface::class);
