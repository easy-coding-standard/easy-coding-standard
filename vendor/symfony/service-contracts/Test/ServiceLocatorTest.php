 ...
 */
namespace ECSPrefix202206\Symfony\Contracts\Service\Test;

use ECSPrefix202206\PHPUnit\Framework\TestCase;
use ECSPrefix202206\Psr\Container\ContainerInterface;
use ECSPrefix202206\Symfony\Contracts\Service\ServiceLocatorTrait;
abstract class ServiceLocatorTest extends TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\ECSPrefix202206\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\ECSPrefix202206\Psr\Container\ContainerExceptionInterface::class);
