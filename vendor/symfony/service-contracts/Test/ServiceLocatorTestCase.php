 ...
 */
namespace ECSPrefix202306\Symfony\Contracts\Service\Test;

use ECSPrefix202306\PHPUnit\Framework\TestCase;
...
abstract class ServiceLocatorTestCase extends TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\ECSPrefix202306\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\ECSPrefix202306\Psr\Container\ContainerExceptionInterface::class);
