 ...
 */
namespace ECSPrefix20210818\Symfony\Component\OptionsResolver\Debug;

use ECSPrefix20210818\Symfony\Component\OptionsResolver\Exception\NoConfigurationException;
use ECSPrefix20210818\Symfony\Component\OptionsResolver\Exception\UndefinedOptionsException;
use ECSPrefix20210818\Symfony\Component\OptionsResolver\OptionsResolver;
/**
...
{
    private $get;
    public function __construct(\ECSPrefix20210818\Symfony\Component\OptionsResolver\OptionsResolver $optionsResolver)
    {
        $this->get = \Closure::bind(function ($property, $option, $message) {
            /** @var OptionsResolver $this */
            if (!$this->isDefined($option)) {
                throw new \ECSPrefix20210818\Symfony\Component\OptionsResolver\Exception\UndefinedOptionsException(\sprintf('The option "%s" does not exist.', $option));
            }
            if (!\array_key_exists($option, $this->{$property})) {
                throw new \ECSPrefix20210818\Symfony\Component\OptionsResolver\Exception\NoConfigurationException($message);
            }
