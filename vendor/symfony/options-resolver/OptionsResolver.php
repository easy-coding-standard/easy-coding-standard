 ...
 */
namespace ECSPrefix202302\Symfony\Component\OptionsResolver;

use ECSPrefix202302\Symfony\Component\OptionsResolver\Exception\AccessException;
use ECSPrefix202302\Symfony\Component\OptionsResolver\Exception\InvalidArgumentException;
use ECSPrefix202302\Symfony\Component\OptionsResolver\Exception\InvalidOptionsException;
use ECSPrefix202302\Symfony\Component\OptionsResolver\Exception\MissingOptionsException;
use ECSPrefix202302\Symfony\Component\OptionsResolver\Exception\NoSuchOptionException;
use ECSPrefix202302\Symfony\Component\OptionsResolver\Exception\OptionDefinitionException;
use ECSPrefix202302\Symfony\Component\OptionsResolver\Exception\UndefinedOptionsException;
/**
    ...
    public function offsetGet($option, bool $triggerDeprecation = \true)
    {
        ...
        if (isset($this->resolved[$option]) || \array_key_exists($option, $this->resolved)) {
            if ($triggerDeprecation && isset($this->deprecated[$option]) && (isset($this->given[$option]) || $this->calling) && \is_string($this->deprecated[$option]['message'])) {
                \ECSPrefix202302\trigger_deprecation($this->deprecated[$option]['package'], $this->deprecated[$option]['version'], \strtr($this->deprecated[$option]['message'], ['%name%' => $option]));
            }
        ...
        if ($triggerDeprecation && isset($this->deprecated[$option]) && (isset($this->given[$option]) || $this->calling && \is_string($this->deprecated[$option]['message']))) {
            ...
            if ('' !== $message) {
                \ECSPrefix202302\trigger_deprecation($deprecation['package'], $deprecation['version'], \strtr($message, ['%name%' => $option]));
            }
        }
