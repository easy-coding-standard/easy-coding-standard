...
use ECSPrefix20210508\Symfony\Component\Messenger\MessageBusInterface;
use ECSPrefix20210508\Symfony\Component\Messenger\Stamp\HandledStamp;
/**
...
class EarlyExpirationDispatcher
{
    ...
    public function __construct(\ECSPrefix20210508\Symfony\Component\Messenger\MessageBusInterface $bus, \ECSPrefix20210508\Symfony\Component\DependencyInjection\ReverseContainer $reverseContainer, callable $callbackWrapper = null)
    {
        $this->bus = $bus;
    ...
    public function __invoke(callable $callback, \ECSPrefix20210508\Symfony\Component\Cache\CacheItem $item, &$save, \ECSPrefix20210508\Symfony\Component\Cache\Adapter\AdapterInterface $pool, \Closure $setMetadata, \ECSPrefix20210508\Psr\Log\LoggerInterface $logger = null)
    {
        ...
        if ($logger) {
            if ($envelope->last(\ECSPrefix20210508\Symfony\Component\Messenger\Stamp\HandledStamp::class)) {
