...
class DefaultMarshaller implements \ECSPrefix20210507\Symfony\Component\Cache\Marshaller\MarshallerInterface
{
    ...
    public function __construct($useIgbinarySerialize = null)
    {
        if (null === $useIgbinarySerialize) {
            ...
            throw new \ECSPrefix20210507\Symfony\Component\Cache\Exception\CacheException(\extension_loaded('igbinary') && \PHP_VERSION_ID >= 70400 ? 'Please upgrade the "igbinary" PHP extension to v3.1.6 or higher.' : 'The "igbinary" PHP extension is not loaded.');
        }
