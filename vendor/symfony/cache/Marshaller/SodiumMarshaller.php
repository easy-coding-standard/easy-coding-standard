 ...
 */
class SodiumMarshaller implements \ConfigTransformer20210601\Symfony\Component\Cache\Marshaller\MarshallerInterface
{
    private $marshaller;
     ...
     */
    public function __construct(array $decryptionKeys, \ConfigTransformer20210601\Symfony\Component\Cache\Marshaller\MarshallerInterface $marshaller = null)
    {
        if (!self::isSupported()) {
            throw new \ConfigTransformer20210601\Symfony\Component\Cache\Exception\CacheException('The "sodium" PHP extension is not loaded.');
        }
        if (!isset($decryptionKeys[0])) {
            throw new \ConfigTransformer20210601\Symfony\Component\Cache\Exception\InvalidArgumentException('At least one decryption key must be provided at index "0".');
        }
