...
use ECSPrefix20210509\Symfony\Component\Cache\Traits\FilesystemCommonTrait;
 ...
 */
class PhpFilesAdapter extends \ECSPrefix20210509\Symfony\Component\Cache\Adapter\AbstractAdapter implements \ECSPrefix20210509\Symfony\Component\Cache\PruneableInterface
{
    ...
    protected function doFetch(array $ids)
    {
        ...
        foreach ($ids as $id) {
            if (null === ($value = isset($this->values[$id]) ? $this->values[$id] : null)) {
                ...
                $values[$id] = $value;
            } elseif (!$value instanceof \ECSPrefix20210509\Symfony\Component\Cache\Adapter\LazyValue) {
                $values[$id] = $value();
            ...
            foreach ($missingIds as $k => $id) {
                try {
                    ...
                    if (isset(self::$valuesCache[$file])) {
                        ...
                        $this->values[$id] = new \ECSPrefix20210509\Symfony\Component\Cache\Adapter\LazyValue($file);
                    }
                    if ($now >= $expiresAt) {
    ...
    protected function doHave($id)
    {
        ...
        try {
            ...
            if (isset(self::$valuesCache[$file])) {
                ...
                $value = new \ECSPrefix20210509\Symfony\Component\Cache\Adapter\LazyValue($file);
            }
        } catch (\ErrorException $e) {
            return \false;
        } finally {
    ...
    protected function doSave(array $values, $lifetime)
    {
        ...
        foreach ($values as $key => $value) {
            ...
            if (null === $value) {
                ...
                try {
                    $value = \ECSPrefix20210509\Symfony\Component\VarExporter\VarExporter::export($value, $isStaticValue);
                } catch (\Exception $e) {
