...
use ConfigTransformer20210601\Symfony\Component\Cache\Traits\FilesystemCommonTrait;
 ...
 */
class PhpFilesAdapter extends \ConfigTransformer20210601\Symfony\Component\Cache\Adapter\AbstractAdapter implements \ConfigTransformer20210601\Symfony\Component\Cache\PruneableInterface
{
    ...
    protected function doFetch(array $ids)
    {
        ...
        foreach ($ids as $id) {
            if (null === ($value = $this->values[$id] ?? null)) {
                ...
                $values[$id] = $value;
            } elseif (!$value instanceof \ConfigTransformer20210601\Symfony\Component\Cache\Adapter\LazyValue) {
                $values[$id] = $value();
            ...
            foreach ($missingIds as $k => $id) {
                try {
                    ...
                    if (isset(self::$valuesCache[$file])) {
                        ...
                        $this->values[$id] = new \ConfigTransformer20210601\Symfony\Component\Cache\Adapter\LazyValue($file);
                    }
                    if ($now >= $expiresAt) {
    ...
    protected function doHave($id)
    {
        ...
        try {
            ...
            if (isset(self::$valuesCache[$file])) {
                ...
                $value = new \ConfigTransformer20210601\Symfony\Component\Cache\Adapter\LazyValue($file);
            }
        } catch (\ErrorException $e) {
            return \false;
        } finally {
    ...
    protected function doSave(array $values, $lifetime)
    {
        ...
        foreach ($values as $key => $value) {
            ...
            if (null === $value) {
                ...
                try {
                    $value = \ConfigTransformer20210601\Symfony\Component\VarExporter\VarExporter::export($value, $isStaticValue);
                } catch (\Exception $e) {
        ...
        if (!$ok && !\is_writable($this->directory)) {
            throw new \ConfigTransformer20210601\Symfony\Component\Cache\Exception\CacheException(\sprintf('Cache directory is not writable (%s).', $this->directory));
        }
        return $ok;
    }
    /**
