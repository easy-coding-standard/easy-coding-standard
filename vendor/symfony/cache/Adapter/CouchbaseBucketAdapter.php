 ...
 */
class CouchbaseBucketAdapter extends \ConfigTransformer20210601\Symfony\Component\Cache\Adapter\AbstractAdapter
{
    ...
    private $bucket;
    private $marshaller;
    public function __construct(\ConfigTransformer20210601\CouchbaseBucket $bucket, string $namespace = '', int $defaultLifetime = 0, \ConfigTransformer20210601\Symfony\Component\Cache\Marshaller\MarshallerInterface $marshaller = null)
    {
        if (!static::isSupported()) {
            throw new \ConfigTransformer20210601\Symfony\Component\Cache\Exception\CacheException('Couchbase >= 2.6.0 < 3.0.0 is required.');
        }
     ...
     */
    public static function createConnection($servers, array $options = []) : \ConfigTransformer20210601\CouchbaseBucket
    {
        ...
        try {
            ...
            foreach ($servers as $dsn) {
                if (0 !== \strpos($dsn, 'couchbase:')) {
                    throw new \ConfigTransformer20210601\Symfony\Component\Cache\Exception\InvalidArgumentException(\sprintf('Invalid Couchbase DSN: "%s" does not start with "couchbase:".', $dsn));
                }
            ...
            $client = new \ConfigTransformer20210601\CouchbaseCluster($connectionString);
