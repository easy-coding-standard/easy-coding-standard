...
class CouchbaseBucketAdapter extends \ECSPrefix20210507\Symfony\Component\Cache\Adapter\AbstractAdapter
{
    ...
    public function __construct($bucket, $namespace = '', $defaultLifetime = 0, $marshaller = null)
    {
        if (!static::isSupported()) {
            throw new \ECSPrefix20210507\Symfony\Component\Cache\Exception\CacheException('Couchbase >= 2.6.0 < 3.0.0 is required.');
        }
        ...
        try {
            ...
            foreach ($servers as $dsn) {
                if (0 !== \strpos($dsn, 'couchbase:')) {
                    throw new \ECSPrefix20210507\Symfony\Component\Cache\Exception\InvalidArgumentException(\sprintf('Invalid Couchbase DSN: "%s" does not start with "couchbase:".', $dsn));
                }
