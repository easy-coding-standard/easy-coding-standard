...
use ConfigTransformer20210601\Symfony\Contracts\Cache\TagAwareCacheInterface;
/**
 ...
 * @internal
 */
abstract class AbstractTagAwareAdapter implements \ConfigTransformer20210601\Symfony\Component\Cache\Adapter\TagAwareAdapterInterface, \ConfigTransformer20210601\Symfony\Contracts\Cache\TagAwareCacheInterface, \ConfigTransformer20210601\Psr\Log\LoggerAwareInterface, \ConfigTransformer20210601\Symfony\Component\Cache\ResettableInterface
{
    ...
    {
        $this->namespace = '' === $namespace ? '' : \ConfigTransformer20210601\Symfony\Component\Cache\CacheItem::validateKey($namespace) . ':';
        ...
        self::$createCacheItem ?? (self::$createCacheItem = \Closure::bind(static function ($key, $value, $isHit) {
            ...
            $item->metadata[\ConfigTransformer20210601\Symfony\Component\Cache\CacheItem::METADATA_TAGS] = $value['tags'] ?? [];
            if (isset($value['meta'])) {
        ...
        self::$mergeByLifetime ?? (self::$mergeByLifetime = \Closure::bind(static function ($deferred, &$expiredIds, $getId, $tagPrefix, $defaultLifetime) {
            ...
            foreach ($deferred as $key => $item) {
                ...
                if (isset(($metadata = $item->newMetadata)[\ConfigTransformer20210601\Symfony\Component\Cache\CacheItem::METADATA_TAGS])) {
                    $value = ['value' => $item->value, 'tags' => $metadata[\ConfigTransformer20210601\Symfony\Component\Cache\CacheItem::METADATA_TAGS]];
                ...
                $oldTags = $item->metadata[\ConfigTransformer20210601\Symfony\Component\Cache\CacheItem::METADATA_TAGS] ?? [];
     ...
     */
    protected abstract function doSave(array $values, int $lifetime, $addTagData = [], $removeTagData = []) : array;
    /**
    ...
    public function deleteItems(array $keys) : bool
    {
        ...
        foreach ($ids as $key => $id) {
            ...
            \ConfigTransformer20210601\Symfony\Component\Cache\CacheItem::log($this->logger, $message, ['key' => $key, 'exception' => $e, 'cache-adapter' => \get_debug_type($this)]);
            $ok = \false;
        }
        return $ok;
    }
