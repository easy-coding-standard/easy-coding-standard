 ...
 * @internal
 */
abstract class AbstractTagAwareAdapter implements \ECSPrefix20210509\Symfony\Component\Cache\Adapter\TagAwareAdapterInterface, \ECSPrefix20210509\Symfony\Contracts\Cache\TagAwareCacheInterface, \ECSPrefix20210509\Psr\Log\LoggerAwareInterface, \ECSPrefix20210509\Symfony\Component\Cache\ResettableInterface
{
    ...
    protected function __construct($namespace = '', $defaultLifetime = 0)
    {
        ...
        $this->namespace = '' === $namespace ? '' : \ECSPrefix20210509\Symfony\Component\Cache\CacheItem::validateKey($namespace) . ':';
        ...
        $this->createCacheItem = \Closure::bind(static function ($key, $value, $isHit) {
            ...
            $item->metadata[\ECSPrefix20210509\Symfony\Component\Cache\CacheItem::METADATA_TAGS] = isset($value['tags']) ? $value['tags'] : [];
            if (isset($value['meta'])) {
        ...
        $this->mergeByLifetime = \Closure::bind(static function ($deferred, &$expiredIds) use($getId, $tagPrefix, $defaultLifetime) {
            ...
            foreach ($deferred as $key => $item) {
                ...
                if (isset(($metadata = $item->newMetadata)[\ECSPrefix20210509\Symfony\Component\Cache\CacheItem::METADATA_TAGS])) {
                    $value = ['value' => $item->value, 'tags' => $metadata[\ECSPrefix20210509\Symfony\Component\Cache\CacheItem::METADATA_TAGS]];
                ...
                $oldTags = isset($item->metadata[\ECSPrefix20210509\Symfony\Component\Cache\CacheItem::METADATA_TAGS]) ? $item->metadata[\ECSPrefix20210509\Symfony\Component\Cache\CacheItem::METADATA_TAGS] : [];
