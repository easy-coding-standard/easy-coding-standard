 ...
 */
abstract class AbstractAdapter implements \ECSPrefix20210507\Symfony\Component\Cache\Adapter\AdapterInterface, \ECSPrefix20210507\Symfony\Contracts\Cache\CacheInterface, \ECSPrefix20210507\Psr\Log\LoggerAwareInterface, \ECSPrefix20210507\Symfony\Component\Cache\ResettableInterface
{
    /**
     * @internal
     */
    ...
    {
        $this->namespace = '' === $namespace ? '' : \ECSPrefix20210507\Symfony\Component\Cache\CacheItem::validateKey($namespace) . static::NS_SEPARATOR;
    ...
    public static function createConnection($dsn, array $options = [])
    {
        ...
        throw new \ECSPrefix20210507\Symfony\Component\Cache\Exception\InvalidArgumentException(\sprintf('Unsupported DSN: "%s".', $dsn));
    }
    /**
     * {@inheritdoc}
     *
