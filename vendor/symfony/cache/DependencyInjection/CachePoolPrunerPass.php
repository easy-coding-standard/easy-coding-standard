 ...
 */
class CachePoolPrunerPass implements \ECSPrefix20210509\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    ...
    public function process(\ECSPrefix20210509\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        ...
        foreach ($container->findTaggedServiceIds($this->cachePoolTag) as $id => $tags) {
            ...
            if ($reflection->implementsInterface(\ECSPrefix20210509\Symfony\Component\Cache\PruneableInterface::class)) {
                $services[$id] = new \ECSPrefix20210509\Symfony\Component\DependencyInjection\Reference($id);
            }
        }
        $container->getDefinition($this->cacheCommandServiceId)->replaceArgument(0, new \ECSPrefix20210509\Symfony\Component\DependencyInjection\Argument\IteratorArgument($services));
    }
}
