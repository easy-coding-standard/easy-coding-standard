...
if (\interface_exists(\ECSPrefix20210507\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \ECSPrefix20210507\Psr\Cache\CacheException, \ECSPrefix20210507\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \ECSPrefix20210507\Psr\Cache\CacheException
    {
    }
}
