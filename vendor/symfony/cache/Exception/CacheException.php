...
if (\interface_exists(\ECSPrefix20210508\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \ECSPrefix20210508\Psr\Cache\CacheException, \ECSPrefix20210508\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \ECSPrefix20210508\Psr\Cache\CacheException
    {
    }
}
