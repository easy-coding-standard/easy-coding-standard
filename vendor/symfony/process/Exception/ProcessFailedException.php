 ...
 */
class ProcessFailedException extends \ECSPrefix20211002\Symfony\Component\Process\Exception\RuntimeException
{
    private $process;
    public function __construct(\ECSPrefix20211002\Symfony\Component\Process\Process $process)
    {
        if ($process->isSuccessful()) {
            throw new \ECSPrefix20211002\Symfony\Component\Process\Exception\InvalidArgumentException('Expected a failed process, but the given process was successful.');
        }
