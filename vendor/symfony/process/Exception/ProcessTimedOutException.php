 ...
 */
class ProcessTimedOutException extends \ECSPrefix20211023\Symfony\Component\Process\Exception\RuntimeException
{
    public const TYPE_GENERAL = 1;
    public const TYPE_IDLE = 2;
    private $process;
    private $timeoutType;
    public function __construct(\ECSPrefix20211023\Symfony\Component\Process\Process $process, int $timeoutType)
    {
