 ...
 * @internal
 */
class UnixPipes extends \ECSPrefix20210513\Symfony\Component\Process\Pipes\AbstractPipes
{
    private $ttyMode;
    private $ptyMode;
    ...
    public function getDescriptors()
    {
        ...
        if ($this->ptyMode && \ECSPrefix20210513\Symfony\Component\Process\Process::isPtySupported()) {
            return [['pty'], ['pty'], ['pty']];
        }
        return [
            ['pipe', 'r'],
    ...
    public function readAndWrite($blocking, $close = \false)
    {
        ...
        if (($r || $w) && \false === \stream_select($r, $w, $e, 0, $blocking ? \ECSPrefix20210513\Symfony\Component\Process\Process::TIMEOUT_PRECISION * 1000000.0 : 0)) {
