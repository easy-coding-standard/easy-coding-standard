...
class PhpProcess extends \ECSPrefix20210507\Symfony\Component\Process\Process
{
    ...
    {
        throw new \ECSPrefix20210507\Symfony\Component\Process\Exception\LogicException(\sprintf('The "%s()" method cannot be called when using "%s".', __METHOD__, self::class));
    }
    /**
     * {@inheritdoc}
     */
    public function start(callable $callback = null, array $env = [])
    {
        if (null === $this->getCommandLine()) {
            throw new \ECSPrefix20210507\Symfony\Component\Process\Exception\RuntimeException('Unable to find the PHP executable.');
        }
