...
use ECSPrefix202306\Symfony\Component\VarDumper\Cloner\Cursor;
    ...
    public function dumpScalar(Cursor $cursor, string $type, $value)
    {
        ...
        switch ($type) {
            ...
            case 'double':
                ...
                $value = \true === (\INF === $value) ? 'INF' : (\true === (-\INF === $value) ? '-INF' : (\true === \is_nan($value) ? 'NAN' : (\strpos($value = (string) $value, $this->decimalPoint) === \false ? $value .= $this->decimalPoint . '0' : $value)));
                break;
            case 'NULL':
                $value = 'null';
                break;
