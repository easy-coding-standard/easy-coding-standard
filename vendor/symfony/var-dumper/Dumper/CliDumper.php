 ...
 */
namespace ECSPrefix202305\Symfony\Component\VarDumper\Dumper;

use ECSPrefix202305\Symfony\Component\VarDumper\Cloner\Cursor;
...
class CliDumper extends AbstractDumper
{
            ...
            case 'double':
                ...
                switch (\true) {
                    ...
                    case \is_nan($value):
                        ...
                        break;
                    default:
                        $value = \strpos($value = (string) $value, $this->decimalPoint) === \false ? $value .= $this->decimalPoint . '0' : $value;
                        break;
                }
                break;
            case 'NULL':
    ...
    public function dumpString(Cursor $cursor, string $str, bool $bin, int $cut)
    {
        ...
        if ('' === $str) {
            ...
            $str = $bin && \strpos($str, "\x00") !== \false ? [$str] : \explode("\n", $str);
    ...
    {
        $this->colors = $this->colors ?? $this->supportsColors();
        $this->dumpKey($cursor);
        $attr = $cursor->attr;
