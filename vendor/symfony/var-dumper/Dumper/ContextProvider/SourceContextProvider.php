...
use ECSPrefix20210517\Twig\Template;
/**
 ...
 */
final class SourceContextProvider implements \ECSPrefix20210517\Symfony\Component\VarDumper\Dumper\ContextProvider\ContextProviderInterface
{
    private $limit;
    private $charset;
    private $projectDir;
            ...
            if (isset($trace[$i]['class'], $trace[$i]['function']) && 'dump' === $trace[$i]['function'] && \ECSPrefix20210517\Symfony\Component\VarDumper\VarDumper::class === $trace[$i]['class']) {
                ...
                while (++$i < $this->limit) {
                    if (isset($trace[$i]['function'], $trace[$i]['file']) && empty($trace[$i]['class']) && 0 !== \strpos($trace[$i]['function'], 'call_user_func')) {
                        ...
                        $line = $trace[$i]['line'];
                        break;
                    } elseif (isset($trace[$i]['object']) && $trace[$i]['object'] instanceof \ECSPrefix20210517\Twig\Template) {
