 ...
 */
class HtmlDumper extends \ECSPrefix20210513\Symfony\Component\VarDumper\Dumper\CliDumper
{
    ...
    {
        $flags = (int) $flags;
        \ECSPrefix20210513\Symfony\Component\VarDumper\Dumper\AbstractDumper::__construct($output, $charset, $flags);
     ...
     */
    public function dump(\ECSPrefix20210513\Symfony\Component\VarDumper\Cloner\Data $data, $output = null, $extraDisplayOptions = [])
    {
...
EOHTML
    ...
    public function enterHash(\ECSPrefix20210513\Symfony\Component\VarDumper\Cloner\Cursor $cursor, $type, $class, $hasChild)
    {
        ...
        if ($hasChild) {
            ...
            if ($cursor->refIndex) {
                $r = \ECSPrefix20210513\Symfony\Component\VarDumper\Cloner\Cursor::HASH_OBJECT !== $type ? 1 - (\ECSPrefix20210513\Symfony\Component\VarDumper\Cloner\Cursor::HASH_RESOURCE !== $type) : 2;
    ...
    protected function dumpLine($depth, $endOfValue = \false)
    {
        ...
        if (-1 === $depth) {
            \ECSPrefix20210513\Symfony\Component\VarDumper\Dumper\AbstractDumper::dumpLine(0);
        }
        \ECSPrefix20210513\Symfony\Component\VarDumper\Dumper\AbstractDumper::dumpLine($depth);
    }
    /**
     * @param string $file
     * @param int $line
