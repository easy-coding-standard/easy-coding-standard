 ...
 */
class HtmlDumper extends \ECSPrefix20210622\Symfony\Component\VarDumper\Dumper\CliDumper
{
    ...
    {
        \ECSPrefix20210622\Symfony\Component\VarDumper\Dumper\AbstractDumper::__construct($output, $charset, $flags);
     ...
     */
    public function dump(\ECSPrefix20210622\Symfony\Component\VarDumper\Cloner\Data $data, $output = null, $extraDisplayOptions = [])
    {
...
EOHTML
    ...
    public function enterHash(\ECSPrefix20210622\Symfony\Component\VarDumper\Cloner\Cursor $cursor, int $type, $class, bool $hasChild)
    {
        ...
        if ($hasChild) {
            ...
            if ($cursor->refIndex) {
                $r = \ECSPrefix20210622\Symfony\Component\VarDumper\Cloner\Cursor::HASH_OBJECT !== $type ? 1 - (\ECSPrefix20210622\Symfony\Component\VarDumper\Cloner\Cursor::HASH_RESOURCE !== $type) : 2;
    ...
    protected function dumpLine(int $depth, $endOfValue = \false)
    {
        ...
        if (-1 === $depth) {
            \ECSPrefix20210622\Symfony\Component\VarDumper\Dumper\AbstractDumper::dumpLine(0);
        }
        \ECSPrefix20210622\Symfony\Component\VarDumper\Dumper\AbstractDumper::dumpLine($depth);
    }
