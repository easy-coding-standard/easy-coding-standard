 ...
 */
class HtmlDumper extends \ConfigTransformer20210601\Symfony\Component\VarDumper\Dumper\CliDumper
{
    ...
    {
        \ConfigTransformer20210601\Symfony\Component\VarDumper\Dumper\AbstractDumper::__construct($output, $charset, $flags);
     ...
     */
    public function dump(\ConfigTransformer20210601\Symfony\Component\VarDumper\Cloner\Data $data, $output = null, $extraDisplayOptions = [])
    {
...
EOHTML
    ...
    public function enterHash(\ConfigTransformer20210601\Symfony\Component\VarDumper\Cloner\Cursor $cursor, int $type, $class, bool $hasChild)
    {
        ...
        if ($hasChild) {
            ...
            if ($cursor->refIndex) {
                $r = \ConfigTransformer20210601\Symfony\Component\VarDumper\Cloner\Cursor::HASH_OBJECT !== $type ? 1 - (\ConfigTransformer20210601\Symfony\Component\VarDumper\Cloner\Cursor::HASH_RESOURCE !== $type) : 2;
    ...
    protected function dumpLine(int $depth, $endOfValue = \false)
    {
        ...
        if (-1 === $depth) {
            \ConfigTransformer20210601\Symfony\Component\VarDumper\Dumper\AbstractDumper::dumpLine(0);
        }
        \ConfigTransformer20210601\Symfony\Component\VarDumper\Dumper\AbstractDumper::dumpLine($depth);
    }
