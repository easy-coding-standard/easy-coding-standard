 ...
 */
class HtmlDumper extends \ECSPrefix20211021\Symfony\Component\VarDumper\Dumper\CliDumper
{
    ...
    {
        \ECSPrefix20211021\Symfony\Component\VarDumper\Dumper\AbstractDumper::__construct($output, $charset, $flags);
...
EOHTML
    ...
    public function enterHash($cursor, $type, $class, $hasChild)
    {
        ...
        if ($hasChild) {
            ...
            if ($cursor->refIndex) {
                $r = \ECSPrefix20211021\Symfony\Component\VarDumper\Cloner\Cursor::HASH_OBJECT !== $type ? 1 - (\ECSPrefix20211021\Symfony\Component\VarDumper\Cloner\Cursor::HASH_RESOURCE !== $type) : 2;
    ...
    protected function dumpLine($depth, $endOfValue = \false)
    {
        ...
        if (-1 === $depth) {
            \ECSPrefix20211021\Symfony\Component\VarDumper\Dumper\AbstractDumper::dumpLine(0);
        }
        \ECSPrefix20211021\Symfony\Component\VarDumper\Dumper\AbstractDumper::dumpLine($depth);
    }
