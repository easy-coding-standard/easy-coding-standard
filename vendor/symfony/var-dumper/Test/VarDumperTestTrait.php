 ...
 */
namespace ECSPrefix20210517\Symfony\Component\VarDumper\Test;
...
trait VarDumperTestTrait
{
    ...
    protected function getDump($data, $key = null, $filter = 0)
    {
        ...
        if (null === ($flags = $this->varDumperConfig['flags'])) {
            ...
            $flags |= \getenv('DUMP_COMMA_SEPARATOR') ? \ECSPrefix20210517\Symfony\Component\VarDumper\Dumper\CliDumper::DUMP_COMMA_SEPARATOR : 0;
        }
        ...
        $dumper = new \ECSPrefix20210517\Symfony\Component\VarDumper\Dumper\CliDumper(null, null, $flags);
