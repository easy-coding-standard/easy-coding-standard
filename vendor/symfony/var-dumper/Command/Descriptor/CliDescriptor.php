 ...
 * @final
 */
class CliDescriptor implements \ECSPrefix20210618\Symfony\Component\VarDumper\Command\Descriptor\DumpDescriptorInterface
{
    private $dumper;
    private $lastIdentifier;
    private $supportsHref;
    public function __construct(\ECSPrefix20210618\Symfony\Component\VarDumper\Dumper\CliDumper $dumper)
    {
        $this->dumper = $dumper;
        $this->supportsHref = \method_exists(\ECSPrefix20210618\Symfony\Component\Console\Formatter\OutputFormatterStyle::class, 'setHref');
    }
    /**
     * @return void
     */
    ...
    {
        $io = $output instanceof \ECSPrefix20210618\Symfony\Component\Console\Style\SymfonyStyle ? $output : new \ECSPrefix20210618\Symfony\Component\Console\Style\SymfonyStyle(new \ECSPrefix20210618\Symfony\Component\Console\Input\ArrayInput([]), $output);
