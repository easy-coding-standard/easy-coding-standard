 ...
 * @final
 */
class CliDescriptor implements \ECSPrefix20211002\Symfony\Component\VarDumper\Command\Descriptor\DumpDescriptorInterface
{
    private $dumper;
    private $lastIdentifier;
    private $supportsHref;
    public function __construct(\ECSPrefix20211002\Symfony\Component\VarDumper\Dumper\CliDumper $dumper)
    {
        $this->dumper = $dumper;
        $this->supportsHref = \method_exists(\ECSPrefix20211002\Symfony\Component\Console\Formatter\OutputFormatterStyle::class, 'setHref');
    }
    /**
    ...
    {
        $io = $output instanceof \ECSPrefix20211002\Symfony\Component\Console\Style\SymfonyStyle ? $output : new \ECSPrefix20211002\Symfony\Component\Console\Style\SymfonyStyle(new \ECSPrefix20211002\Symfony\Component\Console\Input\ArrayInput([]), $output);
