 ...
 */
namespace ECSPrefix20210517\Symfony\Component\VarDumper\Command\Descriptor;
 ...
 * @final
 */
class CliDescriptor implements \ECSPrefix20210517\Symfony\Component\VarDumper\Command\Descriptor\DumpDescriptorInterface
{
    private $dumper;
    private $lastIdentifier;
    private $supportsHref;
    public function __construct(\ECSPrefix20210517\Symfony\Component\VarDumper\Dumper\CliDumper $dumper)
    {
        $this->dumper = $dumper;
        $this->supportsHref = \method_exists(\ECSPrefix20210517\Symfony\Component\Console\Formatter\OutputFormatterStyle::class, 'setHref');
    }
    /**
     * @return void
     */
