...
use ECSPrefix20210508\Symfony\Component\VarDumper\Exception\ThrowingCasterException;
/**
...
class ExceptionCaster
{
    ...
    public static function castThrowingCasterException(\ECSPrefix20210508\Symfony\Component\VarDumper\Exception\ThrowingCasterException $e, array $a, \ECSPrefix20210508\Symfony\Component\VarDumper\Cloner\Stub $stub, $isNested)
    {
        ...
        if (isset($a[$xPrefix . 'previous'], $a[$trace]) && $a[$xPrefix . 'previous'] instanceof \Exception) {
            ...
            $a[$trace] = new \ECSPrefix20210508\Symfony\Component\VarDumper\Caster\TraceStub($b[$xPrefix . 'trace'], \false, 0, -\count($a[$trace]->value));
        }
    ...
    public static function castSilencedErrorContext(\ECSPrefix20210508\Symfony\Component\ErrorHandler\Exception\SilencedErrorContext $e, array $a, \ECSPrefix20210508\Symfony\Component\VarDumper\Cloner\Stub $stub, $isNested)
    {
        ...
        $a[\ECSPrefix20210508\Symfony\Component\VarDumper\Caster\Caster::PREFIX_VIRTUAL . 'trace'] = new \ECSPrefix20210508\Symfony\Component\VarDumper\Caster\TraceStub($trace, self::$traceArgs);
        return $a;
    }
    /**
     * @param bool $isNested
    ...
    public static function castTraceStub(\ECSPrefix20210508\Symfony\Component\VarDumper\Caster\TraceStub $trace, array $a, \ECSPrefix20210508\Symfony\Component\VarDumper\Cloner\Stub $stub, $isNested)
    {
        ...
        for ($j += $trace->numberingOffset - $i++; isset($frames[$i]); ++$i, --$j) {
            ...
            $frame = new \ECSPrefix20210508\Symfony\Component\VarDumper\Caster\FrameStub(['object' => isset($f['object']) ? $f['object'] : null, 'class' => isset($f['class']) ? $f['class'] : null, 'type' => isset($f['type']) ? $f['type'] : null, 'function' => isset($f['function']) ? $f['function'] : null] + $frames[$i - 1], \false, \true);
            ...
            if (isset($f[$prefix . 'src'])) {
                ...
                $f = $frames[$i - 1];
                if ($trace->keepArgs && !empty($f['args']) && $frame instanceof \ECSPrefix20210508\Symfony\Component\VarDumper\Caster\EnumStub) {
                    $frame->value['arguments'] = new \ECSPrefix20210508\Symfony\Component\VarDumper\Caster\ArgsStub($f['args'], isset($f['function']) ? $f['function'] : null, isset($f['class']) ? $f['class'] : null);
                }
            } elseif ('???' !== $lastCall) {
                $label = new \ECSPrefix20210508\Symfony\Component\VarDumper\Caster\ClassStub($lastCall);
            ...
            $a[\substr_replace($label, \sprintf('separator=%s&', $frame instanceof \ECSPrefix20210508\Symfony\Component\VarDumper\Caster\EnumStub ? ' ' : ':'), 2, 0)] = $frame;
            $lastCall = $call;
        }
    ...
    public static function castFrameStub(\ECSPrefix20210508\Symfony\Component\VarDumper\Caster\FrameStub $frame, array $a, \ECSPrefix20210508\Symfony\Component\VarDumper\Cloner\Stub $stub, $isNested)
    {
        ...
        if (isset($f['file'], $f['line'])) {
            ...
            if (isset(self::$framesCache[$cacheKey])) {
                ...
                $src = $f['line'];
                $srcKey = $f['file'];
                $ellipsis = new \ECSPrefix20210508\Symfony\Component\VarDumper\Caster\LinkStub($srcKey, 0);
                ...
                if (\is_file($f['file']) && 0 <= self::$srcContext) {
                    if (!empty($f['class']) && (\is_subclass_of($f['class'], 'ECSPrefix20210508\\Twig\\Template') || \is_subclass_of($f['class'], 'ECSPrefix20210508\\Twig_Template')) && \method_exists($f['class'], 'getDebugInfo')) {
                ...
                self::$framesCache[$cacheKey] = $a[$prefix . 'src'] = new \ECSPrefix20210508\Symfony\Component\VarDumper\Caster\EnumStub(["\0~{$srcAttr}\0{$srcKey}" => $src]);
            }
        }
        ...
        if ($frame->keepArgs && !empty($f['args'])) {
            $a[$prefix . 'arguments'] = new \ECSPrefix20210508\Symfony\Component\VarDumper\Caster\ArgsStub($f['args'], $f['function'], $f['class']);
        }
        return $a;
    }
    /**
    ...
    private static function filterExceptionArray($xClass, array $a, string $xPrefix, int $filter) : array
    {
        ...
        if (!($filter & \ECSPrefix20210508\Symfony\Component\VarDumper\Caster\Caster::EXCLUDE_VERBOSE) && $trace) {
            if (isset($a[\ECSPrefix20210508\Symfony\Component\VarDumper\Caster\Caster::PREFIX_PROTECTED . 'file'], $a[\ECSPrefix20210508\Symfony\Component\VarDumper\Caster\Caster::PREFIX_PROTECTED . 'line'])) {
                self::traceUnshift($trace, $xClass, $a[\ECSPrefix20210508\Symfony\Component\VarDumper\Caster\Caster::PREFIX_PROTECTED . 'file'], $a[\ECSPrefix20210508\Symfony\Component\VarDumper\Caster\Caster::PREFIX_PROTECTED . 'line']);
            }
            $a[\ECSPrefix20210508\Symfony\Component\VarDumper\Caster\Caster::PREFIX_VIRTUAL . 'trace'] = new \ECSPrefix20210508\Symfony\Component\VarDumper\Caster\TraceStub($trace, self::$traceArgs);
        }
        ...
        unset($a[$xPrefix . 'string'], $a[\ECSPrefix20210508\Symfony\Component\VarDumper\Caster\Caster::PREFIX_DYNAMIC . 'xdebug_message'], $a[\ECSPrefix20210508\Symfony\Component\VarDumper\Caster\Caster::PREFIX_DYNAMIC . '__destructorException']);
        if (isset($a[\ECSPrefix20210508\Symfony\Component\VarDumper\Caster\Caster::PREFIX_PROTECTED . 'message']) && \false !== \strpos($a[\ECSPrefix20210508\Symfony\Component\VarDumper\Caster\Caster::PREFIX_PROTECTED . 'message'], "@anonymous\0")) {
            $a[\ECSPrefix20210508\Symfony\Component\VarDumper\Caster\Caster::PREFIX_PROTECTED . 'message'] = \preg_replace_callback('/[a-zA-Z_\\x7f-\\xff][\\\\a-zA-Z0-9_\\x7f-\\xff]*+@anonymous\\x00.*?\\.php(?:0x?|:[0-9]++\\$)[0-9a-fA-F]++/', function ($m) {
                return \class_exists($m[0], \false) ? ((\get_parent_class($m[0]) ?: \key(\class_implements($m[0]))) ?: 'class') . '@anonymous' : $m[0];
            }, $a[\ECSPrefix20210508\Symfony\Component\VarDumper\Caster\Caster::PREFIX_PROTECTED . 'message']);
        }
        if (isset($a[\ECSPrefix20210508\Symfony\Component\VarDumper\Caster\Caster::PREFIX_PROTECTED . 'file'], $a[\ECSPrefix20210508\Symfony\Component\VarDumper\Caster\Caster::PREFIX_PROTECTED . 'line'])) {
            $a[\ECSPrefix20210508\Symfony\Component\VarDumper\Caster\Caster::PREFIX_PROTECTED . 'file'] = new \ECSPrefix20210508\Symfony\Component\VarDumper\Caster\LinkStub($a[\ECSPrefix20210508\Symfony\Component\VarDumper\Caster\Caster::PREFIX_PROTECTED . 'file'], $a[\ECSPrefix20210508\Symfony\Component\VarDumper\Caster\Caster::PREFIX_PROTECTED . 'line']);
        }
        return $a;
    }
    /**
    ...
    private static function extractSource($srcLines, int $line, int $srcContext, string $lang, $file, array $frame) : \ECSPrefix20210508\Symfony\Component\VarDumper\Caster\EnumStub
    {
        ...
        if (isset($frame['function']) ? $frame['function'] : \false) {
            $stub = new \ECSPrefix20210508\Symfony\Component\VarDumper\Caster\CutStub(new \stdClass());
            $stub->class = (isset($frame['class']) ? $frame['class'] . $frame['type'] : '') . $frame['function'];
            $stub->type = \ECSPrefix20210508\Symfony\Component\VarDumper\Cloner\Stub::TYPE_OBJECT;
            ...
            try {
                ...
                $stub->class .= \ECSPrefix20210508\Symfony\Component\VarDumper\Caster\ReflectionCaster::getSignature(\ECSPrefix20210508\Symfony\Component\VarDumper\Caster\ReflectionCaster::castFunctionAbstract($caller, [], $stub, \true, \ECSPrefix20210508\Symfony\Component\VarDumper\Caster\Caster::EXCLUDE_VERBOSE));
        ...
        foreach ($src as $i => $c) {
            ...
            $c = \substr($c, 0, -1);
            if ($i !== $srcContext) {
                $c = new \ECSPrefix20210508\Symfony\Component\VarDumper\Caster\ConstStub('default', $c);
            } else {
                $c = new \ECSPrefix20210508\Symfony\Component\VarDumper\Caster\ConstStub($c, $stub ? 'in ' . $stub->class : '');
                if (null !== $file) {
                    $c->attr['file'] = $file;
                    $c->attr['line'] = $line;
                }
        ...
        return new \ECSPrefix20210508\Symfony\Component\VarDumper\Caster\EnumStub($srcLines);
    }
}
