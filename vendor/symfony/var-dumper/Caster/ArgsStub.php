...
class ArgsStub extends \ECSPrefix20210507\Symfony\Component\VarDumper\Caster\EnumStub
{
    ...
    public function __construct(array $args, $function, $class)
    {
        ...
        $values = [];
        foreach ($args as $k => $v) {
            $values[$k] = !\is_scalar($v) && !$v instanceof \ECSPrefix20210507\Symfony\Component\VarDumper\Cloner\Stub ? new \ECSPrefix20210507\Symfony\Component\VarDumper\Caster\CutStub($v) : $v;
        }
        if (null === $params) {
