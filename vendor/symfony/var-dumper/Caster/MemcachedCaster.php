...
class MemcachedCaster
{
     ...
     * @param bool $isNested
     */
    public static function castMemcached(\Memcached $c, array $a, \ECSPrefix20210511\Symfony\Component\VarDumper\Cloner\Stub $stub, $isNested)
    {
        $isNested = (bool) $isNested;
        $a += [\ECSPrefix20210511\Symfony\Component\VarDumper\Caster\Caster::PREFIX_VIRTUAL . 'servers' => $c->getServerList(), \ECSPrefix20210511\Symfony\Component\VarDumper\Caster\Caster::PREFIX_VIRTUAL . 'options' => new \ECSPrefix20210511\Symfony\Component\VarDumper\Caster\EnumStub(self::getNonDefaultOptions($c))];
        return $a;
    }
    /**
     * @return mixed[]
