...
class ReflectionCaster
{
     ...
     * @param bool $isNested
     */
    public static function castAttribute(\ReflectionAttribute $c, array $a, Stub $stub, $isNested)
    {
        $isNested = (bool) $isNested;
        self::addMap($a, $c, [
            'name' => 'getName',
    ...
    public static function castReflectionGenerator(\ReflectionGenerator $c, array $a, Stub $stub, $isNested)
    {
        ...
        $frame = [
            'class' => $function->class !== null ? $function->class : null,
     ...
     * @param string $prefix
     */
    private static function addMap(array &$a, $c, array $map, $prefix = Caster::PREFIX_VIRTUAL)
    {
