...
class XmlResourceCaster
{
    ...
    public static function castXml($h, array $a, \ECSPrefix20210725\Symfony\Component\VarDumper\Cloner\Stub $stub, bool $isNested)
    {
        ...
        if (isset(self::XML_ERRORS[$a['error_code']])) {
            $a['error_code'] = new \ECSPrefix20210725\Symfony\Component\VarDumper\Caster\ConstStub(self::XML_ERRORS[$a['error_code']], $a['error_code']);
        }
        return $a;
    }
}
