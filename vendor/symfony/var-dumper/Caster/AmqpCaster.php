...
class AmqpCaster
{
     ...
     * @param bool $isNested
     */
    public static function castConnection(\AMQPConnection $c, array $a, \ECSPrefix20210510\Symfony\Component\VarDumper\Cloner\Stub $stub, $isNested)
    {
     ...
     * @param bool $isNested
     */
    public static function castChannel(\AMQPChannel $c, array $a, \ECSPrefix20210510\Symfony\Component\VarDumper\Cloner\Stub $stub, $isNested)
    {
        $isNested = (bool) $isNested;
        $prefix = \ECSPrefix20210510\Symfony\Component\VarDumper\Caster\Caster::PREFIX_VIRTUAL;
     ...
     * @param bool $isNested
     */
    public static function castQueue(\AMQPQueue $c, array $a, \ECSPrefix20210510\Symfony\Component\VarDumper\Cloner\Stub $stub, $isNested)
    {
        $isNested = (bool) $isNested;
        $prefix = \ECSPrefix20210510\Symfony\Component\VarDumper\Caster\Caster::PREFIX_VIRTUAL;
     ...
     * @param bool $isNested
     */
    public static function castExchange(\AMQPExchange $c, array $a, \ECSPrefix20210510\Symfony\Component\VarDumper\Cloner\Stub $stub, $isNested)
    {
        $isNested = (bool) $isNested;
        $prefix = \ECSPrefix20210510\Symfony\Component\VarDumper\Caster\Caster::PREFIX_VIRTUAL;
        $a += [$prefix . 'flags' => self::extractFlags($c->getFlags())];
        $type = isset(self::EXCHANGE_TYPES[$c->getType()]) ? new \ECSPrefix20210510\Symfony\Component\VarDumper\Caster\ConstStub(self::EXCHANGE_TYPES[$c->getType()], $c->getType()) : $c->getType();
        // Recent version of the extension already expose private properties
     ...
     * @param int $filter
     */
    public static function castEnvelope(\AMQPEnvelope $c, array $a, \ECSPrefix20210510\Symfony\Component\VarDumper\Cloner\Stub $stub, $isNested, $filter = 0)
    {
        $isNested = (bool) $isNested;
        $filter = (int) $filter;
        $prefix = \ECSPrefix20210510\Symfony\Component\VarDumper\Caster\Caster::PREFIX_VIRTUAL;
        $deliveryMode = new \ECSPrefix20210510\Symfony\Component\VarDumper\Caster\ConstStub($c->getDeliveryMode() . (2 === $c->getDeliveryMode() ? ' (persistent)' : ' (non-persistent)'), $c->getDeliveryMode());
        // Recent version of the extension already expose private properties
    ...
    private static function extractFlags($flags)
    {
        ...
        return new \ECSPrefix20210510\Symfony\Component\VarDumper\Caster\ConstStub(\implode('|', $flagsArray), $flags);
    }
}
