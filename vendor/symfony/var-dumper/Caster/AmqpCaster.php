...
class AmqpCaster
{
    ...
    public static function castConnection(\AMQPConnection $c, array $a, \ECSPrefix20211001\Symfony\Component\VarDumper\Cloner\Stub $stub, bool $isNested)
    {
    ...
    public static function castChannel(\AMQPChannel $c, array $a, \ECSPrefix20211001\Symfony\Component\VarDumper\Cloner\Stub $stub, bool $isNested)
    {
        $prefix = \ECSPrefix20211001\Symfony\Component\VarDumper\Caster\Caster::PREFIX_VIRTUAL;
    ...
    public static function castQueue(\AMQPQueue $c, array $a, \ECSPrefix20211001\Symfony\Component\VarDumper\Cloner\Stub $stub, bool $isNested)
    {
        $prefix = \ECSPrefix20211001\Symfony\Component\VarDumper\Caster\Caster::PREFIX_VIRTUAL;
    ...
    public static function castExchange(\AMQPExchange $c, array $a, \ECSPrefix20211001\Symfony\Component\VarDumper\Cloner\Stub $stub, bool $isNested)
    {
        $prefix = \ECSPrefix20211001\Symfony\Component\VarDumper\Caster\Caster::PREFIX_VIRTUAL;
        $a += [$prefix . 'flags' => self::extractFlags($c->getFlags())];
        $type = isset(self::EXCHANGE_TYPES[$c->getType()]) ? new \ECSPrefix20211001\Symfony\Component\VarDumper\Caster\ConstStub(self::EXCHANGE_TYPES[$c->getType()], $c->getType()) : $c->getType();
        // Recent version of the extension already expose private properties
    ...
    public static function castEnvelope(\AMQPEnvelope $c, array $a, \ECSPrefix20211001\Symfony\Component\VarDumper\Cloner\Stub $stub, bool $isNested, int $filter = 0)
    {
        $prefix = \ECSPrefix20211001\Symfony\Component\VarDumper\Caster\Caster::PREFIX_VIRTUAL;
        $deliveryMode = new \ECSPrefix20211001\Symfony\Component\VarDumper\Caster\ConstStub($c->getDeliveryMode() . (2 === $c->getDeliveryMode() ? ' (persistent)' : ' (non-persistent)'), $c->getDeliveryMode());
        // Recent version of the extension already expose private properties
    ...
    private static function extractFlags(int $flags) : \ECSPrefix20211001\Symfony\Component\VarDumper\Caster\ConstStub
    {
        $flagsArray = [];
        ...
        return new \ECSPrefix20211001\Symfony\Component\VarDumper\Caster\ConstStub(\implode('|', $flagsArray), $flags);
    }
}
