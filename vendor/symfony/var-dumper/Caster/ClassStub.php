 ...
 */
class ClassStub extends \ECSPrefix20210714\Symfony\Component\VarDumper\Caster\ConstStub
{
    /**
    ...
    public function __construct(string $identifier, $callable = null)
    {
        ...
        try {
            ...
            if (null !== $callable && $r instanceof \ReflectionFunctionAbstract) {
                $s = \ECSPrefix20210714\Symfony\Component\VarDumper\Caster\ReflectionCaster::castFunctionAbstract($r, [], new \ECSPrefix20210714\Symfony\Component\VarDumper\Cloner\Stub(), \true, \ECSPrefix20210714\Symfony\Component\VarDumper\Caster\Caster::EXCLUDE_VERBOSE);
                $s = \ECSPrefix20210714\Symfony\Component\VarDumper\Caster\ReflectionCaster::getSignature($s);
