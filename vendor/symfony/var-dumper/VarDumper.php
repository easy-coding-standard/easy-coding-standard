 ...
 */
namespace ECSPrefix20210517\Symfony\Component\VarDumper;
...
use ECSPrefix20210517\Symfony\Component\VarDumper\Dumper\ContextProvider\CliContextProvider;
use ECSPrefix20210517\Symfony\Component\VarDumper\Dumper\ContextProvider\RequestContextProvider;
use ECSPrefix20210517\Symfony\Component\VarDumper\Dumper\ContextProvider\SourceContextProvider;
use ECSPrefix20210517\Symfony\Component\VarDumper\Dumper\ContextualizedDumper;
use ECSPrefix20210517\Symfony\Component\VarDumper\Dumper\HtmlDumper;
use ECSPrefix20210517\Symfony\Component\VarDumper\Dumper\ServerDumper;
...
class VarDumper
{
    ...
    private static function register()
    {
        ...
        switch (\true) {
            case 'html' === $format:
                ...
                break;
            case 'cli' === $format:
                $dumper = new \ECSPrefix20210517\Symfony\Component\VarDumper\Dumper\CliDumper();
                break;
            case 'server' === $format:
        ...
        if (!$dumper instanceof \ECSPrefix20210517\Symfony\Component\VarDumper\Dumper\ServerDumper) {
            $dumper = new \ECSPrefix20210517\Symfony\Component\VarDumper\Dumper\ContextualizedDumper($dumper, [new \ECSPrefix20210517\Symfony\Component\VarDumper\Dumper\ContextProvider\SourceContextProvider()]);
        }
    ...
    private static function getDefaultContextProviders() : array
    {
        ...
        if (!\in_array(\PHP_SAPI, ['cli', 'phpdbg'], \true) && \class_exists(\ECSPrefix20210517\Symfony\Component\HttpFoundation\Request::class)) {
            $requestStack = new \ECSPrefix20210517\Symfony\Component\HttpFoundation\RequestStack();
