...
use ECSPrefix202306\Symfony\Component\HttpFoundation\Exception\ConflictingHeadersException;
use ECSPrefix202306\Symfony\Component\HttpFoundation\Exception\JsonException;
use ECSPrefix202306\Symfony\Component\HttpFoundation\Exception\SessionNotFoundException;
use ECSPrefix202306\Symfony\Component\HttpFoundation\Exception\SuspiciousOperationException;
use ECSPrefix202306\Symfony\Component\HttpFoundation\Session\SessionInterface;
...
class Request
{
    ...
    public static function create(string $uri, string $method = 'GET', array $parameters = [], array $cookies = [], array $files = [], array $server = [], $content = null)
    {
        ...
        if (\false === $components) {
            \ECSPrefix202306\trigger_deprecation('symfony/http-foundation', '6.3', 'Calling "%s()" with an invalid URI is deprecated.', __METHOD__);
            $components = [];
        }
    ...
    {
        return $this->pathInfo = $this->pathInfo ?? $this->preparePathInfo();
    }
    /**
    ...
    {
        return $this->basePath = $this->basePath ?? $this->prepareBasePath();
    }
    /**
    ...
    {
        return $this->baseUrl = $this->baseUrl ?? $this->prepareBaseUrl();
    }
    /**
    ...
    {
        return $this->requestUri = $this->requestUri ?? $this->prepareRequestUri();
    }
    /**
    ...
    {
        $this->format = $this->format ?? $this->attributes->get('_format');
    ...
    {
        \ECSPrefix202306\trigger_deprecation('symfony/http-foundation', '6.2', 'The "%s()" method is deprecated, use "getContentTypeFormat()" instead.', __METHOD__);
    ...
    private function normalizeAndFilterClientIps(array $clientIps, string $ip) : array
    {
        ...
        foreach ($clientIps as $key => $clientIp) {
            ...
            if (IpUtils::checkIp($clientIp, self::$trustedProxies)) {
                ...
                $firstTrustedIp = $firstTrustedIp ?? $clientIp;
            }
        }
