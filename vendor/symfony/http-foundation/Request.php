 ...
 */
namespace ECSPrefix202303\Symfony\Component\HttpFoundation;

use ECSPrefix202303\Symfony\Component\HttpFoundation\Exception\ConflictingHeadersException;
use ECSPrefix202303\Symfony\Component\HttpFoundation\Exception\JsonException;
use ECSPrefix202303\Symfony\Component\HttpFoundation\Exception\SessionNotFoundException;
use ECSPrefix202303\Symfony\Component\HttpFoundation\Exception\SuspiciousOperationException;
...
class Request
{
    ...
    {
        \ECSPrefix202303\trigger_deprecation('symfony/http-foundation', '6.2', 'The "%s()" method is deprecated, use "getContentTypeFormat()" instead.', __METHOD__);
