...
final class ResponseHasCookie extends \ECSPrefix20210525\PHPUnit\Framework\Constraint\Constraint
{
    private $name;
    private $path;
    private $domain;
     ...
     */
    private function getCookie(\ECSPrefix20210525\Symfony\Component\HttpFoundation\Response $response)
    {
