...
final class ResponseHasCookie extends \ECSPrefix20210510\PHPUnit\Framework\Constraint\Constraint
{
    private $name;
    private $path;
    private $domain;
     ...
     */
    private function getCookie(\ECSPrefix20210510\Symfony\Component\HttpFoundation\Response $response)
    {
