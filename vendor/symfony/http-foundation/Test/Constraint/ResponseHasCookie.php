...
final class ResponseHasCookie extends \ECSPrefix20210511\PHPUnit\Framework\Constraint\Constraint
{
    private $name;
    private $path;
    private $domain;
     ...
     */
    private function getCookie(\ECSPrefix20210511\Symfony\Component\HttpFoundation\Response $response)
    {
