...
final class ResponseHasCookie extends \ECSPrefix20210512\PHPUnit\Framework\Constraint\Constraint
{
    private $name;
    private $path;
    private $domain;
     ...
     */
    private function getCookie(\ECSPrefix20210512\Symfony\Component\HttpFoundation\Response $response)
    {
