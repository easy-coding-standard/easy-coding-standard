...
final class ResponseHasCookie extends \ECSPrefix20210524\PHPUnit\Framework\Constraint\Constraint
{
    private $name;
    private $path;
    private $domain;
     ...
     */
    private function getCookie(\ECSPrefix20210524\Symfony\Component\HttpFoundation\Response $response)
    {
