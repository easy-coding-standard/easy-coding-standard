...
final class ResponseCookieValueSame extends \ECSPrefix20210930\PHPUnit\Framework\Constraint\Constraint
{
    private $name;
    private $value;
    private $path;
     ...
     */
    protected function getCookie($response) : ?\ECSPrefix20210930\Symfony\Component\HttpFoundation\Cookie
    {
