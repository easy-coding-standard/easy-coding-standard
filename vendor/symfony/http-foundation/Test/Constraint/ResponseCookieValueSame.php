...
final class ResponseCookieValueSame extends \ECSPrefix20210610\PHPUnit\Framework\Constraint\Constraint
{
    private $name;
    private $value;
    private $path;
     ...
     */
    protected function getCookie(\ECSPrefix20210610\Symfony\Component\HttpFoundation\Response $response)
    {
        $cookies = $response->headers->getCookies();
        $filteredCookies = \array_filter($cookies, function (\ECSPrefix20210610\Symfony\Component\HttpFoundation\Cookie $cookie) {
