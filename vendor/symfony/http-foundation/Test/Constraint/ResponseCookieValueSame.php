...
final class ResponseCookieValueSame extends \ECSPrefix20210929\PHPUnit\Framework\Constraint\Constraint
{
    private $name;
    private $value;
    private $path;
     ...
     */
    protected function getCookie($response) : ?\ECSPrefix20210929\Symfony\Component\HttpFoundation\Cookie
    {
