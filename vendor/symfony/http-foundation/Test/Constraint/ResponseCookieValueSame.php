...
final class ResponseCookieValueSame extends \ECSPrefix20211021\PHPUnit\Framework\Constraint\Constraint
{
    private $name;
    private $value;
    private $path;
     ...
     */
    protected function getCookie($response) : ?\ECSPrefix20211021\Symfony\Component\HttpFoundation\Cookie
    {
