 ...
 */
final class ResponseFormatSame extends \ECSPrefix20211020\PHPUnit\Framework\Constraint\Constraint
{
    private $request;
    private $format;
    public function __construct(\ECSPrefix20211020\Symfony\Component\HttpFoundation\Request $request, ?string $format)
    {
