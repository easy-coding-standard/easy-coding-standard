 ...
 */
final class ResponseFormatSame extends \ECSPrefix20210929\PHPUnit\Framework\Constraint\Constraint
{
    private $request;
    private $format;
    public function __construct(\ECSPrefix20210929\Symfony\Component\HttpFoundation\Request $request, ?string $format)
    {
