...
class HeaderBag implements \IteratorAggregate, \Countable
{
    ...
    protected function getCacheControlHeader()
    {
        ...
        return \ECSPrefix20210515\Symfony\Component\HttpFoundation\HeaderUtils::toString($this->cacheControl, ',');
    }
    /**
    ...
    protected function parseCacheControl($header)
    {
        ...
        $parts = \ECSPrefix20210515\Symfony\Component\HttpFoundation\HeaderUtils::split($header, ',=');
        return \ECSPrefix20210515\Symfony\Component\HttpFoundation\HeaderUtils::combine($parts);
    }
}
