 ...
 */
class RequestMatcher implements \ECSPrefix20210513\Symfony\Component\HttpFoundation\RequestMatcherInterface
{
    /**
     * @var string|null
     */
    ...
    public function matches(\ECSPrefix20210513\Symfony\Component\HttpFoundation\Request $request)
    {
        ...
        if (\ECSPrefix20210513\Symfony\Component\HttpFoundation\IpUtils::checkIp($request->getClientIp(), $this->ips)) {
            return \true;
        }
