 ...
 */
class RequestMatcher implements \ECSPrefix20210818\Symfony\Component\HttpFoundation\RequestMatcherInterface
{
    /**
     * @var string|null
     */
    ...
    public function matches($request)
    {
        ...
        if (\ECSPrefix20210818\Symfony\Component\HttpFoundation\IpUtils::checkIp($request->getClientIp(), $this->ips)) {
            return \true;
        }
