 ...
 */
class RequestMatcher implements \ConfigTransformer20210601\Symfony\Component\HttpFoundation\RequestMatcherInterface
{
    /**
     * @var string|null
     */
    ...
    public function matches(\ConfigTransformer20210601\Symfony\Component\HttpFoundation\Request $request)
    {
        ...
        if (\ConfigTransformer20210601\Symfony\Component\HttpFoundation\IpUtils::checkIp($request->getClientIp(), $this->ips)) {
            return \true;
        }
