 ...
 */
class ResponseHeaderBag extends \ECSPrefix20210508\Symfony\Component\HttpFoundation\HeaderBag
{
    ...
    public function set($key, $values, $replace = \true)
    {
        ...
        if ('set-cookie' === $uniqueKey) {
            ...
            foreach ((array) $values as $cookie) {
                $this->setCookie(\ECSPrefix20210508\Symfony\Component\HttpFoundation\Cookie::fromString($cookie));
            }
