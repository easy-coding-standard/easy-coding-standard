 ...
 */
class ResponseHeaderBag extends \ECSPrefix20210830\Symfony\Component\HttpFoundation\HeaderBag
{
    ...
    public function set($key, $values, $replace = \true)
    {
        ...
        if ('set-cookie' === $uniqueKey) {
            ...
            foreach ((array) $values as $cookie) {
                $this->setCookie(\ECSPrefix20210830\Symfony\Component\HttpFoundation\Cookie::fromString($cookie));
            }
    ...
    {
        $this->setCookie(new \ECSPrefix20210830\Symfony\Component\HttpFoundation\Cookie($name, null, 1, $path, $domain, $secure, $httpOnly, \false, $sameSite));
    }
    /**
    ...
    {
        return \ECSPrefix20210830\Symfony\Component\HttpFoundation\HeaderUtils::makeDisposition($disposition, $filename, $filenameFallback);
    }
    /**
