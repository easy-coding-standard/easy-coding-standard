 ...
 */
class ResponseHeaderBag extends \ECSPrefix20210620\Symfony\Component\HttpFoundation\HeaderBag
{
    ...
    public function set(string $key, $values, bool $replace = \true)
    {
        ...
        if ('set-cookie' === $uniqueKey) {
            ...
            foreach ((array) $values as $cookie) {
                $this->setCookie(\ECSPrefix20210620\Symfony\Component\HttpFoundation\Cookie::fromString($cookie));
            }
    ...
    public function setCookie(\ECSPrefix20210620\Symfony\Component\HttpFoundation\Cookie $cookie)
    {
    ...
    {
        $this->setCookie(new \ECSPrefix20210620\Symfony\Component\HttpFoundation\Cookie($name, null, 1, $path, $domain, $secure, $httpOnly, \false, $sameSite));
    }
    /**
    ...
    {
        return \ECSPrefix20210620\Symfony\Component\HttpFoundation\HeaderUtils::makeDisposition($disposition, $filename, $filenameFallback);
    }
    /**
