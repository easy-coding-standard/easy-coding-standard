...
use ECSPrefix20211002\Predis\Response\ErrorInterface;
 ...
 */
class RedisSessionHandler extends \ECSPrefix20211002\Symfony\Component\HttpFoundation\Session\Storage\Handler\AbstractSessionHandler
{
    private $redis;
    /**
    ...
    {
        if (!$redis instanceof \Redis && !$redis instanceof \RedisArray && !$redis instanceof \RedisCluster && !$redis instanceof \ECSPrefix20211002\Predis\ClientInterface && !$redis instanceof \ECSPrefix20211002\Symfony\Component\Cache\Traits\RedisProxy && !$redis instanceof \ECSPrefix20211002\Symfony\Component\Cache\Traits\RedisClusterProxy) {
    ...
    protected function doWrite($sessionId, $data) : bool
    {
        ...
        return $result && !$result instanceof \ECSPrefix20211002\Predis\Response\ErrorInterface;
    }
    /**
     * {@inheritdoc}
     * @param string $sessionId
