 ...
 */
namespace ECSPrefix202302\Symfony\Component\HttpFoundation\Session\Storage\Handler;

use ECSPrefix202302\Doctrine\DBAL\DriverManager;
use ECSPrefix202302\Symfony\Component\Cache\Adapter\AbstractAdapter;
/**
...
class SessionHandlerFactory
{
    ...
    public static function createHandler($connection, array $options = []) : AbstractSessionHandler
    {
        ...
        switch (\true) {
            ...
            case $connection instanceof \ECSPrefix202302\Predis\ClientInterface:
