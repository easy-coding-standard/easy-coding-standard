 ...
 */
namespace ECSPrefix202305\Symfony\Component\HttpFoundation\Session\Storage\Handler;

use ECSPrefix202305\Doctrine\DBAL\DriverManager;
use ECSPrefix202305\Symfony\Component\Cache\Adapter\AbstractAdapter;
/**
...
class SessionHandlerFactory
{
    ...
    public static function createHandler($connection, array $options = []) : AbstractSessionHandler
    {
        ...
        switch (\true) {
            ...
            case $connection instanceof \ECSPrefix202305\Predis\ClientInterface:
