 ...
 */
namespace ECSPrefix202303\Symfony\Component\HttpFoundation\Session\Storage\Handler;

use ECSPrefix202303\Doctrine\DBAL\DriverManager;
use ECSPrefix202303\Symfony\Component\Cache\Adapter\AbstractAdapter;
/**
...
class SessionHandlerFactory
{
    ...
    public static function createHandler($connection, array $options = []) : AbstractSessionHandler
    {
        ...
        switch (\true) {
            ...
            case $connection instanceof \ECSPrefix202303\Predis\ClientInterface:
