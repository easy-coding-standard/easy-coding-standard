 ...
 */
class MockFileSessionStorage extends \ECSPrefix20210516\Symfony\Component\HttpFoundation\Session\Storage\MockArraySessionStorage
{
    private $savePath;
    /**
     ...
     * @param string $name
     */
    public function __construct($savePath = null, $name = 'MOCKSESSID', \ECSPrefix20210516\Symfony\Component\HttpFoundation\Session\Storage\MetadataBag $metaBag = null)
    {
        $name = (string) $name;
        if (null === $savePath) {
