...
class Cookie
{
    ...
    public static function fromString(string $cookie, bool $decode = \false)
    {
        ...
        $parts = \ECSPrefix20210705\Symfony\Component\HttpFoundation\HeaderUtils::split($cookie, ';=');
        $part = \array_shift($parts);
        $name = $decode ? \urldecode($part[0]) : $part[0];
        $value = isset($part[1]) ? $decode ? \urldecode($part[1]) : $part[1] : null;
        $data = \ECSPrefix20210705\Symfony\Component\HttpFoundation\HeaderUtils::combine($parts) + $data;
