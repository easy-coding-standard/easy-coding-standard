...
class Response
{
    ...
    {
        $this->headers = new \ECSPrefix20210627\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\ECSPrefix20210627\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @return void
     */
    protected function ensureIEOverSSLCompatibility(\ECSPrefix20210627\Symfony\Component\HttpFoundation\Request $request)
    {
