...
class Response
{
    ...
    {
        $status = (int) $status;
        $this->headers = new \ECSPrefix20210513\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\ECSPrefix20210513\Symfony\Component\HttpFoundation\Request $request)
    {
     ...
     * @return void
     */
    protected function ensureIEOverSSLCompatibility(\ECSPrefix20210513\Symfony\Component\HttpFoundation\Request $request)
    {
