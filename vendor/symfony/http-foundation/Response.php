...
class Response
{
    ...
    {
        $this->headers = new \ConfigTransformer20210601\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\ConfigTransformer20210601\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @return void
     */
    protected function ensureIEOverSSLCompatibility(\ConfigTransformer20210601\Symfony\Component\HttpFoundation\Request $request)
    {
