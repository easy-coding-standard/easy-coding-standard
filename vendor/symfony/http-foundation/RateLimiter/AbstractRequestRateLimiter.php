...
use ECSPrefix20210903\Symfony\Component\RateLimiter\LimiterInterface;
use ECSPrefix20210903\Symfony\Component\RateLimiter\Policy\NoLimiter;
 ...
 * @experimental in 5.3
 */
abstract class AbstractRequestRateLimiter implements \ECSPrefix20210903\Symfony\Component\HttpFoundation\RateLimiter\RequestRateLimiterInterface
{
    /**
    ...
    public function consume($request) : \ECSPrefix20210903\Symfony\Component\RateLimiter\RateLimit
    {
        ...
        if (0 === \count($limiters)) {
            $limiters = [new \ECSPrefix20210903\Symfony\Component\RateLimiter\Policy\NoLimiter()];
        }
