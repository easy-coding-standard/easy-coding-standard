 ...
 */
final class InputBag extends \ECSPrefix20210908\Symfony\Component\HttpFoundation\ParameterBag
{
    /**
    ...
    public function get($key, $default = null)
    {
        ...
        if (null !== $value && $this !== $value && !\is_scalar($value) && !(\is_object($value) && \method_exists($value, '__toString'))) {
            trigger_deprecation('symfony/http-foundation', '5.1', 'Retrieving a non-string value from "%s()" is deprecated, and will throw a "%s" exception in Symfony 6.0, use "%s::all($key)" instead.', __METHOD__, \ECSPrefix20210908\Symfony\Component\HttpFoundation\Exception\BadRequestException::class, __CLASS__);
        }
