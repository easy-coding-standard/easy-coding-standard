...
final class InputBag extends ParameterBag
{
    ...
    public function filter(string $key, $default = null, int $filter = \FILTER_DEFAULT, $options = [])
    {
        ...
        \ECSPrefix202306\trigger_deprecation('symfony/http-foundation', '6.3', 'Ignoring invalid values when using "%s::%s(\'%s\')" is deprecated and will throw a "%s" in 7.0; ' . $hint . ' flag "FILTER_NULL_ON_FAILURE" to keep ignoring them.', \get_class($this), $method, $key, BadRequestException::class);
        return \false;
    }
}
