...
use ECSPrefix20210513\Symfony\Component\HttpFoundation\File\File;
/**
 ...
 */
class BinaryFileResponse extends \ECSPrefix20210513\Symfony\Component\HttpFoundation\Response
{
    ...
    public function setFile($file, $contentDisposition = null, $autoEtag = \false, $autoLastModified = \true)
    {
        $autoEtag = (bool) $autoEtag;
        $autoLastModified = (bool) $autoLastModified;
        if (!$file instanceof \ECSPrefix20210513\Symfony\Component\HttpFoundation\File\File) {
            if ($file instanceof \SplFileInfo) {
                $file = new \ECSPrefix20210513\Symfony\Component\HttpFoundation\File\File($file->getPathname());
            } else {
                $file = new \ECSPrefix20210513\Symfony\Component\HttpFoundation\File\File((string) $file);
            }
        }
        if (!$file->isReadable()) {
            throw new \ECSPrefix20210513\Symfony\Component\HttpFoundation\File\Exception\FileException('File must be readable.');
        }
        $this->file = $file;
        if ($autoEtag) {
            $this->setAutoEtag();
     ...
     * {@inheritdoc}
     */
    public function prepare(\ECSPrefix20210513\Symfony\Component\HttpFoundation\Request $request)
    {
        ...
        if (self::$trustXSendfileTypeHeader && $request->headers->has('X-Sendfile-Type')) {
            ...
            if ('x-accel-redirect' === \strtolower($type)) {
                ...
                $parts = \ECSPrefix20210513\Symfony\Component\HttpFoundation\HeaderUtils::split($request->headers->get('X-Accel-Mapping', ''), ',=');
