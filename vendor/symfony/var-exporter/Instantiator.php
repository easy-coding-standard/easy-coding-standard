...
final class Instantiator
{
    ...
    public static function instantiate($class, array $properties = [], array $privateProperties = [])
    {
        ...
        if (\ECSPrefix20210507\Symfony\Component\VarExporter\Internal\Registry::$cloneable[$class]) {
            $wrappedInstance = [clone \ECSPrefix20210507\Symfony\Component\VarExporter\Internal\Registry::$prototypes[$class]];
        } elseif (\ECSPrefix20210507\Symfony\Component\VarExporter\Internal\Registry::$instantiableWithoutConstructor[$class]) {
            $wrappedInstance = [$reflector->newInstanceWithoutConstructor()];
        } elseif (null === \ECSPrefix20210507\Symfony\Component\VarExporter\Internal\Registry::$prototypes[$class]) {
        ...
        foreach ($privateProperties as $class => $properties) {
            ...
            (isset(\ECSPrefix20210507\Symfony\Component\VarExporter\Internal\Hydrator::$hydrators[$class]) ? \ECSPrefix20210507\Symfony\Component\VarExporter\Internal\Hydrator::$hydrators[$class] : \ECSPrefix20210507\Symfony\Component\VarExporter\Internal\Hydrator::getHydrator($class))($properties, $wrappedInstance);
        }
