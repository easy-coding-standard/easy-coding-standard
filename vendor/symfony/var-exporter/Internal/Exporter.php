 ...
 */
namespace ConfigTransformer20210601\Symfony\Component\VarExporter\Internal;

use ConfigTransformer20210601\Symfony\Component\VarExporter\Exception\NotInstantiableTypeException;
/**
...
class Exporter
{
    ...
    public static function prepare($values, $objectsPool, &$refsPool, &$objectsCount, &$valuesAreStatic) : array
    {
        ...
        foreach ($values as $k => $value) {
            if (\is_resource($value)) {
                throw new \ConfigTransformer20210601\Symfony\Component\VarExporter\Exception\NotInstantiableTypeException(\get_resource_type($value) . ' resource');
            }
            $refs[$k] = $objectsPool;
            if ($isRef = !($valueIsStatic = $values[$k] !== $objectsPool)) {
                ...
                if ($value instanceof \ConfigTransformer20210601\Symfony\Component\VarExporter\Internal\Reference && 0 > $value->id) {
                    $valuesAreStatic = \false;
                    ++$value->count;
                    continue;
                }
                $refsPool[] = [&$refs[$k], $value, &$value];
                $refs[$k] = $values[$k] = new \ConfigTransformer20210601\Symfony\Component\VarExporter\Internal\Reference(-\count($refsPool), $value);
            }
            if (\is_array($value)) {
                if ($value) {
                ...
                goto handle_value;
            } elseif (!\is_object($value) || $value instanceof \ConfigTransformer20210601\UnitEnum) {
                goto handle_value;
            }
            $valueIsStatic = \false;
            if (isset($objectsPool[$value])) {
                ++$objectsCount;
                $value = new \ConfigTransformer20210601\Symfony\Component\VarExporter\Internal\Reference($objectsPool[$value][0]);
                goto handle_value;
            }
            $class = \get_class($value);
            $reflector = \ConfigTransformer20210601\Symfony\Component\VarExporter\Internal\Registry::$reflectors[$class] ?? \ConfigTransformer20210601\Symfony\Component\VarExporter\Internal\Registry::getClassReflector($class);
            ...
            $proto = \ConfigTransformer20210601\Symfony\Component\VarExporter\Internal\Registry::$prototypes[$class];
            if (($value instanceof \ArrayIterator || $value instanceof \ArrayObject) && null !== $proto) {
                ...
                \ConfigTransformer20210601\Symfony\Component\VarExporter\Internal\Registry::getClassReflector($class, \ConfigTransformer20210601\Symfony\Component\VarExporter\Internal\Registry::$instantiableWithoutConstructor[$class], \ConfigTransformer20210601\Symfony\Component\VarExporter\Internal\Registry::$cloneable[$class]);
            } elseif ($value instanceof \SplObjectStorage && \ConfigTransformer20210601\Symfony\Component\VarExporter\Internal\Registry::$cloneable[$class] && null !== $proto) {
                ...
                $value = new \ConfigTransformer20210601\Symfony\Component\VarExporter\Internal\Reference($id);
                goto handle_value;
            }
    ...
    {
        switch (\true) {
            case \is_int($value) || \is_float($value) || $value instanceof \ConfigTransformer20210601\UnitEnum:
        ...
        if ($value instanceof \ConfigTransformer20210601\Symfony\Component\VarExporter\Internal\Reference) {
            if (0 <= $value->id) {
                return '$o[' . $value->id . ']';
            }
            if (!$value->count) {
        ...
        if ($value instanceof \ConfigTransformer20210601\Symfony\Component\VarExporter\Internal\Values) {
            $code = $subIndent . "\$r = [],\n";
        ...
        if ($value instanceof \ConfigTransformer20210601\Symfony\Component\VarExporter\Internal\Registry) {
            return self::exportRegistry($value, $indent, $subIndent);
        }
        if ($value instanceof \ConfigTransformer20210601\Symfony\Component\VarExporter\Internal\Hydrator) {
    ...
    private static function exportRegistry(\ConfigTransformer20210601\Symfony\Component\VarExporter\Internal\Registry $value, string $indent, string $subIndent) : string
    {
        $code = '';
        $serializables = [];
        $seen = [];
        $prototypesAccess = 0;
        $factoriesAccess = 0;
        $r = '\\' . \ConfigTransformer20210601\Symfony\Component\VarExporter\Internal\Registry::class;
        $j = -1;
        foreach ($value as $k => $class) {
            ...
            if (!\ConfigTransformer20210601\Symfony\Component\VarExporter\Internal\Registry::$instantiableWithoutConstructor[$class]) {
            ...
            $c = '[' . self::export($class) . ']';
            if ($seen[$class] ?? \false) {
                if (\ConfigTransformer20210601\Symfony\Component\VarExporter\Internal\Registry::$cloneable[$class]) {
                    ++$prototypesAccess;
                    $code .= 'clone $p' . $c;
                } else {
                    ++$factoriesAccess;
    ...
    private static function exportHydrator(\ConfigTransformer20210601\Symfony\Component\VarExporter\Internal\Hydrator $value, string $indent, string $subIndent) : string
    {
        $code = '';
    ...
    private static function getArrayObjectProperties($value, array &$arrayValue, $proto) : array
    {
        ...
        $reflector = \ConfigTransformer20210601\Symfony\Component\VarExporter\Internal\Registry::$reflectors[$reflector] ?? \ConfigTransformer20210601\Symfony\Component\VarExporter\Internal\Registry::getClassReflector($reflector);
