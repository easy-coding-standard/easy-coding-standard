...
class Exporter
{
    ...
    public static function prepare($values, $objectsPool, &$refsPool, &$objectsCount, &$valuesAreStatic)
    {
        ...
        foreach ($values as $k => $value) {
            if (\is_resource($value)) {
                throw new \ECSPrefix20210509\Symfony\Component\VarExporter\Exception\NotInstantiableTypeException(\get_resource_type($value) . ' resource');
            }
            $refs[$k] = $objectsPool;
            if ($isRef = !($valueIsStatic = $values[$k] !== $objectsPool)) {
                ...
                if ($value instanceof \ECSPrefix20210509\Symfony\Component\VarExporter\Internal\Reference && 0 > $value->id) {
                    $valuesAreStatic = \false;
                    ++$value->count;
                    continue;
                }
                $refsPool[] = [&$refs[$k], $value, &$value];
                $refs[$k] = $values[$k] = new \ECSPrefix20210509\Symfony\Component\VarExporter\Internal\Reference(-\count($refsPool), $value);
            }
            if (\is_array($value)) {
                if ($value) {
            ...
            if (isset($objectsPool[$value])) {
                ++$objectsCount;
                $value = new \ECSPrefix20210509\Symfony\Component\VarExporter\Internal\Reference($objectsPool[$value][0]);
                goto handle_value;
            }
            ...
            $proto = \ECSPrefix20210509\Symfony\Component\VarExporter\Internal\Registry::$prototypes[$class];
            if (($value instanceof \ArrayIterator || $value instanceof \ArrayObject) && null !== $proto) {
                ...
                \ECSPrefix20210509\Symfony\Component\VarExporter\Internal\Registry::getClassReflector($class, \ECSPrefix20210509\Symfony\Component\VarExporter\Internal\Registry::$instantiableWithoutConstructor[$class], \ECSPrefix20210509\Symfony\Component\VarExporter\Internal\Registry::$cloneable[$class]);
            } elseif ($value instanceof \SplObjectStorage && \ECSPrefix20210509\Symfony\Component\VarExporter\Internal\Registry::$cloneable[$class] && null !== $proto) {
                ...
                $value = new \ECSPrefix20210509\Symfony\Component\VarExporter\Internal\Reference($id);
                goto handle_value;
            }
    ...
    public static function export($value, $indent = '')
    {
        ...
        if ($value instanceof \ECSPrefix20210509\Symfony\Component\VarExporter\Internal\Reference) {
            if (0 <= $value->id) {
                return '$o[' . $value->id . ']';
            }
            if (!$value->count) {
        ...
        if ($value instanceof \ECSPrefix20210509\Symfony\Component\VarExporter\Internal\Values) {
            $code = $subIndent . "\$r = [],\n";
        ...
        if ($value instanceof \ECSPrefix20210509\Symfony\Component\VarExporter\Internal\Registry) {
            return self::exportRegistry($value, $indent, $subIndent);
        }
        if ($value instanceof \ECSPrefix20210509\Symfony\Component\VarExporter\Internal\Hydrator) {
     ...
     * @return string
     */
    private static function exportRegistry(\ECSPrefix20210509\Symfony\Component\VarExporter\Internal\Registry $value, $indent, $subIndent)
    {
        $indent = (string) $indent;
        ...
        $prototypesAccess = 0;
        $factoriesAccess = 0;
        $r = '\\' . \ECSPrefix20210509\Symfony\Component\VarExporter\Internal\Registry::class;
        $j = -1;
        foreach ($value as $k => $class) {
            ...
            if (!\ECSPrefix20210509\Symfony\Component\VarExporter\Internal\Registry::$instantiableWithoutConstructor[$class]) {
     ...
     * @return string
     */
    private static function exportHydrator(\ECSPrefix20210509\Symfony\Component\VarExporter\Internal\Hydrator $value, $indent, $subIndent)
    {
        $indent = (string) $indent;
        $subIndent = (string) $subIndent;
        $code = '';
    ...
    private static function getArrayObjectProperties($value, array &$arrayValue, $proto)
    {
        ...
        $reflector = isset(\ECSPrefix20210509\Symfony\Component\VarExporter\Internal\Registry::$reflectors[$reflector]) ? \ECSPrefix20210509\Symfony\Component\VarExporter\Internal\Registry::$reflectors[$reflector] : \ECSPrefix20210509\Symfony\Component\VarExporter\Internal\Registry::getClassReflector($reflector);
