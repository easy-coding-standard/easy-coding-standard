 ...
 */
namespace ECSPrefix20210508\Symfony\Component\EventDispatcher\DependencyInjection;
 ...
 */
class RegisterListenersPass implements \ECSPrefix20210508\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    ...
    public function process(\ECSPrefix20210508\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        ...
        foreach ($container->findTaggedServiceIds($this->listenerTag, \true) as $id => $events) {
            ...
            foreach ($events as $event) {
                ...
                $dispatcherDefinition->addMethodCall('addListener', [$event['event'], [new \ECSPrefix20210508\Symfony\Component\DependencyInjection\Argument\ServiceClosureArgument(new \ECSPrefix20210508\Symfony\Component\DependencyInjection\Reference($id)), $event['method']], $priority]);
        ...
        $extractingDispatcher = new \ECSPrefix20210508\Symfony\Component\EventDispatcher\DependencyInjection\ExtractingEventDispatcher();
        foreach ($container->findTaggedServiceIds($this->subscriberTag, \true) as $id => $tags) {
            ...
            if (!$r->isSubclassOf(\ECSPrefix20210508\Symfony\Component\EventDispatcher\EventSubscriberInterface::class)) {
                throw new \ECSPrefix20210508\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException(\sprintf('Service "%s" must implement interface "%s".', $id, \ECSPrefix20210508\Symfony\Component\EventDispatcher\EventSubscriberInterface::class));
            }
            $class = $r->name;
            ...
            $noPreload = 0;
            \ECSPrefix20210508\Symfony\Component\EventDispatcher\DependencyInjection\ExtractingEventDispatcher::$aliases = $aliases;
            \ECSPrefix20210508\Symfony\Component\EventDispatcher\DependencyInjection\ExtractingEventDispatcher::$subscriber = $class;
            $extractingDispatcher->addSubscriber($extractingDispatcher);
            foreach ($extractingDispatcher->listeners as $args) {
                $args[1] = [new \ECSPrefix20210508\Symfony\Component\DependencyInjection\Argument\ServiceClosureArgument(new \ECSPrefix20210508\Symfony\Component\DependencyInjection\Reference($id)), $args[1]];
            ...
            \ECSPrefix20210508\Symfony\Component\EventDispatcher\DependencyInjection\ExtractingEventDispatcher::$aliases = [];
        }
    }
    /**
     * @param string $id
 ...
 * @internal
 */
class ExtractingEventDispatcher extends \ECSPrefix20210508\Symfony\Component\EventDispatcher\EventDispatcher implements \ECSPrefix20210508\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    public $listeners = [];
