...
trigger_deprecation('symfony/event-dispatcher', '5.1', '%s is deprecated, use the event dispatcher without the proxy.', \ECSPrefix20210508\Symfony\Component\EventDispatcher\LegacyEventDispatcherProxy::class);
/**
