...
use ECSPrefix20220517\Symfony\Component\EventDispatcher\Debug\WrappedListener;
/**
 ...
 */
class EventDispatcher implements \ECSPrefix20220517\Symfony\Component\EventDispatcher\EventDispatcherInterface
{
    /**
     * @var mixed[]
     */
    ...
    {
        $stoppable = $event instanceof \ECSPrefix20220517\Psr\EventDispatcher\StoppableEventInterface;
        ...
        foreach ($this->listeners[$eventName] as &$listeners) {
            foreach ($listeners as &$listener) {
                ...
                if (\is_array($listener) && isset($listener[0]) && $listener[0] instanceof \Closure && 2 >= \count($listener)) {
                    ...
                    $closure = $listener instanceof \Closure || $listener instanceof \ECSPrefix20220517\Symfony\Component\EventDispatcher\Debug\WrappedListener ? $listener : \Closure::fromCallable($listener);
                }
            }
        }
