 ...
 */
namespace ECSPrefix202301\Symfony\Component\EventDispatcher\Debug;

use ECSPrefix202301\Psr\EventDispatcher\StoppableEventInterface;
use ECSPrefix202301\Psr\Log\LoggerInterface;
use ECSPrefix202301\Symfony\Component\EventDispatcher\EventDispatcher;
use ECSPrefix202301\Symfony\Component\EventDispatcher\EventDispatcherInterface;
use ECSPrefix202301\Symfony\Component\EventDispatcher\EventSubscriberInterface;
use ECSPrefix202301\Symfony\Component\HttpFoundation\Request;
use ECSPrefix202301\Symfony\Component\HttpFoundation\RequestStack;
use ECSPrefix202301\Symfony\Component\Stopwatch\Stopwatch;
...
class TraceableEventDispatcher implements EventDispatcherInterface, ResetInterface
{
    ...
    private $callStack;
    /**
     * @var \ECSPrefix202301\Symfony\Component\EventDispatcher\EventDispatcherInterface
     */
    private $dispatcher;
    /**
     * @var mixed[]
    ...
    /**
     * @var \ECSPrefix202301\Symfony\Component\HttpFoundation\RequestStack|null
     */
    ...
    public function dispatch(object $event, string $eventName = null) : object
    {
        ...
        $this->callStack = $this->callStack ?? new \SplObjectStorage();
    ...
    public function getNotCalledListeners(Request $request = null) : array
    {
        try {
            ...
            ($logger = $this->logger) ? $logger->info('An exception was thrown while getting the uncalled listeners.', ['exception' => $e]) : null;
        ...
        \uasort($notCalled, \Closure::fromCallable([$this, 'sortNotCalledListeners']));
        return $notCalled;
    }
    ...
    private function postProcess(string $eventName) : void
    {
        ...
        foreach ($this->dispatcher->getListeners($eventName) as $listener) {
            ...
            if ($listener->wasCalled()) {
                ($logger = $this->logger) ? $logger->debug('Notified event "{event}" to listener "{listener}".', $context) : null;
            } else {
            ...
            if ($listener->stoppedPropagation()) {
                ($logger = $this->logger) ? $logger->debug('Listener "{listener}" stopped propagation of the event "{event}".', $context) : null;
                $skipped = \true;
            }
        }
    }
