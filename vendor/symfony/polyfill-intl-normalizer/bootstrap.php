...
if (!\function_exists('normalizer_is_normalized')) {
    ...
    {
        return \ECSPrefix20210510\Symfony\Polyfill\Intl\Normalizer\Normalizer::isNormalized($string, $form);
    }
}
if (!\function_exists('normalizer_normalize')) {
    function normalizer_normalize($string, $form = \ECSPrefix20210510\Symfony\Polyfill\Intl\Normalizer\Normalizer::FORM_C)
    {
        return \ECSPrefix20210510\Symfony\Polyfill\Intl\Normalizer\Normalizer::normalize($string, $form);
    }
}
