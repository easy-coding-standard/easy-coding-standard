 ...
 * @internal
 */
class GetAttrNode extends \ConfigTransformer20210601\Symfony\Component\ExpressionLanguage\Node\Node
{
    const PROPERTY_CALL = 1;
    const METHOD_CALL = 2;
    const ARRAY_CALL = 3;
    public function __construct(\ConfigTransformer20210601\Symfony\Component\ExpressionLanguage\Node\Node $node, \ConfigTransformer20210601\Symfony\Component\ExpressionLanguage\Node\Node $attribute, \ConfigTransformer20210601\Symfony\Component\ExpressionLanguage\Node\ArrayNode $arguments, int $type)
    {
