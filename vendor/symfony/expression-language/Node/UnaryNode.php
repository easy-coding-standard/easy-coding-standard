 ...
 * @internal
 */
class UnaryNode extends \ConfigTransformer20210601\Symfony\Component\ExpressionLanguage\Node\Node
{
    const OPERATORS = ['!' => '!', 'not' => '!', '+' => '+', '-' => '-'];
    public function __construct(string $operator, \ConfigTransformer20210601\Symfony\Component\ExpressionLanguage\Node\Node $node)
    {
