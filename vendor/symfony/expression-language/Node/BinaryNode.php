 ...
 * @internal
 */
class BinaryNode extends \ConfigTransformer20210601\Symfony\Component\ExpressionLanguage\Node\Node
{
    const OPERATORS = ['~' => '.', 'and' => '&&', 'or' => '||'];
    const FUNCTIONS = ['**' => 'pow', '..' => 'range', 'in' => 'in_array', 'not in' => '!in_array'];
    public function __construct(string $operator, \ConfigTransformer20210601\Symfony\Component\ExpressionLanguage\Node\Node $left, \ConfigTransformer20210601\Symfony\Component\ExpressionLanguage\Node\Node $right)
    {
