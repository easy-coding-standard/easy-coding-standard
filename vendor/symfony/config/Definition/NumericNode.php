 ...
 */
class NumericNode extends \ECSPrefix20210508\Symfony\Component\Config\Definition\ScalarNode
{
    protected $min;
    protected $max;
    /**
    ...
    protected function finalizeValue($value)
    {
        ...
        if (isset($errorMsg)) {
            $ex = new \ECSPrefix20210508\Symfony\Component\Config\Definition\Exception\InvalidConfigurationException($errorMsg);
