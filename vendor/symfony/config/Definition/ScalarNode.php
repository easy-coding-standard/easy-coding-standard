 ...
 */
class ScalarNode extends \ECSPrefix20220120\Symfony\Component\Config\Definition\VariableNode
{
    /**
     * {@inheritdoc}
     * @param mixed $value
    ...
    protected function validateType($value)
    {
        if (!\is_scalar($value) && null !== $value) {
            $ex = new \ECSPrefix20220120\Symfony\Component\Config\Definition\Exception\InvalidTypeException(\sprintf('Invalid type for path "%s". Expected "scalar", but got "%s".', $this->getPath(), \get_debug_type($value)));
