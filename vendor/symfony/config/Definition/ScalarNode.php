 ...
 */
class ScalarNode extends \ECSPrefix20210708\Symfony\Component\Config\Definition\VariableNode
{
    /**
     * {@inheritdoc}
     */
    protected function validateType($value)
    {
        if (!\is_scalar($value) && null !== $value) {
            $ex = new \ECSPrefix20210708\Symfony\Component\Config\Definition\Exception\InvalidTypeException(\sprintf('Invalid type for path "%s". Expected "scalar", but got "%s".', $this->getPath(), \get_debug_type($value)));
