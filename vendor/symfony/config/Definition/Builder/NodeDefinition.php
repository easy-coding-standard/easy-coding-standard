 ...
 */
abstract class NodeDefinition implements \ECSPrefix20210511\Symfony\Component\Config\Definition\Builder\NodeParentInterface
{
    protected $name;
    ...
    protected $pathSeparator = \ECSPrefix20210511\Symfony\Component\Config\Definition\BaseNode::DEFAULT_PATH_SEPARATOR;
    protected $parent;
     ...
     * @return $this
     */
    public function setParent(\ECSPrefix20210511\Symfony\Component\Config\Definition\Builder\NodeParentInterface $parent)
    {
        $this->parent = $parent;
        return $this;
    }
    ...
    public function getNode($forceRootNode = \false)
    {
        ...
        if (null !== $this->normalization) {
            $this->normalization->before = \ECSPrefix20210511\Symfony\Component\Config\Definition\Builder\ExprBuilder::buildExpressions($this->normalization->before);
        }
        if (null !== $this->validation) {
            $this->validation->rules = \ECSPrefix20210511\Symfony\Component\Config\Definition\Builder\ExprBuilder::buildExpressions($this->validation->rules);
        }
    ...
    {
        if (null === $this->validation) {
            $this->validation = new \ECSPrefix20210511\Symfony\Component\Config\Definition\Builder\ValidationBuilder($this);
        }
    ...
    {
        if (null === $this->merge) {
            $this->merge = new \ECSPrefix20210511\Symfony\Component\Config\Definition\Builder\MergeBuilder($this);
        }
        return $this->merge;
    }
    /**
    ...
    {
        if (null === $this->normalization) {
            $this->normalization = new \ECSPrefix20210511\Symfony\Component\Config\Definition\Builder\NormalizationBuilder($this);
        }
    ...
    public function setPathSeparator($separator)
    {
        ...
        if ($this instanceof \ECSPrefix20210511\Symfony\Component\Config\Definition\Builder\ParentNodeDefinitionInterface) {
