 ...
 */
abstract class NodeDefinition implements \ECSPrefix20211106\Symfony\Component\Config\Definition\Builder\NodeParentInterface
{
    protected $name;
    ...
    protected $pathSeparator = \ECSPrefix20211106\Symfony\Component\Config\Definition\BaseNode::DEFAULT_PATH_SEPARATOR;
    protected $parent;
    ...
    public function getNode($forceRootNode = \false)
    {
        ...
        if (null !== $this->normalization) {
            $this->normalization->before = \ECSPrefix20211106\Symfony\Component\Config\Definition\Builder\ExprBuilder::buildExpressions($this->normalization->before);
        }
        if (null !== $this->validation) {
            $this->validation->rules = \ECSPrefix20211106\Symfony\Component\Config\Definition\Builder\ExprBuilder::buildExpressions($this->validation->rules);
        }
    ...
    {
        if (null === $this->validation) {
            $this->validation = new \ECSPrefix20211106\Symfony\Component\Config\Definition\Builder\ValidationBuilder($this);
        }
    ...
    {
        if (null === $this->merge) {
            $this->merge = new \ECSPrefix20211106\Symfony\Component\Config\Definition\Builder\MergeBuilder($this);
        }
        return $this->merge;
    }
    /**
    ...
    {
        if (null === $this->normalization) {
            $this->normalization = new \ECSPrefix20211106\Symfony\Component\Config\Definition\Builder\NormalizationBuilder($this);
        }
    ...
    {
        if ($this instanceof \ECSPrefix20211106\Symfony\Component\Config\Definition\Builder\ParentNodeDefinitionInterface) {
