 ...
 */
namespace ECSPrefix20210801\Symfony\Component\Config\Definition\Builder;

use ECSPrefix20210801\Symfony\Component\Config\Definition\ArrayNode;
use ECSPrefix20210801\Symfony\Component\Config\Definition\Exception\InvalidDefinitionException;
 ...
 */
class ArrayNodeDefinition extends \ECSPrefix20210801\Symfony\Component\Config\Definition\Builder\NodeDefinition implements \ECSPrefix20210801\Symfony\Component\Config\Definition\Builder\ParentNodeDefinitionInterface
{
     ...
     */
    public function __construct($name, \ECSPrefix20210801\Symfony\Component\Config\Definition\Builder\NodeParentInterface $parent = null)
    {
    ...
    protected function getNodeBuilder()
    {
        if (null === $this->nodeBuilder) {
            $this->nodeBuilder = new \ECSPrefix20210801\Symfony\Component\Config\Definition\Builder\NodeBuilder();
        }
    ...
    protected function createNode()
    {
        if (null === $this->prototype) {
            $node = new \ECSPrefix20210801\Symfony\Component\Config\Definition\ArrayNode($this->name, $this->parent, $this->pathSeparator);
            ...
            $node = new \ECSPrefix20210801\Symfony\Component\Config\Definition\PrototypedArrayNode($this->name, $this->parent, $this->pathSeparator);
    ...
    protected function validateConcreteNode($node)
    {
        $path = $node->getPath();
        if (null !== $this->key) {
            throw new \ECSPrefix20210801\Symfony\Component\Config\Definition\Exception\InvalidDefinitionException(\sprintf('->useAttributeAsKey() is not applicable to concrete nodes at path "%s".', $path));
        }
        if (\false === $this->allowEmptyValue) {
            throw new \ECSPrefix20210801\Symfony\Component\Config\Definition\Exception\InvalidDefinitionException(\sprintf('->cannotBeEmpty() is not applicable to concrete nodes at path "%s".', $path));
        }
        if (\true === $this->atLeastOne) {
            throw new \ECSPrefix20210801\Symfony\Component\Config\Definition\Exception\InvalidDefinitionException(\sprintf('->requiresAtLeastOneElement() is not applicable to concrete nodes at path "%s".', $path));
        }
        if ($this->default) {
            throw new \ECSPrefix20210801\Symfony\Component\Config\Definition\Exception\InvalidDefinitionException(\sprintf('->defaultValue() is not applicable to concrete nodes at path "%s".', $path));
        }
        if (\false !== $this->addDefaultChildren) {
            throw new \ECSPrefix20210801\Symfony\Component\Config\Definition\Exception\InvalidDefinitionException(\sprintf('->addDefaultChildrenIfNoneSet() is not applicable to concrete nodes at path "%s".', $path));
        }
    }
    /**
    ...
    protected function validatePrototypeNode($node)
    {
        $path = $node->getPath();
        if ($this->addDefaults) {
            throw new \ECSPrefix20210801\Symfony\Component\Config\Definition\Exception\InvalidDefinitionException(\sprintf('->addDefaultsIfNotSet() is not applicable to prototype nodes at path "%s".', $path));
        }
        if (\false !== $this->addDefaultChildren) {
            if ($this->default) {
                throw new \ECSPrefix20210801\Symfony\Component\Config\Definition\Exception\InvalidDefinitionException(\sprintf('A default value and default children might not be used together at path "%s".', $path));
            }
            if (null !== $this->key && (null === $this->addDefaultChildren || \is_int($this->addDefaultChildren) && $this->addDefaultChildren > 0)) {
                throw new \ECSPrefix20210801\Symfony\Component\Config\Definition\Exception\InvalidDefinitionException(\sprintf('->addDefaultChildrenIfNoneSet() should set default children names as ->useAttributeAsKey() is used at path "%s".', $path));
            }
            if (null === $this->key && (\is_string($this->addDefaultChildren) || \is_array($this->addDefaultChildren))) {
                throw new \ECSPrefix20210801\Symfony\Component\Config\Definition\Exception\InvalidDefinitionException(\sprintf('->addDefaultChildrenIfNoneSet() might not set default children names as ->useAttributeAsKey() is not used at path "%s".', $path));
            }
        }
    }
    /**
     ...
     */
    public function find($nodePath) : \ECSPrefix20210801\Symfony\Component\Config\Definition\Builder\NodeDefinition
    {
