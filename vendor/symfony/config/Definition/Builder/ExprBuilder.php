...
class ExprBuilder
{
    ...
    public $ifPart;
    public $thenPart;
    public function __construct(\ECSPrefix20211010\Symfony\Component\Config\Definition\Builder\NodeDefinition $node)
    {
        $this->node = $node;
    }
    /**
    ...
    {
        $this->thenPart = function () {
            throw new \ECSPrefix20211010\Symfony\Component\Config\Definition\Exception\UnsetKeyException('Unsetting key.');
        };
        return $this;
    }
    /**
