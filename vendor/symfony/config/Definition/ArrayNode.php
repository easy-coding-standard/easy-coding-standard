...
use ECSPrefix202302\Symfony\Component\Config\Definition\Exception\InvalidTypeException;
use ECSPrefix202302\Symfony\Component\Config\Definition\Exception\UnsetKeyException;
/**
    ...
    protected function finalizeValue($value)
    {
        ...
        foreach ($this->children as $name => $child) {
            ...
            if ($child->isDeprecated()) {
                ...
                \ECSPrefix202302\trigger_deprecation($deprecation['package'], $deprecation['version'], $deprecation['message']);
            }
            try {
