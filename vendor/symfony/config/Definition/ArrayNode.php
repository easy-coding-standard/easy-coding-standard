...
use ECSPrefix202301\Symfony\Component\Config\Definition\Exception\InvalidConfigurationException;
use ECSPrefix202301\Symfony\Component\Config\Definition\Exception\InvalidTypeException;
    ...
    protected function finalizeValue($value)
    {
        ...
        foreach ($this->children as $name => $child) {
            ...
            if ($child->isDeprecated()) {
                ...
                \ECSPrefix202301\trigger_deprecation($deprecation['package'], $deprecation['version'], $deprecation['message']);
            }
            try {
