 ...
 */
namespace ECSPrefix202303\Symfony\Component\Config\Definition;

use ECSPrefix202303\Symfony\Component\Config\Definition\Exception\InvalidConfigurationException;
use ECSPrefix202303\Symfony\Component\Config\Definition\Exception\InvalidTypeException;
use ECSPrefix202303\Symfony\Component\Config\Definition\Exception\UnsetKeyException;
/**
    ...
    protected function finalizeValue($value)
    {
        ...
        foreach ($this->children as $name => $child) {
            ...
            if ($child->isDeprecated()) {
                ...
                \ECSPrefix202303\trigger_deprecation($deprecation['package'], $deprecation['version'], $deprecation['message']);
            }
            try {
