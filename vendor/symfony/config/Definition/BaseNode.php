...
abstract class BaseNode implements NodeInterface
{
    ...
    public function getDeprecation($node, $path)
    {
        ...
        $path = (string) $path;
        return [
            'package' => isset($this->deprecation['package']) ? $this->deprecation['package'] : '',
            'version' => isset($this->deprecation['version']) ? $this->deprecation['version'] : '',
            'message' => strtr(isset($this->deprecation['message']) ? $this->deprecation['message'] : '', ['%node%' => $node, '%path%' => $path]),
        ];
    }
