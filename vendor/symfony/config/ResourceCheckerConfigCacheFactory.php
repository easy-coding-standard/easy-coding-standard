 ...
 */
class ResourceCheckerConfigCacheFactory implements \ECSPrefix20210605\Symfony\Component\Config\ConfigCacheFactoryInterface
{
    ...
    {
        $cache = new \ECSPrefix20210605\Symfony\Component\Config\ResourceCheckerConfigCache($file, $this->resourceCheckers);
        if (!$cache->isFresh()) {
            $callable($cache);
        }
        return $cache;
