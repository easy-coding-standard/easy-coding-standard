 ...
 */
namespace ECSPrefix20210823\Symfony\Component\Config\Resource;

use ECSPrefix20210823\Symfony\Component\Finder\Finder;
use ECSPrefix20210823\Symfony\Component\Finder\Glob;
/**
 ...
 * @final
 */
class GlobResource implements \IteratorAggregate, \ECSPrefix20210823\Symfony\Component\Config\Resource\SelfCheckingResourceInterface
{
    private $prefix;
    private $pattern;
    private $recursive;
    ...
    public function getIterator() : \Traversable
    {
        ...
        if (!\class_exists(\ECSPrefix20210823\Symfony\Component\Finder\Finder::class)) {
            throw new \LogicException(\sprintf('Extended glob pattern "%s" cannot be used as the Finder component is not installed.', $this->pattern));
        }
        $finder = new \ECSPrefix20210823\Symfony\Component\Finder\Finder();
        $regex = \ECSPrefix20210823\Symfony\Component\Finder\Glob::toRegex($this->pattern);
        if ($this->recursive) {
