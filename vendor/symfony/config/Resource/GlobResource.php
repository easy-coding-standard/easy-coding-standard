...
use ECSPrefix20220124\Symfony\Component\Finder\Glob;
/**
 ...
 */
class GlobResource implements \IteratorAggregate, \ECSPrefix20220124\Symfony\Component\Config\Resource\SelfCheckingResourceInterface
{
    /**
     * @var string
     */
    ...
    public function getIterator() : \Traversable
    {
        ...
        if (!\class_exists(\ECSPrefix20220124\Symfony\Component\Finder\Finder::class)) {
            throw new \LogicException(\sprintf('Extended glob pattern "%s" cannot be used as the Finder component is not installed.', $this->pattern));
        }
        $finder = new \ECSPrefix20220124\Symfony\Component\Finder\Finder();
        $regex = \ECSPrefix20220124\Symfony\Component\Finder\Glob::toRegex($this->pattern);
        if ($this->recursive) {
