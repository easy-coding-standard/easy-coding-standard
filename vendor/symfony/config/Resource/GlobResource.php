...
use ECSPrefix20220531\Symfony\Component\Finder\Finder;
use ECSPrefix20220531\Symfony\Component\Finder\Glob;
/**
 ...
 */
class GlobResource implements \IteratorAggregate, \ECSPrefix20220531\Symfony\Component\Config\Resource\SelfCheckingResourceInterface
{
    /**
     * @var string
     */
    ...
    public function getIterator() : \Traversable
    {
        ...
        if (!\class_exists(\ECSPrefix20220531\Symfony\Component\Finder\Finder::class)) {
        ...
        $finder = new \ECSPrefix20220531\Symfony\Component\Finder\Finder();
        $regex = \ECSPrefix20220531\Symfony\Component\Finder\Glob::toRegex($pattern);
        if ($this->recursive) {
