 ...
 */
class ConfigCacheFactory implements \ECSPrefix20210509\Symfony\Component\Config\ConfigCacheFactoryInterface
{
    private $debug;
    /**
    ...
    {
        $file = (string) $file;
        $cache = new \ECSPrefix20210509\Symfony\Component\Config\ConfigCache($file, $this->debug);
        if (!$cache->isFresh()) {
            $callback($cache);
        }
        return $cache;
