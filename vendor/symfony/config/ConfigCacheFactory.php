 ...
 */
class ConfigCacheFactory implements \ECSPrefix20211127\Symfony\Component\Config\ConfigCacheFactoryInterface
{
    private $debug;
    /**
    ...
    {
        $cache = new \ECSPrefix20211127\Symfony\Component\Config\ConfigCache($file, $this->debug);
        if (!$cache->isFresh()) {
            $callback($cache);
        }
        return $cache;
