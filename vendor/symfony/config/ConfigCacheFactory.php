 ...
 */
class ConfigCacheFactory implements \ECSPrefix20210605\Symfony\Component\Config\ConfigCacheFactoryInterface
{
    private $debug;
    /**
    ...
    {
        $cache = new \ECSPrefix20210605\Symfony\Component\Config\ConfigCache($file, $this->debug);
        if (!$cache->isFresh()) {
            $callback($cache);
        }
        return $cache;
