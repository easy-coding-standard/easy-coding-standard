...
use ECSPrefix20220609\Symfony\Component\Config\Definition\BooleanNode;
...
use ECSPrefix20220609\Symfony\Component\Config\Definition\FloatNode;
...
class ConfigBuilderGenerator implements ConfigBuilderGeneratorInterface
{
    ...
    public function build(ConfigurationInterface $configuration) : \Closure
    {
        ...
        $rootClass = new ClassBuilder('ECSPrefix20220609\\Symfony\\Config', $rootNode->getName());
