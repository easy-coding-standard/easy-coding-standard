...
use ECSPrefix202306\Symfony\Component\Config\Definition\BooleanNode;
use ECSPrefix202306\Symfony\Component\Config\Definition\Builder\ExprBuilder;
...
use ECSPrefix202306\Symfony\Component\Config\Definition\FloatNode;
...
class ConfigBuilderGenerator implements ConfigBuilderGeneratorInterface
{
    ...
    public function build(ConfigurationInterface $configuration) : \Closure
    {
        ...
        $rootClass = new ClassBuilder('ECSPrefix202306\\Symfony\\Config', $rootNode->getName());
