...
use ECSPrefix20210804\Symfony\Component\Config\Definition\BooleanNode;
...
use ECSPrefix20210804\Symfony\Component\Config\Definition\FloatNode;
 ...
 */
class ConfigBuilderGenerator implements \ECSPrefix20210804\Symfony\Component\Config\Builder\ConfigBuilderGeneratorInterface
{
    private $classes;
    private $outputDir;
    ...
    public function build($configuration) : \Closure
    {
        ...
        $rootClass = new \ECSPrefix20210804\Symfony\Component\Config\Builder\ClassBuilder('ECSPrefix20210804\\Symfony\\Config', $rootNode->getName());
        ...
        if (!\is_file($path)) {
            ...
            $rootClass->addImplements(\ECSPrefix20210804\Symfony\Component\Config\Builder\ConfigBuilderInterface::class);
...
public function NAME(): string
{
    ...
    private function getFullPath(\ECSPrefix20210804\Symfony\Component\Config\Builder\ClassBuilder $class) : string
    {
    ...
    private function buildNode(\ECSPrefix20210804\Symfony\Component\Config\Definition\NodeInterface $node, \ECSPrefix20210804\Symfony\Component\Config\Builder\ClassBuilder $class, string $namespace) : void
    {
        ...
        foreach ($node->getChildren() as $child) {
            switch (\true) {
                case $child instanceof \ECSPrefix20210804\Symfony\Component\Config\Definition\ScalarNode:
                    $this->handleScalarNode($child, $class);
                    break;
                case $child instanceof \ECSPrefix20210804\Symfony\Component\Config\Definition\PrototypedArrayNode:
                    $this->handlePrototypedArrayNode($child, $class, $namespace);
                    break;
                case $child instanceof \ECSPrefix20210804\Symfony\Component\Config\Definition\VariableNode:
                    $this->handleVariableNode($child, $class);
                    break;
                case $child instanceof \ECSPrefix20210804\Symfony\Component\Config\Definition\ArrayNode:
...
public function NAME(array $value = []): CLASS
{
    ...
    return $this->PROPERTY;
        ...
        $class->addUse(\ECSPrefix20210804\Symfony\Component\Config\Definition\Exception\InvalidConfigurationException::class);
    ...
    private function handleVariableNode(\ECSPrefix20210804\Symfony\Component\Config\Definition\VariableNode $node, \ECSPrefix20210804\Symfony\Component\Config\Builder\ClassBuilder $class) : void
    {
        ...
        $class->addUse(\ECSPrefix20210804\Symfony\Component\Config\Loader\ParamConfigurator::class);
        $body = '
/**
COMMENT * @return $this
 */
public function NAME($valueDEFAULT): self
{
    ...
    private function handlePrototypedArrayNode(\ECSPrefix20210804\Symfony\Component\Config\Definition\PrototypedArrayNode $node, \ECSPrefix20210804\Symfony\Component\Config\Builder\ClassBuilder $class, string $namespace) : void
    {
        ...
        if (null !== $parameterType || $prototype instanceof \ECSPrefix20210804\Symfony\Component\Config\Definition\ScalarNode) {
            $class->addUse(\ECSPrefix20210804\Symfony\Component\Config\Loader\ParamConfigurator::class);
            $property = $class->addProperty($node->getName());
...
public function NAME(string $VAR, $VALUE): self
{
    ...
    return $this;
        ...
        $childClass = new \ECSPrefix20210804\Symfony\Component\Config\Builder\ClassBuilder($namespace, $name);
        $class->addRequire($childClass);
        $this->classes[] = $childClass;
        $property = $class->addProperty($node->getName(), $childClass->getFqcn() . '[]');
        if (null === ($key = $node->getKeyAttribute())) {
...
public function NAME($value): self
{
    ...
    private function getParameterType(\ECSPrefix20210804\Symfony\Component\Config\Definition\NodeInterface $node) : ?string
    {
        ...
        if ($node instanceof \ECSPrefix20210804\Symfony\Component\Config\Definition\IntegerNode) {
            return 'int';
        }
        if ($node instanceof \ECSPrefix20210804\Symfony\Component\Config\Definition\FloatNode) {
            return 'float';
        }
        if ($node instanceof \ECSPrefix20210804\Symfony\Component\Config\Definition\EnumNode) {
            return '';
        }
        if ($node instanceof \ECSPrefix20210804\Symfony\Component\Config\Definition\PrototypedArrayNode && $node->getPrototype() instanceof \ECSPrefix20210804\Symfony\Component\Config\Definition\ScalarNode) {
            // This is just an array of variables
            return 'array';
        }
        if ($node instanceof \ECSPrefix20210804\Symfony\Component\Config\Definition\VariableNode) {
            // mixed
            return '';
        }
        return null;
    }
    private function getComment(\ECSPrefix20210804\Symfony\Component\Config\Definition\VariableNode $node) : string
    {
        $comment = '';
     ...
     */
    private function getSingularName(\ECSPrefix20210804\Symfony\Component\Config\Definition\PrototypedArrayNode $node) : string
    {
        $name = $node->getName();
        if ('s' !== \substr($name, -1)) {
            return $name;
        ...
        $mappings = $parent instanceof \ECSPrefix20210804\Symfony\Component\Config\Definition\ArrayNode ? $parent->getXmlRemappings() : [];
...
');
    ...
    private function getSubNamespace(\ECSPrefix20210804\Symfony\Component\Config\Builder\ClassBuilder $rootClass) : string
    {
