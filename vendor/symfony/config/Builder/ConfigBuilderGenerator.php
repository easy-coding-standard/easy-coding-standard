...
use ECSPrefix202209\Symfony\Component\Config\Definition\BooleanNode;
...
use ECSPrefix202209\Symfony\Component\Config\Definition\FloatNode;
...
class ConfigBuilderGenerator implements ConfigBuilderGeneratorInterface
{
    ...
    public function build(ConfigurationInterface $configuration) : \Closure
    {
        ...
        $rootClass = new ClassBuilder('ECSPrefix202209\\Symfony\\Config', $rootNode->getName());
