...
use ECSPrefix202303\Symfony\Component\Config\Definition\BooleanNode;
use ECSPrefix202303\Symfony\Component\Config\Definition\Builder\ExprBuilder;
...
use ECSPrefix202303\Symfony\Component\Config\Definition\FloatNode;
...
class ConfigBuilderGenerator implements ConfigBuilderGeneratorInterface
{
    ...
    public function build(ConfigurationInterface $configuration) : \Closure
    {
        ...
        $rootClass = new ClassBuilder('ECSPrefix202303\\Symfony\\Config', $rootNode->getName());
