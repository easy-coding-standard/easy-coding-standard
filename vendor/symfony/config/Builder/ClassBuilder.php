 ...
 */
namespace ConfigTransformer20210601\Symfony\Component\Config\Builder;
...
', ['NAMESPACE' => $this->namespace, 'REQUIRE' => $require, 'USE' => $use, 'CLASS' => $this->getName(), 'IMPLEMENTS' => $implements, 'BODY' => $body]);
    ...
    {
        $this->methods[] = new \ConfigTransformer20210601\Symfony\Component\Config\Builder\Method(\strtr($body, ['NAME' => $this->camelCase($name)] + $params));
    }
    public function addProperty(string $name, string $classType = null) : \ConfigTransformer20210601\Symfony\Component\Config\Builder\Property
    {
        $property = new \ConfigTransformer20210601\Symfony\Component\Config\Builder\Property($name, $this->camelCase($name));
        if (null !== $classType) {
