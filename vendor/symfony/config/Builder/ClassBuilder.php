 ...
 */
namespace ECSPrefix20210804\Symfony\Component\Config\Builder;
...
', ['NAMESPACE' => $this->namespace, 'REQUIRE' => $require, 'USE' => $use, 'CLASS' => $this->getName(), 'IMPLEMENTS' => $implements, 'BODY' => $body]);
     ...
     */
    public function addProperty($name, $classType = null) : \ECSPrefix20210804\Symfony\Component\Config\Builder\Property
    {
        $property = new \ECSPrefix20210804\Symfony\Component\Config\Builder\Property($name, $this->camelCase($name));
        if (null !== $classType) {
