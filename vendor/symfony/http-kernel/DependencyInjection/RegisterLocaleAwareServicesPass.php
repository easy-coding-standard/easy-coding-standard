 ...
 */
class RegisterLocaleAwareServicesPass implements \ECSPrefix20210723\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    ...
    public function process($container)
    {
        ...
        foreach ($container->findTaggedServiceIds($this->localeAwareTag) as $id => $tags) {
            $services[] = new \ECSPrefix20210723\Symfony\Component\DependencyInjection\Reference($id);
        }
        if (!$services) {
            $container->removeDefinition($this->listenerServiceId);
            return;
        }
        $container->getDefinition($this->listenerServiceId)->setArgument(0, new \ECSPrefix20210723\Symfony\Component\DependencyInjection\Argument\IteratorArgument($services));
    }
}
