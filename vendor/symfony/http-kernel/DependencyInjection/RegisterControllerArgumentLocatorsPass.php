 ...
 */
namespace ECSPrefix202303\Symfony\Component\HttpKernel\DependencyInjection;

use ECSPrefix202303\Symfony\Bundle\FrameworkBundle\Controller\AbstractController;
...
use ECSPrefix202303\Symfony\Component\DependencyInjection\Compiler\ServiceLocatorTagPass;
use ECSPrefix202303\Symfony\Component\DependencyInjection\ContainerAwareInterface;
...
use ECSPrefix202303\Symfony\Component\HttpFoundation\Session\SessionInterface;
/**
            ...
            foreach ($methods as [$r, $parameters]) {
                ...
                foreach ($parameters as $p) {
                    ...
                    if (isset($arguments[$r->name][$p->name])) {
                        ...
                        continue;
                    } elseif (!$autowire || !($autowireAttributes = $autowireAttributes ?? (\method_exists($p, 'getAttributes') ? $p->getAttributes(Autowire::class) : [])) && (!$type || '\\' !== $target[0])) {
                        continue;
