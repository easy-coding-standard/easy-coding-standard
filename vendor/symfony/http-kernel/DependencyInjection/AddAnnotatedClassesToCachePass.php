 ...
 */
class AddAnnotatedClassesToCachePass implements \ECSPrefix20210507\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    private $kernel;
    /**
    ...
    private function getClassesInComposerClassMaps()
    {
        ...
        foreach (\spl_autoload_functions() as $function) {
            ...
            if ($function[0] instanceof \ECSPrefix20210507\Symfony\Component\ErrorHandler\DebugClassLoader || $function[0] instanceof \ECSPrefix20210507\Symfony\Component\Debug\DebugClassLoader) {
                $function = $function[0]->getClassLoader();
            }
            if (\is_array($function) && $function[0] instanceof \ECSPrefix20210507\Composer\Autoload\ClassLoader) {
