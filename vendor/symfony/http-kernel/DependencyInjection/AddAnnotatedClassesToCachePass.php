 ...
 */
class AddAnnotatedClassesToCachePass implements \ECSPrefix20210723\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    private $kernel;
    public function __construct(\ECSPrefix20210723\Symfony\Component\HttpKernel\Kernel $kernel)
    {
        $this->kernel = $kernel;
    }
    /**
    ...
    public function process($container)
    {
        ...
        foreach ($container->getExtensions() as $extension) {
            if ($extension instanceof \ECSPrefix20210723\Symfony\Component\HttpKernel\DependencyInjection\Extension) {
    ...
    private function getClassesInComposerClassMaps() : array
    {
        ...
        foreach (\spl_autoload_functions() as $function) {
            ...
            if ($function[0] instanceof \ECSPrefix20210723\Symfony\Component\ErrorHandler\DebugClassLoader || $function[0] instanceof \ECSPrefix20210723\Symfony\Component\Debug\DebugClassLoader) {
                $function = $function[0]->getClassLoader();
            }
            if (\is_array($function) && $function[0] instanceof \ECSPrefix20210723\Composer\Autoload\ClassLoader) {
