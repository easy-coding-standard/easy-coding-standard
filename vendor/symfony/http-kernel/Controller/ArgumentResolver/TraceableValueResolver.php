 ...
 */
final class TraceableValueResolver implements \ECSPrefix20210818\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface
{
    private $inner;
    private $stopwatch;
    public function __construct(\ECSPrefix20210818\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface $inner, \ECSPrefix20210818\Symfony\Component\Stopwatch\Stopwatch $stopwatch)
    {
        $this->inner = $inner;
