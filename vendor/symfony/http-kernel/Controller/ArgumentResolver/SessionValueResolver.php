 ...
 */
final class SessionValueResolver implements \ECSPrefix20210507\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface
{
    /**
     * {@inheritdoc}
    ...
    public function supports($request, $argument)
    {
        ...
        if (\ECSPrefix20210507\Symfony\Component\HttpFoundation\Session\SessionInterface::class !== $type && !\is_subclass_of($type, \ECSPrefix20210507\Symfony\Component\HttpFoundation\Session\SessionInterface::class)) {
            return \false;
        }
