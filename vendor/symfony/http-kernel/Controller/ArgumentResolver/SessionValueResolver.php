 ...
 */
final class SessionValueResolver implements \ECSPrefix20210512\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface
{
    /**
     * {@inheritdoc}
     * @return bool
    ...
    public function supports(\ECSPrefix20210512\Symfony\Component\HttpFoundation\Request $request, \ECSPrefix20210512\Symfony\Component\HttpKernel\ControllerMetadata\ArgumentMetadata $argument)
    {
        ...
        if (\ECSPrefix20210512\Symfony\Component\HttpFoundation\Session\SessionInterface::class !== $type && !\is_subclass_of($type, \ECSPrefix20210512\Symfony\Component\HttpFoundation\Session\SessionInterface::class)) {
            return \false;
        }
