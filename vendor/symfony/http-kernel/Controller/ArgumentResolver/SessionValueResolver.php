 ...
 */
final class SessionValueResolver implements \ECSPrefix20210922\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface
{
    /**
     * {@inheritdoc}
    ...
    public function supports($request, $argument) : bool
    {
        ...
        if (\ECSPrefix20210922\Symfony\Component\HttpFoundation\Session\SessionInterface::class !== $type && !\is_subclass_of($type, \ECSPrefix20210922\Symfony\Component\HttpFoundation\Session\SessionInterface::class)) {
            return \false;
        }
