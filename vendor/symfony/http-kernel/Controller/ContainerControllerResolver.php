 ...
 */
class ContainerControllerResolver extends \ECSPrefix20210512\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\ECSPrefix20210512\Psr\Container\ContainerInterface $container, \ECSPrefix20210512\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        $controller = (string) $controller;
        if ($this->container instanceof \ECSPrefix20210512\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
