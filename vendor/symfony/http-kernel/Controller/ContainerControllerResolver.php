 ...
 */
class ContainerControllerResolver extends \ECSPrefix20211020\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\ECSPrefix20211020\Psr\Container\ContainerInterface $container, \ECSPrefix20211020\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \ECSPrefix20211020\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
