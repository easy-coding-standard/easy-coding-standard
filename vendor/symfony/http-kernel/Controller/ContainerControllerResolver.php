 ...
 */
class ContainerControllerResolver extends \ECSPrefix20210509\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\ECSPrefix20210509\Psr\Container\ContainerInterface $container, \ECSPrefix20210509\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        $controller = (string) $controller;
        if ($this->container instanceof \ECSPrefix20210509\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
