 ...
 */
class ContainerControllerResolver extends \ECSPrefix20210516\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\ECSPrefix20210516\Psr\Container\ContainerInterface $container, \ECSPrefix20210516\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        $controller = (string) $controller;
        if ($this->container instanceof \ECSPrefix20210516\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
