 ...
 */
class ContainerControllerResolver extends \ConfigTransformer20210601\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\ConfigTransformer20210601\Psr\Container\ContainerInterface $container, \ConfigTransformer20210601\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \ConfigTransformer20210601\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
