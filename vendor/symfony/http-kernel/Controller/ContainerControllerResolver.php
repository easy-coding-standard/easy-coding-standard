 ...
 */
class ContainerControllerResolver extends \ECSPrefix20210712\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\ECSPrefix20210712\Psr\Container\ContainerInterface $container, \ECSPrefix20210712\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \ECSPrefix20210712\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
