 ...
 */
class ContainerControllerResolver extends \ECSPrefix20211101\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\ECSPrefix20211101\Psr\Container\ContainerInterface $container, \ECSPrefix20211101\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \ECSPrefix20211101\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
