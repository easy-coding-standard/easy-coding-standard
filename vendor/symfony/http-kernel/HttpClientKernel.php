...
final class HttpClientKernel implements HttpKernelInterface
{
    ...
    public function handle(Request $request, $type = HttpKernelInterface::MASTER_REQUEST, $catch = true)
    {
        ...
        $response->headers = new Anonymous__6e0937e1ca473be937c05584b1c8bc14__0($response->headers->all());
...
class Anonymous__6e0937e1ca473be937c05584b1c8bc14__0 extends ResponseHeaderBag
{
