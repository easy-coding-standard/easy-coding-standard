...
use ECSPrefix202305\Symfony\Bridge\ProxyManager\LazyProxy\Instantiator\RuntimeInstantiator;
use ECSPrefix202305\Symfony\Bridge\ProxyManager\LazyProxy\PhpDumper\ProxyDumper;
use ECSPrefix202305\Symfony\Component\Config\Builder\ConfigBuilderGenerator;
use ECSPrefix202305\Symfony\Component\Config\ConfigCache;
...
use ECSPrefix202305\Symfony\Component\DependencyInjection\Compiler\PassConfig;
...
use ECSPrefix202305\Symfony\Component\DependencyInjection\Dumper\PhpDumper;
...
use ECSPrefix202305\Symfony\Component\DependencyInjection\Loader\ClosureLoader;
use ECSPrefix202305\Symfony\Component\DependencyInjection\Loader\DirectoryLoader;
use ECSPrefix202305\Symfony\Component\DependencyInjection\Loader\GlobFileLoader;
use ECSPrefix202305\Symfony\Component\DependencyInjection\Loader\IniFileLoader;
use ECSPrefix202305\Symfony\Component\DependencyInjection\Loader\PhpFileLoader;
use ECSPrefix202305\Symfony\Component\DependencyInjection\Loader\XmlFileLoader;
...
use ECSPrefix202305\Symfony\Component\HttpKernel\Bundle\BundleInterface;
use ECSPrefix202305\Symfony\Component\HttpKernel\CacheWarmer\WarmableInterface;
use ECSPrefix202305\Symfony\Component\HttpKernel\Config\FileLocator;
use ECSPrefix202305\Symfony\Component\HttpKernel\DependencyInjection\AddAnnotatedClassesToCachePass;
use ECSPrefix202305\Symfony\Component\HttpKernel\DependencyInjection\MergeExtensionConfigurationPass;
...
abstract class Kernel implements KernelInterface, RebootableInterface, TerminableInterface
{
    ...
    protected function getContainerBuilder() : ContainerBuilder
    {
        ...
        if (\class_exists(\ECSPrefix202305\ProxyManager\Configuration::class) && \class_exists(RuntimeInstantiator::class)) {
    ...
    protected function dumpContainer(ConfigCache $cache, ContainerBuilder $container, string $class, string $baseClass)
    {
        ...
        if (\class_exists(\ECSPrefix202305\ProxyManager\Configuration::class) && \class_exists(ProxyDumper::class)) {
