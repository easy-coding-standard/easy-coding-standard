...
abstract class Bundle implements \ECSPrefix20210507\Symfony\Component\HttpKernel\Bundle\BundleInterface
{
    ...
    public function getContainerExtension()
    {
        if (null === $this->extension) {
            ...
            if (null !== $extension) {
                if (!$extension instanceof \ECSPrefix20210507\Symfony\Component\DependencyInjection\Extension\ExtensionInterface) {
                ...
                $expectedAlias = \ECSPrefix20210507\Symfony\Component\DependencyInjection\Container::underscore($basename);
