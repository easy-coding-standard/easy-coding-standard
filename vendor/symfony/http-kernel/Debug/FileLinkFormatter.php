...
use ECSPrefix20210624\Symfony\Component\Routing\Generator\UrlGeneratorInterface;
/**
...
class FileLinkFormatter
{
     ...
     */
    public function __construct($fileLinkFormat = null, \ECSPrefix20210624\Symfony\Component\HttpFoundation\RequestStack $requestStack = null, string $baseDir = null, $urlFormat = null)
    {
     ...
     * @return string|null
     */
    public static function generateUrlFormat(\ECSPrefix20210624\Symfony\Component\Routing\Generator\UrlGeneratorInterface $router, string $routeName, string $queryString)
    {
        try {
    ...
    private function getFileLinkFormat()
    {
        ...
        if ($this->requestStack && $this->baseDir && $this->urlFormat) {
            ...
            if ($request instanceof \ECSPrefix20210624\Symfony\Component\HttpFoundation\Request && (!$this->urlFormat instanceof \Closure || ($this->urlFormat = ($this->urlFormat)()))) {
