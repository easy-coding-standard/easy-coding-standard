...
use ECSPrefix20210910\Symfony\Component\Routing\Generator\UrlGeneratorInterface;
/**
...
class FileLinkFormatter
{
     ...
     */
    public function __construct(string $fileLinkFormat = null, \ECSPrefix20210910\Symfony\Component\HttpFoundation\RequestStack $requestStack = null, string $baseDir = null, $urlFormat = null)
    {
     ...
     * @internal
     */
    public static function generateUrlFormat(\ECSPrefix20210910\Symfony\Component\Routing\Generator\UrlGeneratorInterface $router, string $routeName, string $queryString) : ?string
    {
        try {
    ...
    private function getFileLinkFormat()
    {
        ...
        if ($this->requestStack && $this->baseDir && $this->urlFormat) {
            ...
            if ($request instanceof \ECSPrefix20210910\Symfony\Component\HttpFoundation\Request && (!$this->urlFormat instanceof \Closure || ($this->urlFormat = ($this->urlFormat)()))) {
