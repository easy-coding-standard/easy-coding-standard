 ...
 */
namespace ECSPrefix202302\Symfony\Component\HttpKernel\EventListener;

use ECSPrefix202302\Psr\Container\ContainerInterface;
use ECSPrefix202302\Symfony\Component\EventDispatcher\EventSubscriberInterface;
use ECSPrefix202302\Symfony\Component\HttpFoundation\Cookie;
use ECSPrefix202302\Symfony\Component\HttpFoundation\Session\Session;
use ECSPrefix202302\Symfony\Component\HttpFoundation\Session\SessionInterface;
use ECSPrefix202302\Symfony\Component\HttpFoundation\Session\SessionUtils;
use ECSPrefix202302\Symfony\Component\HttpKernel\Event\RequestEvent;
use ECSPrefix202302\Symfony\Component\HttpKernel\Event\ResponseEvent;
use ECSPrefix202302\Symfony\Component\HttpKernel\Exception\UnexpectedSessionUsageException;
use ECSPrefix202302\Symfony\Component\HttpKernel\KernelEvents;
...
abstract class AbstractSessionListener implements EventSubscriberInterface, ResetInterface
{
    ...
    public function onKernelResponse(ResponseEvent $event)
    {
        ...
        if ($session->isStarted()) {
            ...
            if ($sessionUseCookies) {
                ...
                $isSessionEmpty = ($session instanceof Session ? $session->isEmpty() : empty($session->all())) && empty($_SESSION);
    ...
    public function onSessionUsage() : void
    {
        ...
        if (($container = $this->container) ? $container->has('session_collector') : null) {
            $this->container->get('session_collector')();
        }
        if (!($requestStack = (($container = $this->container) ? $container->has('request_stack') : null) ? $this->container->get('request_stack') : null)) {
            return;
        }
        $stateless = \false;
