...
use ECSPrefix20210517\Psr\Container\ContainerInterface;
use ECSPrefix20210517\Symfony\Component\EventDispatcher\EventSubscriberInterface;
use ECSPrefix20210517\Symfony\Component\HttpFoundation\Session\Session;
use ECSPrefix20210517\Symfony\Component\HttpFoundation\Session\SessionInterface;
use ECSPrefix20210517\Symfony\Component\HttpKernel\Event\FinishRequestEvent;
use ECSPrefix20210517\Symfony\Component\HttpKernel\Event\RequestEvent;
use ECSPrefix20210517\Symfony\Component\HttpKernel\Event\ResponseEvent;
use ECSPrefix20210517\Symfony\Component\HttpKernel\Exception\UnexpectedSessionUsageException;
 ...
 * @internal
 */
abstract class AbstractSessionListener implements \ECSPrefix20210517\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    ...
    public function onKernelRequest(\ECSPrefix20210517\Symfony\Component\HttpKernel\Event\RequestEvent $event)
    {
        ...
        $this->sessionUsageStack[] = $session instanceof \ECSPrefix20210517\Symfony\Component\HttpFoundation\Session\Session ? $session->getUsageIndex() : 0;
    }
    public function onKernelResponse(\ECSPrefix20210517\Symfony\Component\HttpKernel\Event\ResponseEvent $event)
    {
        if (!$event->isMasterRequest()) {
            return;
        }
        ...
        if ($session instanceof \ECSPrefix20210517\Symfony\Component\HttpFoundation\Session\Session ? $session->getUsageIndex() === \end($this->sessionUsageStack) : !$session->isStarted()) {
            return;
        }
        if ($autoCacheControl) {
    ...
    public function onFinishRequest(\ECSPrefix20210517\Symfony\Component\HttpKernel\Event\FinishRequestEvent $event)
    {
        if ($event->isMasterRequest()) {
    ...
    public static function getSubscribedEvents() : array
    {
        return [
            ...
            \ECSPrefix20210517\Symfony\Component\HttpKernel\KernelEvents::RESPONSE => ['onKernelResponse', -1000],
            \ECSPrefix20210517\Symfony\Component\HttpKernel\KernelEvents::FINISH_REQUEST => ['onFinishRequest'],
        ];
    }
    /**
