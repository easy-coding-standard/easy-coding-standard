 ...
 */
class DisallowRobotsIndexingListener implements \ECSPrefix20210705\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    const HEADER_NAME = 'X-Robots-Tag';
    /**
     * @return void
     */
    public function onResponse(\ECSPrefix20210705\Symfony\Component\HttpKernel\Event\ResponseEvent $event)
    {
    ...
    {
        return [\ECSPrefix20210705\Symfony\Component\HttpKernel\KernelEvents::RESPONSE => ['onResponse', -255]];
    }
}
