...
class SessionListener extends \ECSPrefix20210517\Symfony\Component\HttpKernel\EventListener\AbstractSessionListener
{
    ...
    public function onKernelRequest(\ECSPrefix20210517\Symfony\Component\HttpKernel\Event\RequestEvent $event)
    {
        ...
        if ($this->container->has('session_storage') && ($storage = $this->container->get('session_storage')) instanceof \ECSPrefix20210517\Symfony\Component\HttpFoundation\Session\Storage\NativeSessionStorage && ($masterRequest = $this->container->get('request_stack')->getMasterRequest()) && $masterRequest->isSecure()) {
