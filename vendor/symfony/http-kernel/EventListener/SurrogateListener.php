...
use ConfigTransformer20210601\Symfony\Component\HttpKernel\HttpCache\HttpCache;
 ...
 * @final
 */
class SurrogateListener implements \ConfigTransformer20210601\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    private $surrogate;
    public function __construct(\ConfigTransformer20210601\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface $surrogate = null)
    {
    ...
    public function onKernelResponse(\ConfigTransformer20210601\Symfony\Component\HttpKernel\Event\ResponseEvent $event)
    {
        ...
        if ($kernel instanceof \ConfigTransformer20210601\Symfony\Component\HttpKernel\HttpCache\HttpCache) {
