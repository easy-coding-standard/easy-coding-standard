 ...
 * @final
 */
class SurrogateListener implements \ECSPrefix20210507\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    private $surrogate;
    /**
    ...
    public function onKernelResponse($event)
    {
        ...
        if ($kernel instanceof \ECSPrefix20210507\Symfony\Component\HttpKernel\HttpCache\HttpCache) {
