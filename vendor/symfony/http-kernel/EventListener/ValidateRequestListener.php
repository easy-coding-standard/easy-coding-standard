 ...
 * @final
 */
class ValidateRequestListener implements \ECSPrefix20210524\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    /**
    ...
    {
        return [\ECSPrefix20210524\Symfony\Component\HttpKernel\KernelEvents::REQUEST => [['onKernelRequest', 256]]];
    }
}
