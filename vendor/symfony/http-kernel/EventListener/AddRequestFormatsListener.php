 ...
 * @final
 */
class AddRequestFormatsListener implements \ECSPrefix20211007\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    protected $formats;
    ...
    {
        return [\ECSPrefix20211007\Symfony\Component\HttpKernel\KernelEvents::REQUEST => ['onKernelRequest', 100]];
    }
}
