 ...
 * @final
 */
class AddRequestFormatsListener implements \ECSPrefix20211008\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    protected $formats;
    ...
    {
        return [\ECSPrefix20211008\Symfony\Component\HttpKernel\KernelEvents::REQUEST => ['onKernelRequest', 100]];
    }
}
