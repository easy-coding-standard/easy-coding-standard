 ...
 * @final
 */
class AddRequestFormatsListener implements \ECSPrefix20210911\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    protected $formats;
    ...
    {
        return [\ECSPrefix20210911\Symfony\Component\HttpKernel\KernelEvents::REQUEST => ['onKernelRequest', 100]];
    }
}
