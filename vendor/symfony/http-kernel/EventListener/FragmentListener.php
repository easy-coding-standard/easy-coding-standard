 ...
 * @final
 */
class FragmentListener implements \ECSPrefix20210507\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    private $signer;
    ...
    protected function validateRequest($request)
    {
        ...
        if (!$request->isMethodSafe()) {
            throw new \ECSPrefix20210507\Symfony\Component\HttpKernel\Exception\AccessDeniedHttpException();
        }
    ...
    {
        return [\ECSPrefix20210507\Symfony\Component\HttpKernel\KernelEvents::REQUEST => [['onKernelRequest', 48]]];
    }
}
