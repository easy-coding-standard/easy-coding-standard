...
use ECSPrefix20210508\Symfony\Component\HttpKernel\Exception\AccessDeniedHttpException;
 ...
 * @final
 */
class FragmentListener implements \ECSPrefix20210508\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    private $signer;
    ...
    protected function validateRequest(\ECSPrefix20210508\Symfony\Component\HttpFoundation\Request $request)
    {
        // is the Request safe?
        if (!$request->isMethodSafe()) {
            throw new \ECSPrefix20210508\Symfony\Component\HttpKernel\Exception\AccessDeniedHttpException();
        }
    ...
    {
        return [\ECSPrefix20210508\Symfony\Component\HttpKernel\KernelEvents::REQUEST => [['onKernelRequest', 48]]];
    }
}
