 ...
 * @final
 */
class StreamedResponseListener implements \ECSPrefix20210512\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    /**
    ...
    {
        return [\ECSPrefix20210512\Symfony\Component\HttpKernel\KernelEvents::RESPONSE => ['onKernelResponse', -1024]];
    }
}
