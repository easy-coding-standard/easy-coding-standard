 ...
 */
class LocaleAwareListener implements \ECSPrefix20210511\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
     ...
     */
    public function __construct($localeAwareServices, \ECSPrefix20210511\Symfony\Component\HttpFoundation\RequestStack $requestStack)
    {
    ...
    public static function getSubscribedEvents()
    {
        return [
            ...
            \ECSPrefix20210511\Symfony\Component\HttpKernel\KernelEvents::REQUEST => [['onKernelRequest', 15]],
            \ECSPrefix20210511\Symfony\Component\HttpKernel\KernelEvents::FINISH_REQUEST => [['onKernelFinishRequest', -15]],
        ];
    }
    /**
     * @return void
