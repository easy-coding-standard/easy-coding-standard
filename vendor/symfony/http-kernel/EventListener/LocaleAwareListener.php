 ...
 */
class LocaleAwareListener implements \ECSPrefix20210509\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
     ...
     */
    public function __construct($localeAwareServices, \ECSPrefix20210509\Symfony\Component\HttpFoundation\RequestStack $requestStack)
    {
     ...
     * @return void
     */
    public function onKernelFinishRequest(\ECSPrefix20210509\Symfony\Component\HttpKernel\Event\FinishRequestEvent $event)
    {
    ...
    public static function getSubscribedEvents()
    {
        return [
            ...
            \ECSPrefix20210509\Symfony\Component\HttpKernel\KernelEvents::REQUEST => [['onKernelRequest', 15]],
            \ECSPrefix20210509\Symfony\Component\HttpKernel\KernelEvents::FINISH_REQUEST => [['onKernelFinishRequest', -15]],
        ];
    }
    /**
     * @return void
