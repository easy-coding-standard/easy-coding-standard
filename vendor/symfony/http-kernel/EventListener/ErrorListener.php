 ...
 */
class ErrorListener implements \ECSPrefix20210507\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    ...
    {
        $e = \ECSPrefix20210507\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($event->getThrowable());
    ...
    public function onKernelException($event)
    {
        ...
        try {
            $response = $event->getKernel()->handle($request, \ECSPrefix20210507\Symfony\Component\HttpKernel\HttpKernelInterface::SUB_REQUEST, \false);
        } catch (\Exception $e) {
            $f = \ECSPrefix20210507\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($e);
    ...
    public function onControllerArguments($event)
    {
        ...
        if ($r && (!($r = $r->getType()) instanceof \ReflectionNamedType || \in_array($r->getName(), [\ECSPrefix20210507\Symfony\Component\ErrorHandler\Exception\FlattenException::class, \ECSPrefix20210507\Symfony\Component\Debug\Exception\FlattenException::class], \true))) {
            $arguments = $event->getArguments();
            $arguments[$k] = \ECSPrefix20210507\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($e);
    ...
    {
        return [\ECSPrefix20210507\Symfony\Component\HttpKernel\KernelEvents::CONTROLLER_ARGUMENTS => 'onControllerArguments', \ECSPrefix20210507\Symfony\Component\HttpKernel\KernelEvents::EXCEPTION => [['logKernelException', 0], ['onKernelException', -128]], \ECSPrefix20210507\Symfony\Component\HttpKernel\KernelEvents::RESPONSE => ['removeCspHeader', -128]];
    }
    /**
     * Logs an exception.
     * @return void
    ...
    {
        if (null !== $this->logger) {
            if (!$exception instanceof \ECSPrefix20210507\Symfony\Component\HttpKernel\Exception\HttpExceptionInterface || $exception->getStatusCode() >= 500) {
    ...
    {
        $attributes = ['_controller' => $this->controller, 'exception' => $exception, 'logger' => $this->logger instanceof \ECSPrefix20210507\Symfony\Component\HttpKernel\Log\DebugLoggerInterface ? $this->logger : null];
