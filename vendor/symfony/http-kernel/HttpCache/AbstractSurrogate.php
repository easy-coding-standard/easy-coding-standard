 ...
 */
namespace ECSPrefix20211007\Symfony\Component\HttpKernel\HttpCache;
 ...
 */
abstract class AbstractSurrogate implements \ECSPrefix20211007\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface
{
    ...
    {
        return new \ECSPrefix20211007\Symfony\Component\HttpKernel\HttpCache\ResponseCacheStrategy();
    }
    /**
     * {@inheritdoc}
    ...
    {
        $subRequest = \ECSPrefix20211007\Symfony\Component\HttpFoundation\Request::create($uri, \ECSPrefix20211007\Symfony\Component\HttpFoundation\Request::METHOD_GET, [], $cache->getRequest()->cookies->all(), [], $cache->getRequest()->server->all());
        try {
            $response = $cache->handle($subRequest, \ECSPrefix20211007\Symfony\Component\HttpKernel\HttpKernelInterface::SUB_REQUEST, \true);
