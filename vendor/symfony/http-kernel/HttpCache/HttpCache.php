...
use ECSPrefix20210824\Symfony\Component\HttpKernel\TerminableInterface;
/**
 * Cache provides HTTP caching.
 *
 * @author Fabien Potencier <fabien@symfony.com>
 */
class HttpCache implements \ECSPrefix20210824\Symfony\Component\HttpKernel\HttpKernelInterface, \ECSPrefix20210824\Symfony\Component\HttpKernel\TerminableInterface
{
    private $kernel;
    private $store;
    private $request;
     ...
     *                            (see RFC 5861).
     */
    public function __construct(\ECSPrefix20210824\Symfony\Component\HttpKernel\HttpKernelInterface $kernel, \ECSPrefix20210824\Symfony\Component\HttpKernel\HttpCache\StoreInterface $store, \ECSPrefix20210824\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface $surrogate = null, array $options = [])
    {
        $this->store = $store;
        $this->kernel = $kernel;
    ...
    private function addTraces(\ECSPrefix20210824\Symfony\Component\HttpFoundation\Response $response)
    {
        $traceString = null;
    ...
    public function handle($request, $type = \ECSPrefix20210824\Symfony\Component\HttpKernel\HttpKernelInterface::MAIN_REQUEST, $catch = \true)
    {
        ...
        if (\ECSPrefix20210824\Symfony\Component\HttpKernel\HttpKernelInterface::MAIN_REQUEST === $type) {
            $this->traces = [];
    ...
    {
        if ($this->getKernel() instanceof \ECSPrefix20210824\Symfony\Component\HttpKernel\TerminableInterface) {
            ...
            try {
                ...
                foreach (['Location', 'Content-Location'] as $header) {
                    if ($uri = $response->headers->get($header)) {
                        $subRequest = \ECSPrefix20210824\Symfony\Component\HttpFoundation\Request::create($uri, 'get', [], [], [], $request->server->all());
    ...
    protected function forward($request, $catch = \false, $entry = null)
    {
        ...
        $response = \ECSPrefix20210824\Symfony\Component\HttpKernel\HttpCache\SubRequestHandler::handle($this->kernel, $request, \ECSPrefix20210824\Symfony\Component\HttpKernel\HttpKernelInterface::MAIN_REQUEST, $catch);
        /*
     ...
     */
    private function restoreResponseBody(\ECSPrefix20210824\Symfony\Component\HttpFoundation\Request $request, \ECSPrefix20210824\Symfony\Component\HttpFoundation\Response $response)
    {
     ...
     */
    private function isPrivateRequest(\ECSPrefix20210824\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     */
    private function record(\ECSPrefix20210824\Symfony\Component\HttpFoundation\Request $request, string $event)
    {
     ...
     */
    private function getTraceKey(\ECSPrefix20210824\Symfony\Component\HttpFoundation\Request $request) : string
    {
     ...
     */
    private function mayServeStaleWhileRevalidate(\ECSPrefix20210824\Symfony\Component\HttpFoundation\Response $entry) : bool
    {
     ...
     */
    private function waitForLock(\ECSPrefix20210824\Symfony\Component\HttpFoundation\Request $request) : bool
    {
        $wait = 0;
