...
use ECSPrefix202306\Symfony\Component\HttpKernel\TerminableInterface;
/**
...
class HttpCache implements HttpKernelInterface, TerminableInterface
{
    ...
    private $surrogate;
    /**
     * @var \Symfony\Component\HttpKernel\HttpCache\ResponseCacheStrategyInterface|null
     */
    ...
    public function __construct(HttpKernelInterface $kernel, StoreInterface $store, SurrogateInterface $surrogate = null, array $options = [])
    {
        ...
        \register_shutdown_function(\Closure::fromCallable([$this->store, 'cleanup']));
    ...
    {
        ($surrogate = $this->surrogate) ? $surrogate->addSurrogateCapability($request) : null;
    ...
    {
        if (($surrogate = $this->surrogate) ? $surrogate->needsParsing($response) : null) {
