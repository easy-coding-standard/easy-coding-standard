...
use ECSPrefix20210629\Symfony\Component\HttpKernel\TerminableInterface;
/**
 * Cache provides HTTP caching.
 *
 * @author Fabien Potencier <fabien@symfony.com>
 */
class HttpCache implements \ECSPrefix20210629\Symfony\Component\HttpKernel\HttpKernelInterface, \ECSPrefix20210629\Symfony\Component\HttpKernel\TerminableInterface
{
    private $kernel;
    private $store;
    private $request;
     ...
     *                            (see RFC 5861).
     */
    public function __construct(\ECSPrefix20210629\Symfony\Component\HttpKernel\HttpKernelInterface $kernel, \ECSPrefix20210629\Symfony\Component\HttpKernel\HttpCache\StoreInterface $store, \ECSPrefix20210629\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface $surrogate = null, array $options = [])
    {
        $this->store = $store;
        $this->kernel = $kernel;
    ...
    private function addTraces(\ECSPrefix20210629\Symfony\Component\HttpFoundation\Response $response)
    {
        $traceString = null;
    ...
    public function handle(\ECSPrefix20210629\Symfony\Component\HttpFoundation\Request $request, int $type = \ECSPrefix20210629\Symfony\Component\HttpKernel\HttpKernelInterface::MAIN_REQUEST, bool $catch = \true)
    {
        ...
        if (\ECSPrefix20210629\Symfony\Component\HttpKernel\HttpKernelInterface::MAIN_REQUEST === $type) {
            $this->traces = [];
    ...
    {
        if ($this->getKernel() instanceof \ECSPrefix20210629\Symfony\Component\HttpKernel\TerminableInterface) {
     ...
     */
    protected function pass(\ECSPrefix20210629\Symfony\Component\HttpFoundation\Request $request, bool $catch = \false)
    {
     ...
     * @see RFC2616 13.10
     */
    protected function invalidate(\ECSPrefix20210629\Symfony\Component\HttpFoundation\Request $request, bool $catch = \false)
    {
        $response = $this->pass($request, $catch);
            ...
            try {
                ...
                foreach (['Location', 'Content-Location'] as $header) {
                    if ($uri = $response->headers->get($header)) {
                        $subRequest = \ECSPrefix20210629\Symfony\Component\HttpFoundation\Request::create($uri, 'get', [], [], [], $request->server->all());
     ...
     * @throws \Exception
     */
    protected function lookup(\ECSPrefix20210629\Symfony\Component\HttpFoundation\Request $request, bool $catch = \false)
    {
        try {
     ...
     * @return Response A Response instance
     */
    protected function validate(\ECSPrefix20210629\Symfony\Component\HttpFoundation\Request $request, \ECSPrefix20210629\Symfony\Component\HttpFoundation\Response $entry, bool $catch = \false)
    {
     ...
     * @return Response A Response instance
     */
    protected function fetch(\ECSPrefix20210629\Symfony\Component\HttpFoundation\Request $request, bool $catch = \false)
    {
        $subRequest = clone $request;
        // send no head requests because we want content
        if ('HEAD' === $request->getMethod()) {
     ...
     * @return Response A Response instance
     */
    protected function forward(\ECSPrefix20210629\Symfony\Component\HttpFoundation\Request $request, bool $catch = \false, \ECSPrefix20210629\Symfony\Component\HttpFoundation\Response $entry = null)
    {
        if ($this->surrogate) {
            $this->surrogate->addSurrogateCapability($request);
        }
        // always a "master" request (as the real master request can be in cache)
        $response = \ECSPrefix20210629\Symfony\Component\HttpKernel\HttpCache\SubRequestHandler::handle($this->kernel, $request, \ECSPrefix20210629\Symfony\Component\HttpKernel\HttpKernelInterface::MAIN_REQUEST, $catch);
        /*
     ...
     */
    protected function isFreshEnough(\ECSPrefix20210629\Symfony\Component\HttpFoundation\Request $request, \ECSPrefix20210629\Symfony\Component\HttpFoundation\Response $entry)
    {
        if (!$entry->isFresh()) {
     ...
     */
    protected function lock(\ECSPrefix20210629\Symfony\Component\HttpFoundation\Request $request, \ECSPrefix20210629\Symfony\Component\HttpFoundation\Response $entry)
    {
     ...
     * @throws \Exception
     */
    protected function store(\ECSPrefix20210629\Symfony\Component\HttpFoundation\Request $request, \ECSPrefix20210629\Symfony\Component\HttpFoundation\Response $response)
    {
        try {
     ...
     */
    private function restoreResponseBody(\ECSPrefix20210629\Symfony\Component\HttpFoundation\Request $request, \ECSPrefix20210629\Symfony\Component\HttpFoundation\Response $response)
    {
    ...
    protected function processResponseBody(\ECSPrefix20210629\Symfony\Component\HttpFoundation\Request $request, \ECSPrefix20210629\Symfony\Component\HttpFoundation\Response $response)
    {
     ...
     */
    private function isPrivateRequest(\ECSPrefix20210629\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     */
    private function record(\ECSPrefix20210629\Symfony\Component\HttpFoundation\Request $request, string $event)
    {
     ...
     */
    private function getTraceKey(\ECSPrefix20210629\Symfony\Component\HttpFoundation\Request $request) : string
    {
     ...
     */
    private function mayServeStaleWhileRevalidate(\ECSPrefix20210629\Symfony\Component\HttpFoundation\Response $entry) : bool
    {
     ...
     */
    private function waitForLock(\ECSPrefix20210629\Symfony\Component\HttpFoundation\Request $request) : bool
    {
        $wait = 0;
