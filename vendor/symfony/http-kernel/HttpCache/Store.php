 ...
 */
class Store implements \ECSPrefix20210517\Symfony\Component\HttpKernel\HttpCache\StoreInterface
{
    protected $root;
    private $keyCache;
    private $locks;
     ...
     */
    public function lock(\ECSPrefix20210517\Symfony\Component\HttpFoundation\Request $request)
    {
     ...
     */
    public function unlock(\ECSPrefix20210517\Symfony\Component\HttpFoundation\Request $request)
    {
        $key = $this->getCacheKey($request);
        if (isset($this->locks[$key])) {
    ...
    public function isLocked(\ECSPrefix20210517\Symfony\Component\HttpFoundation\Request $request)
    {
        $key = $this->getCacheKey($request);
        if (isset($this->locks[$key])) {
            return \true;
     ...
     */
    public function lookup(\ECSPrefix20210517\Symfony\Component\HttpFoundation\Request $request)
    {
        $key = $this->getCacheKey($request);
     ...
     * @throws \RuntimeException
     */
    public function write(\ECSPrefix20210517\Symfony\Component\HttpFoundation\Request $request, \ECSPrefix20210517\Symfony\Component\HttpFoundation\Response $response)
    {
        $key = $this->getCacheKey($request);
     ...
     * @return string
     */
    protected function generateContentDigest(\ECSPrefix20210517\Symfony\Component\HttpFoundation\Response $response)
    {
     ...
     * @throws \RuntimeException
     */
    public function invalidate(\ECSPrefix20210517\Symfony\Component\HttpFoundation\Request $request)
    {
        $modified = \false;
        $key = $this->getCacheKey($request);
        $entries = [];
     ...
     */
    protected function generateCacheKey(\ECSPrefix20210517\Symfony\Component\HttpFoundation\Request $request)
    {
    ...
    private function restoreResponse(array $headers, $path = null)
    {
        ...
        return new \ECSPrefix20210517\Symfony\Component\HttpFoundation\Response($path, $status, $headers);
    }
}
