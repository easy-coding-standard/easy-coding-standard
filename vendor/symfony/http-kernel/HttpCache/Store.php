 ...
 */
class Store implements \ECSPrefix20210713\Symfony\Component\HttpKernel\HttpCache\StoreInterface
{
    protected $root;
    private $keyCache;
    private $locks;
    ...
    {
        $key = $this->getCacheKey(\ECSPrefix20210713\Symfony\Component\HttpFoundation\Request::create($url));
        if (isset($this->locks[$key])) {
            \flock($this->locks[$key], \LOCK_UN);
            \fclose($this->locks[$key]);
            unset($this->locks[$key]);
     ...
     */
    private function getCacheKey(\ECSPrefix20210713\Symfony\Component\HttpFoundation\Request $request) : string
    {
     ...
     */
    private function persistRequest(\ECSPrefix20210713\Symfony\Component\HttpFoundation\Request $request) : array
    {
     ...
     */
    private function persistResponse(\ECSPrefix20210713\Symfony\Component\HttpFoundation\Response $response) : array
    {
     ...
     */
    private function restoreResponse(array $headers, string $path = null) : \ECSPrefix20210713\Symfony\Component\HttpFoundation\Response
    {
        ...
        return new \ECSPrefix20210713\Symfony\Component\HttpFoundation\Response($path, $status, $headers);
    }
}
