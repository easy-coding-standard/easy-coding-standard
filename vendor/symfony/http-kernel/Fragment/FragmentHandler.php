...
class FragmentHandler
{
     ...
     */
    public function __construct(\ECSPrefix20211002\Symfony\Component\HttpFoundation\RequestStack $requestStack, array $renderers = [], bool $debug = \false)
    {
    ...
    protected function deliver($response)
    {
        if (!$response->isSuccessful()) {
            ...
            throw new \RuntimeException(\sprintf('Error when rendering "%s" (Status code is %d).', $this->requestStack->getCurrentRequest()->getUri(), $responseStatusCode), 0, new \ECSPrefix20211002\Symfony\Component\HttpKernel\Exception\HttpException($responseStatusCode));
        }
