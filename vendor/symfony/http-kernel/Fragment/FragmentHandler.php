...
class FragmentHandler
{
     ...
     */
    public function __construct(\ConfigTransformer20210601\Symfony\Component\HttpFoundation\RequestStack $requestStack, array $renderers = [], bool $debug = \false)
    {
     ...
     * Adds a renderer.
     */
    public function addRenderer(\ConfigTransformer20210601\Symfony\Component\HttpKernel\Fragment\FragmentRendererInterface $renderer)
    {
     ...
     */
    protected function deliver(\ConfigTransformer20210601\Symfony\Component\HttpFoundation\Response $response)
    {
        if (!$response->isSuccessful()) {
            $responseStatusCode = $response->getStatusCode();
            throw new \RuntimeException(\sprintf('Error when rendering "%s" (Status code is %d).', $this->requestStack->getCurrentRequest()->getUri(), $responseStatusCode), 0, new \ConfigTransformer20210601\Symfony\Component\HttpKernel\Exception\HttpException($responseStatusCode));
        }
