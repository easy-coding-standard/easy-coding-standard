...
use ECSPrefix20210517\Twig\Environment;
/**
 * Implements the Hinclude rendering strategy.
 *
 * @author Fabien Potencier <fabien@symfony.com>
 */
class HIncludeFragmentRenderer extends \ECSPrefix20210517\Symfony\Component\HttpKernel\Fragment\RoutableFragmentRenderer
{
    ...
    public function render($uri, \ECSPrefix20210517\Symfony\Component\HttpFoundation\Request $request, array $options = [])
    {
        ...
        return new \ECSPrefix20210517\Symfony\Component\HttpFoundation\Response(\sprintf('<hx:include src="%s"%s>%s</hx:include>', $uri, $renderedAttributes, $content));
    }
    /**
     * {@inheritdoc}
     */
