...
use ECSPrefix20211002\Twig\Environment;
/**
 * Implements the Hinclude rendering strategy.
 *
 * @author Fabien Potencier <fabien@symfony.com>
 */
class HIncludeFragmentRenderer extends \ECSPrefix20211002\Symfony\Component\HttpKernel\Fragment\RoutableFragmentRenderer
{
     ...
     */
    public function __construct(\ECSPrefix20211002\Twig\Environment $twig = null, \ECSPrefix20211002\Symfony\Component\HttpKernel\UriSigner $signer = null, string $globalDefaultTemplate = null, string $charset = 'utf-8')
    {
        $this->twig = $twig;
    ...
    public function render($uri, $request, $options = [])
    {
        if ($uri instanceof \ECSPrefix20211002\Symfony\Component\HttpKernel\Controller\ControllerReference) {
            $uri = (new \ECSPrefix20211002\Symfony\Component\HttpKernel\Fragment\FragmentUriGenerator($this->fragmentPath, $this->signer))->generate($uri, $request);
        }
        ...
        return new \ECSPrefix20211002\Symfony\Component\HttpFoundation\Response(\sprintf('<hx:include src="%s"%s>%s</hx:include>', $uri, $renderedAttributes, $content));
    }
    /**
     * {@inheritdoc}
     */
