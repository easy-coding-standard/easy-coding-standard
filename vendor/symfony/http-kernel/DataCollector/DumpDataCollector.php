 ...
 */
namespace ECSPrefix202303\Symfony\Component\HttpKernel\DataCollector;

use ECSPrefix202303\Symfony\Component\HttpFoundation\Request;
use ECSPrefix202303\Symfony\Component\HttpFoundation\RequestStack;
use ECSPrefix202303\Symfony\Component\HttpFoundation\Response;
use ECSPrefix202303\Symfony\Component\HttpKernel\Debug\FileLinkFormatter;
use ECSPrefix202303\Symfony\Component\Stopwatch\Stopwatch;
use ECSPrefix202303\Symfony\Component\VarDumper\Cloner\Data;
use ECSPrefix202303\Symfony\Component\VarDumper\Cloner\VarCloner;
use ECSPrefix202303\Symfony\Component\VarDumper\Dumper\CliDumper;
use ECSPrefix202303\Symfony\Component\VarDumper\Dumper\ContextProvider\SourceContextProvider;
use ECSPrefix202303\Symfony\Component\VarDumper\Dumper\DataDumperInterface;
use ECSPrefix202303\Symfony\Component\VarDumper\Dumper\HtmlDumper;
use ECSPrefix202303\Symfony\Component\VarDumper\Server\Connection;
/**
...
class DumpDataCollector extends DataCollector implements DataDumperInterface
{
    ...
    private $stopwatch;
    /**
     * @var string|\Symfony\Component\HttpKernel\Debug\FileLinkFormatter|false
     */
    ...
    /**
     * @var \Symfony\Component\VarDumper\Dumper\DataDumperInterface|\Symfony\Component\VarDumper\Server\Connection|null
     */
    private $dumper;
    /**
     * @var mixed
     ...
     * @param \Symfony\Component\VarDumper\Dumper\DataDumperInterface|\Symfony\Component\VarDumper\Server\Connection $dumper
     */
    ...
    {
        ($stopwatch = $this->stopwatch) ? $stopwatch->start('dump') : null;
        ...
        ++$this->dataCount;
        ($stopwatch = $this->stopwatch) ? $stopwatch->stop('dump') : null;
    }
