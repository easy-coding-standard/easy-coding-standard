...
use ECSPrefix20210508\Symfony\Component\HttpKernel\Debug\FileLinkFormatter;
use ECSPrefix20210508\Symfony\Component\Stopwatch\Stopwatch;
use ECSPrefix20210508\Symfony\Component\VarDumper\Cloner\Data;
use ECSPrefix20210508\Symfony\Component\VarDumper\Cloner\VarCloner;
use ECSPrefix20210508\Symfony\Component\VarDumper\Dumper\CliDumper;
use ECSPrefix20210508\Symfony\Component\VarDumper\Dumper\ContextProvider\SourceContextProvider;
use ECSPrefix20210508\Symfony\Component\VarDumper\Dumper\DataDumperInterface;
 ...
 * @final
 */
class DumpDataCollector extends \ECSPrefix20210508\Symfony\Component\HttpKernel\DataCollector\DataCollector implements \ECSPrefix20210508\Symfony\Component\VarDumper\Dumper\DataDumperInterface
{
    private $stopwatch;
     ...
     */
    public function __construct(\ECSPrefix20210508\Symfony\Component\Stopwatch\Stopwatch $stopwatch = null, $fileLinkFormat = null, $charset = null, \ECSPrefix20210508\Symfony\Component\HttpFoundation\RequestStack $requestStack = null, $dumper = null)
    {
        ...
        $this->sourceContextProvider = $dumper instanceof \ECSPrefix20210508\Symfony\Component\VarDumper\Server\Connection && isset($dumper->getContextProviders()['source']) ? $dumper->getContextProviders()['source'] : new \ECSPrefix20210508\Symfony\Component\VarDumper\Dumper\ContextProvider\SourceContextProvider($this->charset);
    }
    ...
    public function dump(\ECSPrefix20210508\Symfony\Component\VarDumper\Cloner\Data $data)
    {
        ...
        if ($this->dumper instanceof \ECSPrefix20210508\Symfony\Component\VarDumper\Server\Connection) {
    ...
    public function collect(\ECSPrefix20210508\Symfony\Component\HttpFoundation\Request $request, \ECSPrefix20210508\Symfony\Component\HttpFoundation\Response $response, \Throwable $exception = null)
    {
        ...
        if (!$this->requestStack || !$response->headers->has('X-Debug-Token') || $response->isRedirection() || $response->headers->has('Content-Type') && \false === \strpos($response->headers->get('Content-Type'), 'html') || 'html' !== $request->getRequestFormat() || \false === \strripos($response->getContent(), '</body>')) {
            if ($response->headers->has('Content-Type') && \false !== \strpos($response->headers->get('Content-Type'), 'html')) {
                $dumper = new \ECSPrefix20210508\Symfony\Component\VarDumper\Dumper\HtmlDumper('php://output', $this->charset);
                $dumper->setDisplayOptions(['fileLinkFormat' => $this->fileLinkFormat]);
            } else {
                $dumper = new \ECSPrefix20210508\Symfony\Component\VarDumper\Dumper\CliDumper('php://output', $this->charset);
    ...
    public function __wakeup()
    {
        ...
        self::__construct($this->stopwatch, \is_string($fileLinkFormat) || $fileLinkFormat instanceof \ECSPrefix20210508\Symfony\Component\HttpKernel\Debug\FileLinkFormatter ? $fileLinkFormat : null, \is_string($charset) ? $charset : null);
    }
    /**
     * @return int
     */
    ...
    public function getDumps($format, $maxDepthLimit = -1, $maxItemsPerDepth = -1)
    {
        ...
        if ('html' === $format) {
            $dumper = new \ECSPrefix20210508\Symfony\Component\VarDumper\Dumper\HtmlDumper($data, $this->charset);
            $dumper->setDisplayOptions(['fileLinkFormat' => $this->fileLinkFormat]);
        } else {
    ...
    private function doDump(\ECSPrefix20210508\Symfony\Component\VarDumper\Dumper\DataDumperInterface $dumper, \ECSPrefix20210508\Symfony\Component\VarDumper\Cloner\Data $data, $name, string $file, int $line)
    {
        ...
        if ($dumper instanceof \ECSPrefix20210508\Symfony\Component\VarDumper\Dumper\CliDumper) {
            ...
            $cloner = new \ECSPrefix20210508\Symfony\Component\VarDumper\Cloner\VarCloner();
