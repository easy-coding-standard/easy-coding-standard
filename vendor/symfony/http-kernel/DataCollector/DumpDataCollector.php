 ...
 */
namespace ECSPrefix20210517\Symfony\Component\HttpKernel\DataCollector;
...
use ECSPrefix20210517\Symfony\Component\HttpKernel\Debug\FileLinkFormatter;
use ECSPrefix20210517\Symfony\Component\Stopwatch\Stopwatch;
use ECSPrefix20210517\Symfony\Component\VarDumper\Cloner\Data;
use ECSPrefix20210517\Symfony\Component\VarDumper\Cloner\VarCloner;
use ECSPrefix20210517\Symfony\Component\VarDumper\Dumper\CliDumper;
use ECSPrefix20210517\Symfony\Component\VarDumper\Dumper\ContextProvider\SourceContextProvider;
use ECSPrefix20210517\Symfony\Component\VarDumper\Dumper\DataDumperInterface;
use ECSPrefix20210517\Symfony\Component\VarDumper\Dumper\HtmlDumper;
 ...
 * @final
 */
class DumpDataCollector extends \ECSPrefix20210517\Symfony\Component\HttpKernel\DataCollector\DataCollector implements \ECSPrefix20210517\Symfony\Component\VarDumper\Dumper\DataDumperInterface
{
    private $stopwatch;
    ...
    public function __construct(\ECSPrefix20210517\Symfony\Component\Stopwatch\Stopwatch $stopwatch = null, $fileLinkFormat = null, string $charset = null, \ECSPrefix20210517\Symfony\Component\HttpFoundation\RequestStack $requestStack = null, $dumper = null)
    {
        ...
        $this->sourceContextProvider = $dumper instanceof \ECSPrefix20210517\Symfony\Component\VarDumper\Server\Connection && isset($dumper->getContextProviders()['source']) ? $dumper->getContextProviders()['source'] : new \ECSPrefix20210517\Symfony\Component\VarDumper\Dumper\ContextProvider\SourceContextProvider($this->charset);
    }
    ...
    public function dump(\ECSPrefix20210517\Symfony\Component\VarDumper\Cloner\Data $data)
    {
        ...
        if ($this->dumper instanceof \ECSPrefix20210517\Symfony\Component\VarDumper\Server\Connection) {
    ...
    public function collect(\ECSPrefix20210517\Symfony\Component\HttpFoundation\Request $request, \ECSPrefix20210517\Symfony\Component\HttpFoundation\Response $response, \Throwable $exception = null)
    {
        if (!$this->dataCount) {
            $this->data = [];
        }
        ...
        if (!$this->requestStack || !$response->headers->has('X-Debug-Token') || $response->isRedirection() || $response->headers->has('Content-Type') && \false === \strpos($response->headers->get('Content-Type'), 'html') || 'html' !== $request->getRequestFormat() || \false === \strripos($response->getContent(), '</body>')) {
            if ($response->headers->has('Content-Type') && \false !== \strpos($response->headers->get('Content-Type'), 'html')) {
                $dumper = new \ECSPrefix20210517\Symfony\Component\VarDumper\Dumper\HtmlDumper('php://output', $this->charset);
                $dumper->setDisplayOptions(['fileLinkFormat' => $this->fileLinkFormat]);
            } else {
                $dumper = new \ECSPrefix20210517\Symfony\Component\VarDumper\Dumper\CliDumper('php://output', $this->charset);
    ...
    public function getDumps($format, $maxDepthLimit = -1, $maxItemsPerDepth = -1) : array
    {
        ...
        if ('html' === $format) {
            $dumper = new \ECSPrefix20210517\Symfony\Component\VarDumper\Dumper\HtmlDumper($data, $this->charset);
            $dumper->setDisplayOptions(['fileLinkFormat' => $this->fileLinkFormat]);
        } else {
