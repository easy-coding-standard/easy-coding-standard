 ...
 */
class RouterDataCollector extends \ECSPrefix20211002\Symfony\Component\HttpKernel\DataCollector\DataCollector
{
    /**
    ...
    {
        if ($response instanceof \ECSPrefix20211002\Symfony\Component\HttpFoundation\RedirectResponse) {
