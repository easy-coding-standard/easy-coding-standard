...
use ECSPrefix20210608\Symfony\Component\HttpFoundation\ParameterBag;
 ...
 * @final
 */
class RequestDataCollector extends \ECSPrefix20210608\Symfony\Component\HttpKernel\DataCollector\DataCollector implements \ECSPrefix20210608\Symfony\Component\EventDispatcher\EventSubscriberInterface, \ECSPrefix20210608\Symfony\Component\HttpKernel\DataCollector\LateDataCollectorInterface
{
    ...
    public function collect(\ECSPrefix20210608\Symfony\Component\HttpFoundation\Request $request, \ECSPrefix20210608\Symfony\Component\HttpFoundation\Response $response, \Throwable $exception = null)
    {
        ...
        if ($response->isRedirect()) {
            $response->headers->setCookie(new \ECSPrefix20210608\Symfony\Component\HttpFoundation\Cookie('sf_redirect', \json_encode(['token' => $response->headers->get('x-debug-token'), 'route' => $request->attributes->get('_route', 'n/a'), 'method' => $request->getMethod(), 'controller' => $this->parseController($request->attributes->get('_controller')), 'status_code' => $statusCode, 'status_text' => \ECSPrefix20210608\Symfony\Component\HttpFoundation\Response::$statusTexts[(int) $statusCode]]), 0, '/', null, $request->isSecure(), \true, \false, 'lax'));
        }
    ...
    {
        return new \ECSPrefix20210608\Symfony\Component\HttpFoundation\ParameterBag($this->data['request_request']->getValue());
    }
    public function getRequestQuery()
    {
        return new \ECSPrefix20210608\Symfony\Component\HttpFoundation\ParameterBag($this->data['request_query']->getValue());
    }
    public function getRequestFiles()
    {
        return new \ECSPrefix20210608\Symfony\Component\HttpFoundation\ParameterBag($this->data['request_files']->getValue());
    }
    public function getRequestHeaders()
    {
        return new \ECSPrefix20210608\Symfony\Component\HttpFoundation\ParameterBag($this->data['request_headers']->getValue());
    }
    public function getRequestServer($raw = \false)
    {
        return new \ECSPrefix20210608\Symfony\Component\HttpFoundation\ParameterBag($this->data['request_server']->getValue($raw));
    }
    public function getRequestCookies($raw = \false)
    {
        return new \ECSPrefix20210608\Symfony\Component\HttpFoundation\ParameterBag($this->data['request_cookies']->getValue($raw));
    }
    public function getRequestAttributes()
    {
        return new \ECSPrefix20210608\Symfony\Component\HttpFoundation\ParameterBag($this->data['request_attributes']->getValue());
    }
    public function getResponseHeaders()
    {
        return new \ECSPrefix20210608\Symfony\Component\HttpFoundation\ParameterBag($this->data['response_headers']->getValue());
    }
    public function getResponseCookies()
    {
        return new \ECSPrefix20210608\Symfony\Component\HttpFoundation\ParameterBag($this->data['response_cookies']->getValue());
    }
    ...
    {
        return new \ECSPrefix20210608\Symfony\Component\HttpFoundation\ParameterBag($this->data['dotenv_vars']->getValue());
    }
    /**
     * Gets the route name.
     *
    ...
    {
        return [\ECSPrefix20210608\Symfony\Component\HttpKernel\KernelEvents::CONTROLLER => 'onKernelController', \ECSPrefix20210608\Symfony\Component\HttpKernel\KernelEvents::RESPONSE => 'onKernelResponse'];
    }
    /**
     * {@inheritdoc}
     */
    ...
    public function collectSessionUsage()
    {
        ...
        for ($i = $traceEndIndex; $i > 0; --$i) {
            if (null !== ($class = $trace[$i]['class'] ?? null) && (\is_subclass_of($class, \ECSPrefix20210608\Symfony\Component\HttpFoundation\Session\SessionInterface::class) || \is_subclass_of($class, \ECSPrefix20210608\Symfony\Component\HttpFoundation\Session\SessionBagInterface::class))) {
                $traceEndIndex = $i;
                break;
            }
        }
