 ...
 * @final
 */
class ExceptionDataCollector extends \ECSPrefix20210608\Symfony\Component\HttpKernel\DataCollector\DataCollector
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        if (null !== $exception) {
            $this->data = ['exception' => \ECSPrefix20210608\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($exception)];
        }
    }
    /**
     * {@inheritdoc}
