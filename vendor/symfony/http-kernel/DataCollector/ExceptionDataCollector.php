 ...
 * @final
 */
class ExceptionDataCollector extends \ECSPrefix20211031\Symfony\Component\HttpKernel\DataCollector\DataCollector
{
    /**
     * {@inheritdoc}
    ...
    {
        if (null !== $exception) {
            $this->data = ['exception' => \ECSPrefix20211031\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($exception)];
        }
    }
    /**
     * {@inheritdoc}
