...
use ECSPrefix20210706\Symfony\Component\HttpKernel\Attribute\ArgumentInterface;
/**
...
class ArgumentMetadata
{
    ...
    public function __construct(string $name, $type, bool $isVariadic, bool $hasDefaultValue, $defaultValue, bool $isNullable = \false, $attributes = [])
    {
        ...
        if (null === $attributes || $attributes instanceof \ECSPrefix20210706\Symfony\Component\HttpKernel\Attribute\ArgumentInterface) {
    ...
    public function getAttribute()
    {
        ...
        return $this->attributes[0] instanceof \ECSPrefix20210706\Symfony\Component\HttpKernel\Attribute\ArgumentInterface ? $this->attributes[0] : null;
    }
    /**
     * @return object[]
     */
