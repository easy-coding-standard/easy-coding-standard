 ...
 */
namespace ECSPrefix20211002\Symfony\Component\HttpKernel\ControllerMetadata;

use ECSPrefix20211002\Symfony\Component\HttpKernel\Attribute\ArgumentInterface;
/**
...
class ArgumentMetadata
{
    ...
    public function __construct(string $name, ?string $type, bool $isVariadic, bool $hasDefaultValue, $defaultValue, bool $isNullable = \false, $attributes = [])
    {
        ...
        if (null === $attributes || $attributes instanceof \ECSPrefix20211002\Symfony\Component\HttpKernel\Attribute\ArgumentInterface) {
     ...
     */
    public function getAttribute() : ?\ECSPrefix20211002\Symfony\Component\HttpKernel\Attribute\ArgumentInterface
    {
        trigger_deprecation('symfony/http-kernel', '5.3', 'Method "%s()" is deprecated, use "getAttributes()" instead.', __METHOD__);
        if (!$this->attributes) {
            return null;
        }
        return $this->attributes[0] instanceof \ECSPrefix20211002\Symfony\Component\HttpKernel\Attribute\ArgumentInterface ? $this->attributes[0] : null;
    }
    /**
     * @return object[]
     ...
     * @param int $flags
     */
    public function getAttributes($name = null, $flags = 0) : array
    {
        if (!$name) {
