 ...
 */
namespace ECSPrefix202302\Symfony\Component\HttpKernel\ControllerMetadata;
...
class ArgumentMetadata
{
     ...
     */
    public function __construct(string $name, ?string $type, bool $isVariadic, bool $hasDefaultValue, $defaultValue, bool $isNullable = \false, array $attributes = [])
    {
        $this->name = $name;
        $this->type = $type;
