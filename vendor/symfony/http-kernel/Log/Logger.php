 ...
 */
namespace ECSPrefix202306\Symfony\Component\HttpKernel\Log;

use ECSPrefix202306\Psr\Log\AbstractLogger;
use ECSPrefix202306\Psr\Log\InvalidArgumentException;
use ECSPrefix202306\Psr\Log\LogLevel;
/**
...
class Logger extends AbstractLogger
{
    ...
    public function __construct(string $minLevel = null, $output = null, callable $formatter = null)
    {
        ...
        $this->formatter = null !== $formatter ? \Closure::fromCallable($formatter) : \Closure::fromCallable([$this, 'format']);
