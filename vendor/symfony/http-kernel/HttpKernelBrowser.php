 ...
 */
namespace ECSPrefix202303\Symfony\Component\HttpKernel;

use ECSPrefix202303\Symfony\Component\BrowserKit\AbstractBrowser;
use ECSPrefix202303\Symfony\Component\BrowserKit\CookieJar;
use ECSPrefix202303\Symfony\Component\BrowserKit\History;
use ECSPrefix202303\Symfony\Component\BrowserKit\Request as DomRequest;
use ECSPrefix202303\Symfony\Component\BrowserKit\Response as DomResponse;
use ECSPrefix202303\Symfony\Component\HttpFoundation\File\UploadedFile;
...
class HttpKernelBrowser extends AbstractBrowser
{
    ...
    protected function getScript(object $request)
    {
        ...
        foreach (\get_declared_classes() as $class) {
            if (\strncmp($class, 'ComposerAutoloaderInit', \strlen('ComposerAutoloaderInit')) === 0) {
