 ...
 */
namespace ECSPrefix20211101\Symfony\Component\HttpKernel\Profiler;
 ...
 */
class FileProfilerStorage implements \ECSPrefix20211101\Symfony\Component\HttpKernel\Profiler\ProfilerStorageInterface
{
    /**
     ...
     * {@inheritdoc}
     */
    public function read(string $token) : ?\ECSPrefix20211101\Symfony\Component\HttpKernel\Profiler\Profile
    {
     ...
     * @throws \RuntimeException
     */
    public function write(\ECSPrefix20211101\Symfony\Component\HttpKernel\Profiler\Profile $profile) : bool
    {
        ...
        $childrenToken = \array_filter(\array_map(function (\ECSPrefix20211101\Symfony\Component\HttpKernel\Profiler\Profile $p) use($profileToken) {
    ...
    protected function createProfileFromData(string $token, array $data, \ECSPrefix20211101\Symfony\Component\HttpKernel\Profiler\Profile $parent = null)
    {
        $profile = new \ECSPrefix20211101\Symfony\Component\HttpKernel\Profiler\Profile($token);
