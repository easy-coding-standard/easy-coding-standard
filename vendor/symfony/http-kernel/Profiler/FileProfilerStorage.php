 ...
 */
namespace ECSPrefix20210725\Symfony\Component\HttpKernel\Profiler;
 ...
 */
class FileProfilerStorage implements \ECSPrefix20210725\Symfony\Component\HttpKernel\Profiler\ProfilerStorageInterface
{
    /**
    ...
    public function write($profile) : bool
    {
        ...
        $childrenToken = \array_filter(\array_map(function (\ECSPrefix20210725\Symfony\Component\HttpKernel\Profiler\Profile $p) use($profileToken) {
    ...
    {
        $profile = new \ECSPrefix20210725\Symfony\Component\HttpKernel\Profiler\Profile($token);
