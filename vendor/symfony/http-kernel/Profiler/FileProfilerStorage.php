 ...
 */
namespace ECSPrefix20210927\Symfony\Component\HttpKernel\Profiler;
 ...
 */
class FileProfilerStorage implements \ECSPrefix20210927\Symfony\Component\HttpKernel\Profiler\ProfilerStorageInterface
{
    /**
     ...
     * @param string $token
     */
    public function read($token) : ?\ECSPrefix20210927\Symfony\Component\HttpKernel\Profiler\Profile
    {
    ...
    public function write($profile) : bool
    {
        ...
        $childrenToken = \array_filter(\array_map(function (\ECSPrefix20210927\Symfony\Component\HttpKernel\Profiler\Profile $p) use($profileToken) {
    ...
    {
        $profile = new \ECSPrefix20210927\Symfony\Component\HttpKernel\Profiler\Profile($token);
