 ...
 */
namespace ECSPrefix20210604\Symfony\Component\HttpKernel\Profiler;
 ...
 */
class FileProfilerStorage implements \ECSPrefix20210604\Symfony\Component\HttpKernel\Profiler\ProfilerStorageInterface
{
    /**
     ...
     * @throws \RuntimeException
     */
    public function write(\ECSPrefix20210604\Symfony\Component\HttpKernel\Profiler\Profile $profile) : bool
    {
        ...
        $childrenToken = \array_filter(\array_map(function (\ECSPrefix20210604\Symfony\Component\HttpKernel\Profiler\Profile $p) use($profileToken) {
    ...
    protected function createProfileFromData(string $token, array $data, \ECSPrefix20210604\Symfony\Component\HttpKernel\Profiler\Profile $parent = null)
    {
        $profile = new \ECSPrefix20210604\Symfony\Component\HttpKernel\Profiler\Profile($token);
