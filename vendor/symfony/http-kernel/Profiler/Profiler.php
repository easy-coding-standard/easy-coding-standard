 ...
 */
class Profiler implements \ECSPrefix20210507\Symfony\Contracts\Service\ResetInterface
{
    private $storage;
    /**
    ...
    public function saveProfile($profile)
    {
        ...
        foreach ($profile->getCollectors() as $collector) {
            if ($collector instanceof \ECSPrefix20210507\Symfony\Component\HttpKernel\DataCollector\LateDataCollectorInterface) {
    ...
    public function collect($request, $response, $exception = null)
    {
        ...
        } catch (\ECSPrefix20210507\Symfony\Component\HttpFoundation\Exception\ConflictingHeadersException $e) {
