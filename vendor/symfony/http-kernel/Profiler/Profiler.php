...
use ECSPrefix20211031\Symfony\Component\HttpKernel\DataCollector\DataCollectorInterface;
use ECSPrefix20211031\Symfony\Component\HttpKernel\DataCollector\LateDataCollectorInterface;
 ...
 */
class Profiler implements \ECSPrefix20211031\Symfony\Contracts\Service\ResetInterface
{
    private $storage;
    /**
    ...
    private $enabled = \true;
    public function __construct(\ECSPrefix20211031\Symfony\Component\HttpKernel\Profiler\ProfilerStorageInterface $storage, \ECSPrefix20211031\Psr\Log\LoggerInterface $logger = null, bool $enable = \true)
    {
    ...
    public function saveProfile(\ECSPrefix20211031\Symfony\Component\HttpKernel\Profiler\Profile $profile)
    {
        ...
        foreach ($profile->getCollectors() as $collector) {
            if ($collector instanceof \ECSPrefix20211031\Symfony\Component\HttpKernel\DataCollector\LateDataCollectorInterface) {
    ...
    public function collect(\ECSPrefix20211031\Symfony\Component\HttpFoundation\Request $request, \ECSPrefix20211031\Symfony\Component\HttpFoundation\Response $response, \Throwable $exception = null)
    {
        ...
        $profile = new \ECSPrefix20211031\Symfony\Component\HttpKernel\Profiler\Profile(\substr(\hash('sha256', \uniqid(\mt_rand(), \true)), 0, 6));
        $profile->setTime(\time());
        ...
        } catch (\ECSPrefix20211031\Symfony\Component\HttpFoundation\Exception\ConflictingHeadersException $e) {
