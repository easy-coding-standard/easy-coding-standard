...
use ECSPrefix20210508\Symfony\Component\HttpKernel\DataCollector\DataCollectorInterface;
 ...
 */
class Profiler implements \ECSPrefix20210508\Symfony\Contracts\Service\ResetInterface
{
    private $storage;
    /**
     ...
     */
    public function loadProfileFromResponse(\ECSPrefix20210508\Symfony\Component\HttpFoundation\Response $response)
    {
     ...
     * @return bool
     */
    public function saveProfile(\ECSPrefix20210508\Symfony\Component\HttpKernel\Profiler\Profile $profile)
    {
        // late collect
        foreach ($profile->getCollectors() as $collector) {
            if ($collector instanceof \ECSPrefix20210508\Symfony\Component\HttpKernel\DataCollector\LateDataCollectorInterface) {
    ...
    public function collect(\ECSPrefix20210508\Symfony\Component\HttpFoundation\Request $request, \ECSPrefix20210508\Symfony\Component\HttpFoundation\Response $response, \Throwable $exception = null)
    {
        ...
        $profile = new \ECSPrefix20210508\Symfony\Component\HttpKernel\Profiler\Profile(\substr(\hash('sha256', \uniqid(\mt_rand(), \true)), 0, 6));
        $profile->setTime(\time());
        ...
        } catch (\ECSPrefix20210508\Symfony\Component\HttpFoundation\Exception\ConflictingHeadersException $e) {
     ...
     * Adds a Collector.
     */
    public function add(\ECSPrefix20210508\Symfony\Component\HttpKernel\DataCollector\DataCollectorInterface $collector)
    {
