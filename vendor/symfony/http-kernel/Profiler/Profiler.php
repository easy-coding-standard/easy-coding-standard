...
use ECSPrefix20211002\Symfony\Component\HttpKernel\DataCollector\LateDataCollectorInterface;
 ...
 */
class Profiler implements \ECSPrefix20211002\Symfony\Contracts\Service\ResetInterface
{
    private $storage;
    /**
    ...
    private $enabled = \true;
    public function __construct(\ECSPrefix20211002\Symfony\Component\HttpKernel\Profiler\ProfilerStorageInterface $storage, \ECSPrefix20211002\Psr\Log\LoggerInterface $logger = null, bool $enable = \true)
    {
    ...
    public function saveProfile($profile)
    {
        ...
        foreach ($profile->getCollectors() as $collector) {
            if ($collector instanceof \ECSPrefix20211002\Symfony\Component\HttpKernel\DataCollector\LateDataCollectorInterface) {
    ...
    public function collect($request, $response, $exception = null)
    {
        ...
        $profile = new \ECSPrefix20211002\Symfony\Component\HttpKernel\Profiler\Profile(\substr(\hash('sha256', \uniqid(\mt_rand(), \true)), 0, 6));
        $profile->setTime(\time());
        ...
        } catch (\ECSPrefix20211002\Symfony\Component\HttpFoundation\Exception\ConflictingHeadersException $e) {
