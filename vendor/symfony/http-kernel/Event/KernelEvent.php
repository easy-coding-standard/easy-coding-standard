...
use ECSPrefix20210708\Symfony\Contracts\EventDispatcher\Event;
/**
 * Base class for events thrown in the HttpKernel component.
 *
 * @author Bernhard Schussek <bschussek@gmail.com>
 */
class KernelEvent extends \ECSPrefix20210708\Symfony\Contracts\EventDispatcher\Event
{
    private $kernel;
    private $request;
    private $requestType;
     ...
     */
    public function __construct(\ECSPrefix20210708\Symfony\Component\HttpKernel\HttpKernelInterface $kernel, \ECSPrefix20210708\Symfony\Component\HttpFoundation\Request $request, $requestType)
    {
        $this->kernel = $kernel;
    ...
    {
        return \ECSPrefix20210708\Symfony\Component\HttpKernel\HttpKernelInterface::MAIN_REQUEST === $this->requestType;
    }
    /**
