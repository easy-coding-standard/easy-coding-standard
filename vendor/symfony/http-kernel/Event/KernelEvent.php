 ...
 */
class KernelEvent extends \ECSPrefix20210601\Symfony\Contracts\EventDispatcher\Event
{
    private $kernel;
    private $request;
    private $requestType;
     ...
     */
    public function __construct(\ECSPrefix20210601\Symfony\Component\HttpKernel\HttpKernelInterface $kernel, \ECSPrefix20210601\Symfony\Component\HttpFoundation\Request $request, $requestType)
    {
        $this->kernel = $kernel;
    ...
    {
        return \ECSPrefix20210601\Symfony\Component\HttpKernel\HttpKernelInterface::MAIN_REQUEST === $this->requestType;
    }
    /**
