 ...
 */
class ChildDefinition extends \ECSPrefix20210710\Symfony\Component\DependencyInjection\Definition
{
    private $parent;
    /**
    ...
    public function replaceArgument($index, $value)
    {
        if (\is_int($index)) {
            ...
            throw new \ECSPrefix20210710\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException('The argument must be an existing index or the name of a constructor\'s parameter.');
        }
        return $this;
    }
}
