...
abstract class Extension implements \ECSPrefix20210507\Symfony\Component\DependencyInjection\Extension\ExtensionInterface, \ECSPrefix20210507\Symfony\Component\DependencyInjection\Extension\ConfigurationExtensionInterface
{
    ...
    public function getAlias()
    {
        ...
        if ('Extension' != \substr($className, -9)) {
            throw new \ECSPrefix20210507\Symfony\Component\DependencyInjection\Exception\BadMethodCallException('This extension does not follow the naming convention; you must overwrite the getAlias() method.');
        }
        $classBaseName = \substr(\strrchr($className, '\\'), 1, -9);
        return \ECSPrefix20210507\Symfony\Component\DependencyInjection\Container::underscore($classBaseName);
    }
    /**
     * {@inheritdoc}
    ...
    public function getConfiguration(array $config, $container)
    {
        ...
        if (!$class->implementsInterface(\ECSPrefix20210507\Symfony\Component\Config\Definition\ConfigurationInterface::class)) {
            throw new \ECSPrefix20210507\Symfony\Component\DependencyInjection\Exception\LogicException(\sprintf('The extension configuration class "%s" must implement "%s".', $class->getName(), \ECSPrefix20210507\Symfony\Component\Config\Definition\ConfigurationInterface::class));
        }
    ...
    protected function isConfigEnabled($container, array $config)
    {
        if (!\array_key_exists('enabled', $config)) {
            throw new \ECSPrefix20210507\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException("The config array has no 'enabled' key.");
        }
