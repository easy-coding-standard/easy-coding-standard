 ...
 */
class AutowiringFailedException extends \ECSPrefix20210508\Symfony\Component\DependencyInjection\Exception\RuntimeException
{
    private $serviceId;
    ...
    public function __construct($serviceId, $message = '', $code = 0, \Throwable $previous = null)
    {
        ...
        $this->message = new \ECSPrefix20210508\Symfony\Component\DependencyInjection\Exception\Anonymous__f2200998121b1c0886562f1a6a7e315b__0($this->message, $this->messageCallback);
    }
    /**
     * @return \Closure|null
     */
