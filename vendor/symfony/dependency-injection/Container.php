...
use ECSPrefix20210509\Symfony\Component\DependencyInjection\Argument\ServiceLocator as ArgumentServiceLocator;
...
\class_exists(\ECSPrefix20210509\Symfony\Component\DependencyInjection\Argument\RewindableGenerator::class);
\class_exists(\ECSPrefix20210509\Symfony\Component\DependencyInjection\Argument\ServiceLocator::class);
/**
 ...
 */
class Container implements \ECSPrefix20210509\Symfony\Component\DependencyInjection\ContainerInterface, \ECSPrefix20210509\Symfony\Contracts\Service\ResetInterface
{
    ...
    {
        $this->parameterBag = isset($parameterBag) ? $parameterBag : new \ECSPrefix20210509\Symfony\Component\DependencyInjection\ParameterBag\EnvPlaceholderParameterBag();
    }
    /**
    ...
    public function compile()
    {
        ...
        $this->parameterBag = new \ECSPrefix20210509\Symfony\Component\DependencyInjection\ParameterBag\FrozenParameterBag($this->parameterBag->all());
        $this->compiled = \true;
    }
    /**
    ...
    public function set($id, $service)
    {
        ...
        if ('service_container' === $id) {
            throw new \ECSPrefix20210509\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException('You cannot set service "service_container".');
        }
        if (!(isset($this->fileMap[$id]) || isset($this->methodMap[$id]))) {
            if (isset($this->syntheticIds[$id]) || !isset($this->getRemovedIds()[$id])) {
                // no-op
            } elseif (null === $service) {
                throw new \ECSPrefix20210509\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException(\sprintf('The "%s" service is private, you cannot unset it.', $id));
            } else {
                throw new \ECSPrefix20210509\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException(\sprintf('The "%s" service is private, you cannot replace it.', $id));
            }
        } elseif (isset($this->services[$id])) {
            throw new \ECSPrefix20210509\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException(\sprintf('The "%s" service is already initialized, you cannot replace it.', $id));
        }
    ...
    private function make($id, $invalidBehavior)
    {
        ...
        if (isset($this->loading[$id])) {
            throw new \ECSPrefix20210509\Symfony\Component\DependencyInjection\Exception\ServiceCircularReferenceException($id, \array_merge(\array_keys($this->loading), [$id]));
        }
        $this->loading[$id] = \true;
        try {
        ...
        if (1 === $invalidBehavior) {
            ...
            if (isset($this->syntheticIds[$id])) {
                throw new \ECSPrefix20210509\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException($id, null, null, [], \sprintf('The "%s" service is synthetic, it needs to be set at boot time before it can be used.', $id));
            }
            if (isset($this->getRemovedIds()[$id])) {
                throw new \ECSPrefix20210509\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException($id, null, null, [], \sprintf('The "%s" service or alias has been removed or inlined when the container was compiled. You should either make it public, or stop using the container directly and use dependency injection instead.', $id));
            }
            $alternatives = [];
            ...
            throw new \ECSPrefix20210509\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException($id, null, null, $alternatives);
        }
        return null;
    }
    /**
    ...
    public function reset()
    {
        ...
        foreach ($services as $service) {
            try {
                if ($service instanceof \ECSPrefix20210509\Symfony\Contracts\Service\ResetInterface) {
                    $service->reset();
                }
            } catch (\Throwable $e) {
                continue;
    ...
    protected function getEnv($name)
    {
        if (isset($this->resolving[$envName = "env({$name})"])) {
            throw new \ECSPrefix20210509\Symfony\Component\DependencyInjection\Exception\ParameterCircularReferenceException(\array_keys($this->resolving));
        }
        if (isset($this->envCache[$name]) || \array_key_exists($name, $this->envCache)) {
            return $this->envCache[$name];
        }
        if (!$this->has($id = 'container.env_var_processors_locator')) {
            $this->set($id, new \ECSPrefix20210509\Symfony\Component\DependencyInjection\ServiceLocator([]));
        }
        if (!$this->getEnv) {
        ...
        $processor = $processors->has($prefix) ? $processors->get($prefix) : new \ECSPrefix20210509\Symfony\Component\DependencyInjection\EnvVarProcessor($this);
    ...
    protected final function getService($registry, $id, $method, $load)
    {
        ...
        if (\is_string($load)) {
            throw new \ECSPrefix20210509\Symfony\Component\DependencyInjection\Exception\RuntimeException($load);
        }
        if (null === $method) {
