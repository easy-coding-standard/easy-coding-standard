...
final class ReverseContainer
{
    ...
    public function __construct(\ECSPrefix20210819\Symfony\Component\DependencyInjection\Container $serviceContainer, \ECSPrefix20210819\Psr\Container\ContainerInterface $reversibleLocator, string $tagName = 'container.reversible')
    {
        ...
        }, $serviceContainer, \ECSPrefix20210819\Symfony\Component\DependencyInjection\Container::class);
    }
    /**
    ...
    public function getService(string $id)
    {
        ...
        if (isset($this->serviceContainer->getRemovedIds()[$id])) {
            throw new \ECSPrefix20210819\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException($id, null, null, [], \sprintf('The "%s" service is private and cannot be accessed by reference. You should either make it public, or tag it as "%s".', $id, $this->tagName));
        }
