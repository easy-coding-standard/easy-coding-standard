...
use ECSPrefix202303\Symfony\Component\Config\Resource\ComposerResource;
use ECSPrefix202303\Symfony\Component\Config\Resource\DirectoryResource;
use ECSPrefix202303\Symfony\Component\Config\Resource\FileExistenceResource;
use ECSPrefix202303\Symfony\Component\Config\Resource\FileResource;
use ECSPrefix202303\Symfony\Component\Config\Resource\GlobResource;
use ECSPrefix202303\Symfony\Component\Config\Resource\ReflectionClassResource;
...
use ECSPrefix202303\Symfony\Component\DependencyInjection\Compiler\Compiler;
...
use ECSPrefix202303\Symfony\Component\DependencyInjection\Compiler\ResolveEnvPlaceholdersPass;
...
use ECSPrefix202303\Symfony\Component\DependencyInjection\LazyProxy\Instantiator\InstantiatorInterface;
use ECSPrefix202303\Symfony\Component\DependencyInjection\LazyProxy\Instantiator\RealServiceInstantiator;
...
use ECSPrefix202303\Symfony\Component\ExpressionLanguage\ExpressionFunctionProviderInterface;
/**
        ...
        if (null !== $factory) {
            ...
            if (!$definition->isDeprecated() && \is_array($factory) && \is_string($factory[0])) {
                ...
                if (0 < \strpos($r->getDocComment(), "\n * @deprecated ")) {
                    \ECSPrefix202303\trigger_deprecation('', '', 'The "%s" service relies on the deprecated "%s" factory class. It should either be deprecated or its factory upgraded.', $id, $r->name);
                }
            }
        } else {
            ...
            if (!$definition->isDeprecated() && 0 < \strpos($r->getDocComment(), "\n * @deprecated ")) {
                \ECSPrefix202303\trigger_deprecation('', '', 'The "%s" service relies on the deprecated "%s" class. It should either be deprecated or its implementation upgraded.', $id, $r->name);
            }
        }
