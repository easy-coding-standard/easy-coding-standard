...
use ECSPrefix202301\Composer\InstalledVersions;
use ECSPrefix202301\Symfony\Component\Config\Resource\ClassExistenceResource;
use ECSPrefix202301\Symfony\Component\Config\Resource\ComposerResource;
use ECSPrefix202301\Symfony\Component\Config\Resource\DirectoryResource;
use ECSPrefix202301\Symfony\Component\Config\Resource\FileExistenceResource;
use ECSPrefix202301\Symfony\Component\Config\Resource\FileResource;
use ECSPrefix202301\Symfony\Component\Config\Resource\GlobResource;
use ECSPrefix202301\Symfony\Component\Config\Resource\ReflectionClassResource;
...
use ECSPrefix202301\Symfony\Component\DependencyInjection\Compiler\Compiler;
use ECSPrefix202301\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface;
use ECSPrefix202301\Symfony\Component\DependencyInjection\Compiler\PassConfig;
use ECSPrefix202301\Symfony\Component\DependencyInjection\Compiler\ResolveEnvPlaceholdersPass;
...
use ECSPrefix202301\Symfony\Component\DependencyInjection\LazyProxy\Instantiator\InstantiatorInterface;
use ECSPrefix202301\Symfony\Component\DependencyInjection\LazyProxy\Instantiator\RealServiceInstantiator;
...
use ECSPrefix202301\Symfony\Component\ExpressionLanguage\ExpressionFunctionProviderInterface;
/**
...
class ContainerBuilder extends Container implements TaggedContainerInterface
{
    ...
    /**
     * @var \ECSPrefix202301\Symfony\Component\DependencyInjection\Compiler\Compiler
     */
    private $compiler;
    /**
     * @var bool
    ...
    /**
     * @var \ECSPrefix202301\Symfony\Component\DependencyInjection\LazyProxy\Instantiator\InstantiatorInterface|null
     */
     ...
     * @param string|\ECSPrefix202301\Symfony\Component\DependencyInjection\Alias $id
     */
        ...
        if (null !== $factory) {
            ...
            if (!$definition->isDeprecated() && \is_array($factory) && \is_string($factory[0])) {
                ...
                if (0 < \strpos($r->getDocComment(), "\n * @deprecated ")) {
                    \ECSPrefix202301\trigger_deprecation('', '', 'The "%s" service relies on the deprecated "%s" factory class. It should either be deprecated or its factory upgraded.', $id, $r->name);
                }
            }
        } else {
            ...
            if (!$definition->isDeprecated() && 0 < \strpos($r->getDocComment(), "\n * @deprecated ")) {
                \ECSPrefix202301\trigger_deprecation('', '', 'The "%s" service relies on the deprecated "%s" class. It should either be deprecated or its implementation upgraded.', $id, $r->name);
            }
        }
