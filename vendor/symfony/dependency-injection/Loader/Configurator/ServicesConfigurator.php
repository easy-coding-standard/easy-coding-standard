 ...
 */
class ServicesConfigurator extends \ECSPrefix20210517\Symfony\Component\DependencyInjection\Loader\Configurator\AbstractConfigurator
{
    ...
    public function __construct(\ECSPrefix20210517\Symfony\Component\DependencyInjection\ContainerBuilder $container, \ECSPrefix20210517\Symfony\Component\DependencyInjection\Loader\PhpFileLoader $loader, array &$instanceof, string $path = null, int &$anonymousCount = 0)
    {
        ...
        $this->path = $path;
        $this->anonymousHash = \ECSPrefix20210517\Symfony\Component\DependencyInjection\ContainerBuilder::hash($path ?: \mt_rand());
    ...
    public final function set($id, string $class = null) : \ECSPrefix20210517\Symfony\Component\DependencyInjection\Loader\Configurator\ServiceConfigurator
    {
        ...
        $configurator = new \ECSPrefix20210517\Symfony\Component\DependencyInjection\Loader\Configurator\ServiceConfigurator($this->container, $this->instanceof, \true, $this, $definition, $id, $defaults->getTags(), $this->path);
    ...
    public final function alias(string $id, string $referencedId) : \ECSPrefix20210517\Symfony\Component\DependencyInjection\Loader\Configurator\AliasConfigurator
    {
        ...
        return new \ECSPrefix20210517\Symfony\Component\DependencyInjection\Loader\Configurator\AliasConfigurator($this, $alias);
    }
    /**
    ...
    public final function stack(string $id, array $services) : \ECSPrefix20210517\Symfony\Component\DependencyInjection\Loader\Configurator\AliasConfigurator
    {
        foreach ($services as $i => $service) {
            ...
            } elseif (!$service instanceof \ECSPrefix20210517\Symfony\Component\DependencyInjection\Loader\Configurator\ReferenceConfigurator) {
                throw new \ECSPrefix20210517\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException(\sprintf('"%s()" expects a list of definitions as returned by "%s()" or "%s()", "%s" given at index "%s" for service "%s".', __METHOD__, \ECSPrefix20210517\Symfony\Component\DependencyInjection\Loader\Configurator\InlineServiceConfigurator::FACTORY, \ECSPrefix20210517\Symfony\Component\DependencyInjection\Loader\Configurator\ReferenceConfigurator::FACTORY, $service instanceof \ECSPrefix20210517\Symfony\Component\DependencyInjection\Loader\Configurator\AbstractConfigurator ? $service::FACTORY . '()' : \get_debug_type($service), $i, $id));
            }
        }
        $alias = $this->alias($id, '');
