...
trait DecorateTrait
{
     ...
     */
    public final function decorate($id, string $renamedId = null, int $priority = 0, int $invalidBehavior = \ECSPrefix20210605\Symfony\Component\DependencyInjection\ContainerInterface::EXCEPTION_ON_INVALID_REFERENCE)
    {
