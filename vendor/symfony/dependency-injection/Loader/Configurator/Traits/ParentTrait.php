...
trait ParentTrait
{
    ...
    public final function parent($parent)
    {
        ...
        if (!$this->allowParent) {
            throw new \ECSPrefix20210509\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException(\sprintf('A parent cannot be defined when either "_instanceof" or "_defaults" are also defined for service prototype "%s".', $this->id));
        }
        if ($this->definition instanceof \ECSPrefix20210509\Symfony\Component\DependencyInjection\ChildDefinition) {
