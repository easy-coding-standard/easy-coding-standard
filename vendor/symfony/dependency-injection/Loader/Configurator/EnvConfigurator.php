...
class EnvConfigurator extends \ECSPrefix20210927\Symfony\Component\Config\Loader\ParamConfigurator
{
    /**
     * @var string[]
     */
    ...
    {
        $processor = \strtolower(\preg_replace(['/([A-Z]+)([A-Z][a-z])/', '/([a-z\\d])([A-Z])/'], 'ECSPrefix20210927\\1_\\2', $name));
