...
class EnvConfigurator extends \ECSPrefix20211122\Symfony\Component\Config\Loader\ParamConfigurator
{
    /**
     * @var string[]
     */
    ...
    {
        $processor = \strtolower(\preg_replace(['/([A-Z]+)([A-Z][a-z])/', '/([a-z\\d])([A-Z])/'], 'ECSPrefix20211122\\1_\\2', $name));
