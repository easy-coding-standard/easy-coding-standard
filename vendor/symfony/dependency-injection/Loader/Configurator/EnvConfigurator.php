...
class EnvConfigurator extends \ConfigTransformer20210601\Symfony\Component\Config\Loader\ParamConfigurator
{
    /**
     * @var string[]
     */
    ...
    {
        $processor = \strtolower(\preg_replace(['/([A-Z]+)([A-Z][a-z])/', '/([a-z\\d])([A-Z])/'], 'ConfigTransformer20210601\\1_\\2', $name));
