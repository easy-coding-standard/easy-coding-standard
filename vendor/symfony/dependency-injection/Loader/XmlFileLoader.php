...
class XmlFileLoader extends FileLoader
{
     ...
     * @param string $file
     */
    private function parseDefinitions(\DOMDocument $xml, $file, Definition $defaults)
    {
        $file = (string) $file;
        $xpath = new \DOMXPath($xml);
        $xpath->registerNamespace('container', self::NS);
     ...
     * @param string $file
     */
    private function parseDefinition(\DOMElement $service, $file, Definition $defaults)
    {
        $file = (string) $file;
