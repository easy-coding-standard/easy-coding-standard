...
EOF;
     ...
     */
    private function collectCircularReferences($sourceId, array $edges, array &$checkedNodes, array &$loops = [], array $path = [], $byConstructor = true)
    {
     ...
     * @return string
     */
    private function addServiceMethodCalls(Definition $definition, $variableName, $sharedNonLazyId)
    {
...
EOTXT
     ...
     * @return string
     */
    private function addNewInstance(Definition $definition, $return = '', $id = null)
    {
...
EOF;
     ...
     * @return mixed[]
     */
    private function getClasses(Definition $definition, $id)
    {
        $id = (string) $id;
        $classes = [];
