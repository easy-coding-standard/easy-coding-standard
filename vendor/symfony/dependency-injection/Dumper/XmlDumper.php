 ...
 */
class XmlDumper extends \ECSPrefix20210517\Symfony\Component\DependencyInjection\Dumper\Dumper
{
    /**
     * @var \DOMDocument
     */
     ...
     */
    private function addService(\ECSPrefix20210517\Symfony\Component\DependencyInjection\Definition $definition, $id, \DOMElement $parent)
    {
        ...
        if ($callable = $definition->getFactory()) {
            ...
            if (\is_array($callable) && $callable[0] instanceof \ECSPrefix20210517\Symfony\Component\DependencyInjection\Definition) {
                $this->addService($callable[0], null, $factory);
                $factory->setAttribute('method', $callable[1]);
            } elseif (\is_array($callable)) {
                if (null !== $callable[0]) {
                    $factory->setAttribute($callable[0] instanceof \ECSPrefix20210517\Symfony\Component\DependencyInjection\Reference ? 'service' : 'class', $callable[0]);
                }
                $factory->setAttribute('method', $callable[1]);
            } else {
        ...
        if ($callable = $definition->getConfigurator()) {
            ...
            if (\is_array($callable) && $callable[0] instanceof \ECSPrefix20210517\Symfony\Component\DependencyInjection\Definition) {
                ...
                $configurator->setAttribute($callable[0] instanceof \ECSPrefix20210517\Symfony\Component\DependencyInjection\Reference ? 'service' : 'class', $callable[0]);
                $configurator->setAttribute('method', $callable[1]);
            } else {
    ...
    private function convertParameters(array $parameters, string $type, \DOMElement $parent, string $keyAttribute = 'key')
    {
        ...
        foreach ($parameters as $key => $value) {
            ...
            if (\is_array($tag = $value)) {
            ...
            } elseif ($value instanceof \ECSPrefix20210517\Symfony\Component\DependencyInjection\Argument\TaggedIteratorArgument || $value instanceof \ECSPrefix20210517\Symfony\Component\DependencyInjection\Argument\ServiceLocatorArgument && ($tag = $value->getTaggedIteratorArgument())) {
                $element->setAttribute('type', $value instanceof \ECSPrefix20210517\Symfony\Component\DependencyInjection\Argument\TaggedIteratorArgument ? 'tagged_iterator' : 'tagged_locator');
            ...
            } elseif ($value instanceof \ECSPrefix20210517\Symfony\Component\DependencyInjection\Argument\IteratorArgument) {
                ...
                $this->convertParameters($value->getValues(), $type, $element, 'key');
            } elseif ($value instanceof \ECSPrefix20210517\Symfony\Component\DependencyInjection\Reference || $value instanceof \ECSPrefix20210517\Symfony\Component\DependencyInjection\Argument\ServiceClosureArgument) {
                ...
                if (\ECSPrefix20210517\Symfony\Component\DependencyInjection\ContainerInterface::NULL_ON_INVALID_REFERENCE == $behavior) {
                    $element->setAttribute('on-invalid', 'null');
                } elseif (\ECSPrefix20210517\Symfony\Component\DependencyInjection\ContainerInterface::IGNORE_ON_INVALID_REFERENCE == $behavior) {
                    $element->setAttribute('on-invalid', 'ignore');
                } elseif (\ECSPrefix20210517\Symfony\Component\DependencyInjection\ContainerInterface::IGNORE_ON_UNINITIALIZED_REFERENCE == $behavior) {
    ...
    public static function phpToXml($value) : string
    {
        switch (\true) {
            ...
            case \false === $value:
                return 'false';
            case $value instanceof \ECSPrefix20210517\Symfony\Component\DependencyInjection\Parameter:
                return '%' . $value . '%';
