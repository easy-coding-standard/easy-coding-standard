 ...
 */
class XmlDumper extends \ConfigTransformer20210601\Symfony\Component\DependencyInjection\Dumper\Dumper
{
    /**
     * @var \DOMDocument
     */
     ...
     */
    private function addService(\ConfigTransformer20210601\Symfony\Component\DependencyInjection\Definition $definition, $id, \DOMElement $parent)
    {
        ...
        if (null !== ($decoratedService = $definition->getDecoratedService())) {
            ...
            $decorationOnInvalid = $decoratedService[3] ?? \ConfigTransformer20210601\Symfony\Component\DependencyInjection\ContainerInterface::EXCEPTION_ON_INVALID_REFERENCE;
            if (\in_array($decorationOnInvalid, [\ConfigTransformer20210601\Symfony\Component\DependencyInjection\ContainerInterface::IGNORE_ON_INVALID_REFERENCE, \ConfigTransformer20210601\Symfony\Component\DependencyInjection\ContainerInterface::NULL_ON_INVALID_REFERENCE], \true)) {
                $invalidBehavior = \ConfigTransformer20210601\Symfony\Component\DependencyInjection\ContainerInterface::NULL_ON_INVALID_REFERENCE === $decorationOnInvalid ? 'null' : 'ignore';
        ...
        if ($callable = $definition->getFactory()) {
            ...
            if (\is_array($callable) && $callable[0] instanceof \ConfigTransformer20210601\Symfony\Component\DependencyInjection\Definition) {
                $this->addService($callable[0], null, $factory);
                $factory->setAttribute('method', $callable[1]);
            } elseif (\is_array($callable)) {
                if (null !== $callable[0]) {
                    $factory->setAttribute($callable[0] instanceof \ConfigTransformer20210601\Symfony\Component\DependencyInjection\Reference ? 'service' : 'class', $callable[0]);
                }
                $factory->setAttribute('method', $callable[1]);
            } else {
        ...
        if ($callable = $definition->getConfigurator()) {
            ...
            if (\is_array($callable) && $callable[0] instanceof \ConfigTransformer20210601\Symfony\Component\DependencyInjection\Definition) {
                ...
                $configurator->setAttribute($callable[0] instanceof \ConfigTransformer20210601\Symfony\Component\DependencyInjection\Reference ? 'service' : 'class', $callable[0]);
                $configurator->setAttribute('method', $callable[1]);
            } else {
    ...
    private function addServiceAlias(string $alias, \ConfigTransformer20210601\Symfony\Component\DependencyInjection\Alias $id, \DOMElement $parent)
    {
        $service = $this->document->createElement('service');
    ...
    private function convertParameters(array $parameters, string $type, \DOMElement $parent, string $keyAttribute = 'key')
    {
        ...
        foreach ($parameters as $key => $value) {
            ...
            if (\is_array($tag = $value)) {
            ...
            } elseif ($value instanceof \ConfigTransformer20210601\Symfony\Component\DependencyInjection\Argument\TaggedIteratorArgument || $value instanceof \ConfigTransformer20210601\Symfony\Component\DependencyInjection\Argument\ServiceLocatorArgument && ($tag = $value->getTaggedIteratorArgument())) {
                $element->setAttribute('type', $value instanceof \ConfigTransformer20210601\Symfony\Component\DependencyInjection\Argument\TaggedIteratorArgument ? 'tagged_iterator' : 'tagged_locator');
            ...
            } elseif ($value instanceof \ConfigTransformer20210601\Symfony\Component\DependencyInjection\Argument\IteratorArgument) {
                ...
                $this->convertParameters($value->getValues(), $type, $element, 'key');
            } elseif ($value instanceof \ConfigTransformer20210601\Symfony\Component\DependencyInjection\Reference || $value instanceof \ConfigTransformer20210601\Symfony\Component\DependencyInjection\Argument\ServiceClosureArgument) {
                ...
                if (\ConfigTransformer20210601\Symfony\Component\DependencyInjection\ContainerInterface::NULL_ON_INVALID_REFERENCE == $behavior) {
                    $element->setAttribute('on-invalid', 'null');
                } elseif (\ConfigTransformer20210601\Symfony\Component\DependencyInjection\ContainerInterface::IGNORE_ON_INVALID_REFERENCE == $behavior) {
                    $element->setAttribute('on-invalid', 'ignore');
                } elseif (\ConfigTransformer20210601\Symfony\Component\DependencyInjection\ContainerInterface::IGNORE_ON_UNINITIALIZED_REFERENCE == $behavior) {
