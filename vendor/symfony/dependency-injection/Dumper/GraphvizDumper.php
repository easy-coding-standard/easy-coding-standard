 ...
 */
class GraphvizDumper extends \ECSPrefix20211130\Symfony\Component\DependencyInjection\Dumper\Dumper
{
    /**
     * @var mixed[]
     */
    ...
    private function findEdges(string $id, array $arguments, bool $required, string $name, bool $lazy = \false) : array
    {
        ...
        foreach ($arguments as $argument) {
            if ($argument instanceof \ECSPrefix20211130\Symfony\Component\DependencyInjection\Parameter) {
            ...
            } elseif ($argument instanceof \ECSPrefix20211130\Symfony\Component\DependencyInjection\Argument\ArgumentInterface) {
    ...
    private function findNodes() : array
    {
        ...
        foreach ($container->getDefinitions() as $id => $definition) {
            ...
            $container->setDefinition($id, new \ECSPrefix20211130\Symfony\Component\DependencyInjection\Definition('stdClass'));
        }
    ...
    private function cloneContainer() : \ECSPrefix20211130\Symfony\Component\DependencyInjection\ContainerBuilder
    {
        $parameterBag = new \ECSPrefix20211130\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag($this->container->getParameterBag()->all());
        $container = new \ECSPrefix20211130\Symfony\Component\DependencyInjection\ContainerBuilder($parameterBag);
