 ...
 */
class GraphvizDumper extends \ECSPrefix20210508\Symfony\Component\DependencyInjection\Dumper\Dumper
{
    private $nodes;
    private $edges;
    ...
    private function findEdges($id, array $arguments, $required, $name, $lazy = \false)
    {
        ...
        foreach ($arguments as $argument) {
            ...
            if ($argument instanceof \ECSPrefix20210508\Symfony\Component\DependencyInjection\Reference) {
                $lazyEdge = $lazy;
            ...
            } elseif ($argument instanceof \ECSPrefix20210508\Symfony\Component\DependencyInjection\Argument\ArgumentInterface) {
    ...
    private function findNodes()
    {
        ...
        foreach ($container->getDefinitions() as $id => $definition) {
            ...
            $container->setDefinition($id, new \ECSPrefix20210508\Symfony\Component\DependencyInjection\Definition('stdClass'));
        }
    ...
    {
        $parameterBag = new \ECSPrefix20210508\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag($this->container->getParameterBag()->all());
        $container = new \ECSPrefix20210508\Symfony\Component\DependencyInjection\ContainerBuilder($parameterBag);
