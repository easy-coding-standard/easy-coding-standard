 ...
 */
class GraphvizDumper extends \ECSPrefix20210511\Symfony\Component\DependencyInjection\Dumper\Dumper
{
    private $nodes;
    private $edges;
    ...
    private function findEdges($id, array $arguments, $required, $name, $lazy = \false)
    {
        ...
        foreach ($arguments as $argument) {
            if ($argument instanceof \ECSPrefix20210511\Symfony\Component\DependencyInjection\Parameter) {
                $argument = $this->container->hasParameter($argument) ? $this->container->getParameter($argument) : null;
            } elseif (\is_string($argument) && \preg_match('/^%([^%]+)%$/', $argument, $match)) {
                $argument = $this->container->hasParameter($match[1]) ? $this->container->getParameter($match[1]) : null;
            }
            if ($argument instanceof \ECSPrefix20210511\Symfony\Component\DependencyInjection\Reference) {
                $lazyEdge = $lazy;
            ...
            } elseif ($argument instanceof \ECSPrefix20210511\Symfony\Component\DependencyInjection\Argument\ArgumentInterface) {
    ...
    private function findNodes()
    {
        ...
        foreach ($container->getDefinitions() as $id => $definition) {
            ...
            $container->setDefinition($id, new \ECSPrefix20210511\Symfony\Component\DependencyInjection\Definition('stdClass'));
        }
    ...
    {
        $parameterBag = new \ECSPrefix20210511\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag($this->container->getParameterBag()->all());
        $container = new \ECSPrefix20210511\Symfony\Component\DependencyInjection\ContainerBuilder($parameterBag);
