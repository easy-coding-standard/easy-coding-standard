 ...
 */
namespace ECSPrefix20211216\Symfony\Component\DependencyInjection\Attribute;
...
final class Target
{
    ...
    public static function parseName(\ReflectionParameter $parameter) : string
    {
        ...
        if (!\preg_match('/^[a-zA-Z_\\x7f-\\xff]/', $name)) {
            ...
            throw new \ECSPrefix20211216\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException(\sprintf('Invalid #[Target] name "%s" on parameter "$%s" of "%s()": the first character must be a letter.', $name, $parameter->name, $function));
        }
        return $name;
    }
}
