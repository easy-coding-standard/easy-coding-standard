...
use ECSPrefix20210509\Symfony\Contracts\Service\ServiceLocatorTrait;
use ECSPrefix20210509\Symfony\Contracts\Service\ServiceProviderInterface;
use ECSPrefix20210509\Symfony\Contracts\Service\ServiceSubscriberInterface;
/**
 * @author Robin Chalas <robin.chalas@gmail.com>
 * @author Nicolas Grekas <p@tchwork.com>
 */
class ServiceLocator implements \ECSPrefix20210509\Symfony\Contracts\Service\ServiceProviderInterface
{
     ...
     */
    public function withContext($externalId, \ECSPrefix20210509\Symfony\Component\DependencyInjection\Container $container)
    {
    ...
    private function createNotFoundException($id)
    {
        ...
        if ($this->loading) {
            ...
            return new \ECSPrefix20210509\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException($id, \end($this->loading) ?: null, null, [], $msg);
        }
        ...
        if (!$class) {
            // no-op
        } elseif (\is_subclass_of($class, \ECSPrefix20210509\Symfony\Contracts\Service\ServiceSubscriberInterface::class)) {
            $msg[] = \sprintf('Unless you need extra laziness, try using dependency injection instead. Otherwise, you need to declare it using "%s::getSubscribedServices()".', \preg_replace('/([^\\\\]++\\\\)++/', '', $class));
        } else {
            $msg[] = 'Try using dependency injection instead.';
        }
        return new \ECSPrefix20210509\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException($id, \end($this->loading) ?: null, null, [], \implode(' ', $msg));
    }
    /**
     * @param string $id
    ...
    {
        $id = (string) $id;
        return new \ECSPrefix20210509\Symfony\Component\DependencyInjection\Exception\ServiceCircularReferenceException($id, $path);
    }
    /**
