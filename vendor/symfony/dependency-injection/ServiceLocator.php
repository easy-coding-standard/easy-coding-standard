 ...
 */
class ServiceLocator implements \ECSPrefix20210507\Symfony\Contracts\Service\ServiceProviderInterface
{
    ...
    private function createNotFoundException($id)
    {
        if ($this->loading) {
            ...
            return new \ECSPrefix20210507\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException($id, \end($this->loading) ?: null, null, [], $msg);
        }
        ...
        if (!$this->container) {
            ...
            try {
                ...
                $class = null;
            } catch (\ECSPrefix20210507\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException $e) {
        ...
        if (!$class) {
            // no-op
        } elseif (\is_subclass_of($class, \ECSPrefix20210507\Symfony\Contracts\Service\ServiceSubscriberInterface::class)) {
            $msg[] = \sprintf('Unless you need extra laziness, try using dependency injection instead. Otherwise, you need to declare it using "%s::getSubscribedServices()".', \preg_replace('/([^\\\\]++\\\\)++/', '', $class));
        } else {
            $msg[] = 'Try using dependency injection instead.';
        }
        return new \ECSPrefix20210507\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException($id, \end($this->loading) ?: null, null, [], \implode(' ', $msg));
    }
    /**
     * @param string $id
    ...
    {
        return new \ECSPrefix20210507\Symfony\Component\DependencyInjection\Exception\ServiceCircularReferenceException($id, $path);
    }
    /**
