    ...
    public function setDeprecated()
    {
        ...
        if ('' !== $message) {
            ...
            if (\strpos($message, '%alias_id%') === \false) {
                throw new \ECSPrefix20211117\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException('The deprecation template must contain the "%alias_id%" placeholder.');
            }
        }
