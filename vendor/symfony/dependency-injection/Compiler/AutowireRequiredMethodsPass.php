 ...
 */
class AutowireRequiredMethodsPass extends \ECSPrefix20211130\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    /**
     * {@inheritdoc}
     * @param mixed $value
    ...
    protected function processValue($value, $isRoot = \false)
    {
        ...
        foreach ($reflectionClass->getMethods() as $reflectionMethod) {
            ...
            while (\true) {
                if ($r->getAttributes(\ECSPrefix20211130\Symfony\Contracts\Service\Attribute\Required::class)) {
