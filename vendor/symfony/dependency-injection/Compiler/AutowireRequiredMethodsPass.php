 ...
 */
class AutowireRequiredMethodsPass extends \ECSPrefix20210624\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    /**
     * {@inheritdoc}
     */
    protected function processValue($value, bool $isRoot = \false)
    {
        ...
        foreach ($reflectionClass->getMethods() as $reflectionMethod) {
            ...
            while (\true) {
                if (\PHP_VERSION_ID >= 80000 && $r->getAttributes(\ECSPrefix20210624\Symfony\Contracts\Service\Attribute\Required::class)) {
