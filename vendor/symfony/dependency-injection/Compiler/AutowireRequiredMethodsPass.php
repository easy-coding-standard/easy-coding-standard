 ...
 */
class AutowireRequiredMethodsPass extends \ECSPrefix20211201\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    /**
     * {@inheritdoc}
     * @param mixed $value
    ...
    protected function processValue($value, $isRoot = \false)
    {
        ...
        foreach ($reflectionClass->getMethods() as $reflectionMethod) {
            ...
            while (\true) {
                if ($r->getAttributes(\ECSPrefix20211201\Symfony\Contracts\Service\Attribute\Required::class)) {
