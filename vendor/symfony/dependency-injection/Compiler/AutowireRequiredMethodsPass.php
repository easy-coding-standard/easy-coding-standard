 ...
 */
class AutowireRequiredMethodsPass extends \ECSPrefix20211021\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    /**
     * {@inheritdoc}
     * @param bool $isRoot
    ...
    protected function processValue($value, $isRoot = \false)
    {
        ...
        foreach ($reflectionClass->getMethods() as $reflectionMethod) {
            ...
            while (\true) {
                if (\PHP_VERSION_ID >= 80000 && $r->getAttributes(\ECSPrefix20211021\Symfony\Contracts\Service\Attribute\Required::class)) {
