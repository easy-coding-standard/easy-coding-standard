 ...
 */
class AutowireRequiredMethodsPass extends \ECSPrefix20220116\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    /**
     * {@inheritdoc}
     * @param mixed $value
    ...
    protected function processValue($value, bool $isRoot = \false)
    {
        ...
        foreach ($reflectionClass->getMethods() as $reflectionMethod) {
            ...
            while (\true) {
                if (\method_exists($r, 'getAttributes') ? $r->getAttributes(\ECSPrefix20220116\Symfony\Contracts\Service\Attribute\Required::class) : []) {
