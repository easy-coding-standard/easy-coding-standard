 ...
 */
class AutowireRequiredMethodsPass extends \ECSPrefix20210710\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    /**
     * {@inheritdoc}
     * @param bool $isRoot
    ...
    protected function processValue($value, $isRoot = \false)
    {
        ...
        foreach ($reflectionClass->getMethods() as $reflectionMethod) {
            ...
            while (\true) {
                if (\PHP_VERSION_ID >= 80000 && $r->getAttributes(\ECSPrefix20210710\Symfony\Contracts\Service\Attribute\Required::class)) {
