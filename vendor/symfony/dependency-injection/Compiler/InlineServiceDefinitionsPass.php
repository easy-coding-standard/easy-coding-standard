 ...
 */
class InlineServiceDefinitionsPass extends \ECSPrefix20210816\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    ...
    private $graph;
    public function __construct(\ECSPrefix20210816\Symfony\Component\DependencyInjection\Compiler\AnalyzeServiceReferencesPass $analyzingPass = null)
    {
    ...
    public function process($container)
    {
        ...
        if ($this->analyzingPass) {
            $analyzedContainer = new \ECSPrefix20210816\Symfony\Component\DependencyInjection\ContainerBuilder();
    ...
    protected function processValue($value, $isRoot = \false)
    {
        ...
        if ($value instanceof \ECSPrefix20210816\Symfony\Component\DependencyInjection\Definition && $this->cloningIds) {
            if ($value->isShared()) {
                return $value;
            }
            $value = clone $value;
        ...
        if (isset($this->cloningIds[$id])) {
            ...
            $ids[] = $id;
            throw new \ECSPrefix20210816\Symfony\Component\DependencyInjection\Exception\ServiceCircularReferenceException($id, \array_slice($ids, \array_search($id, $ids)));
        }
     ...
     */
    private function isInlineableDefinition(string $id, \ECSPrefix20210816\Symfony\Component\DependencyInjection\Definition $definition) : bool
    {
        ...
        if ($srcCount > 1 && \is_array($factory = $definition->getFactory()) && ($factory[0] instanceof \ECSPrefix20210816\Symfony\Component\DependencyInjection\Reference || $factory[0] instanceof \ECSPrefix20210816\Symfony\Component\DependencyInjection\Definition)) {
            return \false;
        }
