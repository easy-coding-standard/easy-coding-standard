 ...
 */
class AnalyzeServiceReferencesPass extends \ECSPrefix20211023\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    private $graph;
    ...
    protected function processValue($value, $isRoot = \false)
    {
        ...
        if ($value instanceof \ECSPrefix20211023\Symfony\Component\DependencyInjection\Argument\ArgumentInterface) {
            $this->lazy = !$this->byFactory || !$value instanceof \ECSPrefix20211023\Symfony\Component\DependencyInjection\Argument\IteratorArgument;
        ...
        if ($value instanceof \ECSPrefix20211023\Symfony\Component\DependencyInjection\Reference) {
            ...
            $this->graph->connect($this->currentId, $this->currentDefinition, $targetId, $targetDefinition, $value, $this->lazy || $this->hasProxyDumper && $targetDefinition && $targetDefinition->isLazy(), \ECSPrefix20211023\Symfony\Component\DependencyInjection\ContainerInterface::IGNORE_ON_UNINITIALIZED_REFERENCE === $value->getInvalidBehavior(), $this->byConstructor);
            if ($inExpression) {
