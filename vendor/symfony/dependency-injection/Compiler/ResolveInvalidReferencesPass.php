 ...
 */
class ResolveInvalidReferencesPass implements \ECSPrefix20220220\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    private $container;
    ...
    public function process(\ECSPrefix20220220\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        ...
        $this->signalingException = new \ECSPrefix20220220\Symfony\Component\DependencyInjection\Exception\RuntimeException('Invalid reference.');
        try {
    ...
    private function processValue($value, int $rootLevel = 0, int $level = 0)
    {
        if ($value instanceof \ECSPrefix20220220\Symfony\Component\DependencyInjection\Argument\ServiceClosureArgument) {
            ...
            if ($currentDefinition->innerServiceId === $id && \ECSPrefix20220220\Symfony\Component\DependencyInjection\ContainerInterface::NULL_ON_INVALID_REFERENCE === $currentDefinition->decorationOnInvalid) {
                return null;
            }
            $invalidBehavior = $value->getInvalidBehavior();
            if (\ECSPrefix20220220\Symfony\Component\DependencyInjection\ContainerInterface::RUNTIME_EXCEPTION_ON_INVALID_REFERENCE === $invalidBehavior && $value instanceof \ECSPrefix20220220\Symfony\Component\DependencyInjection\TypedReference && !$this->container->has($id)) {
                $e = new \ECSPrefix20220220\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException($id, $this->currentId);
                ...
                return new \ECSPrefix20220220\Symfony\Component\DependencyInjection\TypedReference($id, $value->getType(), $value->getInvalidBehavior());
            }
            // resolve invalid behavior
            if (\ECSPrefix20220220\Symfony\Component\DependencyInjection\ContainerInterface::NULL_ON_INVALID_REFERENCE === $invalidBehavior) {
                $value = null;
            } elseif (\ECSPrefix20220220\Symfony\Component\DependencyInjection\ContainerInterface::IGNORE_ON_INVALID_REFERENCE === $invalidBehavior) {
