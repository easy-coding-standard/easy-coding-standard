...
trait PriorityTaggedServiceTrait
{
    ...
    private function findAndSortTaggedServices($tagName, ContainerBuilder $container)
    {
        ...
        foreach ($container->findTaggedServiceIds($tagName, true) as $serviceId => $attributes) {
            ...
            foreach ($attributes as $attribute) {
                ...
                if (null !== $indexAttribute && isset($attribute[$indexAttribute])) {
                    ...
                    $defaultIndex = PriorityTaggedServiceUtil::getDefaultIndex($container, $serviceId, $class, isset($defaultIndexMethod) ? $defaultIndexMethod : 'getDefaultName', $tagName, $indexAttribute);
                }
        ...
        uasort($services, static function ($a, $b) { $battleShipcompare = function ($left, $right) {
            if ($left === $right) {
                return 0;
            }
...
class PriorityTaggedServiceUtil
{
     ...
     */
    public static function getDefaultIndex(ContainerBuilder $container, $serviceId, $class, $defaultIndexMethod, $tagName, $indexAttribute)
    {
     ...
     * @param string $tagName
     */
    public static function getDefaultPriority(ContainerBuilder $container, $serviceId, $class, $defaultPriorityMethod, $tagName)
    {
        $serviceId = (string) $serviceId;
        $class = (string) $class;
