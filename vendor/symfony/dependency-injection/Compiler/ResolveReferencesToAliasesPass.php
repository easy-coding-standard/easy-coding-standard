 ...
 */
class ResolveReferencesToAliasesPass extends \ECSPrefix20210823\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    /**
     * {@inheritdoc}
    ...
    protected function processValue($value, $isRoot = \false)
    {
        ...
        return $defId !== $id ? new \ECSPrefix20210823\Symfony\Component\DependencyInjection\Reference($defId, $value->getInvalidBehavior()) : $value;
    }
    private function getDefinitionId(string $id, \ECSPrefix20210823\Symfony\Component\DependencyInjection\ContainerBuilder $container) : string
    {
        ...
        do {
            if (isset($seen[$id])) {
                throw new \ECSPrefix20210823\Symfony\Component\DependencyInjection\Exception\ServiceCircularReferenceException($id, \array_merge(\array_keys($seen), [$id]));
            }
            $seen[$id] = \true;
