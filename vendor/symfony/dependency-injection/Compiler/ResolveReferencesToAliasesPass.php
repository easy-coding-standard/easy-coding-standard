...
class ResolveReferencesToAliasesPass extends \ECSPrefix20210507\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    ...
    protected function processValue($value, $isRoot = \false)
    {
        ...
        return $defId !== $id ? new \ECSPrefix20210507\Symfony\Component\DependencyInjection\Reference($defId, $value->getInvalidBehavior()) : $value;
    }
    /**
     * @param string $id
     * @param \Symfony\Component\DependencyInjection\ContainerBuilder $container
    ...
    private function getDefinitionId($id, $container)
    {
        ...
        do {
            if (isset($seen[$id])) {
                throw new \ECSPrefix20210507\Symfony\Component\DependencyInjection\Exception\ServiceCircularReferenceException($id, \array_merge(\array_keys($seen), [$id]));
            }
            $seen[$id] = \true;
