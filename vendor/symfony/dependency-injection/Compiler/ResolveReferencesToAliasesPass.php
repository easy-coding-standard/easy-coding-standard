 ...
 */
class ResolveReferencesToAliasesPass extends \ECSPrefix20210515\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    /**
     * {@inheritdoc}
     */
    ...
    protected function processValue($value, $isRoot = \false)
    {
        ...
        return $defId !== $id ? new \ECSPrefix20210515\Symfony\Component\DependencyInjection\Reference($defId, $value->getInvalidBehavior()) : $value;
    }
    /**
     * @param string $id
     * @return string
     */
    private function getDefinitionId($id, \ECSPrefix20210515\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        $id = (string) $id;
        ...
        do {
            if (isset($seen[$id])) {
                throw new \ECSPrefix20210515\Symfony\Component\DependencyInjection\Exception\ServiceCircularReferenceException($id, \array_merge(\array_keys($seen), [$id]));
            }
            $seen[$id] = \true;
