 ...
 */
class ResolveReferencesToAliasesPass extends \ECSPrefix20220416\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    /**
     * {@inheritdoc}
     */
    ...
    protected function processValue($value, bool $isRoot = \false)
    {
        ...
        return $defId !== $id ? new \ECSPrefix20220416\Symfony\Component\DependencyInjection\Reference($defId, $value->getInvalidBehavior()) : $value;
    }
    private function getDefinitionId(string $id, \ECSPrefix20220416\Symfony\Component\DependencyInjection\ContainerBuilder $container) : string
    {
        ...
        do {
            if (isset($seen[$id])) {
                throw new \ECSPrefix20220416\Symfony\Component\DependencyInjection\Exception\ServiceCircularReferenceException($id, \array_merge(\array_keys($seen), [$id]));
            }
            $seen[$id] = \true;
