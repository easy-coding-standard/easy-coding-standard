...
use ECSPrefix20210517\Symfony\Component\DependencyInjection\Exception\ExceptionInterface;
...
class ResolveChildDefinitionsPass extends \ECSPrefix20210517\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    ...
    protected function processValue($value, $isRoot = \false)
    {
        ...
        if ($value instanceof \ECSPrefix20210517\Symfony\Component\DependencyInjection\ChildDefinition) {
            $this->currentPath = [];
    ...
    private function resolveDefinition(\ECSPrefix20210517\Symfony\Component\DependencyInjection\ChildDefinition $definition)
    {
        try {
            ...
            throw $e;
        } catch (\ECSPrefix20210517\Symfony\Component\DependencyInjection\Exception\ExceptionInterface $e) {
    ...
    private function doResolveDefinition(\ECSPrefix20210517\Symfony\Component\DependencyInjection\ChildDefinition $definition)
    {
        ...
        if (\false !== $searchKey) {
            throw new \ECSPrefix20210517\Symfony\Component\DependencyInjection\Exception\ServiceCircularReferenceException($parent, \array_slice($this->currentPath, $searchKey));
        }
        $parentDef = $this->container->findDefinition($parent);
        if ($parentDef instanceof \ECSPrefix20210517\Symfony\Component\DependencyInjection\ChildDefinition) {
            $id = $this->currentId;
        ...
        $def = new \ECSPrefix20210517\Symfony\Component\DependencyInjection\Definition();
