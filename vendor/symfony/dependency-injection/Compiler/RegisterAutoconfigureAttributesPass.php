...
use ECSPrefix20210823\Symfony\Component\DependencyInjection\Attribute\Autoconfigure;
...
use ECSPrefix20210823\Symfony\Component\DependencyInjection\Loader\YamlFileLoader;
/**
 ...
 */
final class RegisterAutoconfigureAttributesPass implements \ECSPrefix20210823\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    ...
    {
        foreach ($class->getAttributes(\ECSPrefix20210823\Symfony\Component\DependencyInjection\Attribute\Autoconfigure::class, \ReflectionAttribute::IS_INSTANCEOF) as $attribute) {
            self::registerForAutoconfiguration($container, $class, $attribute);
        }
    }
    private static function registerForAutoconfiguration(\ECSPrefix20210823\Symfony\Component\DependencyInjection\ContainerBuilder $container, \ReflectionClass $class, \ReflectionAttribute $attribute)
    {
        if (self::$registerForAutoconfiguration) {
            return (self::$registerForAutoconfiguration)($container, $class, $attribute);
        }
        $parseDefinitions = new \ReflectionMethod(\ECSPrefix20210823\Symfony\Component\DependencyInjection\Loader\YamlFileLoader::class, 'parseDefinitions');
        $parseDefinitions->setAccessible(\true);
        $yamlLoader = $parseDefinitions->getDeclaringClass()->newInstanceWithoutConstructor();
        self::$registerForAutoconfiguration = static function (\ECSPrefix20210823\Symfony\Component\DependencyInjection\ContainerBuilder $container, \ReflectionClass $class, \ReflectionAttribute $attribute) use($parseDefinitions, $yamlLoader) {
