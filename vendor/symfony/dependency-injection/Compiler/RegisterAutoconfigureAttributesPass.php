...
use ECSPrefix20211208\Symfony\Component\DependencyInjection\Attribute\Autoconfigure;
...
use ECSPrefix20211208\Symfony\Component\DependencyInjection\Loader\YamlFileLoader;
/**
 ...
 */
final class RegisterAutoconfigureAttributesPass implements \ECSPrefix20211208\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    ...
    private static function registerForAutoconfiguration(\ECSPrefix20211208\Symfony\Component\DependencyInjection\ContainerBuilder $container, \ReflectionClass $class, \ReflectionAttribute $attribute)
    {
        if (self::$registerForAutoconfiguration) {
            return (self::$registerForAutoconfiguration)($container, $class, $attribute);
        }
        $parseDefinitions = new \ReflectionMethod(\ECSPrefix20211208\Symfony\Component\DependencyInjection\Loader\YamlFileLoader::class, 'parseDefinitions');
        $parseDefinitions->setAccessible(\true);
        $yamlLoader = $parseDefinitions->getDeclaringClass()->newInstanceWithoutConstructor();
        self::$registerForAutoconfiguration = static function (\ECSPrefix20211208\Symfony\Component\DependencyInjection\ContainerBuilder $container, \ReflectionClass $class, \ReflectionAttribute $attribute) use($parseDefinitions, $yamlLoader) {
