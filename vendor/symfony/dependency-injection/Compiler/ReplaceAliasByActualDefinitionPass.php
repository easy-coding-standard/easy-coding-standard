 ...
 */
class ReplaceAliasByActualDefinitionPass extends \ECSPrefix20210612\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
        ...
        foreach ($container->getAliases() as $definitionId => $target) {
            ...
            try {
                ...
                if ('' !== $e->getId() && '@' === $e->getId()[0]) {
                    throw new \ECSPrefix20210612\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException($e->getId(), $e->getSourceId(), null, [\substr($e->getId(), 1)]);
                }
                throw $e;
            }
    ...
    {
        if ($value instanceof \ECSPrefix20210612\Symfony\Component\DependencyInjection\Reference && isset($this->replacements[$referenceId = (string) $value])) {
            // Perform the replacement
            $newId = $this->replacements[$referenceId];
            $value = new \ECSPrefix20210612\Symfony\Component\DependencyInjection\Reference($newId, $value->getInvalidBehavior());
