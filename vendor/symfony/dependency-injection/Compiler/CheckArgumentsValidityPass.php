 ...
 */
class CheckArgumentsValidityPass extends \ECSPrefix20211124\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
            ...
            if ($k !== $i++) {
                if (!\is_int($k)) {
                    ...
                    if ($this->throwExceptions) {
                        throw new \ECSPrefix20211124\Symfony\Component\DependencyInjection\Exception\RuntimeException($msg);
                    }
                    break;
                }
