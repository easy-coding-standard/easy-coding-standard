 ...
 */
class CheckArgumentsValidityPass extends \ECSPrefix20220602\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    /**
     * @var bool
     */
            ...
            if ($k !== $i++) {
                if (!\is_int($k)) {
                    ...
                    if ($this->throwExceptions) {
                        throw new \ECSPrefix20220602\Symfony\Component\DependencyInjection\Exception\RuntimeException($msg);
                    }
                    break;
                }
