...
class Compiler
{
    ...
    {
        $this->passConfig = new \ECSPrefix20210517\Symfony\Component\DependencyInjection\Compiler\PassConfig();
        $this->serviceReferenceGraph = new \ECSPrefix20210517\Symfony\Component\DependencyInjection\Compiler\ServiceReferenceGraph();
    }
    /**
     ...
     */
    public function compile(\ECSPrefix20210517\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        try {
            ...
            if ($usedEnvs) {
                $e = new \ECSPrefix20210517\Symfony\Component\DependencyInjection\Exception\EnvParameterException($usedEnvs, $e);
            }
            throw $e;
        } finally {
