...
class AutowirePass extends AbstractRecursivePass
{
     ...
     * @param string $id
     */
    private function populateAvailableType(ContainerBuilder $container, $id, Definition $definition)
    {
        $id = (string) $id;
     ...
     * @return string
     */
    private function createTypeNotFoundMessage(TypedReference $reference, $label, $currentId)
    {
        $label = (string) $label;
     ...
     * @param string $type
     */
    private function getAliasesSuggestionForType(ContainerBuilder $container, $type)
    {
        $type = (string) $type;
        $aliases = [];
