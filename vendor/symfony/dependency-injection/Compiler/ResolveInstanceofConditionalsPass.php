 ...
 */
class ResolveInstanceofConditionalsPass implements \ECSPrefix20211223\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    /**
     * {@inheritdoc}
     */
    public function process(\ECSPrefix20211223\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        foreach ($container->getAutoconfiguredInstanceof() as $interface => $definition) {
            if ($definition->getArguments()) {
                throw new \ECSPrefix20211223\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException(\sprintf('Autoconfigured instanceof for type "%s" defines arguments but these are not supported and should be removed.', $interface));
            }
        }
        $tagsToKeep = [];
    ...
    private function processDefinition(\ECSPrefix20211223\Symfony\Component\DependencyInjection\ContainerBuilder $container, string $id, \ECSPrefix20211223\Symfony\Component\DependencyInjection\Definition $definition, array $tagsToKeep) : \ECSPrefix20211223\Symfony\Component\DependencyInjection\Definition
    {
        ...
        $parent = $definition instanceof \ECSPrefix20211223\Symfony\Component\DependencyInjection\ChildDefinition ? $definition->getParent() : null;
        ...
        if ($parent) {
            ...
            if (\ECSPrefix20211223\Symfony\Component\DependencyInjection\Definition::class === \get_class($abstract)) {
    ...
    private function mergeConditionals(array $autoconfiguredInstanceof, array $instanceofConditionals, \ECSPrefix20211223\Symfony\Component\DependencyInjection\ContainerBuilder $container) : array
    {
        ...
        foreach ($instanceofConditionals as $interface => $instanceofDef) {
            ...
            if (!$container->getReflectionClass($interface)) {
                throw new \ECSPrefix20211223\Symfony\Component\DependencyInjection\Exception\RuntimeException(\sprintf('"%s" is set as an "instanceof" conditional, but it does not exist.', $interface));
            }
