 ...
 */
class CheckCircularReferencesPass implements \ECSPrefix20211130\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    /**
     * @var mixed[]
     */
        ...
        foreach ($edges as $edge) {
            ...
            if (empty($this->checkedNodes[$id])) {
                ...
                if (!$node->getValue() || !$edge->isLazy() && !$edge->isWeak()) {
                    ...
                    $this->currentPath[] = $id;
                    if (\false !== $searchKey) {
                        throw new \ECSPrefix20211130\Symfony\Component\DependencyInjection\Exception\ServiceCircularReferenceException($id, \array_slice($this->currentPath, $searchKey));
                    }
                    $this->checkOutEdges($node->getOutEdges());
                }
