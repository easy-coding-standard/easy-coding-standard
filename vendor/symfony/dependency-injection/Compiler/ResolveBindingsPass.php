 ...
 */
class ResolveBindingsPass extends \ECSPrefix20220607\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    /**
     * @var mixed[]
     */
    ...
    public function process(\ECSPrefix20220607\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        ...
        try {
            ...
            foreach ($this->unusedBindings as [$key, $serviceId, $bindingType, $file]) {
                ...
                if (\ECSPrefix20220607\Symfony\Component\DependencyInjection\Argument\BoundArgument::DEFAULTS_BINDING === $bindingType) {
                    $message .= 'under "_defaults"';
                } elseif (\ECSPrefix20220607\Symfony\Component\DependencyInjection\Argument\BoundArgument::INSTANCEOF_BINDING === $bindingType) {
                ...
                throw new \ECSPrefix20220607\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException($message);
            }
        } finally {
            $this->usedBindings = [];
            $this->unusedBindings = [];
    ...
    {
        if ($value instanceof \ECSPrefix20220607\Symfony\Component\DependencyInjection\TypedReference && $value->getType() === (string) $value) {
            // Already checked
        ...
        if (!$value instanceof \ECSPrefix20220607\Symfony\Component\DependencyInjection\Definition || !($bindings = $value->getBindings())) {
            return parent::processValue($value, $isRoot);
        }
        $bindingNames = [];
        foreach ($bindings as $key => $binding) {
            ...
            if (\is_subclass_of($m[1], \ECSPrefix20220607\UnitEnum::class)) {
                $bindingNames[\substr($key, \strlen($m[0]))] = $binding;
                continue;
            }
            if (null !== $bindingValue && !$bindingValue instanceof \ECSPrefix20220607\Symfony\Component\DependencyInjection\Reference && !$bindingValue instanceof \ECSPrefix20220607\Symfony\Component\DependencyInjection\Definition && !$bindingValue instanceof \ECSPrefix20220607\Symfony\Component\DependencyInjection\Argument\TaggedIteratorArgument && !$bindingValue instanceof \ECSPrefix20220607\Symfony\Component\DependencyInjection\Argument\ServiceLocatorArgument) {
                throw new \ECSPrefix20220607\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException(\sprintf('Invalid value for binding key "%s" for service "%s": expected "%s", "%s", "%s", "%s" or null, "%s" given.', $key, $this->currentId, \ECSPrefix20220607\Symfony\Component\DependencyInjection\Reference::class, \ECSPrefix20220607\Symfony\Component\DependencyInjection\Definition::class, \ECSPrefix20220607\Symfony\Component\DependencyInjection\Argument\TaggedIteratorArgument::class, \ECSPrefix20220607\Symfony\Component\DependencyInjection\Argument\ServiceLocatorArgument::class, \get_debug_type($bindingValue)));
            }
        }
        if ($value->isAbstract()) {
            return parent::processValue($value, $isRoot);
        ...
        foreach ($calls as $i => $call) {
            ...
            foreach ($reflectionMethod->getParameters() as $key => $parameter) {
                ...
                $typeHint = \ECSPrefix20220607\Symfony\Component\DependencyInjection\LazyProxy\ProxyHelper::getTypeHint($reflectionMethod, $parameter);
                $name = \ECSPrefix20220607\Symfony\Component\DependencyInjection\Attribute\Target::parseName($parameter);
     ...
     * @return mixed
     */
    private function getBindingValue(\ECSPrefix20220607\Symfony\Component\DependencyInjection\Argument\BoundArgument $binding)
    {
