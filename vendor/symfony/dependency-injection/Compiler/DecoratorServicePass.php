 ...
 */
class DecoratorServicePass extends \ECSPrefix20211130\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    /**
    ...
    public function process($container)
    {
        ...
        foreach ($definitions as [$id, $definition]) {
            ...
            $invalidBehavior = $decoratedService[3] ?? \ECSPrefix20211130\Symfony\Component\DependencyInjection\ContainerInterface::EXCEPTION_ON_INVALID_REFERENCE;
            ...
            if ($container->hasAlias($inner)) {
                ...
                $container->setAlias($renamedId, new \ECSPrefix20211130\Symfony\Component\DependencyInjection\Alias((string) $alias, \false));
                ...
                continue;
            } elseif (\ECSPrefix20211130\Symfony\Component\DependencyInjection\ContainerInterface::NULL_ON_INVALID_REFERENCE === $invalidBehavior) {
                $public = $definition->isPublic();
                $decoratedDefinition = null;
            } else {
                throw new \ECSPrefix20211130\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException($inner, $id);
            }
            if ($decoratedDefinition && $decoratedDefinition->isSynthetic()) {
                throw new \ECSPrefix20211130\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException(\sprintf('A synthetic service cannot be decorated: service "%s" cannot decorate "%s".', $id, $inner));
            }
    ...
    {
        if ($value instanceof \ECSPrefix20211130\Symfony\Component\DependencyInjection\Reference && '.inner' === (string) $value) {
            return new \ECSPrefix20211130\Symfony\Component\DependencyInjection\Reference($this->currentId, $value->getInvalidBehavior());
        }
