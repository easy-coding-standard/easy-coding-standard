 ...
 */
class DecoratorServicePass extends \ECSPrefix20210511\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    ...
    public function process(\ECSPrefix20210511\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        ...
        foreach ($definitions as list($id, $definition)) {
            ...
            $invalidBehavior = isset($decoratedService[3]) ? $decoratedService[3] : \ECSPrefix20210511\Symfony\Component\DependencyInjection\ContainerInterface::EXCEPTION_ON_INVALID_REFERENCE;
            ...
            if ($container->hasAlias($inner)) {
                ...
                $container->setAlias($renamedId, new \ECSPrefix20210511\Symfony\Component\DependencyInjection\Alias((string) $alias, \false));
                ...
                continue;
            } elseif (\ECSPrefix20210511\Symfony\Component\DependencyInjection\ContainerInterface::NULL_ON_INVALID_REFERENCE === $invalidBehavior) {
                $public = $definition->isPublic();
                $private = $definition->isPrivate();
            } else {
                throw new \ECSPrefix20210511\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException($inner, $id);
            }
    ...
    {
        $isRoot = (bool) $isRoot;
        if ($value instanceof \ECSPrefix20210511\Symfony\Component\DependencyInjection\Reference && $this->innerId === (string) $value) {
            return new \ECSPrefix20210511\Symfony\Component\DependencyInjection\Reference($this->currentId, $value->getInvalidBehavior());
        }
