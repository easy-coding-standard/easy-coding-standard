...
class ServiceReferenceGraph
{
    ...
    public function getNode($id)
    {
        ...
        if (!isset($this->nodes[$id])) {
            throw new \ECSPrefix20210511\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException(\sprintf('There is no node with id "%s".', $id));
        }
    ...
    public function connect($sourceId, $sourceValue, $destId, $destValue = null, $reference = null, $lazy = \false, $weak = \false, $byConstructor = \false)
    {
        ...
        $edge = new \ECSPrefix20210511\Symfony\Component\DependencyInjection\Compiler\ServiceReferenceGraphEdge($sourceNode, $destNode, $reference, $lazy, $weak, $byConstructor);
    ...
    private function createNode($id, $value)
    {
        ...
        return $this->nodes[$id] = new \ECSPrefix20210511\Symfony\Component\DependencyInjection\Compiler\ServiceReferenceGraphNode($id, $value);
    }
}
