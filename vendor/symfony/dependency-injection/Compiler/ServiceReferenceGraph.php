...
class ServiceReferenceGraph
{
    ...
    public function connect($sourceId, $sourceValue, $destId, $destValue = null, $reference = null, $lazy = \false, $weak = \false, $byConstructor = \false)
    {
        ...
        $edge = new \ECSPrefix20210508\Symfony\Component\DependencyInjection\Compiler\ServiceReferenceGraphEdge($sourceNode, $destNode, $reference, $lazy, $weak, $byConstructor);
    ...
    private function createNode($id, $value)
    {
        ...
        return $this->nodes[$id] = new \ECSPrefix20210508\Symfony\Component\DependencyInjection\Compiler\ServiceReferenceGraphNode($id, $value);
    }
}
