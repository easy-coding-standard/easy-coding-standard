 ...
 */
class ResolveHotPathPass extends \ECSPrefix20220517\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    /**
     * @var mixed[]
     */
    ...
    {
        if ($value instanceof \ECSPrefix20220517\Symfony\Component\DependencyInjection\Argument\ArgumentInterface) {
            return $value;
        }
        if ($value instanceof \ECSPrefix20220517\Symfony\Component\DependencyInjection\Definition && $isRoot) {
        ...
        if ($value instanceof \ECSPrefix20220517\Symfony\Component\DependencyInjection\Reference && \ECSPrefix20220517\Symfony\Component\DependencyInjection\ContainerBuilder::IGNORE_ON_UNINITIALIZED_REFERENCE !== $value->getInvalidBehavior() && $this->container->hasDefinition($id = (string) $value)) {
