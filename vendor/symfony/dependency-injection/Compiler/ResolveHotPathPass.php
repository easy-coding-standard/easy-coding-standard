 ...
 */
class ResolveHotPathPass extends \ECSPrefix20210511\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    private $tagName;
    private $resolvedIds = [];
    /**
    ...
    {
        $isRoot = (bool) $isRoot;
        if ($value instanceof \ECSPrefix20210511\Symfony\Component\DependencyInjection\Argument\ArgumentInterface) {
            return $value;
        }
        if ($value instanceof \ECSPrefix20210511\Symfony\Component\DependencyInjection\Definition && $isRoot) {
        ...
        if ($value instanceof \ECSPrefix20210511\Symfony\Component\DependencyInjection\Reference && \ECSPrefix20210511\Symfony\Component\DependencyInjection\ContainerBuilder::IGNORE_ON_UNINITIALIZED_REFERENCE !== $value->getInvalidBehavior() && $this->container->hasDefinition($id = (string) $value)) {
