 ...
 */
class ByteString extends \ECSPrefix20210508\Symfony\Component\String\AbstractString
{
    ...
    public static function fromRandom($length = 16, $alphabet = null)
    {
        ...
        if ($bits <= 0 || $bits > 56) {
            throw new \ECSPrefix20210508\Symfony\Component\String\Exception\InvalidArgumentException('The length of the alphabet must in the [2^1, 2^56] range.');
        }
        $ret = '';
        while ($length > 0) {
    ...
    public function snake()
    {
        ...
        $str->string = \strtolower(\preg_replace(['/([A-Z]+)([A-Z][a-z])/', '/([a-z\\d])([A-Z])/'], 'ECSPrefix20210508\\1_\\2', $str->string));
        return $str;
    }
    /**
    ...
    {
        $u = new \ECSPrefix20210508\Symfony\Component\String\CodePointString();
        ...
        if (!$validEncoding) {
            throw new \ECSPrefix20210508\Symfony\Component\String\Exception\InvalidArgumentException(\sprintf('Invalid "%s" string.', isset($fromEncoding) ? $fromEncoding : 'Windows-1252'));
        }
