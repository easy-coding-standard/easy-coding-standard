 ...
 */
class CodePointString extends \ECSPrefix20210516\Symfony\Component\String\AbstractUnicodeString
{
    /**
     * @param string $string
     */
    ...
    {
        if ($suffix instanceof \ECSPrefix20210516\Symfony\Component\String\AbstractString) {
    ...
    {
        if ($string instanceof \ECSPrefix20210516\Symfony\Component\String\AbstractString) {
            $string = $string->string;
    ...
    {
        $offset = (int) $offset;
        if ($needle instanceof \ECSPrefix20210516\Symfony\Component\String\AbstractString) {
    ...
    public function split($delimiter, $limit = null, $flags = null)
    {
        ...
        if (!\preg_match('//u', $delimiter)) {
            throw new \ECSPrefix20210516\Symfony\Component\String\Exception\InvalidArgumentException('Split delimiter is not a valid UTF-8 string.');
        }
        $str = clone $this;
    ...
    {
        if ($prefix instanceof \ECSPrefix20210516\Symfony\Component\String\AbstractString) {
