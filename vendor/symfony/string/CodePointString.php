 ...
 */
class CodePointString extends \ECSPrefix20211202\Symfony\Component\String\AbstractUnicodeString
{
    ...
    public function split($delimiter, $limit = null, $flags = null) : array
    {
        ...
        if (!\preg_match('//u', $delimiter)) {
            throw new \ECSPrefix20211202\Symfony\Component\String\Exception\InvalidArgumentException('Split delimiter is not a valid UTF-8 string.');
        }
        $str = clone $this;
