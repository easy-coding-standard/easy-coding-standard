 ...
 */
class CodePointString extends \ECSPrefix20220520\Symfony\Component\String\AbstractUnicodeString
{
    ...
    public function split(string $delimiter, int $limit = null, int $flags = null) : array
    {
        ...
        if (!\preg_match('//u', $delimiter)) {
            throw new \ECSPrefix20220520\Symfony\Component\String\Exception\InvalidArgumentException('Split delimiter is not a valid UTF-8 string.');
        }
        $str = clone $this;
