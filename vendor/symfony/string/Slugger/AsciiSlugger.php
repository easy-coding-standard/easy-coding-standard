 ...
 */
namespace ECSPrefix20210820\Symfony\Component\String\Slugger;

use ECSPrefix20210820\Symfony\Component\String\AbstractUnicodeString;
use ECSPrefix20210820\Symfony\Component\String\UnicodeString;
use ECSPrefix20210820\Symfony\Contracts\Translation\LocaleAwareInterface;
if (!\interface_exists(\ECSPrefix20210820\Symfony\Contracts\Translation\LocaleAwareInterface::class)) {
    throw new \LogicException('You cannot use the "Symfony\\Component\\String\\Slugger\\AsciiSlugger" as the "symfony/translation-contracts" package is not installed. Try running "composer require symfony/translation-contracts".');
}
/**
 * @author Titouan Galopin <galopintitouan@gmail.com>
 */
class AsciiSlugger implements \ECSPrefix20210820\Symfony\Component\String\Slugger\SluggerInterface, \ECSPrefix20210820\Symfony\Contracts\Translation\LocaleAwareInterface
{
     ...
     */
    public function slug($string, $separator = '-', $locale = null) : \ECSPrefix20210820\Symfony\Component\String\AbstractUnicodeString
    {
        ...
        $unicodeString = (new \ECSPrefix20210820\Symfony\Component\String\UnicodeString($string))->ascii($transliterator);
