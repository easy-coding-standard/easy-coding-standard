 ...
 */
namespace ConfigTransformer20210601\Symfony\Component\String\Slugger;

use ConfigTransformer20210601\Symfony\Component\String\AbstractUnicodeString;
use ConfigTransformer20210601\Symfony\Component\String\UnicodeString;
use ConfigTransformer20210601\Symfony\Contracts\Translation\LocaleAwareInterface;
if (!\interface_exists(\ConfigTransformer20210601\Symfony\Contracts\Translation\LocaleAwareInterface::class)) {
    throw new \LogicException('You cannot use the "Symfony\\Component\\String\\Slugger\\AsciiSlugger" as the "symfony/translation-contracts" package is not installed. Try running "composer require symfony/translation-contracts".');
}
/**
 * @author Titouan Galopin <galopintitouan@gmail.com>
 */
class AsciiSlugger implements \ConfigTransformer20210601\Symfony\Component\String\Slugger\SluggerInterface, \ConfigTransformer20210601\Symfony\Contracts\Translation\LocaleAwareInterface
{
     ...
     * {@inheritdoc}
     */
    public function slug(string $string, string $separator = '-', string $locale = null) : \ConfigTransformer20210601\Symfony\Component\String\AbstractUnicodeString
    {
        ...
        $unicodeString = (new \ConfigTransformer20210601\Symfony\Component\String\UnicodeString($string))->ascii($transliterator);
