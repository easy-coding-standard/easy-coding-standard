 ...
 */
namespace ECSPrefix20211121\Symfony\Component\String\Slugger;

use ECSPrefix20211121\Symfony\Component\String\AbstractUnicodeString;
use ECSPrefix20211121\Symfony\Component\String\UnicodeString;
use ECSPrefix20211121\Symfony\Contracts\Translation\LocaleAwareInterface;
if (!\interface_exists(\ECSPrefix20211121\Symfony\Contracts\Translation\LocaleAwareInterface::class)) {
    throw new \LogicException('You cannot use the "Symfony\\Component\\String\\Slugger\\AsciiSlugger" as the "symfony/translation-contracts" package is not installed. Try running "composer require symfony/translation-contracts".');
}
/**
 * @author Titouan Galopin <galopintitouan@gmail.com>
 */
class AsciiSlugger implements \ECSPrefix20211121\Symfony\Component\String\Slugger\SluggerInterface, \ECSPrefix20211121\Symfony\Contracts\Translation\LocaleAwareInterface
{
     ...
     */
    public function slug($string, $separator = '-', $locale = null) : \ECSPrefix20211121\Symfony\Component\String\AbstractUnicodeString
    {
        ...
        $unicodeString = (new \ECSPrefix20211121\Symfony\Component\String\UnicodeString($string))->ascii($transliterator);
