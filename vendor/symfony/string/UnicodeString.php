 ...
 */
class UnicodeString extends \ECSPrefix20210623\Symfony\Component\String\AbstractUnicodeString
{
    ...
    public function append(string ...$suffix) : \ECSPrefix20210623\Symfony\Component\String\AbstractString
    {
        $str = clone $this;
    ...
    {
        if (1 > $length) {
            throw new \ECSPrefix20210623\Symfony\Component\String\Exception\InvalidArgumentException('The chunk length must be greater than zero.');
        }
        if ('' === $this->string) {
            return [];
        }
    ...
    {
        if ($suffix instanceof \ECSPrefix20210623\Symfony\Component\String\AbstractString) {
    ...
    {
        if ($string instanceof \ECSPrefix20210623\Symfony\Component\String\AbstractString) {
    ...
    {
        if ($needle instanceof \ECSPrefix20210623\Symfony\Component\String\AbstractString) {
    ...
    public function join(array $strings, string $lastGlue = null) : \ECSPrefix20210623\Symfony\Component\String\AbstractString
    {
    ...
    public function prepend(string ...$prefix) : \ECSPrefix20210623\Symfony\Component\String\AbstractString
    {
        $str = clone $this;
    ...
    public function replace(string $from, string $to) : \ECSPrefix20210623\Symfony\Component\String\AbstractString
    {
        $str = clone $this;
    ...
    public function replaceMatches(string $fromRegexp, $to) : \ECSPrefix20210623\Symfony\Component\String\AbstractString
    {
        $str = parent::replaceMatches($fromRegexp, $to);
        \normalizer_is_normalized($str->string) ?: ($str->string = \normalizer_normalize($str->string));
        return $str;
    }
    public function slice(int $start = 0, int $length = null) : \ECSPrefix20210623\Symfony\Component\String\AbstractString
    {
        $str = clone $this;
    ...
    public function splice(string $replacement, int $start = 0, int $length = null) : \ECSPrefix20210623\Symfony\Component\String\AbstractString
    {
        $str = clone $this;
        if (\PHP_VERSION_ID < 80000 && 0 > $start && \grapheme_strlen($this->string) < -$start) {
            $start = 0;
    ...
    public function split(string $delimiter, int $limit = null, int $flags = null) : array
    {
        if (1 > ($limit = $limit ?? 2147483647)) {
            throw new \ECSPrefix20210623\Symfony\Component\String\Exception\InvalidArgumentException('Split limit must be a positive integer.');
        }
        if ('' === $delimiter) {
            throw new \ECSPrefix20210623\Symfony\Component\String\Exception\InvalidArgumentException('Split delimiter is empty.');
        }
        if (null !== $flags) {
        ...
        if (\false === $delimiter) {
            throw new \ECSPrefix20210623\Symfony\Component\String\Exception\InvalidArgumentException('Split delimiter is not a valid UTF-8 string.');
        }
        $str = clone $this;
        $tail = $this->string;
        $chunks = [];
    ...
    {
        if ($prefix instanceof \ECSPrefix20210623\Symfony\Component\String\AbstractString) {
