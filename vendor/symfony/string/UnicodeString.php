 ...
 */
class UnicodeString extends \ECSPrefix20211111\Symfony\Component\String\AbstractUnicodeString
{
     ...
     * @param string ...$suffix
     */
    public function append(...$suffix) : \ECSPrefix20211111\Symfony\Component\String\AbstractString
    {
        $str = clone $this;
    ...
    {
        if (1 > $length) {
            throw new \ECSPrefix20211111\Symfony\Component\String\Exception\InvalidArgumentException('The chunk length must be greater than zero.');
        }
        if ('' === $this->string) {
            return [];
        }
    ...
    {
        if ($suffix instanceof \ECSPrefix20211111\Symfony\Component\String\AbstractString) {
    ...
    {
        if ($string instanceof \ECSPrefix20211111\Symfony\Component\String\AbstractString) {
    ...
    {
        if ($needle instanceof \ECSPrefix20211111\Symfony\Component\String\AbstractString) {
     ...
     */
    public function join($strings, $lastGlue = null) : \ECSPrefix20211111\Symfony\Component\String\AbstractString
    {
     ...
     * @param string ...$prefix
     */
    public function prepend(...$prefix) : \ECSPrefix20211111\Symfony\Component\String\AbstractString
    {
        $str = clone $this;
     ...
     * @param string $to
     */
    public function replace($from, $to) : \ECSPrefix20211111\Symfony\Component\String\AbstractString
    {
        $str = clone $this;
     ...
     */
    public function replaceMatches($fromRegexp, $to) : \ECSPrefix20211111\Symfony\Component\String\AbstractString
    {
     ...
     */
    public function slice($start = 0, $length = null) : \ECSPrefix20211111\Symfony\Component\String\AbstractString
    {
        $str = clone $this;
     ...
     * @param int|null $length
     */
    public function splice($replacement, $start = 0, $length = null) : \ECSPrefix20211111\Symfony\Component\String\AbstractString
    {
        $str = clone $this;
        if (\PHP_VERSION_ID < 80000 && 0 > $start && \grapheme_strlen($this->string) < -$start) {
            $start = 0;
    ...
    public function split($delimiter, $limit = null, $flags = null) : array
    {
        if (1 > ($limit = $limit ?? 2147483647)) {
            throw new \ECSPrefix20211111\Symfony\Component\String\Exception\InvalidArgumentException('Split limit must be a positive integer.');
        }
        if ('' === $delimiter) {
            throw new \ECSPrefix20211111\Symfony\Component\String\Exception\InvalidArgumentException('Split delimiter is empty.');
        }
        if (null !== $flags) {
        ...
        if (\false === $delimiter) {
            throw new \ECSPrefix20211111\Symfony\Component\String\Exception\InvalidArgumentException('Split delimiter is not a valid UTF-8 string.');
        }
        $str = clone $this;
        $tail = $this->string;
        $chunks = [];
    ...
    {
        if ($prefix instanceof \ECSPrefix20211111\Symfony\Component\String\AbstractString) {
