...
abstract class AbstractString implements \Stringable, \JsonSerializable
{
    ...
    public function repeat($multiplier)
    {
        ...
        if (0 > $multiplier) {
            throw new \ECSPrefix20210516\Symfony\Component\String\Exception\InvalidArgumentException(\sprintf('Multiplier must be positive, %d given.', $multiplier));
        }
        $str = clone $this;
            ...
            if (\false === ($chunks = \preg_split($delimiter, $this->string, $limit, $flags))) {
                ...
                foreach (\get_defined_constants(\true)['pcre'] as $k => $v) {
                    if ($lastError === $v && '_ERROR' === \substr($k, -6)) {
                        throw new \ECSPrefix20210516\Symfony\Component\String\Exception\RuntimeException('Splitting failed with ' . $k . '.');
                    }
                }
                throw new \ECSPrefix20210516\Symfony\Component\String\Exception\RuntimeException('Splitting failed with unknown error code.');
            }
        } finally {
    ...
    {
        $b = new \ECSPrefix20210516\Symfony\Component\String\ByteString();
        $toEncoding = \in_array($toEncoding, ['utf8', 'utf-8', 'UTF8'], \true) ? 'UTF-8' : $toEncoding;
        if (null === $toEncoding || $toEncoding === ($fromEncoding = $this instanceof \ECSPrefix20210516\Symfony\Component\String\AbstractUnicodeString || \preg_match('//u', $b->string) ? 'UTF-8' : 'Windows-1252')) {
    ...
    {
        return new \ECSPrefix20210516\Symfony\Component\String\CodePointString($this->string);
    }
    /**
     * @return string
     */
    ...
    {
        return new \ECSPrefix20210516\Symfony\Component\String\UnicodeString($this->string);
    }
    /**
     * @return static
     * @param string $chars
