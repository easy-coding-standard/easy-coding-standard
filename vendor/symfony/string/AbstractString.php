...
abstract class AbstractString implements \JsonSerializable
{
    ...
    {
        if (0 > $multiplier) {
            throw new \ECSPrefix20220117\Symfony\Component\String\Exception\InvalidArgumentException(\sprintf('Multiplier must be positive, %d given.', $multiplier));
        }
        $str = clone $this;
            ...
            if (\false === ($chunks = \preg_split($delimiter, $this->string, $limit, $flags))) {
                ...
                foreach (\get_defined_constants(\true)['pcre'] as $k => $v) {
                    if ($lastError === $v && '_ERROR' === \substr($k, -6)) {
                        throw new \ECSPrefix20220117\Symfony\Component\String\Exception\RuntimeException('Splitting failed with ' . $k . '.');
                    }
                }
                throw new \ECSPrefix20220117\Symfony\Component\String\Exception\RuntimeException('Splitting failed with unknown error code.');
            }
        } finally {
    ...
    public function toByteString(string $toEncoding = null) : \ECSPrefix20220117\Symfony\Component\String\ByteString
    {
        $b = new \ECSPrefix20220117\Symfony\Component\String\ByteString();
        $toEncoding = \in_array($toEncoding, ['utf8', 'utf-8', 'UTF8'], \true) ? 'UTF-8' : $toEncoding;
        if (null === $toEncoding || $toEncoding === ($fromEncoding = $this instanceof \ECSPrefix20220117\Symfony\Component\String\AbstractUnicodeString || \preg_match('//u', $b->string) ? 'UTF-8' : 'Windows-1252')) {
    ...
    public function toCodePointString() : \ECSPrefix20220117\Symfony\Component\String\CodePointString
    {
        return new \ECSPrefix20220117\Symfony\Component\String\CodePointString($this->string);
    }
    public function toString() : string
    {
        return $this->string;
    }
    public function toUnicodeString() : \ECSPrefix20220117\Symfony\Component\String\UnicodeString
    {
        return new \ECSPrefix20220117\Symfony\Component\String\UnicodeString($this->string);
    }
    /**
     * @return $this
     */
