...
use Event;
use EventBase;
use ECSPrefix20220607\React\EventLoop\Tick\FutureTickQueue;
use ECSPrefix20220607\React\EventLoop\Timer\Timer;
 ...
 */
final class ExtLibeventLoop implements \ECSPrefix20220607\React\EventLoop\LoopInterface
{
    /** @internal */
     ...
     */
    private function scheduleTimer(\ECSPrefix20220607\React\EventLoop\TimerInterface $timer)
    {
    ...
    private function createTimerCallback()
    {
        ...
        $this->timerCallback = function ($_, $__, $timer) use($timers, $that) {
            ...
            if ($timer->isPeriodic()) {
                \event_add($timers[$timer], $timer->getInterval() * \ECSPrefix20220607\React\EventLoop\ExtLibeventLoop::MICROSECONDS_PER_SECOND);
