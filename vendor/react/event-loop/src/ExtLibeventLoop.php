 ...
 */
final class ExtLibeventLoop implements \ECSPrefix20210917\React\EventLoop\LoopInterface
{
    /** @internal */
    ...
    private function createTimerCallback()
    {
        ...
        $this->timerCallback = function ($_, $__, $timer) use($timers, $that) {
            ...
            if ($timer->isPeriodic()) {
                \event_add($timers[$timer], $timer->getInterval() * \ECSPrefix20210917\React\EventLoop\ExtLibeventLoop::MICROSECONDS_PER_SECOND);
