...
use Event;
use EventBase;
use ECSPrefix202609\React\EventLoop\Tick\FutureTickQueue;
use ECSPrefix202609\React\EventLoop\Timer\Timer;
...
final class ExtLibeventLoop implements LoopInterface
{
    ...
    {
        if (!\function_exists('event_base_new') && !\function_exists('ECSPrefix202609\event_base_new')) {
