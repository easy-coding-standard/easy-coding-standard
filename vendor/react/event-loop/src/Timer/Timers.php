...
namespace ECSPrefix20210830\React\EventLoop\Timer;

use ECSPrefix20210830\React\EventLoop\TimerInterface;
/**
...
final class Timers
{
    ...
    public function add(\ECSPrefix20210830\React\EventLoop\TimerInterface $timer)
    {
    ...
    public function contains(\ECSPrefix20210830\React\EventLoop\TimerInterface $timer)
    {
        return isset($this->timers[\spl_object_hash($timer)]);
    }
    public function cancel(\ECSPrefix20210830\React\EventLoop\TimerInterface $timer)
    {
        $id = \spl_object_hash($timer);
