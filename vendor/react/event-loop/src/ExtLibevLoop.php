...
use ECSPrefix20220607\libev\EventLoop;
use ECSPrefix20220607\libev\IOEvent;
use ECSPrefix20220607\libev\SignalEvent;
use ECSPrefix20220607\libev\TimerEvent;
 ...
 */
final class ExtLibevLoop implements \ECSPrefix20220607\React\EventLoop\LoopInterface
{
    private $loop;
    ...
    public function __construct()
    {
        ...
        $this->loop = new \ECSPrefix20220607\libev\EventLoop();
    ...
    public function addReadStream($stream, $listener)
    {
        ...
        $event = new \ECSPrefix20220607\libev\IOEvent($callback, $stream, \ECSPrefix20220607\libev\IOEvent::READ);
        $this->loop->add($event);
    ...
    public function addWriteStream($stream, $listener)
    {
        ...
        $event = new \ECSPrefix20220607\libev\IOEvent($callback, $stream, \ECSPrefix20220607\libev\IOEvent::WRITE);
        $this->loop->add($event);
    ...
    public function addTimer($interval, $callback)
    {
        ...
        $event = new \ECSPrefix20220607\libev\TimerEvent($callback, $timer->getInterval());
    ...
    public function addPeriodicTimer($interval, $callback)
    {
        ...
        $event = new \ECSPrefix20220607\libev\TimerEvent($callback, $timer->getInterval(), $timer->getInterval());
        $this->timerEvents->attach($timer, $event);
        $this->loop->add($event);
        return $timer;
    }
    ...
    public function addSignal($signal, $listener)
    {
        ...
        if (!isset($this->signalEvents[$signal])) {
            ...
            $this->signalEvents[$signal] = new \ECSPrefix20220607\libev\SignalEvent(function () use($signals, $signal) {
                $signals->call($signal);
            }, $signal);
    ...
    public function run()
    {
        ...
        while ($this->running) {
            ...
            $flags = \ECSPrefix20220607\libev\EventLoop::RUN_ONCE;
            if (!$this->running || !$this->futureTickQueue->isEmpty()) {
                $flags |= \ECSPrefix20220607\libev\EventLoop::RUN_NOWAIT;
