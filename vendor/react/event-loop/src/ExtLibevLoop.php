...
use ECSPrefix202503\libev\EventLoop;
use ECSPrefix202503\libev\IOEvent;
use ECSPrefix202503\libev\SignalEvent;
use ECSPrefix202503\libev\TimerEvent;
...
final class ExtLibevLoop implements LoopInterface
{
    ...
    {
        if (!\class_exists('ECSPrefix202503\\libev\\EventLoop', \false)) {
