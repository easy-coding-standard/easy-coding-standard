...
final class Loop
{
    ...
    {
        if (self::$instance instanceof \ECSPrefix20210822\React\EventLoop\LoopInterface) {
            return self::$instance;
        }
        self::$instance = $loop = \ECSPrefix20210822\React\EventLoop\Factory::create();
     ...
     * @return void
     */
    public static function set(\ECSPrefix20210822\React\EventLoop\LoopInterface $loop)
    {
        self::$instance = $loop;
    }
    /**
     ...
     */
    public static function cancelTimer(\ECSPrefix20210822\React\EventLoop\TimerInterface $timer)
    {
