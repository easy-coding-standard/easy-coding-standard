 ...
 */
final class TcpServer extends \ECSPrefix20211124\Evenement\EventEmitter implements \ECSPrefix20211124\React\Socket\ServerInterface
{
    private $master;
    private $loop;
     ...
     */
    public function __construct($uri, \ECSPrefix20211124\React\EventLoop\LoopInterface $loop = null, array $context = array())
    {
    ...
    {
        $this->emit('connection', array(new \ECSPrefix20211124\React\Socket\Connection($socket, $this->loop)));
    }
}
