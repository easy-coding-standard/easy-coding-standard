 ...
 */
final class TcpServer extends \ECSPrefix20211001\Evenement\EventEmitter implements \ECSPrefix20211001\React\Socket\ServerInterface
{
    private $master;
    private $loop;
    ...
    {
        $this->emit('connection', array(new \ECSPrefix20211001\React\Socket\Connection($socket, $this->loop)));
    }
}
