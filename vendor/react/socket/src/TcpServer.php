 ...
 */
final class TcpServer extends \ECSPrefix20211030\Evenement\EventEmitter implements \ECSPrefix20211030\React\Socket\ServerInterface
{
    private $master;
    private $loop;
     ...
     */
    public function __construct($uri, \ECSPrefix20211030\React\EventLoop\LoopInterface $loop = null, array $context = array())
    {
    ...
    {
        $this->emit('connection', array(new \ECSPrefix20211030\React\Socket\Connection($socket, $this->loop)));
    }
}
