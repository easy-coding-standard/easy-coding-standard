 ...
 */
final class TcpServer extends \ECSPrefix20210928\Evenement\EventEmitter implements \ECSPrefix20210928\React\Socket\ServerInterface
{
    private $master;
    private $loop;
     ...
     */
    public function __construct($uri, \ECSPrefix20210928\React\EventLoop\LoopInterface $loop = null, array $context = array())
    {
    ...
    {
        $this->emit('connection', array(new \ECSPrefix20210928\React\Socket\Connection($socket, $this->loop)));
    }
}
