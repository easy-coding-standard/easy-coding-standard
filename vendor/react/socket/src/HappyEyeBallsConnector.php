...
final class HappyEyeBallsConnector implements \ECSPrefix20220223\React\Socket\ConnectorInterface
{
    private $loop;
    private $connector;
    private $resolver;
    public function __construct(\ECSPrefix20220223\React\EventLoop\LoopInterface $loop = null, \ECSPrefix20220223\React\Socket\ConnectorInterface $connector = null, \ECSPrefix20220223\React\Dns\Resolver\ResolverInterface $resolver = null)
    {
    ...
    public function connect($uri)
    {
        ...
        if (!$parts || !isset($parts['host'])) {
            return \ECSPrefix20220223\React\Promise\reject(new \InvalidArgumentException('Given URI "' . $original . '" is invalid (EINVAL)', \defined('SOCKET_EINVAL') ? \SOCKET_EINVAL : 22));
        }
        $host = \trim($parts['host'], '[]');
        ...
        $builder = new \ECSPrefix20220223\React\Socket\HappyEyeBallsConnectionBuilder($this->loop, $this->connector, $this->resolver, $uri, $host, $parts);
