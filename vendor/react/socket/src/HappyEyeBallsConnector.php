...
final class HappyEyeBallsConnector implements \ECSPrefix20211024\React\Socket\ConnectorInterface
{
    private $loop;
    private $connector;
    private $resolver;
    public function __construct(\ECSPrefix20211024\React\EventLoop\LoopInterface $loop = null, \ECSPrefix20211024\React\Socket\ConnectorInterface $connector = null, \ECSPrefix20211024\React\Dns\Resolver\ResolverInterface $resolver = null)
    {
    ...
    public function connect($uri)
    {
        ...
        $builder = new \ECSPrefix20211024\React\Socket\HappyEyeBallsConnectionBuilder($this->loop, $this->connector, $this->resolver, $uri, $host, $parts);
