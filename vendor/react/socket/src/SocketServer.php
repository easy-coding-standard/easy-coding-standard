...
final class SocketServer extends \ECSPrefix20220417\Evenement\EventEmitter implements \ECSPrefix20220417\React\Socket\ServerInterface
{
    private $server;
    /**
     ...
     */
    public function __construct($uri, array $context = array(), \ECSPrefix20220417\React\EventLoop\LoopInterface $loop = null)
    {
        ...
        if ($scheme === 'unix') {
            ...
            $server = new \ECSPrefix20220417\React\Socket\FdServer($uri, $loop);
        } else {
