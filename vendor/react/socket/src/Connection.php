 ...
 * @internal
 */
class Connection extends \ECSPrefix20220204\Evenement\EventEmitter implements \ECSPrefix20220204\React\Socket\ConnectionInterface
{
    /**
    ...
    public $stream;
    private $input;
    public function __construct($resource, \ECSPrefix20220204\React\EventLoop\LoopInterface $loop)
    {
        ...
        $this->input = new \ECSPrefix20220204\React\Stream\DuplexResourceStream($resource, $loop, $clearCompleteBuffer ? -1 : null, new \ECSPrefix20220204\React\Stream\WritableResourceStream($resource, $loop, null, $limitWriteChunks ? 8192 : null));
        $this->stream = $resource;
        \ECSPrefix20220204\React\Stream\Util::forwardEvents($this->input, $this, array('data', 'end', 'error', 'close', 'pipe', 'drain'));
