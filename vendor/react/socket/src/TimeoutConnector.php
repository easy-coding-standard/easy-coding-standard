...
use ECSPrefix20220317\React\Promise\Timer\TimeoutException;
final class TimeoutConnector implements \ECSPrefix20220317\React\Socket\ConnectorInterface
{
    private $connector;
    private $timeout;
    private $loop;
    public function __construct(\ECSPrefix20220317\React\Socket\ConnectorInterface $connector, $timeout, \ECSPrefix20220317\React\EventLoop\LoopInterface $loop = null)
    {
    ...
    {
        return \ECSPrefix20220317\React\Promise\Timer\timeout($this->connector->connect($uri), $this->timeout, $this->loop)->then(null, self::handler($uri));
    }
    /**
