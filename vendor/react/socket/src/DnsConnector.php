...
final class DnsConnector implements \ECSPrefix20211001\React\Socket\ConnectorInterface
{
    private $connector;
    private $resolver;
    public function __construct(\ECSPrefix20211001\React\Socket\ConnectorInterface $connector, \ECSPrefix20211001\React\Dns\Resolver\ResolverInterface $resolver)
    {
    ...
    public function connect($uri)
    {
        ...
        $resolved = null;
        return new \ECSPrefix20211001\React\Promise\Promise(function ($resolve, $reject) use(&$promise, &$resolved, $uri, $connector, $host, $parts) {
            ...
            if ($promise instanceof \ECSPrefix20211001\React\Promise\CancellablePromiseInterface) {
