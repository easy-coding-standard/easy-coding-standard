...
final class DnsConnector implements \ECSPrefix20210929\React\Socket\ConnectorInterface
{
    private $connector;
    private $resolver;
    public function __construct(\ECSPrefix20210929\React\Socket\ConnectorInterface $connector, \ECSPrefix20210929\React\Dns\Resolver\ResolverInterface $resolver)
    {
    ...
    public function connect($uri)
    {
        ...
        $resolved = null;
        return new \ECSPrefix20210929\React\Promise\Promise(function ($resolve, $reject) use(&$promise, &$resolved, $uri, $connector, $host, $parts) {
            ...
            if ($promise instanceof \ECSPrefix20210929\React\Promise\CancellablePromiseInterface) {
