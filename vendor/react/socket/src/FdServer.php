 ...
 * @internal
 */
final class FdServer extends \ECSPrefix20220325\Evenement\EventEmitter implements \ECSPrefix20220325\React\Socket\ServerInterface
{
    private $master;
    private $loop;
    private $unix = \false;
     ...
     */
    public function __construct($fd, \ECSPrefix20220325\React\EventLoop\LoopInterface $loop = null)
    {
        ...
        if (\false === $this->master) {
            ...
            throw new \RuntimeException('Failed to listen on FD ' . $fd . ': ' . $errstr . \ECSPrefix20220325\React\Socket\SocketServer::errconst($errno), $errno);
        }
