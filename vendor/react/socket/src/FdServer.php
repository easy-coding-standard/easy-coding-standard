 ...
 * @internal
 */
final class FdServer extends \ECSPrefix20211230\Evenement\EventEmitter implements \ECSPrefix20211230\React\Socket\ServerInterface
{
    private $master;
    private $loop;
    private $unix = \false;
     ...
     */
    public function __construct($fd, \ECSPrefix20211230\React\EventLoop\LoopInterface $loop = null)
    {
        ...
        if (\false === $this->master) {
            ...
            throw new \RuntimeException('Failed to listen on FD ' . $fd . ': ' . $errstr . \ECSPrefix20211230\React\Socket\SocketServer::errconst($errno), $errno);
        }
