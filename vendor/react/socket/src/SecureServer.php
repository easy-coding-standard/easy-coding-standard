 ...
 */
final class SecureServer extends \ECSPrefix20220325\Evenement\EventEmitter implements \ECSPrefix20220325\React\Socket\ServerInterface
{
    private $tcp;
    private $encryption;
    private $context;
     ...
     */
    public function __construct(\ECSPrefix20220325\React\Socket\ServerInterface $tcp, \ECSPrefix20220325\React\EventLoop\LoopInterface $loop = null, array $context = array())
    {
        ...
        $this->tcp = $tcp;
        $this->encryption = new \ECSPrefix20220325\React\Socket\StreamEncryption($loop ?: \ECSPrefix20220325\React\EventLoop\Loop::get());
    ...
    /** @internal */
    public function handleConnection(\ECSPrefix20220325\React\Socket\ConnectionInterface $connection)
    {
