 ...
 */
final class SecureServer extends \ECSPrefix20220512\Evenement\EventEmitter implements \ECSPrefix20220512\React\Socket\ServerInterface
{
    private $tcp;
    private $encryption;
    private $context;
     ...
     */
    public function __construct(\ECSPrefix20220512\React\Socket\ServerInterface $tcp, \ECSPrefix20220512\React\EventLoop\LoopInterface $loop = null, array $context = array())
    {
        ...
        $this->tcp = $tcp;
        $this->encryption = new \ECSPrefix20220512\React\Socket\StreamEncryption($loop ?: \ECSPrefix20220512\React\EventLoop\Loop::get());
    ...
    /** @internal */
    public function handleConnection(\ECSPrefix20220512\React\Socket\ConnectionInterface $connection)
    {
