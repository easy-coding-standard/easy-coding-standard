 ...
 */
final class SecureServer extends \ECSPrefix20220520\Evenement\EventEmitter implements \ECSPrefix20220520\React\Socket\ServerInterface
{
    private $tcp;
    private $encryption;
    private $context;
     ...
     */
    public function __construct(\ECSPrefix20220520\React\Socket\ServerInterface $tcp, \ECSPrefix20220520\React\EventLoop\LoopInterface $loop = null, array $context = array())
    {
        ...
        $this->tcp = $tcp;
        $this->encryption = new \ECSPrefix20220520\React\Socket\StreamEncryption($loop ?: \ECSPrefix20220520\React\EventLoop\Loop::get());
    ...
    /** @internal */
    public function handleConnection(\ECSPrefix20220520\React\Socket\ConnectionInterface $connection)
    {
