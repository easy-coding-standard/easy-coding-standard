 ...
 */
final class SecureServer extends \ECSPrefix20211120\Evenement\EventEmitter implements \ECSPrefix20211120\React\Socket\ServerInterface
{
    private $tcp;
    private $encryption;
    private $context;
     ...
     */
    public function __construct(\ECSPrefix20211120\React\Socket\ServerInterface $tcp, \ECSPrefix20211120\React\EventLoop\LoopInterface $loop = null, array $context = array())
    {
        ...
        $this->tcp = $tcp;
        $this->encryption = new \ECSPrefix20211120\React\Socket\StreamEncryption($loop ?: \ECSPrefix20211120\React\EventLoop\Loop::get());
