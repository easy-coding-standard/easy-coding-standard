 ...
 */
final class SecureServer extends \ECSPrefix20220307\Evenement\EventEmitter implements \ECSPrefix20220307\React\Socket\ServerInterface
{
    private $tcp;
    private $encryption;
    private $context;
     ...
     */
    public function __construct(\ECSPrefix20220307\React\Socket\ServerInterface $tcp, \ECSPrefix20220307\React\EventLoop\LoopInterface $loop = null, array $context = array())
    {
        ...
        $this->tcp = $tcp;
        $this->encryption = new \ECSPrefix20220307\React\Socket\StreamEncryption($loop ?: \ECSPrefix20220307\React\EventLoop\Loop::get());
