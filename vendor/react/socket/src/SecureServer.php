 ...
 */
final class SecureServer extends \ECSPrefix20220217\Evenement\EventEmitter implements \ECSPrefix20220217\React\Socket\ServerInterface
{
    private $tcp;
    private $encryption;
    private $context;
     ...
     */
    public function __construct(\ECSPrefix20220217\React\Socket\ServerInterface $tcp, \ECSPrefix20220217\React\EventLoop\LoopInterface $loop = null, array $context = array())
    {
        ...
        $this->tcp = $tcp;
        $this->encryption = new \ECSPrefix20220217\React\Socket\StreamEncryption($loop ?: \ECSPrefix20220217\React\EventLoop\Loop::get());
    ...
    /** @internal */
    public function handleConnection(\ECSPrefix20220217\React\Socket\ConnectionInterface $connection)
    {
