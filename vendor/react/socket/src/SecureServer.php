 ...
 */
final class SecureServer extends \ECSPrefix20211230\Evenement\EventEmitter implements \ECSPrefix20211230\React\Socket\ServerInterface
{
    private $tcp;
    private $encryption;
    private $context;
     ...
     */
    public function __construct(\ECSPrefix20211230\React\Socket\ServerInterface $tcp, \ECSPrefix20211230\React\EventLoop\LoopInterface $loop = null, array $context = array())
    {
        ...
        $this->tcp = $tcp;
        $this->encryption = new \ECSPrefix20211230\React\Socket\StreamEncryption($loop ?: \ECSPrefix20211230\React\EventLoop\Loop::get());
    ...
    /** @internal */
    public function handleConnection(\ECSPrefix20211230\React\Socket\ConnectionInterface $connection)
    {
