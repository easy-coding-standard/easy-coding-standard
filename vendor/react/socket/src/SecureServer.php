 ...
 */
final class SecureServer extends \ECSPrefix20211214\Evenement\EventEmitter implements \ECSPrefix20211214\React\Socket\ServerInterface
{
    private $tcp;
    private $encryption;
    private $context;
     ...
     */
    public function __construct(\ECSPrefix20211214\React\Socket\ServerInterface $tcp, \ECSPrefix20211214\React\EventLoop\LoopInterface $loop = null, array $context = array())
    {
        ...
        $this->tcp = $tcp;
        $this->encryption = new \ECSPrefix20211214\React\Socket\StreamEncryption($loop ?: \ECSPrefix20211214\React\EventLoop\Loop::get());
    ...
    /** @internal */
    public function handleConnection(\ECSPrefix20211214\React\Socket\ConnectionInterface $connection)
    {
