 ...
 */
final class SecureServer extends \ECSPrefix20210927\Evenement\EventEmitter implements \ECSPrefix20210927\React\Socket\ServerInterface
{
    private $tcp;
    private $encryption;
    private $context;
     ...
     */
    public function __construct(\ECSPrefix20210927\React\Socket\ServerInterface $tcp, \ECSPrefix20210927\React\EventLoop\LoopInterface $loop = null, array $context = array())
    {
        ...
        $this->tcp = $tcp;
        $this->encryption = new \ECSPrefix20210927\React\Socket\StreamEncryption($loop ?: \ECSPrefix20210927\React\EventLoop\Loop::get());
