 ...
 */
final class SecureServer extends \ECSPrefix20210928\Evenement\EventEmitter implements \ECSPrefix20210928\React\Socket\ServerInterface
{
    private $tcp;
    private $encryption;
    private $context;
     ...
     */
    public function __construct(\ECSPrefix20210928\React\Socket\ServerInterface $tcp, \ECSPrefix20210928\React\EventLoop\LoopInterface $loop = null, array $context = array())
    {
        ...
        $this->tcp = $tcp;
        $this->encryption = new \ECSPrefix20210928\React\Socket\StreamEncryption($loop ?: \ECSPrefix20210928\React\EventLoop\Loop::get());
