 ...
 */
final class SecureServer extends \ECSPrefix20211216\Evenement\EventEmitter implements \ECSPrefix20211216\React\Socket\ServerInterface
{
    private $tcp;
    private $encryption;
    private $context;
     ...
     */
    public function __construct(\ECSPrefix20211216\React\Socket\ServerInterface $tcp, \ECSPrefix20211216\React\EventLoop\LoopInterface $loop = null, array $context = array())
    {
        ...
        $this->tcp = $tcp;
        $this->encryption = new \ECSPrefix20211216\React\Socket\StreamEncryption($loop ?: \ECSPrefix20211216\React\EventLoop\Loop::get());
    ...
    /** @internal */
    public function handleConnection(\ECSPrefix20211216\React\Socket\ConnectionInterface $connection)
    {
