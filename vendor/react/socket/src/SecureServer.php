 ...
 */
final class SecureServer extends \ECSPrefix20220313\Evenement\EventEmitter implements \ECSPrefix20220313\React\Socket\ServerInterface
{
    private $tcp;
    private $encryption;
    private $context;
     ...
     */
    public function __construct(\ECSPrefix20220313\React\Socket\ServerInterface $tcp, \ECSPrefix20220313\React\EventLoop\LoopInterface $loop = null, array $context = array())
    {
        ...
        $this->tcp = $tcp;
        $this->encryption = new \ECSPrefix20220313\React\Socket\StreamEncryption($loop ?: \ECSPrefix20220313\React\EventLoop\Loop::get());
    ...
    /** @internal */
    public function handleConnection(\ECSPrefix20220313\React\Socket\ConnectionInterface $connection)
    {
