 ...
 */
final class SecureServer extends \ECSPrefix20210923\Evenement\EventEmitter implements \ECSPrefix20210923\React\Socket\ServerInterface
{
    private $tcp;
    private $encryption;
    private $context;
     ...
     */
    public function __construct(\ECSPrefix20210923\React\Socket\ServerInterface $tcp, \ECSPrefix20210923\React\EventLoop\LoopInterface $loop = null, array $context = array())
    {
        ...
        $this->tcp = $tcp;
        $this->encryption = new \ECSPrefix20210923\React\Socket\StreamEncryption($loop ?: \ECSPrefix20210923\React\EventLoop\Loop::get());
