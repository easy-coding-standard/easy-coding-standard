 ...
 */
final class SecureServer extends \ECSPrefix20211212\Evenement\EventEmitter implements \ECSPrefix20211212\React\Socket\ServerInterface
{
    private $tcp;
    private $encryption;
    private $context;
     ...
     */
    public function __construct(\ECSPrefix20211212\React\Socket\ServerInterface $tcp, \ECSPrefix20211212\React\EventLoop\LoopInterface $loop = null, array $context = array())
    {
        ...
        $this->tcp = $tcp;
        $this->encryption = new \ECSPrefix20211212\React\Socket\StreamEncryption($loop ?: \ECSPrefix20211212\React\EventLoop\Loop::get());
    ...
    /** @internal */
    public function handleConnection(\ECSPrefix20211212\React\Socket\ConnectionInterface $connection)
    {
