 ...
 */
final class SecureServer extends \ECSPrefix20220604\Evenement\EventEmitter implements \ECSPrefix20220604\React\Socket\ServerInterface
{
    private $tcp;
    private $encryption;
    private $context;
     ...
     */
    public function __construct(\ECSPrefix20220604\React\Socket\ServerInterface $tcp, \ECSPrefix20220604\React\EventLoop\LoopInterface $loop = null, array $context = array())
    {
        ...
        $this->tcp = $tcp;
        $this->encryption = new \ECSPrefix20220604\React\Socket\StreamEncryption($loop ?: \ECSPrefix20220604\React\EventLoop\Loop::get());
    ...
    /** @internal */
    public function handleConnection(\ECSPrefix20220604\React\Socket\ConnectionInterface $connection)
    {
