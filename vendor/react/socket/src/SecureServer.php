 ...
 */
final class SecureServer extends \ECSPrefix20211113\Evenement\EventEmitter implements \ECSPrefix20211113\React\Socket\ServerInterface
{
    private $tcp;
    private $encryption;
    private $context;
     ...
     */
    public function __construct(\ECSPrefix20211113\React\Socket\ServerInterface $tcp, \ECSPrefix20211113\React\EventLoop\LoopInterface $loop = null, array $context = array())
    {
        ...
        $this->tcp = $tcp;
        $this->encryption = new \ECSPrefix20211113\React\Socket\StreamEncryption($loop ?: \ECSPrefix20211113\React\EventLoop\Loop::get());
