 ...
 * ```
 */
class FixedUriConnector implements \ECSPrefix20211031\React\Socket\ConnectorInterface
{
    private $uri;
    private $connector;
    /**
     ...
     */
    public function __construct($uri, \ECSPrefix20211031\React\Socket\ConnectorInterface $connector)
    {
        $this->uri = $uri;
