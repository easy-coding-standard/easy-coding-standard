 ...
 * ```
 */
class FixedUriConnector implements \ECSPrefix20211007\React\Socket\ConnectorInterface
{
    private $uri;
    private $connector;
    /**
     ...
     */
    public function __construct($uri, \ECSPrefix20211007\React\Socket\ConnectorInterface $connector)
    {
        $this->uri = $uri;
