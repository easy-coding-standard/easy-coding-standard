 ...
 * ```
 */
class FixedUriConnector implements \ECSPrefix20210929\React\Socket\ConnectorInterface
{
    private $uri;
    private $connector;
    /**
     ...
     */
    public function __construct($uri, \ECSPrefix20210929\React\Socket\ConnectorInterface $connector)
    {
        $this->uri = $uri;
