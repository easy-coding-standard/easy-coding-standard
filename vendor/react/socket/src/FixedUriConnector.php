 ...
 * ```
 */
class FixedUriConnector implements \ECSPrefix20220307\React\Socket\ConnectorInterface
{
    private $uri;
    private $connector;
    /**
     ...
     */
    public function __construct($uri, \ECSPrefix20220307\React\Socket\ConnectorInterface $connector)
    {
        $this->uri = $uri;
