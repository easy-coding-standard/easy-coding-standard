 ...
 */
class LimitingServer extends \ECSPrefix20211008\Evenement\EventEmitter implements \ECSPrefix20211008\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\ECSPrefix20211008\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
