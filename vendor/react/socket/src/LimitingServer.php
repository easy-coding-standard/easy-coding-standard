 ...
 */
class LimitingServer extends \ECSPrefix20211227\Evenement\EventEmitter implements \ECSPrefix20211227\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\ECSPrefix20211227\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
    ...
    /** @internal */
    public function handleDisconnection(\ECSPrefix20211227\React\Socket\ConnectionInterface $connection)
    {
