 ...
 */
class LimitingServer extends \ECSPrefix20211128\Evenement\EventEmitter implements \ECSPrefix20211128\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\ECSPrefix20211128\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
