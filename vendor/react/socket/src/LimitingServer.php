 ...
 */
class LimitingServer extends \ECSPrefix20211029\Evenement\EventEmitter implements \ECSPrefix20211029\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\ECSPrefix20211029\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
