 ...
 */
class LimitingServer extends \ECSPrefix20211119\Evenement\EventEmitter implements \ECSPrefix20211119\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\ECSPrefix20211119\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
