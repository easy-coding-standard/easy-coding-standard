 ...
 */
class LimitingServer extends \ECSPrefix20210928\Evenement\EventEmitter implements \ECSPrefix20210928\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\ECSPrefix20210928\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
