 ...
 */
class LimitingServer extends \ECSPrefix20211204\Evenement\EventEmitter implements \ECSPrefix20211204\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\ECSPrefix20211204\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
