 ...
 */
class LimitingServer extends \ECSPrefix20220125\Evenement\EventEmitter implements \ECSPrefix20220125\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\ECSPrefix20220125\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
    ...
    /** @internal */
    public function handleDisconnection(\ECSPrefix20220125\React\Socket\ConnectionInterface $connection)
    {
