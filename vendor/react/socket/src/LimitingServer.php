 ...
 */
class LimitingServer extends \ECSPrefix20211002\Evenement\EventEmitter implements \ECSPrefix20211002\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\ECSPrefix20211002\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
