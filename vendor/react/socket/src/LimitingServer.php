 ...
 */
class LimitingServer extends \ECSPrefix20211104\Evenement\EventEmitter implements \ECSPrefix20211104\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\ECSPrefix20211104\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
