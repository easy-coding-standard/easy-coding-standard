 ...
 */
class LimitingServer extends \ECSPrefix20211117\Evenement\EventEmitter implements \ECSPrefix20211117\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\ECSPrefix20211117\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
