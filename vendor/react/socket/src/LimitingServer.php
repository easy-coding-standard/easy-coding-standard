 ...
 */
class LimitingServer extends \ECSPrefix20211127\Evenement\EventEmitter implements \ECSPrefix20211127\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\ECSPrefix20211127\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
