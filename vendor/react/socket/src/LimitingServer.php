 ...
 */
class LimitingServer extends \ECSPrefix20211106\Evenement\EventEmitter implements \ECSPrefix20211106\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\ECSPrefix20211106\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
