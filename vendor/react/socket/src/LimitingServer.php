 ...
 */
class LimitingServer extends \ECSPrefix20211123\Evenement\EventEmitter implements \ECSPrefix20211123\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\ECSPrefix20211123\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
