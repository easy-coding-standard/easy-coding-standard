 ...
 */
class LimitingServer extends \ECSPrefix20211125\Evenement\EventEmitter implements \ECSPrefix20211125\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\ECSPrefix20211125\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
