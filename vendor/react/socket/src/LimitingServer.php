 ...
 */
class LimitingServer extends \ECSPrefix20211027\Evenement\EventEmitter implements \ECSPrefix20211027\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\ECSPrefix20211027\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
