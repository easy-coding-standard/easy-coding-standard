 ...
 */
class LimitingServer extends \ECSPrefix20220227\Evenement\EventEmitter implements \ECSPrefix20220227\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\ECSPrefix20220227\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
    ...
    /** @internal */
    public function handleDisconnection(\ECSPrefix20220227\React\Socket\ConnectionInterface $connection)
    {
