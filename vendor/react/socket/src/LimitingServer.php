 ...
 */
class LimitingServer extends \ECSPrefix20211120\Evenement\EventEmitter implements \ECSPrefix20211120\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\ECSPrefix20211120\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
