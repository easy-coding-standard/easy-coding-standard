 ...
 */
class LimitingServer extends \ECSPrefix20211107\Evenement\EventEmitter implements \ECSPrefix20211107\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\ECSPrefix20211107\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
