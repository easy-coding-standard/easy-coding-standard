 ...
 */
class LimitingServer extends \ECSPrefix20211020\Evenement\EventEmitter implements \ECSPrefix20211020\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\ECSPrefix20211020\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
