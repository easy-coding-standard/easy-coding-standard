 ...
 */
class LimitingServer extends \ECSPrefix20211102\Evenement\EventEmitter implements \ECSPrefix20211102\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\ECSPrefix20211102\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
