 ...
 */
class LimitingServer extends \ECSPrefix20211116\Evenement\EventEmitter implements \ECSPrefix20211116\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\ECSPrefix20211116\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
