 ...
 */
class LimitingServer extends \ECSPrefix20211001\Evenement\EventEmitter implements \ECSPrefix20211001\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\ECSPrefix20211001\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
