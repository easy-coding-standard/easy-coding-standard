 ...
 */
class LimitingServer extends \ECSPrefix20211007\Evenement\EventEmitter implements \ECSPrefix20211007\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\ECSPrefix20211007\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
