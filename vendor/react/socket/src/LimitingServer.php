 ...
 */
class LimitingServer extends \ECSPrefix20220224\Evenement\EventEmitter implements \ECSPrefix20220224\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\ECSPrefix20220224\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
    ...
    /** @internal */
    public function handleDisconnection(\ECSPrefix20220224\React\Socket\ConnectionInterface $connection)
    {
