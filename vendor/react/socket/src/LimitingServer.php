 ...
 */
class LimitingServer extends \ECSPrefix20211206\Evenement\EventEmitter implements \ECSPrefix20211206\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\ECSPrefix20211206\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
