 ...
 */
class LimitingServer extends \ECSPrefix20211012\Evenement\EventEmitter implements \ECSPrefix20211012\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\ECSPrefix20211012\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
