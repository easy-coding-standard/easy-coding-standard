 ...
 */
class LimitingServer extends \ECSPrefix20220206\Evenement\EventEmitter implements \ECSPrefix20220206\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\ECSPrefix20220206\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
    ...
    /** @internal */
    public function handleDisconnection(\ECSPrefix20220206\React\Socket\ConnectionInterface $connection)
    {
