 ...
 */
class LimitingServer extends \ECSPrefix20211011\Evenement\EventEmitter implements \ECSPrefix20211011\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\ECSPrefix20211011\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
