 ...
 */
class LimitingServer extends \ECSPrefix20211208\Evenement\EventEmitter implements \ECSPrefix20211208\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\ECSPrefix20211208\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
