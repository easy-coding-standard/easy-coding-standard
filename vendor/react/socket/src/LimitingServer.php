 ...
 */
class LimitingServer extends \ECSPrefix20211214\Evenement\EventEmitter implements \ECSPrefix20211214\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\ECSPrefix20211214\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
    ...
    /** @internal */
    public function handleDisconnection(\ECSPrefix20211214\React\Socket\ConnectionInterface $connection)
    {
