 ...
 */
class LimitingServer extends \ECSPrefix20211101\Evenement\EventEmitter implements \ECSPrefix20211101\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\ECSPrefix20211101\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
