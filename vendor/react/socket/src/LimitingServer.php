 ...
 */
class LimitingServer extends \ECSPrefix20211209\Evenement\EventEmitter implements \ECSPrefix20211209\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\ECSPrefix20211209\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
