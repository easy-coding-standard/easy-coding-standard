 ...
 */
class LimitingServer extends \ECSPrefix20211014\Evenement\EventEmitter implements \ECSPrefix20211014\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\ECSPrefix20211014\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
