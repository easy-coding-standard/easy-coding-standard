 ...
 */
class LimitingServer extends \ECSPrefix20211103\Evenement\EventEmitter implements \ECSPrefix20211103\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\ECSPrefix20211103\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
