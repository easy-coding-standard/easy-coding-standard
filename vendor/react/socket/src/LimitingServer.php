 ...
 */
class LimitingServer extends \ECSPrefix20211124\Evenement\EventEmitter implements \ECSPrefix20211124\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\ECSPrefix20211124\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
