 ...
 */
class LimitingServer extends \ECSPrefix20211021\Evenement\EventEmitter implements \ECSPrefix20211021\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\ECSPrefix20211021\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
