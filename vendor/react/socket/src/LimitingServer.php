 ...
 */
class LimitingServer extends \ECSPrefix20220601\Evenement\EventEmitter implements \ECSPrefix20220601\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\ECSPrefix20220601\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
    ...
    /** @internal */
    public function handleDisconnection(\ECSPrefix20220601\React\Socket\ConnectionInterface $connection)
    {
