 ...
 */
class LimitingServer extends \ECSPrefix20211126\Evenement\EventEmitter implements \ECSPrefix20211126\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\ECSPrefix20211126\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
