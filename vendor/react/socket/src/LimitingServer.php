 ...
 */
class LimitingServer extends \ECSPrefix20220308\Evenement\EventEmitter implements \ECSPrefix20220308\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\ECSPrefix20220308\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
    ...
    /** @internal */
    public function handleDisconnection(\ECSPrefix20220308\React\Socket\ConnectionInterface $connection)
    {
