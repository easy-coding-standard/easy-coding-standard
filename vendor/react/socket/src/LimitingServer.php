 ...
 */
class LimitingServer extends \ECSPrefix20220531\Evenement\EventEmitter implements \ECSPrefix20220531\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\ECSPrefix20220531\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
    ...
    /** @internal */
    public function handleDisconnection(\ECSPrefix20220531\React\Socket\ConnectionInterface $connection)
    {
