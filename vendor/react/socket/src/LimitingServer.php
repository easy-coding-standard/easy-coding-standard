 ...
 */
class LimitingServer extends \ECSPrefix20211025\Evenement\EventEmitter implements \ECSPrefix20211025\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\ECSPrefix20211025\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
