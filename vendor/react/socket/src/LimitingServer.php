 ...
 */
class LimitingServer extends \ECSPrefix20211203\Evenement\EventEmitter implements \ECSPrefix20211203\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\ECSPrefix20211203\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
