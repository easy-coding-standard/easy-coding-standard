...
namespace ECSPrefix202305\React\Socket;

use ECSPrefix202305\React\Dns\Config\Config as DnsConfig;
use ECSPrefix202305\React\Dns\Resolver\Factory as DnsFactory;
use ECSPrefix202305\React\Dns\Resolver\ResolverInterface;
...
final class Connector implements ConnectorInterface
{
    ...
    public function connect($uri)
    {
        ...
        if (!isset($this->connectors[$scheme])) {
            return \ECSPrefix202305\React\Promise\reject(new \RuntimeException('No connector available for URI scheme "' . $scheme . '" (EINVAL)', \defined('SOCKET_EINVAL') ? \SOCKET_EINVAL : 22));
        }
