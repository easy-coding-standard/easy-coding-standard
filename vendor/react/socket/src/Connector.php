...
namespace ECSPrefix202303\React\Socket;

use ECSPrefix202303\React\Dns\Config\Config as DnsConfig;
use ECSPrefix202303\React\Dns\Resolver\Factory as DnsFactory;
use ECSPrefix202303\React\Dns\Resolver\ResolverInterface;
...
final class Connector implements ConnectorInterface
{
    ...
    public function connect($uri)
    {
        ...
        if (!isset($this->connectors[$scheme])) {
            return \ECSPrefix202303\React\Promise\reject(new \RuntimeException('No connector available for URI scheme "' . $scheme . '" (EINVAL)', \defined('SOCKET_EINVAL') ? \SOCKET_EINVAL : 22));
        }
