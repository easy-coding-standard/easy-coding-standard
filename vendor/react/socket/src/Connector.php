...
use ECSPrefix202206\React\Dns\Config\Config as DnsConfig;
use ECSPrefix202206\React\Dns\Resolver\Factory as DnsFactory;
...
final class Connector implements ConnectorInterface
{
    ...
    public function connect($uri)
    {
        ...
        if (!isset($this->connectors[$scheme])) {
            return \ECSPrefix202206\React\Promise\reject(new \RuntimeException('No connector available for URI scheme "' . $scheme . '" (EINVAL)', \defined('SOCKET_EINVAL') ? \SOCKET_EINVAL : 22));
        }
