 ...
 */
final class UnixServer extends \ECSPrefix20220325\Evenement\EventEmitter implements \ECSPrefix20220325\React\Socket\ServerInterface
{
    private $master;
    private $loop;
     ...
     */
    public function __construct($path, \ECSPrefix20220325\React\EventLoop\LoopInterface $loop = null, array $context = array())
    {
        ...
        if (\false === $this->master) {
            ...
            throw new \RuntimeException('Failed to listen on Unix domain socket "' . $path . '": ' . $errstr . \ECSPrefix20220325\React\Socket\SocketServer::errconst($errno), $errno);
        }
    ...
    {
        $connection = new \ECSPrefix20220325\React\Socket\Connection($socket, $this->loop);
        $connection->unix = \true;
