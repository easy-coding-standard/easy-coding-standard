 ...
 */
final class UnixServer extends \ECSPrefix20211007\Evenement\EventEmitter implements \ECSPrefix20211007\React\Socket\ServerInterface
{
    private $master;
    private $loop;
     ...
     */
    public function __construct($path, \ECSPrefix20211007\React\EventLoop\LoopInterface $loop = null, array $context = array())
    {
    ...
    {
        $connection = new \ECSPrefix20211007\React\Socket\Connection($socket, $this->loop);
        $connection->unix = \true;
