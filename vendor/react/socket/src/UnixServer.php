 ...
 */
final class UnixServer extends \ECSPrefix20210929\Evenement\EventEmitter implements \ECSPrefix20210929\React\Socket\ServerInterface
{
    private $master;
    private $loop;
     ...
     */
    public function __construct($path, \ECSPrefix20210929\React\EventLoop\LoopInterface $loop = null, array $context = array())
    {
    ...
    {
        $connection = new \ECSPrefix20210929\React\Socket\Connection($socket, $this->loop);
        $connection->unix = \true;
