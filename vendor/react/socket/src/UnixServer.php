 ...
 */
final class UnixServer extends \ECSPrefix20211111\Evenement\EventEmitter implements \ECSPrefix20211111\React\Socket\ServerInterface
{
    private $master;
    private $loop;
     ...
     */
    public function __construct($path, \ECSPrefix20211111\React\EventLoop\LoopInterface $loop = null, array $context = array())
    {
    ...
    {
        $connection = new \ECSPrefix20211111\React\Socket\Connection($socket, $this->loop);
        $connection->unix = \true;
