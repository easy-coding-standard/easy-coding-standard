...
namespace ECSPrefix20211227\React\Cache;

use ECSPrefix20211227\React\Promise;
use ECSPrefix20211227\React\Promise\PromiseInterface;
class ArrayCache implements \ECSPrefix20211227\React\Cache\CacheInterface
{
    private $limit;
    private $data = array();
    ...
    public function get($key, $default = null)
    {
        ...
        if (!\array_key_exists($key, $this->data)) {
            return \ECSPrefix20211227\React\Promise\resolve($default);
        }
        // remove and append to end of array to keep track of LRU info
        $value = $this->data[$key];
        unset($this->data[$key]);
        $this->data[$key] = $value;
        return \ECSPrefix20211227\React\Promise\resolve($value);
    }
    public function set($key, $value, $ttl = null)
    {
        ...
        return \ECSPrefix20211227\React\Promise\resolve(\true);
    }
    ...
    public function getMultiple(array $keys, $default = null)
    {
        ...
        return \ECSPrefix20211227\React\Promise\all($values);
    }
    ...
    public function has($key)
    {
        ...
        if (!\array_key_exists($key, $this->data)) {
            return \ECSPrefix20211227\React\Promise\resolve(\false);
        }
        // remove and append to end of array to keep track of LRU info
        $value = $this->data[$key];
        unset($this->data[$key]);
