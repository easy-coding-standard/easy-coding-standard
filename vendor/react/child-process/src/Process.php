...
namespace ECSPrefix20210703\React\ChildProcess;

use ECSPrefix20210703\Evenement\EventEmitter;
use ECSPrefix20210703\React\EventLoop\LoopInterface;
use ECSPrefix20210703\React\Stream\ReadableResourceStream;
use ECSPrefix20210703\React\Stream\ReadableStreamInterface;
use ECSPrefix20210703\React\Stream\WritableResourceStream;
use ECSPrefix20210703\React\Stream\WritableStreamInterface;
use ECSPrefix20210703\React\Stream\DuplexResourceStream;
use ECSPrefix20210703\React\Stream\DuplexStreamInterface;
/**
 * Process component.
 *
 ...
 */
class Process extends \ECSPrefix20210703\Evenement\EventEmitter
{
    /**
     ...
     */
    public function start(\ECSPrefix20210703\React\EventLoop\LoopInterface $loop, $interval = 0.1)
    {
        if ($this->isRunning()) {
        ...
        foreach ($pipes as $n => $fd) {
            ...
            if ($mode === 'r+') {
                $stream = new \ECSPrefix20210703\React\Stream\DuplexResourceStream($fd, $loop);
            } elseif ($mode === 'w') {
                $stream = new \ECSPrefix20210703\React\Stream\WritableResourceStream($fd, $loop);
            } else {
                $stream = new \ECSPrefix20210703\React\Stream\ReadableResourceStream($fd, $loop);
