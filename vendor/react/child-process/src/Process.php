...
namespace ECSPrefix202606\React\ChildProcess;
...
use ECSPrefix202606\React\Stream\ReadableResourceStream;
use ECSPrefix202606\React\Stream\ReadableStreamInterface;
use ECSPrefix202606\React\Stream\WritableResourceStream;
use ECSPrefix202606\React\Stream\WritableStreamInterface;
use ECSPrefix202606\React\Stream\DuplexResourceStream;
...
class Process extends EventEmitter
{
    ...
    final public static function isSigchildEnabled()
    {
        ...
        if (!\function_exists('phpinfo') && !\function_exists('ECSPrefix202606\phpinfo')) {
