...
namespace ECSPrefix20210816\React\ChildProcess;

use ECSPrefix20210816\Evenement\EventEmitter;
use ECSPrefix20210816\React\EventLoop\Loop;
use ECSPrefix20210816\React\EventLoop\LoopInterface;
use ECSPrefix20210816\React\Stream\ReadableResourceStream;
use ECSPrefix20210816\React\Stream\ReadableStreamInterface;
use ECSPrefix20210816\React\Stream\WritableResourceStream;
use ECSPrefix20210816\React\Stream\WritableStreamInterface;
use ECSPrefix20210816\React\Stream\DuplexResourceStream;
use ECSPrefix20210816\React\Stream\DuplexStreamInterface;
/**
 * Process component.
 *
 ...
 */
class Process extends \ECSPrefix20210816\Evenement\EventEmitter
{
    /**
    ...
    public function start($loop = null, $interval = 0.1)
    {
        ...
        $loop = $loop ?: \ECSPrefix20210816\React\EventLoop\Loop::get();
        $cmd = $this->cmd;
        $fdSpec = $this->fds;
        $sigchild = null;
        ...
        foreach ($pipes as $n => $fd) {
            ...
            if ($mode === 'r+') {
                $stream = new \ECSPrefix20210816\React\Stream\DuplexResourceStream($fd, $loop);
            } elseif ($mode === 'w') {
                $stream = new \ECSPrefix20210816\React\Stream\WritableResourceStream($fd, $loop);
            } else {
                $stream = new \ECSPrefix20210816\React\Stream\ReadableResourceStream($fd, $loop);
