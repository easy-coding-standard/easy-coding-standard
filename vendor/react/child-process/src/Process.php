...
namespace ECSPrefix20210909\React\ChildProcess;
...
use ECSPrefix20210909\React\Stream\ReadableStreamInterface;
use ECSPrefix20210909\React\Stream\WritableResourceStream;
use ECSPrefix20210909\React\Stream\WritableStreamInterface;
use ECSPrefix20210909\React\Stream\DuplexResourceStream;
use ECSPrefix20210909\React\Stream\DuplexStreamInterface;
/**
 * Process component.
 *
 ...
 */
class Process extends \ECSPrefix20210909\Evenement\EventEmitter
{
    /**
    ...
    public function start($loop = null, $interval = 0.1)
    {
        ...
        $loop = $loop ?: \ECSPrefix20210909\React\EventLoop\Loop::get();
        $cmd = $this->cmd;
        $fdSpec = $this->fds;
        $sigchild = null;
        ...
        foreach ($pipes as $n => $fd) {
            ...
            if ($mode === 'r+') {
                $stream = new \ECSPrefix20210909\React\Stream\DuplexResourceStream($fd, $loop);
            } elseif ($mode === 'w') {
                $stream = new \ECSPrefix20210909\React\Stream\WritableResourceStream($fd, $loop);
            } else {
                $stream = new \ECSPrefix20210909\React\Stream\ReadableResourceStream($fd, $loop);
