...
namespace ECSPrefix20210930\React\ChildProcess;
...
use ECSPrefix20210930\React\Stream\ReadableResourceStream;
use ECSPrefix20210930\React\Stream\ReadableStreamInterface;
use ECSPrefix20210930\React\Stream\WritableResourceStream;
use ECSPrefix20210930\React\Stream\WritableStreamInterface;
use ECSPrefix20210930\React\Stream\DuplexResourceStream;
use ECSPrefix20210930\React\Stream\DuplexStreamInterface;
/**
 * Process component.
 *
 ...
 */
class Process extends \ECSPrefix20210930\Evenement\EventEmitter
{
    /**
    ...
    public function start($loop = null, $interval = 0.1)
    {
        ...
        foreach ($pipes as $n => $fd) {
            ...
            if ($mode === 'r+') {
                $stream = new \ECSPrefix20210930\React\Stream\DuplexResourceStream($fd, $loop);
            } elseif ($mode === 'w') {
                $stream = new \ECSPrefix20210930\React\Stream\WritableResourceStream($fd, $loop);
            } else {
                $stream = new \ECSPrefix20210930\React\Stream\ReadableResourceStream($fd, $loop);
