...
function timeout(PromiseInterface $promise, $time, LoopInterface $loop = null)
{
    ...
    $canceller = null;
    if ($promise instanceof CancellablePromiseInterface || !\interface_exists('ECSPrefix20220613\\React\\Promise\\CancellablePromiseInterface') && \method_exists($promise, 'cancel')) {
