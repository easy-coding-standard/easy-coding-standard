...
final class Util
{
     ...
     */
    public static function pipe(\ECSPrefix20211031\React\Stream\ReadableStreamInterface $source, \ECSPrefix20211031\React\Stream\WritableStreamInterface $dest, array $options = array())
    {
