...
final class Util
{
     ...
     */
    public static function pipe(\ECSPrefix20210809\React\Stream\ReadableStreamInterface $source, \ECSPrefix20210809\React\Stream\WritableStreamInterface $dest, array $options = array())
    {
