...
final class Util
{
     ...
     */
    public static function pipe(\ECSPrefix20220307\React\Stream\ReadableStreamInterface $source, \ECSPrefix20220307\React\Stream\WritableStreamInterface $dest, array $options = array())
    {
