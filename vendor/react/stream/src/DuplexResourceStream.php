...
namespace ECSPrefix20210814\React\Stream;
...
final class DuplexResourceStream extends \ECSPrefix20210814\Evenement\EventEmitter implements \ECSPrefix20210814\React\Stream\DuplexStreamInterface
{
    private $stream;
    /** @var LoopInterface */
    private $loop;
    ...
    public function __construct($stream, \ECSPrefix20210814\React\EventLoop\LoopInterface $loop = null, $readChunkSize = null, \ECSPrefix20210814\React\Stream\WritableStreamInterface $buffer = null)
    {
        ...
        if ($buffer === null) {
            $buffer = new \ECSPrefix20210814\React\Stream\WritableResourceStream($stream, $loop);
        }
        $this->stream = $stream;
        $this->loop = $loop ?: \ECSPrefix20210814\React\EventLoop\Loop::get();
    ...
    {
        return \ECSPrefix20210814\React\Stream\Util::pipe($this, $dest, $options);
    }
    /** @internal */
