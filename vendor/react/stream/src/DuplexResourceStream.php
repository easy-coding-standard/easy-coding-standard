...
final class DuplexResourceStream extends \ECSPrefix20220607\Evenement\EventEmitter implements \ECSPrefix20220607\React\Stream\DuplexStreamInterface
{
    private $stream;
    /** @var LoopInterface */
    private $loop;
    ...
    public function __construct($stream, \ECSPrefix20220607\React\EventLoop\LoopInterface $loop = null, $readChunkSize = null, \ECSPrefix20220607\React\Stream\WritableStreamInterface $buffer = null)
    {
        ...
        if ($buffer === null) {
            $buffer = new \ECSPrefix20220607\React\Stream\WritableResourceStream($stream, $loop);
        }
        $this->stream = $stream;
