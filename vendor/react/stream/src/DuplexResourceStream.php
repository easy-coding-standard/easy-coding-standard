...
namespace ECSPrefix20210703\React\Stream;

use ECSPrefix20210703\Evenement\EventEmitter;
use ECSPrefix20210703\React\EventLoop\LoopInterface;
use InvalidArgumentException;
final class DuplexResourceStream extends \ECSPrefix20210703\Evenement\EventEmitter implements \ECSPrefix20210703\React\Stream\DuplexStreamInterface
{
    private $stream;
    private $loop;
    /**
    ...
    public function __construct($stream, \ECSPrefix20210703\React\EventLoop\LoopInterface $loop, $readChunkSize = null, \ECSPrefix20210703\React\Stream\WritableStreamInterface $buffer = null)
    {
        ...
        if ($buffer === null) {
            $buffer = new \ECSPrefix20210703\React\Stream\WritableResourceStream($stream, $loop);
        }
        $this->stream = $stream;
        $this->loop = $loop;
    ...
    public function pipe(\ECSPrefix20210703\React\Stream\WritableStreamInterface $dest, array $options = array())
    {
        return \ECSPrefix20210703\React\Stream\Util::pipe($this, $dest, $options);
    }
    /** @internal */
