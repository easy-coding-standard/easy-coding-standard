...
namespace ECSPrefix20211211\React\Stream;
...
final class DuplexResourceStream extends \ECSPrefix20211211\Evenement\EventEmitter implements \ECSPrefix20211211\React\Stream\DuplexStreamInterface
{
    private $stream;
    /** @var LoopInterface */
    private $loop;
    ...
    public function __construct($stream, \ECSPrefix20211211\React\EventLoop\LoopInterface $loop = null, $readChunkSize = null, \ECSPrefix20211211\React\Stream\WritableStreamInterface $buffer = null)
    {
        ...
        if ($buffer === null) {
            $buffer = new \ECSPrefix20211211\React\Stream\WritableResourceStream($stream, $loop);
        }
        $this->stream = $stream;
    ...
    public function pipe(\ECSPrefix20211211\React\Stream\WritableStreamInterface $dest, array $options = array())
    {
        return \ECSPrefix20211211\React\Stream\Util::pipe($this, $dest, $options);
    }
    /** @internal */
