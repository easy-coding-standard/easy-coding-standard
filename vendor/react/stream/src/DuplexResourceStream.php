...
final class DuplexResourceStream extends \ECSPrefix20210705\Evenement\EventEmitter implements \ECSPrefix20210705\React\Stream\DuplexStreamInterface
{
    private $stream;
    private $loop;
    /**
    ...
    public function __construct($stream, \ECSPrefix20210705\React\EventLoop\LoopInterface $loop, $readChunkSize = null, \ECSPrefix20210705\React\Stream\WritableStreamInterface $buffer = null)
    {
        ...
        if ($buffer === null) {
            $buffer = new \ECSPrefix20210705\React\Stream\WritableResourceStream($stream, $loop);
        }
        $this->stream = $stream;
        $this->loop = $loop;
    ...
    {
        return \ECSPrefix20210705\React\Stream\Util::pipe($this, $dest, $options);
    }
    /** @internal */
