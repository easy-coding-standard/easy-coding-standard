...
namespace ECSPrefix20220605\React\Stream;
...
final class DuplexResourceStream extends \ECSPrefix20220605\Evenement\EventEmitter implements \ECSPrefix20220605\React\Stream\DuplexStreamInterface
{
    private $stream;
    /** @var LoopInterface */
    private $loop;
    ...
    public function __construct($stream, \ECSPrefix20220605\React\EventLoop\LoopInterface $loop = null, $readChunkSize = null, \ECSPrefix20220605\React\Stream\WritableStreamInterface $buffer = null)
    {
        ...
        if ($buffer === null) {
            $buffer = new \ECSPrefix20220605\React\Stream\WritableResourceStream($stream, $loop);
        }
        $this->stream = $stream;
    ...
    public function pipe(\ECSPrefix20220605\React\Stream\WritableStreamInterface $dest, array $options = array())
    {
        return \ECSPrefix20220605\React\Stream\Util::pipe($this, $dest, $options);
    }
    /** @internal */
