...
namespace ECSPrefix20210904\React\Stream;
...
final class DuplexResourceStream extends \ECSPrefix20210904\Evenement\EventEmitter implements \ECSPrefix20210904\React\Stream\DuplexStreamInterface
{
    private $stream;
    /** @var LoopInterface */
    private $loop;
    ...
    public function __construct($stream, \ECSPrefix20210904\React\EventLoop\LoopInterface $loop = null, $readChunkSize = null, \ECSPrefix20210904\React\Stream\WritableStreamInterface $buffer = null)
    {
        ...
        if ($buffer === null) {
            $buffer = new \ECSPrefix20210904\React\Stream\WritableResourceStream($stream, $loop);
        }
        $this->stream = $stream;
        $this->loop = $loop ?: \ECSPrefix20210904\React\EventLoop\Loop::get();
    ...
    {
        return \ECSPrefix20210904\React\Stream\Util::pipe($this, $dest, $options);
    }
    /** @internal */
