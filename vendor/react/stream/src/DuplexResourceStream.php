...
final class DuplexResourceStream extends \ECSPrefix20220220\Evenement\EventEmitter implements \ECSPrefix20220220\React\Stream\DuplexStreamInterface
{
    private $stream;
    /** @var LoopInterface */
    private $loop;
    ...
    public function __construct($stream, \ECSPrefix20220220\React\EventLoop\LoopInterface $loop = null, $readChunkSize = null, \ECSPrefix20220220\React\Stream\WritableStreamInterface $buffer = null)
    {
        ...
        if ($buffer === null) {
            $buffer = new \ECSPrefix20220220\React\Stream\WritableResourceStream($stream, $loop);
        }
        $this->stream = $stream;
