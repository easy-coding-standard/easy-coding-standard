...
final class DuplexResourceStream extends \ECSPrefix20210908\Evenement\EventEmitter implements \ECSPrefix20210908\React\Stream\DuplexStreamInterface
{
    private $stream;
    /** @var LoopInterface */
    private $loop;
    ...
    public function __construct($stream, \ECSPrefix20210908\React\EventLoop\LoopInterface $loop = null, $readChunkSize = null, \ECSPrefix20210908\React\Stream\WritableStreamInterface $buffer = null)
    {
        ...
        if ($buffer === null) {
            $buffer = new \ECSPrefix20210908\React\Stream\WritableResourceStream($stream, $loop);
        }
        $this->stream = $stream;
