...
final class DuplexResourceStream extends \ECSPrefix20211121\Evenement\EventEmitter implements \ECSPrefix20211121\React\Stream\DuplexStreamInterface
{
    private $stream;
    /** @var LoopInterface */
    private $loop;
    ...
    public function __construct($stream, \ECSPrefix20211121\React\EventLoop\LoopInterface $loop = null, $readChunkSize = null, \ECSPrefix20211121\React\Stream\WritableStreamInterface $buffer = null)
    {
        ...
        if ($buffer === null) {
            $buffer = new \ECSPrefix20211121\React\Stream\WritableResourceStream($stream, $loop);
        }
        $this->stream = $stream;
