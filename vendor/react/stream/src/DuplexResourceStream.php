...
namespace ECSPrefix20220516\React\Stream;
...
final class DuplexResourceStream extends \ECSPrefix20220516\Evenement\EventEmitter implements \ECSPrefix20220516\React\Stream\DuplexStreamInterface
{
    private $stream;
    /** @var LoopInterface */
    private $loop;
    ...
    public function __construct($stream, \ECSPrefix20220516\React\EventLoop\LoopInterface $loop = null, $readChunkSize = null, \ECSPrefix20220516\React\Stream\WritableStreamInterface $buffer = null)
    {
        ...
        if ($buffer === null) {
            $buffer = new \ECSPrefix20220516\React\Stream\WritableResourceStream($stream, $loop);
        }
        $this->stream = $stream;
    ...
    public function pipe(\ECSPrefix20220516\React\Stream\WritableStreamInterface $dest, array $options = array())
    {
        return \ECSPrefix20220516\React\Stream\Util::pipe($this, $dest, $options);
    }
    /** @internal */
