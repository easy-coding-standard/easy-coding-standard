...
final class WritableResourceStream extends \ECSPrefix20220512\Evenement\EventEmitter implements \ECSPrefix20220512\React\Stream\WritableStreamInterface
{
    private $stream;
    /** @var LoopInterface */
    private $loop;
    ...
    private $data = '';
    public function __construct($stream, \ECSPrefix20220512\React\EventLoop\LoopInterface $loop = null, $writeBufferSoftLimit = null, $writeChunkSize = null)
    {
