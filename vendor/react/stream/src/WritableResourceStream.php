...
final class WritableResourceStream extends \ECSPrefix20220514\Evenement\EventEmitter implements \ECSPrefix20220514\React\Stream\WritableStreamInterface
{
    private $stream;
    /** @var LoopInterface */
    private $loop;
    ...
    private $data = '';
    public function __construct($stream, \ECSPrefix20220514\React\EventLoop\LoopInterface $loop = null, $writeBufferSoftLimit = null, $writeChunkSize = null)
    {
