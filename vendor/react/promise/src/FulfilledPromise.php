 ...
 */
class FulfilledPromise implements \ECSPrefix20211002\React\Promise\ExtendedPromiseInterface, \ECSPrefix20211002\React\Promise\CancellablePromiseInterface
{
    private $value;
    public function __construct($value = null)
    {
        if ($value instanceof \ECSPrefix20211002\React\Promise\PromiseInterface) {
