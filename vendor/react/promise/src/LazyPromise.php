 ...
 */
class LazyPromise implements \ECSPrefix20220124\React\Promise\ExtendedPromiseInterface, \ECSPrefix20220124\React\Promise\CancellablePromiseInterface
{
    private $factory;
    private $promise;
    ...
    public function promise()
    {
        if (null === $this->promise) {
            try {
                ...
                $this->promise = new \ECSPrefix20220124\React\Promise\RejectedPromise($exception);
