 ...
 */
class LazyPromise implements \ECSPrefix20210930\React\Promise\ExtendedPromiseInterface, \ECSPrefix20210930\React\Promise\CancellablePromiseInterface
{
    private $factory;
    private $promise;
    ...
    public function promise()
    {
        if (null === $this->promise) {
            try {
                ...
                $this->promise = new \ECSPrefix20210930\React\Promise\RejectedPromise($exception);
