 ...
 */
class LazyPromise implements \ECSPrefix20220117\React\Promise\ExtendedPromiseInterface, \ECSPrefix20220117\React\Promise\CancellablePromiseInterface
{
    private $factory;
    private $promise;
    ...
    public function promise()
    {
        if (null === $this->promise) {
            try {
                ...
                $this->promise = new \ECSPrefix20220117\React\Promise\RejectedPromise($exception);
