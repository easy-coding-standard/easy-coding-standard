 ...
 */
class LazyPromise implements \ECSPrefix20210923\React\Promise\ExtendedPromiseInterface, \ECSPrefix20210923\React\Promise\CancellablePromiseInterface
{
    private $factory;
    private $promise;
    ...
    public function promise()
    {
        if (null === $this->promise) {
            try {
                ...
                $this->promise = new \ECSPrefix20210923\React\Promise\RejectedPromise($exception);
