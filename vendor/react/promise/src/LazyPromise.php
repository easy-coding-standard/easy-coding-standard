 ...
 */
class LazyPromise implements \ECSPrefix20220202\React\Promise\ExtendedPromiseInterface, \ECSPrefix20220202\React\Promise\CancellablePromiseInterface
{
    private $factory;
    private $promise;
    ...
    public function promise()
    {
        if (null === $this->promise) {
            try {
                ...
                $this->promise = new \ECSPrefix20220202\React\Promise\RejectedPromise($exception);
