 ...
 */
class LazyPromise implements \ECSPrefix20211120\React\Promise\ExtendedPromiseInterface, \ECSPrefix20211120\React\Promise\CancellablePromiseInterface
{
    private $factory;
    private $promise;
    ...
    public function promise()
    {
        if (null === $this->promise) {
            try {
                ...
                $this->promise = new \ECSPrefix20211120\React\Promise\RejectedPromise($exception);
