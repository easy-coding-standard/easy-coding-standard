 ...
 */
class RejectedPromise implements \ECSPrefix20211120\React\Promise\ExtendedPromiseInterface, \ECSPrefix20211120\React\Promise\CancellablePromiseInterface
{
    private $reason;
    public function __construct($reason = null)
    {
        if ($reason instanceof \ECSPrefix20211120\React\Promise\PromiseInterface) {
    ...
    {
        if (null === $onRejected) {
            throw \ECSPrefix20211120\React\Promise\UnhandledRejectionException::resolve($this->reason);
        }
        $result = $onRejected($this->reason);
        if ($result instanceof self) {
            throw \ECSPrefix20211120\React\Promise\UnhandledRejectionException::resolve($result->reason);
        }
