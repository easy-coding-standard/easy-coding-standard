...
class Promise implements \ECSPrefix20211008\React\Promise\ExtendedPromiseInterface, \ECSPrefix20211008\React\Promise\CancellablePromiseInterface
{
    private $canceller;
    private $result;
    private $handlers = [];
    ...
    public function done($onFulfilled = null, $onRejected = null, $onProgress = null)
    {
        ...
        $this->handlers[] = static function (\ECSPrefix20211008\React\Promise\ExtendedPromiseInterface $promise) use($onFulfilled, $onRejected) {
    ...
    public function otherwise($onRejected)
    {
        return $this->then(null, static function ($reason) use($onRejected) {
            if (!_checkTypehint($onRejected, $reason)) {
                return new \ECSPrefix20211008\React\Promise\RejectedPromise($reason);
            }
    ...
    private function resolver(callable $onFulfilled = null, callable $onRejected = null, callable $onProgress = null)
    {
        return function ($resolve, $reject, $notify) use($onFulfilled, $onRejected, $onProgress) {
            ...
            $this->handlers[] = static function (\ECSPrefix20211008\React\Promise\ExtendedPromiseInterface $promise) use($onFulfilled, $onRejected, $resolve, $reject, $progressHandler) {
    ...
    private function settle(\ECSPrefix20211008\React\Promise\ExtendedPromiseInterface $promise)
    {
        $promise = $this->unwrap($promise);
        if ($promise === $this) {
            $promise = new \ECSPrefix20211008\React\Promise\RejectedPromise(new \LogicException('Cannot resolve a promise with itself.'));
        }
    ...
    {
        if ($promise instanceof \ECSPrefix20211008\React\Promise\LazyPromise) {
