 ...
 * ```
 */
class SelectiveTransportExecutor implements \ECSPrefix20220605\React\Dns\Query\ExecutorInterface
{
    private $datagramExecutor;
    private $streamExecutor;
    public function __construct(\ECSPrefix20220605\React\Dns\Query\ExecutorInterface $datagramExecutor, \ECSPrefix20220605\React\Dns\Query\ExecutorInterface $streamExecutor)
    {
    ...
    public function query(\ECSPrefix20220605\React\Dns\Query\Query $query)
    {
        ...
        return new \ECSPrefix20220605\React\Promise\Promise(function ($resolve, $reject) use(&$pending, $stream, $query) {
