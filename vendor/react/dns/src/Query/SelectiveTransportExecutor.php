 ...
 * ```
 */
class SelectiveTransportExecutor implements \ECSPrefix20211125\React\Dns\Query\ExecutorInterface
{
    private $datagramExecutor;
    private $streamExecutor;
    public function __construct(\ECSPrefix20211125\React\Dns\Query\ExecutorInterface $datagramExecutor, \ECSPrefix20211125\React\Dns\Query\ExecutorInterface $streamExecutor)
    {
    ...
    public function query($query)
    {
        ...
        return new \ECSPrefix20211125\React\Promise\Promise(function ($resolve, $reject) use(&$pending, $stream, $query) {
