 ...
 * ```
 */
class SelectiveTransportExecutor implements \ECSPrefix20211202\React\Dns\Query\ExecutorInterface
{
    private $datagramExecutor;
    private $streamExecutor;
    public function __construct(\ECSPrefix20211202\React\Dns\Query\ExecutorInterface $datagramExecutor, \ECSPrefix20211202\React\Dns\Query\ExecutorInterface $streamExecutor)
    {
    ...
    public function query($query)
    {
        ...
        return new \ECSPrefix20211202\React\Promise\Promise(function ($resolve, $reject) use(&$pending, $stream, $query) {
