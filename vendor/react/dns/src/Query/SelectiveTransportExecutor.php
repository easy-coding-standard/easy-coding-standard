 ...
 * ```
 */
class SelectiveTransportExecutor implements \ECSPrefix20211214\React\Dns\Query\ExecutorInterface
{
    private $datagramExecutor;
    private $streamExecutor;
    public function __construct(\ECSPrefix20211214\React\Dns\Query\ExecutorInterface $datagramExecutor, \ECSPrefix20211214\React\Dns\Query\ExecutorInterface $streamExecutor)
    {
    ...
    public function query(\ECSPrefix20211214\React\Dns\Query\Query $query)
    {
        ...
        return new \ECSPrefix20211214\React\Promise\Promise(function ($resolve, $reject) use(&$pending, $stream, $query) {
