 ...
 * ```
 */
class SelectiveTransportExecutor implements \ECSPrefix20220211\React\Dns\Query\ExecutorInterface
{
    private $datagramExecutor;
    private $streamExecutor;
    public function __construct(\ECSPrefix20220211\React\Dns\Query\ExecutorInterface $datagramExecutor, \ECSPrefix20220211\React\Dns\Query\ExecutorInterface $streamExecutor)
    {
    ...
    public function query(\ECSPrefix20220211\React\Dns\Query\Query $query)
    {
        ...
        return new \ECSPrefix20220211\React\Promise\Promise(function ($resolve, $reject) use(&$pending, $stream, $query) {
