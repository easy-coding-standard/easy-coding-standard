 ...
 * ```
 */
final class CoopExecutor implements \ECSPrefix20211210\React\Dns\Query\ExecutorInterface
{
    private $executor;
    private $pending = array();
    private $counts = array();
    public function __construct(\ECSPrefix20211210\React\Dns\Query\ExecutorInterface $base)
    {
        $this->executor = $base;
    }
    ...
    private function serializeQueryToIdentity(\ECSPrefix20211210\React\Dns\Query\Query $query)
    {
