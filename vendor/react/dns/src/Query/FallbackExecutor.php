...
final class FallbackExecutor implements \ECSPrefix20220516\React\Dns\Query\ExecutorInterface
{
    private $executor;
    private $fallback;
    public function __construct(\ECSPrefix20220516\React\Dns\Query\ExecutorInterface $executor, \ECSPrefix20220516\React\Dns\Query\ExecutorInterface $fallback)
    {
    ...
    public function query(\ECSPrefix20220516\React\Dns\Query\Query $query)
    {
        ...
        return new \ECSPrefix20220516\React\Promise\Promise(function ($resolve, $reject) use(&$promise, $fallback, $query, &$cancelled) {
