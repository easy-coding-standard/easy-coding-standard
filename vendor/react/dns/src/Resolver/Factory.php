...
namespace ECSPrefix202305\React\Dns\Resolver;

use ECSPrefix202305\React\Cache\ArrayCache;
use ECSPrefix202305\React\Cache\CacheInterface;
use ECSPrefix202305\React\Dns\Config\Config;
use ECSPrefix202305\React\Dns\Config\HostsFile;
use ECSPrefix202305\React\Dns\Query\CachingExecutor;
use ECSPrefix202305\React\Dns\Query\CoopExecutor;
use ECSPrefix202305\React\Dns\Query\ExecutorInterface;
use ECSPrefix202305\React\Dns\Query\FallbackExecutor;
use ECSPrefix202305\React\Dns\Query\HostsFileExecutor;
use ECSPrefix202305\React\Dns\Query\RetryExecutor;
use ECSPrefix202305\React\Dns\Query\SelectiveTransportExecutor;
use ECSPrefix202305\React\Dns\Query\TcpTransportExecutor;
use ECSPrefix202305\React\Dns\Query\TimeoutExecutor;
use ECSPrefix202305\React\Dns\Query\UdpTransportExecutor;
