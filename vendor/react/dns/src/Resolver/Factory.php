...
namespace ECSPrefix202302\React\Dns\Resolver;

use ECSPrefix202302\React\Cache\ArrayCache;
use ECSPrefix202302\React\Cache\CacheInterface;
use ECSPrefix202302\React\Dns\Config\Config;
use ECSPrefix202302\React\Dns\Config\HostsFile;
use ECSPrefix202302\React\Dns\Query\CachingExecutor;
use ECSPrefix202302\React\Dns\Query\CoopExecutor;
use ECSPrefix202302\React\Dns\Query\ExecutorInterface;
use ECSPrefix202302\React\Dns\Query\FallbackExecutor;
use ECSPrefix202302\React\Dns\Query\HostsFileExecutor;
use ECSPrefix202302\React\Dns\Query\RetryExecutor;
use ECSPrefix202302\React\Dns\Query\SelectiveTransportExecutor;
use ECSPrefix202302\React\Dns\Query\TcpTransportExecutor;
use ECSPrefix202302\React\Dns\Query\TimeoutExecutor;
use ECSPrefix202302\React\Dns\Query\UdpTransportExecutor;
