...
namespace ECSPrefix202405\React\Dns\Resolver;

use ECSPrefix202405\React\Cache\ArrayCache;
use ECSPrefix202405\React\Cache\CacheInterface;
use ECSPrefix202405\React\Dns\Config\Config;
use ECSPrefix202405\React\Dns\Config\HostsFile;
use ECSPrefix202405\React\Dns\Query\CachingExecutor;
use ECSPrefix202405\React\Dns\Query\CoopExecutor;
use ECSPrefix202405\React\Dns\Query\ExecutorInterface;
use ECSPrefix202405\React\Dns\Query\FallbackExecutor;
use ECSPrefix202405\React\Dns\Query\HostsFileExecutor;
use ECSPrefix202405\React\Dns\Query\RetryExecutor;
use ECSPrefix202405\React\Dns\Query\SelectiveTransportExecutor;
use ECSPrefix202405\React\Dns\Query\TcpTransportExecutor;
use ECSPrefix202405\React\Dns\Query\TimeoutExecutor;
use ECSPrefix202405\React\Dns\Query\UdpTransportExecutor;
