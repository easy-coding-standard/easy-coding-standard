...
namespace ECSPrefix202303\React\Dns\Resolver;

use ECSPrefix202303\React\Cache\ArrayCache;
use ECSPrefix202303\React\Cache\CacheInterface;
use ECSPrefix202303\React\Dns\Config\Config;
use ECSPrefix202303\React\Dns\Config\HostsFile;
use ECSPrefix202303\React\Dns\Query\CachingExecutor;
use ECSPrefix202303\React\Dns\Query\CoopExecutor;
use ECSPrefix202303\React\Dns\Query\ExecutorInterface;
use ECSPrefix202303\React\Dns\Query\FallbackExecutor;
use ECSPrefix202303\React\Dns\Query\HostsFileExecutor;
use ECSPrefix202303\React\Dns\Query\RetryExecutor;
use ECSPrefix202303\React\Dns\Query\SelectiveTransportExecutor;
use ECSPrefix202303\React\Dns\Query\TcpTransportExecutor;
use ECSPrefix202303\React\Dns\Query\TimeoutExecutor;
use ECSPrefix202303\React\Dns\Query\UdpTransportExecutor;
