...
namespace ECSPrefix202505\React\Dns\Resolver;

use ECSPrefix202505\React\Cache\ArrayCache;
use ECSPrefix202505\React\Cache\CacheInterface;
use ECSPrefix202505\React\Dns\Config\Config;
use ECSPrefix202505\React\Dns\Config\HostsFile;
use ECSPrefix202505\React\Dns\Query\CachingExecutor;
use ECSPrefix202505\React\Dns\Query\CoopExecutor;
use ECSPrefix202505\React\Dns\Query\ExecutorInterface;
use ECSPrefix202505\React\Dns\Query\FallbackExecutor;
use ECSPrefix202505\React\Dns\Query\HostsFileExecutor;
use ECSPrefix202505\React\Dns\Query\RetryExecutor;
use ECSPrefix202505\React\Dns\Query\SelectiveTransportExecutor;
use ECSPrefix202505\React\Dns\Query\TcpTransportExecutor;
use ECSPrefix202505\React\Dns\Query\TimeoutExecutor;
use ECSPrefix202505\React\Dns\Query\UdpTransportExecutor;
