...
namespace ECSPrefix20211025\React\Dns\Model;
...
final class Message
{
     ...
     * @return self
     */
    public static function createRequestForQuery(\ECSPrefix20211025\React\Dns\Query\Query $query)
    {
        $request = new \ECSPrefix20211025\React\Dns\Model\Message();
     ...
     * @return self
     */
    public static function createResponseWithAnswersForQuery(\ECSPrefix20211025\React\Dns\Query\Query $query, array $answers)
    {
        $response = new \ECSPrefix20211025\React\Dns\Model\Message();
     ...
     * @see self::RCODE_OK
     */
    public $rcode = \ECSPrefix20211025\React\Dns\Model\Message::RCODE_OK;
    /**
