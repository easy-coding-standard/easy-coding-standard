...
namespace ECSPrefix20220511\React\Dns\Model;
...
final class Message
{
     ...
     * @return self
     */
    public static function createRequestForQuery(\ECSPrefix20220511\React\Dns\Query\Query $query)
    {
        $request = new \ECSPrefix20220511\React\Dns\Model\Message();
     ...
     * @return self
     */
    public static function createResponseWithAnswersForQuery(\ECSPrefix20220511\React\Dns\Query\Query $query, array $answers)
    {
        $response = new \ECSPrefix20220511\React\Dns\Model\Message();
     ...
     * @see self::RCODE_OK
     */
    public $rcode = \ECSPrefix20220511\React\Dns\Model\Message::RCODE_OK;
    /**
