 ...
 * SQLite storage.
 */
class SQLiteStorage implements \ECSPrefix20210510\Nette\Caching\Storage, \ECSPrefix20210510\Nette\Caching\BulkReader
{
    ...
    {
        $key = (string) $key;
        $expire = isset($dependencies[\ECSPrefix20210510\Nette\Caching\Cache::EXPIRATION]) ? $dependencies[\ECSPrefix20210510\Nette\Caching\Cache::EXPIRATION] + \time() : null;
        $slide = isset($dependencies[\ECSPrefix20210510\Nette\Caching\Cache::SLIDING]) ? $dependencies[\ECSPrefix20210510\Nette\Caching\Cache::EXPIRATION] : null;
    ...
    public function clean(array $conditions)
    {
        if (!empty($conditions[\ECSPrefix20210510\Nette\Caching\Cache::ALL])) {
            ...
            if (!empty($conditions[\ECSPrefix20210510\Nette\Caching\Cache::TAGS])) {
                $tags = $conditions[\ECSPrefix20210510\Nette\Caching\Cache::TAGS];
