...
class Helpers
{
    ...
    public static function getLastError() : string
    {
        ...
        $message = \ini_get('html_errors') ? \ECSPrefix20220602\Nette\Utils\Html::htmlToText($message) : $message;
    ...
    {
        if ($min > $max) {
            throw new \ECSPrefix20220602\Nette\InvalidArgumentException("Minimum ({$min}) is not less than maximum ({$max}).");
        }
