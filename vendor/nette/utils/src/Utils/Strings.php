...
namespace ECSPrefix202301\Nette\Utils;

use ECSPrefix202301\JetBrains\PhpStorm\Language;
use ECSPrefix202301\Nette;
...
class Strings
{
     ...
     */
    public static function split(string $subject, #[\JetBrains\PhpStorm\Language('RegExp')] string $pattern, int $flags = 0) : array
    {
     ...
     */
    public static function match(string $subject, #[\JetBrains\PhpStorm\Language('RegExp')] string $pattern, int $flags = 0, int $offset = 0) : ?array
    {
     ...
     */
    public static function matchAll(string $subject, #[\JetBrains\PhpStorm\Language('RegExp')] string $pattern, int $flags = 0, int $offset = 0) : array
    {
        if ($offset > strlen($subject)) {
            return [];
        }
     ...
     */
    public static function replace(string $subject, #[\JetBrains\PhpStorm\Language('RegExp')] $pattern, $replacement = '', int $limit = -1) : string
    {
