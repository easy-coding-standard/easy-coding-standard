...
use ECSPrefix20210611\Nette\MemberAccessException;
/**
...
final class ObjectHelpers
{
    ...
    public static function strictGet(string $class, string $name)
    {
        ...
        throw new \ECSPrefix20210611\Nette\MemberAccessException("Cannot read an undeclared property {$class}::\${$name}" . ($hint ? ", did you mean \${$hint}?" : '.'));
    }
    /** @throws MemberAccessException
     * @return void */
    public static function strictSet(string $class, string $name)
    {
        ...
        throw new \ECSPrefix20210611\Nette\MemberAccessException("Cannot write to an undeclared property {$class}::\${$name}" . ($hint ? ", did you mean \${$hint}?" : '.'));
    }
    /** @throws MemberAccessException
     * @return void */
    public static function strictCall(string $class, string $method, array $additionalMethods = [])
    {
        ...
        throw new \ECSPrefix20210611\Nette\MemberAccessException("Call to undefined method {$class}::{$method}()" . ($hint ? ", did you mean {$hint}()?" : '.'));
    }
    /** @throws MemberAccessException
     * @return void */
    public static function strictStaticCall(string $class, string $method)
    {
        ...
        throw new \ECSPrefix20210611\Nette\MemberAccessException("Call to undefined static method {$class}::{$method}()" . ($hint ? ", did you mean {$hint}()?" : '.'));
    }
    /**
