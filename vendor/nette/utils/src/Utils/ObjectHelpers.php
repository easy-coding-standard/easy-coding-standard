...
use ECSPrefix20210728\Nette\MemberAccessException;
/**
...
final class ObjectHelpers
{
    ...
    public static function strictGet($class, $name)
    {
        ...
        throw new \ECSPrefix20210728\Nette\MemberAccessException("Cannot read an undeclared property {$class}::\${$name}" . ($hint ? ", did you mean \${$hint}?" : '.'));
    }
    /** @throws MemberAccessException
     * @param string $class
     * @param string $name
    ...
    public static function strictSet($class, $name)
    {
        ...
        throw new \ECSPrefix20210728\Nette\MemberAccessException("Cannot write to an undeclared property {$class}::\${$name}" . ($hint ? ", did you mean \${$hint}?" : '.'));
    }
    /** @throws MemberAccessException
     * @param string $class
     * @param string $method
    ...
    public static function strictCall($class, $method, $additionalMethods = [])
    {
        ...
        throw new \ECSPrefix20210728\Nette\MemberAccessException("Call to undefined method {$class}::{$method}()" . ($hint ? ", did you mean {$hint}()?" : '.'));
    }
    /** @throws MemberAccessException
     * @param string $class
     * @param string $method
    ...
    public static function strictStaticCall($class, $method)
    {
        ...
        throw new \ECSPrefix20210728\Nette\MemberAccessException("Call to undefined static method {$class}::{$method}()" . ($hint ? ", did you mean {$hint}()?" : '.'));
    }
    /**
