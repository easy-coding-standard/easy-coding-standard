 ...
 */
class Html implements \ArrayAccess, \Countable, \IteratorAggregate, \ECSPrefix20210507\Nette\HtmlStringable
{
    ...
    {
        if (!$text instanceof \ECSPrefix20210507\Nette\HtmlStringable) {
