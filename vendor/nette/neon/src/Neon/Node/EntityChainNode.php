...
use ECSPrefix20211127\Nette\Neon;
use ECSPrefix20211127\Nette\Neon\Node;
/** @internal */
final class EntityChainNode extends \ECSPrefix20211127\Nette\Neon\Node
{
    /** @var EntityNode[] */
    public $chain = [];
    ...
    public function toValue() : \ECSPrefix20211127\Nette\Neon\Entity
    {
        ...
        return new \ECSPrefix20211127\Nette\Neon\Entity(\ECSPrefix20211127\Nette\Neon\Neon::CHAIN, $entities);
    }
