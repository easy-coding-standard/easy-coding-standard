...
use ECSPrefix20220325\Nette\Neon;
use ECSPrefix20220325\Nette\Neon\Node;
/** @internal */
final class EntityChainNode extends \ECSPrefix20220325\Nette\Neon\Node
{
    /** @var EntityNode[] */
    public $chain = [];
    ...
    public function toValue() : \ECSPrefix20220325\Nette\Neon\Entity
    {
        ...
        return new \ECSPrefix20220325\Nette\Neon\Entity(\ECSPrefix20220325\Nette\Neon\Neon::Chain, $entities);
    }
