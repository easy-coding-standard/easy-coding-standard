...
use ECSPrefix20220115\Nette\Neon;
use ECSPrefix20220115\Nette\Neon\Node;
/** @internal */
final class EntityChainNode extends \ECSPrefix20220115\Nette\Neon\Node
{
    /** @var EntityNode[] */
    public $chain = [];
    ...
    public function toValue() : \ECSPrefix20220115\Nette\Neon\Entity
    {
        ...
        return new \ECSPrefix20220115\Nette\Neon\Entity(\ECSPrefix20220115\Nette\Neon\Neon::CHAIN, $entities);
    }
