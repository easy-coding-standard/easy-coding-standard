...
final class Neon
{
    public const BLOCK = \ECSPrefix20220524\Nette\Neon\Encoder::BLOCK;
    ...
    {
        $encoder = new \ECSPrefix20220524\Nette\Neon\Encoder();
    ...
    {
        $decoder = new \ECSPrefix20220524\Nette\Neon\Decoder();
    ...
    {
        if (!\is_file($file)) {
            throw new \ECSPrefix20220524\Nette\Neon\Exception("File '{$file}' does not exist.");
        }
