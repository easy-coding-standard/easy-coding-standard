...
final class Neon
{
    public const BLOCK = \ECSPrefix20211030\Nette\Neon\Encoder::BLOCK;
    ...
    {
        $encoder = new \ECSPrefix20211030\Nette\Neon\Encoder();
    ...
    public static function decode(string $input)
    {
        ...
        $decoder = new \ECSPrefix20211030\Nette\Neon\Decoder();
