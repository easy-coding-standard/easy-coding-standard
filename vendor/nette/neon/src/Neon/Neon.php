...
final class Neon
{
    const BLOCK = \ECSPrefix20210513\Nette\Neon\Encoder::BLOCK;
    const CHAIN = '!!chain';
    /**
    ...
    {
        $flags = (int) $flags;
        $encoder = new \ECSPrefix20210513\Nette\Neon\Encoder();
    ...
    {
        $input = (string) $input;
        $decoder = new \ECSPrefix20210513\Nette\Neon\Decoder();
