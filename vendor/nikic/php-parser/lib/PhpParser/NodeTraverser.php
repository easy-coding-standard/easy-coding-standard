...
class NodeTraverser implements \ConfigTransformer20210601\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    protected function traverseNode(\ConfigTransformer20210601\PhpParser\Node $node) : \ConfigTransformer20210601\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \ConfigTransformer20210601\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \ConfigTransformer20210601\PhpParser\Node) {
    ...
    {
        if ($old instanceof \ConfigTransformer20210601\PhpParser\Node\Stmt && $new instanceof \ConfigTransformer20210601\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \ConfigTransformer20210601\PhpParser\Node\Expr && $new instanceof \ConfigTransformer20210601\PhpParser\Node\Stmt) {
