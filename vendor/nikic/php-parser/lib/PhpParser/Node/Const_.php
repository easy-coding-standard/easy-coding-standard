 ...
 */
class Const_ extends \ECSPrefix20210804\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \ECSPrefix20210804\PhpParser\Node\Expr $value, array $attributes = [])
    {
