...
class NullsafeMethodCall extends \ConfigTransformer20210601\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\ConfigTransformer20210601\PhpParser\Node\Expr $var, $name, array $args = [], array $attributes = [])
    {
