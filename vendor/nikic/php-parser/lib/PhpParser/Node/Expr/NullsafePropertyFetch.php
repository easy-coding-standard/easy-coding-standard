...
class NullsafePropertyFetch extends \ECSPrefix20210803\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\ECSPrefix20210803\PhpParser\Node\Expr $var, $name, array $attributes = [])
    {
