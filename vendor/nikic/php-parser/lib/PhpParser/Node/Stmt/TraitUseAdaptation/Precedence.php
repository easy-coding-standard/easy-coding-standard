...
class Precedence extends \ECSPrefix20210804\PhpParser\Node\Stmt\TraitUseAdaptation
{
     ...
     */
    public function __construct(\ECSPrefix20210804\PhpParser\Node\Name $trait, $method, array $insteadof, array $attributes = [])
    {
