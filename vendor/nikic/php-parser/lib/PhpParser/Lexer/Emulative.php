...
namespace ECSPrefix202606\PhpParser\Lexer;

use ECSPrefix202606\PhpParser\Error;
use ECSPrefix202606\PhpParser\ErrorHandler;
use ECSPrefix202606\PhpParser\Lexer;
use ECSPrefix202606\PhpParser\Lexer\TokenEmulator\AsymmetricVisibilityTokenEmulator;
use ECSPrefix202606\PhpParser\Lexer\TokenEmulator\AttributeEmulator;
use ECSPrefix202606\PhpParser\Lexer\TokenEmulator\EnumTokenEmulator;
use ECSPrefix202606\PhpParser\Lexer\TokenEmulator\ExplicitOctalEmulator;
use ECSPrefix202606\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use ECSPrefix202606\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use ECSPrefix202606\PhpParser\Lexer\TokenEmulator\PipeOperatorEmulator;
use ECSPrefix202606\PhpParser\Lexer\TokenEmulator\PropertyTokenEmulator;
use ECSPrefix202606\PhpParser\Lexer\TokenEmulator\ReadonlyFunctionTokenEmulator;
use ECSPrefix202606\PhpParser\Lexer\TokenEmulator\ReadonlyTokenEmulator;
use ECSPrefix202606\PhpParser\Lexer\TokenEmulator\ReverseEmulator;
use ECSPrefix202606\PhpParser\Lexer\TokenEmulator\TokenEmulator;
use ECSPrefix202606\PhpParser\Lexer\TokenEmulator\VoidCastEmulator;
