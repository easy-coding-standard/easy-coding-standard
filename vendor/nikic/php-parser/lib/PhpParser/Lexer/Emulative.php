...
namespace ECSPrefix202607\PhpParser\Lexer;

use ECSPrefix202607\PhpParser\Error;
use ECSPrefix202607\PhpParser\ErrorHandler;
use ECSPrefix202607\PhpParser\Lexer;
use ECSPrefix202607\PhpParser\Lexer\TokenEmulator\AsymmetricVisibilityTokenEmulator;
use ECSPrefix202607\PhpParser\Lexer\TokenEmulator\AttributeEmulator;
use ECSPrefix202607\PhpParser\Lexer\TokenEmulator\EnumTokenEmulator;
use ECSPrefix202607\PhpParser\Lexer\TokenEmulator\ExplicitOctalEmulator;
use ECSPrefix202607\PhpParser\Lexer\TokenEmulator\FnTokenEmulator;
use ECSPrefix202607\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use ECSPrefix202607\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use ECSPrefix202607\PhpParser\Lexer\TokenEmulator\PipeOperatorEmulator;
use ECSPrefix202607\PhpParser\Lexer\TokenEmulator\PropertyTokenEmulator;
use ECSPrefix202607\PhpParser\Lexer\TokenEmulator\ReadonlyFunctionTokenEmulator;
use ECSPrefix202607\PhpParser\Lexer\TokenEmulator\ReadonlyTokenEmulator;
use ECSPrefix202607\PhpParser\Lexer\TokenEmulator\ReverseEmulator;
use ECSPrefix202607\PhpParser\Lexer\TokenEmulator\TokenEmulator;
use ECSPrefix202607\PhpParser\Lexer\TokenEmulator\VoidCastEmulator;
