...
class Use_ implements \ConfigTransformer20210601\PhpParser\Builder
{
    protected $name;
    protected $type;
    ...
    {
        $this->name = \ConfigTransformer20210601\PhpParser\BuilderHelpers::normalizeName($name);
        $this->type = $type;
    }
    /**
    ...
    {
        return new \ConfigTransformer20210601\PhpParser\Node\Stmt\Use_([new \ConfigTransformer20210601\PhpParser\Node\Stmt\UseUse($this->name, $this->alias)], $this->type);
    }
}
