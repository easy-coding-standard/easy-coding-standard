...
final class NullableTypeTransformer extends AbstractTransformer
{
    ...
    public function process(Tokens $tokens, Token $token, int $index) : void
    {
        ...
        static $types;
        if (null === $types) {
            $types = ['(', ',', [CT::T_TYPE_COLON], [CT::T_CONSTRUCTOR_PROPERTY_PROMOTION_PUBLIC], [CT::T_CONSTRUCTOR_PROPERTY_PROMOTION_PROTECTED], [CT::T_CONSTRUCTOR_PROPERTY_PROMOTION_PRIVATE], [CT::T_ATTRIBUTE_CLOSE], [\T_PRIVATE], [\T_PROTECTED], [\T_PUBLIC], [\T_VAR], [\T_STATIC], [\T_CONST]];
