...
final class BraceClassInstantiationTransformer extends AbstractTransformer
{
    ...
    public function processToken(Tokens $tokens, Token $token, int $index): void
    {
        ...
        if ($tokens[$tokens->getPrevMeaningfulToken($index)]->equalsAny([')', ']', [CT::T_ARRAY_INDEX_BRACE_CLOSE], [CT::T_ARRAY_BRACKET_CLOSE], [CT::T_CLASS_INSTANTIATION_PARENTHESIS_CLOSE], [\T_ARRAY], [\T_CLASS], [\T_ELSEIF], [\T_FOR], [\T_FOREACH], [\T_IF], [\T_STATIC], [\T_STRING], [\T_SWITCH], [\T_VARIABLE], [\T_WHILE]])) {
            return;
        }
