...
use ECSPrefix202508\React\Socket\TcpServer;
...
final class Runner
{
    ...
    private function fixFile(\SplFileInfo $file, LintingResultInterface $lintingResult) : ?array
    {
        ...
        if (Utils::isFutureModeEnabled() && !\filter_var(\getenv('PHP_CS_FIXER_NON_MONOLITHIC'), \FILTER_VALIDATE_BOOL) && !$tokens->isMonolithicPhp()) {
