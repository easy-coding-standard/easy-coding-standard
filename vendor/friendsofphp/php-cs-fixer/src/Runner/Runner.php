...
use ECSPrefix202412\React\Socket\TcpServer;
...
final class Runner
{
    ...
    private function fixFile(\SplFileInfo $file, LintingResultInterface $lintingResult) : ?array
    {
        ...
        $this->dispatchEvent(FileProcessed::NAME, new FileProcessed(null !== $fixInfo ? FileProcessed::STATUS_FIXED : FileProcessed::STATUS_NO_CHANGES, $name, $newHash));
        return $fixInfo;
    }
    /**
