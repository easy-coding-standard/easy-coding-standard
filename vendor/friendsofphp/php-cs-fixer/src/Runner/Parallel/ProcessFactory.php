...
use ECSPrefix202412\Symfony\Component\Process\PhpExecutableFinder;
/**
...
final class ProcessFactory
{
    ...
    public function getCommandArgs(int $serverPort, \PhpCsFixer\Runner\Parallel\ProcessIdentifier $identifier, RunnerConfig $runnerConfig) : array
    {
        ...
        $commandArgs = [\escapeshellarg($phpBinary), \escapeshellarg($mainScript), 'worker', '--port', (string) $serverPort, '--identifier', \escapeshellarg($identifier->toString())];
