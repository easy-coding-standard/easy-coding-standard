...
final class FileFilterIterator extends \FilterIterator
{
     ...
     * @return void
     */
    private function dispatchEvent(string $name, \ECSPrefix20210520\Symfony\Contracts\EventDispatcher\Event $event)
    {
        if (null === $this->eventDispatcher) {
            return;
        }
        // BC compatibility < Sf 4.3
        if (!$this->eventDispatcher instanceof \ECSPrefix20210520\Symfony\Contracts\EventDispatcher\EventDispatcherInterface) {
