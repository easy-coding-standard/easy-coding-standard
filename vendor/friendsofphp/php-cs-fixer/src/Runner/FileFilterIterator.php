...
use ECSPrefix20220219\Symfony\Contracts\EventDispatcher\Event;
/**
...
final class FileFilterIterator extends \FilterIterator
{
    ...
    public function __construct(\Traversable $iterator, ?\ECSPrefix20220219\Symfony\Component\EventDispatcher\EventDispatcherInterface $eventDispatcher, \PhpCsFixer\Cache\CacheManagerInterface $cacheManager)
    {
    ...
    private function dispatchEvent(string $name, \ECSPrefix20220219\Symfony\Contracts\EventDispatcher\Event $event) : void
    {
