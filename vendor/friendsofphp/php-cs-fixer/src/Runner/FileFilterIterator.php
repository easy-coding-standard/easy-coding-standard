...
use ECSPrefix20211102\Symfony\Contracts\EventDispatcher\Event;
/**
...
final class FileFilterIterator extends \FilterIterator
{
    ...
    public function __construct(\Traversable $iterator, ?\ECSPrefix20211102\Symfony\Component\EventDispatcher\EventDispatcherInterface $eventDispatcher, \PhpCsFixer\Cache\CacheManagerInterface $cacheManager)
    {
    ...
    private function dispatchEvent(string $name, \ECSPrefix20211102\Symfony\Contracts\EventDispatcher\Event $event) : void
    {
