...
final class FileFilterIterator extends \FilterIterator
{
     ...
     * @param string $name
     */
    private function dispatchEvent($name, \ECSPrefix20210515\Symfony\Contracts\EventDispatcher\Event $event)
    {
        $name = (string) $name;
        ...
        if (!$this->eventDispatcher instanceof \ECSPrefix20210515\Symfony\Contracts\EventDispatcher\EventDispatcherInterface) {
