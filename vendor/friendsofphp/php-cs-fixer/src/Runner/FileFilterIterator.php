...
use ECSPrefix20220417\Symfony\Contracts\EventDispatcher\Event;
/**
...
final class FileFilterIterator extends \FilterIterator
{
    ...
    public function __construct(\Traversable $iterator, ?\ECSPrefix20220417\Symfony\Component\EventDispatcher\EventDispatcherInterface $eventDispatcher, \PhpCsFixer\Cache\CacheManagerInterface $cacheManager)
    {
    ...
    private function dispatchEvent(string $name, \ECSPrefix20220417\Symfony\Contracts\EventDispatcher\Event $event) : void
    {
