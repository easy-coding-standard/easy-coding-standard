...
abstract class AbstractPhpdocToTypeDeclarationFixer extends \PhpCsFixer\AbstractFixer implements ConfigurableFixerInterface
{
     ...
     */
    protected abstract function createTokensFromRawType(string $type) : Tokens;
    /**
    ...
    protected function getUnionTypes(TypeExpression $typesExpression, bool $isReturnType) : ?string
    {
        ...
        foreach ($types as $type) {
            ...
            if (!$containsOtherThanIterableType && !\in_array($commonType, ['array', 'Traversable', 'iterable'], \true)) {
