...
final class FixerConfigurationResolver implements \PhpCsFixer\FixerConfiguration\FixerConfigurationResolverInterface
{
    ...
    {
        $resolver = new \ECSPrefix20210601\Symfony\Component\OptionsResolver\OptionsResolver();
            ...
            if ($option instanceof \PhpCsFixer\FixerConfiguration\AliasedFixerOption) {
                ...
                if (\array_key_exists($alias, $options)) {
                    if (\array_key_exists($name, $options)) {
                        throw new \ECSPrefix20210601\Symfony\Component\OptionsResolver\Exception\InvalidOptionsException(\sprintf('Aliased option "%s"/"%s" is passed multiple times.', $name, $alias));
                    }
