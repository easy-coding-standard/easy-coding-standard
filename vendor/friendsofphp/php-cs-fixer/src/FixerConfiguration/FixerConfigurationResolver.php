...
final class FixerConfigurationResolver implements \PhpCsFixer\FixerConfiguration\FixerConfigurationResolverInterface
{
    ...
    {
        $resolver = new \ECSPrefix20211122\Symfony\Component\OptionsResolver\OptionsResolver();
            ...
            if ($option instanceof \PhpCsFixer\FixerConfiguration\AliasedFixerOption) {
                ...
                if (\array_key_exists($alias, $configuration)) {
                    if (\array_key_exists($name, $configuration)) {
                        throw new \ECSPrefix20211122\Symfony\Component\OptionsResolver\Exception\InvalidOptionsException(\sprintf('Aliased option "%s"/"%s" is passed multiple times.', $name, $alias));
                    }
