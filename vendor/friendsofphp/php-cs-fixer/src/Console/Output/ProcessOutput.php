...
final class ProcessOutput implements \PhpCsFixer\Console\Output\ProcessOutputInterface
{
    ...
    public function __construct(\ECSPrefix20211208\Symfony\Component\Console\Output\OutputInterface $output, \ECSPrefix20211208\Symfony\Component\EventDispatcher\EventDispatcherInterface $dispatcher, int $width, int $nbFiles)
    {
        $this->output = $output;
