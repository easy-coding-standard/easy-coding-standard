...
final class ProcessOutput implements \PhpCsFixer\Console\Output\ProcessOutputInterface
{
     ...
     * @param int $nbFiles
     */
    public function __construct(\ECSPrefix20210513\Symfony\Component\Console\Output\OutputInterface $output, \ECSPrefix20210513\Symfony\Component\EventDispatcher\EventDispatcherInterface $dispatcher, $width, $nbFiles)
    {
        $width = (int) $width;
        $nbFiles = (int) $nbFiles;
        $this->output = $output;
