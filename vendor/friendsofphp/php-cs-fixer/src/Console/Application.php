...
use ECSPrefix20210512\Symfony\Component\Console\Application as BaseApplication;
 ...
 * @internal
 */
final class Application extends \ECSPrefix20210512\Symfony\Component\Console\Application
{
    const VERSION = '3.0.0';
    ...
    {
        $stdErr = $output instanceof \ECSPrefix20210512\Symfony\Component\Console\Output\ConsoleOutputInterface ? $output->getErrorOutput() : ($input->hasParameterOption('--format', \true) && 'txt' !== $input->getParameterOption('--format', null, \true) ? null : $output);
        if (null !== $stdErr) {
        ...
        if (null !== $stdErr && $output->getVerbosity() >= \ECSPrefix20210512\Symfony\Component\Console\Output\OutputInterface::VERBOSITY_VERBOSE) {
    ...
    {
        return [new \PhpCsFixer\Console\Command\HelpCommand(), new \ECSPrefix20210512\Symfony\Component\Console\Command\ListCommand()];
    }
}
