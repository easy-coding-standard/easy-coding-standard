...
use ECSPrefix20210517\Symfony\Component\Console\Application as BaseApplication;
 ...
 * @internal
 */
final class Application extends \ECSPrefix20210517\Symfony\Component\Console\Application
{
    const VERSION = '3.0.0';
    ...
    public function doRun(\ECSPrefix20210517\Symfony\Component\Console\Input\InputInterface $input, \ECSPrefix20210517\Symfony\Component\Console\Output\OutputInterface $output)
    {
        ...
        if (null !== $stdErr && $output->getVerbosity() >= \ECSPrefix20210517\Symfony\Component\Console\Output\OutputInterface::VERBOSITY_VERBOSE) {
