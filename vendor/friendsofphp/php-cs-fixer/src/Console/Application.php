...
use ECSPrefix20220219\Symfony\Component\Console\Application as BaseApplication;
 ...
 * @internal
 */
final class Application extends \ECSPrefix20220219\Symfony\Component\Console\Application
{
    ...
    {
        $stdErr = $output instanceof \ECSPrefix20220219\Symfony\Component\Console\Output\ConsoleOutputInterface ? $output->getErrorOutput() : ($input->hasParameterOption('--format', \true) && 'txt' !== $input->getParameterOption('--format', null, \true) ? null : $output);
        if (null !== $stdErr) {
        ...
        if (null !== $stdErr && $output->getVerbosity() >= \ECSPrefix20220219\Symfony\Component\Console\Output\OutputInterface::VERBOSITY_VERBOSE) {
    ...
    {
        return [new \PhpCsFixer\Console\Command\HelpCommand(), new \ECSPrefix20220219\Symfony\Component\Console\Command\ListCommand()];
    }
}
