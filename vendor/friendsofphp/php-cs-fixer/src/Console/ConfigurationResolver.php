...
use ECSPrefix202306\Symfony\Component\Finder\Finder as SymfonyFinder;
/**
        ...
        if (null === $this->progress) {
            if (OutputInterface::VERBOSITY_VERBOSE <= $this->options['verbosity'] && 'txt' === $this->getFormat()) {
                ...
                if (null === $progressType) {
                    ...
                    throw new InvalidConfigurationException(\sprintf('The progress type "%s" is not defined, supported are %s.', $progressType, Utils::naturalLanguageJoin($progressTypes)));
                }
