...
use ECSPrefix20210827\Symfony\Component\Finder\Finder as SymfonyFinder;
/**
...
final class ConfigurationResolver
{
    ...
    public function getProgress() : string
    {
        if (null === $this->progress) {
            if (\ECSPrefix20210827\Symfony\Component\Console\Output\OutputInterface::VERBOSITY_VERBOSE <= $this->options['verbosity'] && 'txt' === $this->getFormat()) {
    ...
    private function resolveFinder() : iterable
    {
        ...
        if ($currentFinder instanceof \ECSPrefix20210827\Symfony\Component\Finder\Finder && null === $nestedFinder) {
