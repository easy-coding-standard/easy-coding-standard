 ...
 * @internal
 */
final class SelfUpdateCommand extends \ECSPrefix20211114\Symfony\Component\Console\Command\Command
{
    /**
     * @var string
     */
    ...
    {
        $this->setAliases(['selfupdate'])->setDefinition([new \ECSPrefix20211114\Symfony\Component\Console\Input\InputOption('--force', '-f', \ECSPrefix20211114\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Force update to next major version if available.')])->setDescription('Update php-cs-fixer.phar to the latest stable version.')->setHelp(<<<'EOT'
