 ...
 * @internal
 */
final class SelfUpdateCommand extends \ECSPrefix20210612\Symfony\Component\Console\Command\Command
{
    ...
    {
        $this->setAliases(['selfupdate'])->setDefinition([new \ECSPrefix20210612\Symfony\Component\Console\Input\InputOption('--force', '-f', \ECSPrefix20210612\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Force update to next major version if available.')])->setDescription('Update php-cs-fixer.phar to the latest stable version.')->setHelp(<<<'EOT'
