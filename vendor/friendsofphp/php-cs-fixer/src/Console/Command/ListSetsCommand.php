 ...
 * @internal
 */
final class ListSetsCommand extends \ECSPrefix20211230\Symfony\Component\Console\Command\Command
{
    /**
     * @var string
     */
    ...
    protected function execute(\ECSPrefix20211230\Symfony\Component\Console\Input\InputInterface $input, \ECSPrefix20211230\Symfony\Component\Console\Output\OutputInterface $output)
    {
        ...
        $output->isDecorated() ? $output->write(\ECSPrefix20211230\Symfony\Component\Console\Formatter\OutputFormatter::escape($report)) : $output->write($report, \false, \ECSPrefix20211230\Symfony\Component\Console\Output\OutputInterface::OUTPUT_RAW);
        return 0;
    }
