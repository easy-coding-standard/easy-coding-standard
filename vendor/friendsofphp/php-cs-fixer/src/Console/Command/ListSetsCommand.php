...
final class ListSetsCommand extends Command
{
    ...
    protected function configure() : void
    {
        ...
        $this->setDefinition([new InputOption('format', '', InputOption::VALUE_REQUIRED, \sprintf('To output results in other formats (can be %s).', \implode(', ', \array_map(static function ($format) {
            return \sprintf('`%s`', $format);
        }, $formats))), (new TextReporter())->getFormat())]);
    }
