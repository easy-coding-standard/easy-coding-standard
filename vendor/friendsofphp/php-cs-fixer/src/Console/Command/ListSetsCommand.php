 ...
 * @internal
 */
final class ListSetsCommand extends \ECSPrefix20210605\Symfony\Component\Console\Command\Command
{
    ...
    protected function execute(\ECSPrefix20210605\Symfony\Component\Console\Input\InputInterface $input, \ECSPrefix20210605\Symfony\Component\Console\Output\OutputInterface $output)
    {
        ...
        $output->isDecorated() ? $output->write(\ECSPrefix20210605\Symfony\Component\Console\Formatter\OutputFormatter::escape($report)) : $output->write($report, \false, \ECSPrefix20210605\Symfony\Component\Console\Output\OutputInterface::OUTPUT_RAW);
        return 0;
    }
    /**
     * @param string $format
