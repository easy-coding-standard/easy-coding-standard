 ...
 * @internal
 */
final class ListSetsCommand extends \ECSPrefix20210629\Symfony\Component\Console\Command\Command
{
    ...
    {
        $this->setDefinition([new \ECSPrefix20210629\Symfony\Component\Console\Input\InputOption('format', '', \ECSPrefix20210629\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'To output results in other formats.', (new \PhpCsFixer\Console\Report\ListSetsReport\TextReporter())->getFormat())])->setDescription('List all available RuleSets.');
    }
    protected function execute(\ECSPrefix20210629\Symfony\Component\Console\Input\InputInterface $input, \ECSPrefix20210629\Symfony\Component\Console\Output\OutputInterface $output)
    {
        ...
        $output->isDecorated() ? $output->write(\ECSPrefix20210629\Symfony\Component\Console\Formatter\OutputFormatter::escape($report)) : $output->write($report, \false, \ECSPrefix20210629\Symfony\Component\Console\Output\OutputInterface::OUTPUT_RAW);
        return 0;
    }
    /**
     * @param string $format
