 ...
 * @internal
 */
final class ListSetsCommand extends \ECSPrefix20210906\Symfony\Component\Console\Command\Command
{
    /**
     * @var string
     */
    ...
    protected function execute($input, $output)
    {
        ...
        $output->isDecorated() ? $output->write(\ECSPrefix20210906\Symfony\Component\Console\Formatter\OutputFormatter::escape($report)) : $output->write($report, \false, \ECSPrefix20210906\Symfony\Component\Console\Output\OutputInterface::OUTPUT_RAW);
        return 0;
    }
