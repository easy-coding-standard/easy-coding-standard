 ...
 * @internal
 */
final class ListSetsCommand extends \ECSPrefix20220302\Symfony\Component\Console\Command\Command
{
    /**
     * @var string
     */
    ...
    {
        $this->setDefinition([new \ECSPrefix20220302\Symfony\Component\Console\Input\InputOption('format', '', \ECSPrefix20220302\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'To output results in other formats.', (new \PhpCsFixer\Console\Report\ListSetsReport\TextReporter())->getFormat())])->setDescription('List all available RuleSets.');
    }
    protected function execute(\ECSPrefix20220302\Symfony\Component\Console\Input\InputInterface $input, \ECSPrefix20220302\Symfony\Component\Console\Output\OutputInterface $output)
    {
        ...
        $output->isDecorated() ? $output->write(\ECSPrefix20220302\Symfony\Component\Console\Formatter\OutputFormatter::escape($report)) : $output->write($report, \false, \ECSPrefix20220302\Symfony\Component\Console\Output\OutputInterface::OUTPUT_RAW);
        return 0;
    }
