            ...
            foreach ($options as $option) {
                ...
                if (null === $allowed) {
                    ...
                    $allowed = \array_map(static function ($value) : string {
                        return $value instanceof AllowedValueSubset ? 'a subset of <comment>' . \PhpCsFixer\Console\Command\HelpCommand::toString($value->getAllowedValues()) . '</comment>' : '<comment>' . \PhpCsFixer\Console\Command\HelpCommand::toString($value) . '</comment>';
                    }, $allowed);
                }
