...
use ECSPrefix202504\Symfony\Component\EventDispatcher\EventDispatcher;
use ECSPrefix202504\Symfony\Component\EventDispatcher\EventDispatcherInterface;
use ECSPrefix202504\Symfony\Component\Stopwatch\Stopwatch;
/**
...
EOF;
    ...
    protected function execute(InputInterface $input, OutputInterface $output) : int
    {
        ...
        $finder = new \ArrayIterator(\iterator_to_array(\is_array($resolver->getFinder()) ? new \ArrayIterator($resolver->getFinder()) : $resolver->getFinder()));
