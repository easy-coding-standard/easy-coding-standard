...
use PhpCsFixer\Preg;
use ECSPrefix20210820\Symfony\Component\Console\Command\HelpCommand as BaseHelpCommand;
 ...
 * @internal
 */
final class HelpCommand extends \ECSPrefix20210820\Symfony\Component\Console\Command\HelpCommand
{
    /**
     * @var string
     */
    ...
    {
        $output->getFormatter()->setStyle('url', new \ECSPrefix20210820\Symfony\Component\Console\Formatter\OutputFormatterStyle('blue'));
    }
    /**
