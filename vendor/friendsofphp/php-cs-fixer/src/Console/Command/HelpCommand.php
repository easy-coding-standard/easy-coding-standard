...
use PhpCsFixer\Preg;
use ECSPrefix20211008\Symfony\Component\Console\Command\HelpCommand as BaseHelpCommand;
 ...
 * @internal
 */
final class HelpCommand extends \ECSPrefix20211008\Symfony\Component\Console\Command\HelpCommand
{
    /**
     * @var string
     */
    ...
    {
        $output->getFormatter()->setStyle('url', new \ECSPrefix20211008\Symfony\Component\Console\Formatter\OutputFormatterStyle('blue'));
    }
    /**
     * @param mixed $value
     */
