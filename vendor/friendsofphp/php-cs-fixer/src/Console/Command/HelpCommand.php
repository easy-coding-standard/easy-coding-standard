...
use PhpCsFixer\Preg;
use ECSPrefix20210629\Symfony\Component\Console\Command\HelpCommand as BaseHelpCommand;
 ...
 * @internal
 */
final class HelpCommand extends \ECSPrefix20210629\Symfony\Component\Console\Command\HelpCommand
{
    ...
    {
        $output->getFormatter()->setStyle('url', new \ECSPrefix20210629\Symfony\Component\Console\Formatter\OutputFormatterStyle('blue'));
    }
    /**
