...
use PhpCsFixer\Preg;
use ECSPrefix20210927\Symfony\Component\Console\Command\HelpCommand as BaseHelpCommand;
 ...
 * @internal
 */
final class HelpCommand extends \ECSPrefix20210927\Symfony\Component\Console\Command\HelpCommand
{
    /**
     * @var string
     */
    ...
    {
        $output->getFormatter()->setStyle('url', new \ECSPrefix20210927\Symfony\Component\Console\Formatter\OutputFormatterStyle('blue'));
    }
    /**
     * @param mixed $value
     */
