...
use PhpCsFixer\Preg;
use ECSPrefix20211020\Symfony\Component\Console\Command\HelpCommand as BaseHelpCommand;
 ...
 * @internal
 */
final class HelpCommand extends \ECSPrefix20211020\Symfony\Component\Console\Command\HelpCommand
{
    /**
     * @var string
     */
    ...
    {
        $output->getFormatter()->setStyle('url', new \ECSPrefix20211020\Symfony\Component\Console\Formatter\OutputFormatterStyle('blue'));
    }
    /**
     * @param mixed $value
     */
