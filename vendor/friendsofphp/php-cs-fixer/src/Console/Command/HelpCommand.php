...
use PhpCsFixer\Preg;
use ECSPrefix20220516\Symfony\Component\Console\Command\HelpCommand as BaseHelpCommand;
 ...
 * @internal
 */
final class HelpCommand extends \ECSPrefix20220516\Symfony\Component\Console\Command\HelpCommand
{
    /**
     * @var string
     */
     ...
     * {@inheritdoc}
     */
    protected function initialize(\ECSPrefix20220516\Symfony\Component\Console\Input\InputInterface $input, \ECSPrefix20220516\Symfony\Component\Console\Output\OutputInterface $output) : void
    {
        $output->getFormatter()->setStyle('url', new \ECSPrefix20220516\Symfony\Component\Console\Formatter\OutputFormatterStyle('blue'));
    }
    /**
     * @param mixed $value
     */
