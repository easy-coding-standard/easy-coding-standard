...
use PhpCsFixer\Preg;
use ECSPrefix20210802\Symfony\Component\Console\Command\HelpCommand as BaseHelpCommand;
...
final class HelpCommand extends \ECSPrefix20210802\Symfony\Component\Console\Command\HelpCommand
{
    ...
    {
        $output->getFormatter()->setStyle('url', new \ECSPrefix20210802\Symfony\Component\Console\Formatter\OutputFormatterStyle('blue'));
    }
    /**
