...
use ECSPrefix20220220\Symfony\Component\Filesystem\Filesystem;
use ECSPrefix20220220\Symfony\Component\Finder\Finder;
use ECSPrefix20220220\Symfony\Component\Finder\SplFileInfo;
/**
 * @internal
 */
final class DocumentationCommand extends \ECSPrefix20220220\Symfony\Component\Console\Command\Command
{
    /**
     * @var string
     */
    ...
    {
        $filesystem = new \ECSPrefix20220220\Symfony\Component\Filesystem\Filesystem();
        ...
        foreach ((new \ECSPrefix20220220\Symfony\Component\Finder\Finder())->files()->in($locator->getFixersDocumentationDirectoryPath())->notPath($docForFixerRelativePaths) as $file) {
        ...
        // RuleSet docs.
        /** @var SplFileInfo $file */
        foreach ((new \ECSPrefix20220220\Symfony\Component\Finder\Finder())->files()->in($locator->getRuleSetsDocumentationDirectoryPath()) as $file) {
            $filesystem->remove($file->getPathname());
        }
        $paths = [];
