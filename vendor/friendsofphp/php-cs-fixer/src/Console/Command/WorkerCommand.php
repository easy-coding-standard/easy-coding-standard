...
use ECSPrefix202406\Clue\React\NDJson\Decoder;
use ECSPrefix202406\Clue\React\NDJson\Encoder;
...
use ECSPrefix202406\React\EventLoop\StreamSelectLoop;
use ECSPrefix202406\React\Socket\ConnectionInterface;
use ECSPrefix202406\React\Socket\TcpConnector;
...
use ECSPrefix202406\Symfony\Component\EventDispatcher\EventDispatcher;
use ECSPrefix202406\Symfony\Component\EventDispatcher\EventDispatcherInterface;
/**
    ...
    protected function execute(InputInterface $input, OutputInterface $output) : int
    {
        ...
        $tcpConnector->connect(\sprintf('127.0.0.1:%d', $port))->then(
            ...
            function (ConnectionInterface $connection) use($loop, $runner, $identifier) : void {
                ...
                $in = new Decoder($connection, \true, 512, $jsonInvalidUtf8Ignore);
                ...
                $in->on('data', function (array $json) use($loop, $runner, $out) : void {
                    ...
                    foreach ($files as $absolutePath) {
                        ...
                        $out->write(['action' => ParallelAction::WORKER_RESULT, 'file' => $absolutePath, 'fileHash' => $this->events[0]->getFileHash(), 'status' => $this->events[0]->getStatus(), 'fixInfo' => \array_pop($analysisResult), 'errors' => $this->errorsManager->forPath($absolutePath)]);
                    }
