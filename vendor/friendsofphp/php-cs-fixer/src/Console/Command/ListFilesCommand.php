 ...
 * @internal
 */
final class ListFilesCommand extends \ECSPrefix20211012\Symfony\Component\Console\Command\Command
{
    /**
     * @var string
     */
    ...
    {
        $this->setDefinition([new \ECSPrefix20211012\Symfony\Component\Console\Input\InputOption('config', '', \ECSPrefix20211012\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'The path to a .php-cs-fixer.php file.')])->setDescription('List all files being fixed by the given config.');
    }
    /**
