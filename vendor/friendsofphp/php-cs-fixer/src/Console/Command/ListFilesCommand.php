 ...
 * @internal
 */
final class ListFilesCommand extends \ECSPrefix20210708\Symfony\Component\Console\Command\Command
{
    ...
    {
        $this->setDefinition([new \ECSPrefix20210708\Symfony\Component\Console\Input\InputOption('config', '', \ECSPrefix20210708\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'The path to a .php-cs-fixer.php file.')])->setDescription('List all files being fixed by the given config.');
    }
