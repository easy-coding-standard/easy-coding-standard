...
final class PERCS2x0Set extends AbstractRuleSetDescription
{
    ...
    {
        $rules = ['@PER-CS1.0' => \true, 'array_indentation' => \true, 'cast_spaces' => \true, 'concat_space' => ['spacing' => 'one'], 'function_declaration' => ['closure_fn_spacing' => 'none'], 'method_argument_space' => \true, 'new_with_parentheses' => ['anonymous_class' => \false], 'single_line_empty_body' => \true, 'trailing_comma_in_multiline' => ['after_heredoc' => \true, 'elements' => ['arguments', 'arrays']]];
