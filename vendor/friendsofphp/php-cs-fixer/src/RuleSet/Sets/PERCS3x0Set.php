...
final class PERCS3x0Set extends AbstractRuleSetDescription
{
    ...
    {
        return ['@PER-CS2.0' => \true, 'nullable_type_declaration' => \true, 'operator_linebreak' => \true, 'ordered_types' => ['null_adjustment' => 'always_last', 'sort_algorithm' => 'none'], 'single_class_element_per_statement' => \true, 'types_spaces' => \true];
    }
