...
abstract class AbstractFixer implements \PhpCsFixer\Fixer\FixerInterface
{
    ...
    public function configure($configuration)
    {
        ...
        } catch (\ECSPrefix20210507\Symfony\Component\OptionsResolver\Exception\MissingOptionsException $exception) {
        ...
        } catch (\ECSPrefix20210507\Symfony\Component\OptionsResolver\Exception\ExceptionInterface $exception) {
