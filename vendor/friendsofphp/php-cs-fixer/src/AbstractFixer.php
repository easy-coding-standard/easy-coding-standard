...
use ECSPrefix20210602\Symfony\Component\OptionsResolver\Exception\ExceptionInterface;
...
abstract class AbstractFixer implements \PhpCsFixer\Fixer\FixerInterface
{
    ...
    public function configure(array $configuration)
    {
        ...
        } catch (\ECSPrefix20210602\Symfony\Component\OptionsResolver\Exception\MissingOptionsException $exception) {
        ...
        } catch (\ECSPrefix20210602\Symfony\Component\OptionsResolver\Exception\ExceptionInterface $exception) {
