...
', ['stick_comment_to_next_continuous_control_statement' => \true])]);
    ...
    protected function applyFix(\SplFileInfo $file, Tokens $tokens) : void
    {
        ...
        $blockSignatureFirstTokens = [\T_USE, \T_IF, \T_ELSE, \T_ELSEIF, \T_FOR, \T_FOREACH, \T_WHILE, \T_DO, \T_SWITCH, \T_CASE, \T_DEFAULT, \T_TRY, \T_CLASS, \T_INTERFACE, \T_TRAIT, \T_EXTENDS, \T_IMPLEMENTS, \T_CONST];
    ...
    private function isPropertyStart(Tokens $tokens, int $index) : bool
    {
        ...
        if (null === $nextIndex || $tokens[$nextIndex]->isGivenKind($propertyKeywords) || $tokens[$nextIndex]->isGivenKind([\T_CONST, \T_FUNCTION])) {
            return \false;
        }
