...
', ['elements' => ['property']])]);
    ...
    {
        return new FixerConfigurationResolver([(new FixerOptionBuilder('elements', 'Structural elements where the spacing after the type declaration should be fixed.'))->setAllowedTypes(['string[]'])->setAllowedValues([new AllowedValueSubset(['function', 'property'])])->setDefault(['function', 'property'])->getOption()]);
    }
