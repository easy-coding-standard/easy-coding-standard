...
', ['sets' => ['@mbreg']])], null, 'Risky when any of the alias functions are overridden.');
    ...
    protected function createConfigurationDefinition() : \PhpCsFixer\FixerConfiguration\FixerConfigurationResolverInterface
    {
        ...
        return new \PhpCsFixer\FixerConfiguration\FixerConfigurationResolver([(new \PhpCsFixer\FixerConfiguration\FixerOptionBuilder('sets', $list))->setAllowedTypes(['array'])->setAllowedValues([new \PhpCsFixer\FixerConfiguration\AllowedValueSubset(\array_keys($sets))])->setDefault(['@internal', '@IMAP', '@pg'])->getOption()]);
    }
}
