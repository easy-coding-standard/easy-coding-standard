...
', ['statements' => ['break', 'continue']])]);
    ...
    protected function createConfigurationDefinition() : FixerConfigurationResolverInterface
    {
        ...
        return new FixerConfigurationResolver([(new FixerOptionBuilder('statements', 'List of control statements to fix.'))->setAllowedTypes(['array'])->setAllowedValues([new AllowedValueSubset(self::CONFIG_OPTIONS)])->setDefault(\array_values($defaults))->getOption()]);
    }
    ...
    private function isKnownNegativePre(Token $token) : bool
    {
        ...
        if (null === $knownNegativeTypes) {
            ...
            if (\defined('T_MATCH')) {
                // @TODO: drop condition and add directly in `$knownNegativeTypes` above when PHP 8.0+ is required
