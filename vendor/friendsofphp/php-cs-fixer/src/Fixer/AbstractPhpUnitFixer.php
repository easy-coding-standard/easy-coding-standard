...
abstract class AbstractPhpUnitFixer extends AbstractFixer
{
     ...
     */
    protected final function ensureIsDockBlockWithAnnotation(Tokens $tokens, int $index, string $annotation, bool $addWithEmptyLineBeforePhpdoc, bool $addWithEmptyLineBeforeAnnotation, array $preventingAnnotations) : void
    {
     ...
     * @param array<string> $preventingAnnotations
     */
    private function updateDocBlockIfNeeded(Tokens $tokens, int $docBlockIndex, string $annotation, bool $addWithEmptyLineBeforeAnnotation, array $preventingAnnotations) : void
    {
