...
final class PhpUnitAttributesFixer extends AbstractPhpUnitFixer
{
    ...
    {
        return new FixerDefinition('PHPUnit attributes must be used over their respective PHPDoc-based annotations.', [new VersionSpecificCodeSample(<<<'PHP'
<?php
 ...
 * @internal
 */
\class_alias('ECSPrefix202406\\FooTest', 'FooTest', \false);
...
, new VersionSpecification(80000))]);
    ...
    {
        if ([] !== $attributeTokens) {
            $attributeTokens = \array_merge([new Token('(')], \is_array($attributeTokens) ? $attributeTokens : \iterator_to_array($attributeTokens), [new Token(')')]);
        }
