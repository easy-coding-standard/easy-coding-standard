...
final class PhpUnitSizeClassFixer extends AbstractPhpUnitFixer implements WhitespacesAwareFixerInterface, ConfigurableFixerInterface
{
    ...
    protected function applyPhpUnitClassFix(Tokens $tokens, int $startIndex, int $endIndex) : void
    {
        ...
        $this->ensureIsDocBlockWithAnnotation($tokens, $classIndex, $this->configuration['group'], self::SIZES, ['ECSPrefix202508\\phpunit\\framework\\attributes\\small', 'ECSPrefix202508\\phpunit\\framework\\attributes\\medium', 'ECSPrefix202508\\phpunit\\framework\\attributes\\large']);
    }
