...
final class PhpUnitSizeClassFixer extends AbstractPhpUnitFixer implements WhitespacesAwareFixerInterface, ConfigurableFixerInterface
{
    ...
    protected function applyPhpUnitClassFix(Tokens $tokens, int $startIndex, int $endIndex) : void
    {
        ...
        $this->ensureIsDocBlockWithAnnotation($tokens, $classIndex, $this->configuration['group'], self::SIZES, ['ECSPrefix202406\\phpunit\\framework\\attributes\\small', 'ECSPrefix202406\\phpunit\\framework\\attributes\\medium', 'ECSPrefix202406\\phpunit\\framework\\attributes\\large']);
    }
