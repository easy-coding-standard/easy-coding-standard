...
')]);
    ...
    protected function applyPhpUnitClassFix(Tokens $tokens, int $startIndex, int $endIndex) : void
    {
        ...
        $this->ensureIsDocBlockWithAnnotation($tokens, $classIndex, 'coversNothing', ['covers', 'coversDefaultClass', 'coversNothing'], ['ECSPrefix202405\\phpunit\\framework\\attributes\\coversclass', 'ECSPrefix202405\\phpunit\\framework\\attributes\\coversnothing']);
    }
}
