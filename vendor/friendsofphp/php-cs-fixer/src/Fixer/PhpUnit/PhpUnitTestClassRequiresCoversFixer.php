...
')]);
    ...
    protected function applyPhpUnitClassFix(Tokens $tokens, int $startIndex, int $endIndex) : void
    {
        ...
        $this->ensureIsDocBlockWithAnnotation($tokens, $classIndex, 'coversNothing', ['covers', 'coversDefaultClass', 'coversNothing'], ['ECSPrefix202505\\phpunit\\framework\\attributes\\coversclass', 'ECSPrefix202505\\phpunit\\framework\\attributes\\coversnothing', 'ECSPrefix202505\\phpunit\\framework\\attributes\\coversmethod', 'ECSPrefix202505\\phpunit\\framework\\attributes\\coversfunction']);
    }
}
