...
final class VoidReturnFixer extends AbstractFixer
{
    ...
    {
        return new FixerDefinition('Add `void` return type to functions with missing or empty return statements, but priority is given to `@return` annotations.', [new CodeSample("<?php\nfunction foo(\$a) {};\n")], null, 'Modifies the signature of functions.');
    }
    /**
     * {@inheritdoc}
     *
    ...
    {
        $previousTokens = [\T_ABSTRACT, \T_FINAL, \T_PRIVATE, \T_PROTECTED, \T_PUBLIC, \T_STATIC];
