...
final class NativeTypeDeclarationCasingFixer extends AbstractFixer
{
     ...
     * static
     */
    private const CLASS_CONST_SUPPORTED_HINTS = ['array' => \true, 'bool' => \true, 'float' => \true, 'int' => \true, 'iterable' => \true, 'mixed' => \true, 'null' => \true, 'object' => \true, 'parent' => \true, 'self' => \true, 'string' => \true, 'static' => \true];
    private const CLASS_PROPERTY_SUPPORTED_HINTS = ['array' => \true, 'bool' => \true, 'float' => \true, 'int' => \true, 'iterable' => \true, 'mixed' => \true, 'null' => \true, 'object' => \true, 'parent' => \true, 'self' => \true, 'static' => \true, 'string' => \true];
    private const TYPE_SEPARATION_TYPES = [CT::T_TYPE_ALTERNATION, CT::T_TYPE_INTERSECTION, CT::T_DISJUNCTIVE_NORMAL_FORM_TYPE_PARENTHESIS_OPEN, CT::T_DISJUNCTIVE_NORMAL_FORM_TYPE_PARENTHESIS_CLOSE];
    /**
    ...
    public function __construct()
    {
        ...
        if (\PHP_VERSION_ID >= 80000) {
            ...
            $this->functionTypeHints['mixed'] = \true;
            $this->functionTypeHints['null'] = \true;
            $this->functionTypeHints['static'] = \true;
        }
    ...
    private function fixClassConstantsAndProperties(Tokens $tokens) : void
    {
        ...
        foreach ($elements as $index => $element) {
            if ('const' === $element['type']) {
                if (\PHP_VERSION_ID >= 80300 && !$this->isConstWithoutType($tokens, $index)) {
    ...
    {
        return $tokens->getPrevMeaningfulToken($tokens->getNextTokenOfKind($index, ['=']));
    }
    /** @return iterable<int> */
    ...
    private function getTypeEnd(Tokens $tokens, int $index, int $upperLimit) : int
    {
        if (!$tokens[$index]->isGivenKind([\T_STRING, \T_NS_SEPARATOR])) {
            return $index;
            // callable, array, self, static, etc.
        }
        $endIndex = $index;
