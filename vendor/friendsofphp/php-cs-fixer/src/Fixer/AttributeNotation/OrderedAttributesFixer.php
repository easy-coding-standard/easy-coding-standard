...
use ECSPrefix202406\Symfony\Component\OptionsResolver\Options;
/**
...
\class_alias('ECSPrefix202406\\Sample1', 'Sample1', \false);
#[Foo, Bar(3), Qux(new Bar(5)), Corge(a: 'test')]
class Sample2
{
}
\class_alias('ECSPrefix202406\\Sample2', 'Sample2', \false);
...
use ECSPrefix202406\A\B\Foo;
use ECSPrefix202406\A\B\Bar as BarAlias;
use ECSPrefix202406\A\B as AB;
#[Foo]
#[BarAlias(3)]
#[AB\Qux(new Bar(5))]
#[\ECSPrefix202406\A\B\Corge(a: 'test')]
class Sample1
{
}
\class_alias('ECSPrefix202406\\Sample1', 'Sample1', \false);
...
EOL
, new VersionSpecification(80000), ['sort_algorithm' => self::ORDER_CUSTOM, 'order' => ['ECSPrefix202406\\A\\B\\Qux', 'ECSPrefix202406\\A\\B\\Bar', 'ECSPrefix202406\\A\\B\\Corge']])]);
    }
    /**
     * {@inheritdoc}
     *
    ...
    protected function applyFix(\SplFileInfo $file, Tokens $tokens) : void
    {
        ...
        while (null !== ($index = $tokens->getNextTokenOfKind($index, [[\T_ATTRIBUTE]]))) {
            ...
            $elements = \array_map(function (AttributeAnalysis $attributeAnalysis) use($tokens) : array {
                return ['name' => $this->sortAttributes($tokens, $attributeAnalysis->getStartIndex(), $attributeAnalysis->getAttributes()), 'start' => $attributeAnalysis->getStartIndex(), 'end' => $attributeAnalysis->getEndIndex()];
