...
use ECSPrefix202505\Symfony\Component\OptionsResolver\Options;
/**
...
\class_alias('ECSPrefix202505\\Sample1', 'Sample1', \false);
#[Foo, Bar(3), Qux(new Bar(5)), Corge(a: 'test')]
class Sample2
{
}
\class_alias('ECSPrefix202505\\Sample2', 'Sample2', \false);
...
use ECSPrefix202505\A\B\Foo;
use ECSPrefix202505\A\B\Bar as BarAlias;
use ECSPrefix202505\A\B as AB;
#[Foo]
#[BarAlias(3)]
#[AB\Qux(new Bar(5))]
#[\ECSPrefix202505\A\B\Corge(a: 'test')]
class Sample1
{
}
\class_alias('ECSPrefix202505\\Sample1', 'Sample1', \false);
...
EOL
, new VersionSpecification(80000), ['sort_algorithm' => self::ORDER_CUSTOM, 'order' => ['ECSPrefix202505\\A\\B\\Qux', 'ECSPrefix202505\\A\\B\\Bar', 'ECSPrefix202505\\A\\B\\Corge']])]);
    }
    /**
     * {@inheritdoc}
     *
