...
use ECSPrefix202405\Symfony\Component\OptionsResolver\Options;
/**
...
\class_alias('ECSPrefix202405\\Sample1', 'Sample1', \false);
#[Foo, Bar(3), Qux(new Bar(5)), Corge(a: 'test')]
class Sample2
{
}
\class_alias('ECSPrefix202405\\Sample2', 'Sample2', \false);
...
use ECSPrefix202405\A\B\Foo;
use ECSPrefix202405\A\B\Bar as BarAlias;
use ECSPrefix202405\A\B as AB;
#[Foo]
#[BarAlias(3)]
#[AB\Qux(new Bar(5))]
#[\ECSPrefix202405\A\B\Corge(a: 'test')]
class Sample1
{
}
\class_alias('ECSPrefix202405\\Sample1', 'Sample1', \false);
...
EOL
, new VersionSpecification(80000), ['sort_algorithm' => self::ORDER_CUSTOM, 'order' => ['ECSPrefix202405\\A\\B\\Qux', 'ECSPrefix202405\\A\\B\\Bar', 'ECSPrefix202405\\A\\B\\Corge']])]);
    }
    /**
     * {@inheritdoc}
     *
