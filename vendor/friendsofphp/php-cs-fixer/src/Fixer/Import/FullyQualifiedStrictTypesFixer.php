...
use ECSPrefix202509\Foo\Bar;
use ECSPrefix202509\Foo\Bar\Baz;
use ECSPrefix202509\Foo\OtherClass;
use ECSPrefix202509\Foo\SomeContract;
use ECSPrefix202509\Foo\SomeException;
/**
* @see \Foo\Bar\Baz
*/
class SomeClass extends \ECSPrefix202509\Foo\OtherClass implements \ECSPrefix202509\Foo\SomeContract
{
    /**
    * @var \Foo\Bar\Baz
    */
    ...
    */
    ...
    public function doX(\ECSPrefix202509\Foo\Bar $foo, \Exception $e) : \ECSPrefix202509\Foo\Bar\Baz
    {
        try {
        } catch (\ECSPrefix202509\Foo\SomeException $e) {
        }
    }
}
/**
* @see \Foo\Bar\Baz
*/
\class_alias('ECSPrefix202509\\SomeClass', 'SomeClass', \false);
...
class SomeClass
{
    public function doY(Foo\NotImported $u, \ECSPrefix202509\Foo\NotImported $v)
    {
    }
}
\class_alias('ECSPrefix202509\\SomeClass', 'SomeClass', \false);
...
use ECSPrefix202509\Foo\A;
try {
    foo();
} catch (\Exception|\ECSPrefix202509\Foo\A $e) {
}
namespace ECSPrefix202509\Foo\Bar;

class SomeClass implements \ECSPrefix202509\Foo\Bar\Baz
{
}
...
namespace ECSPrefix202509\Foo\Test;

class Foo extends \ECSPrefix202509\Other\BaseClass implements \ECSPrefix202509\Other\Interface1, \ECSPrefix202509\Other\Interface2
{
    /** @var \Other\PropertyPhpDoc */
    private $array;
    public function __construct(\ECSPrefix202509\Other\FunctionArgument $arg)
    {
    }
    public function foo() : \ECSPrefix202509\Other\FunctionReturnType
    {
        try {
            \ECSPrefix202509\Other\StaticFunctionCall::bar();
        } catch (\ECSPrefix202509\Other\CaughtThrowable $e) {
        }
    }
}
