...
final class NewWithParenthesesFixer extends AbstractFixer implements ConfigurableFixerInterface
{
    ...
    private const NEXT_TOKEN_KINDS = ['?', ';', ',', '(', ')', '[', ']', ':', '<', '>', '+', '-', '*', '/', '%', '&', '^', '|', [\T_CLASS], [\T_IS_SMALLER_OR_EQUAL], [\T_IS_GREATER_OR_EQUAL], [\T_IS_EQUAL], [\T_IS_NOT_EQUAL], [\T_IS_IDENTICAL], [\T_IS_NOT_IDENTICAL], [\T_CLOSE_TAG], [\T_LOGICAL_AND], [\T_LOGICAL_OR], [\T_LOGICAL_XOR], [\T_BOOLEAN_AND], [\T_BOOLEAN_OR], [\T_SL], [\T_SR], [\T_INSTANCEOF], [\T_AS], [\T_DOUBLE_ARROW], [\T_POW], [\T_SPACESHIP], [CT::T_ARRAY_BRACKET_OPEN], [CT::T_ARRAY_BRACKET_CLOSE], [CT::T_CLASS_INSTANTIATION_PARENTHESIS_OPEN], [CT::T_CLASS_INSTANTIATION_PARENTHESIS_CLOSE], [FCT::T_AMPERSAND_FOLLOWED_BY_VAR_OR_VARARG], [FCT::T_AMPERSAND_NOT_FOLLOWED_BY_VAR_OR_VARARG]];
