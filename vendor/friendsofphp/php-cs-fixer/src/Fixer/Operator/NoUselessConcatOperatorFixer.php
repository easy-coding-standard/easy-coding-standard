...
final class NoUselessConcatOperatorFixer extends AbstractFixer implements ConfigurableFixerInterface
{
     ...
     * } $secondOperand
     */
    private function mergeContantEscapedStringOperands(Tokens $tokens, array $firstOperand, int $concatOperatorIndex, array $secondOperand) : void
    {
     ...
     * } $secondOperand
     */
    private function mergeContantEscapedStringVarOperands(Tokens $tokens, array $firstOperand, int $concatOperatorIndex, array $secondOperand) : void
    {
