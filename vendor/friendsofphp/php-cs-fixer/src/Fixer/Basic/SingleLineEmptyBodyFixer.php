...
final class SingleLineEmptyBodyFixer extends AbstractFixer
{
    ...
    {
        return new FixerDefinition('Empty body of class or function must be abbreviated as `{}` and placed on the same line as the previous symbol, separated by a space.', [new CodeSample('<?php function foo(
    int $x
)
{
}
