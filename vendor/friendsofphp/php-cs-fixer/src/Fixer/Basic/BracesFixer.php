...
', ['position_after_functions_and_oop_constructs' => self::LINE_SAME])]);
    ...
    protected function createProxyFixers() : array
    {
        ...
        $singleSpaceAfterConstructFixer->configure(['constructs' => ['elseif', 'for', 'foreach', 'if', 'match', 'while', 'use_lambda']]);
        $noExtraBlankLinesFixer = new NoExtraBlankLinesFixer();
        $noExtraBlankLinesFixer->configure(['tokens' => ['curly_brace_block']]);
        return [$singleSpaceAfterConstructFixer, new ControlStructureBracesFixer(), $noExtraBlankLinesFixer, $this->getCurlyBracesPositionFixer(), $this->getControlStructureContinuationPositionFixer(), new DeclareParenthesesFixer(), new \PhpCsFixer\Fixer\Basic\NoMultipleStatementsPerLineFixer(), new StatementIndentationFixer(\true)];
    }
