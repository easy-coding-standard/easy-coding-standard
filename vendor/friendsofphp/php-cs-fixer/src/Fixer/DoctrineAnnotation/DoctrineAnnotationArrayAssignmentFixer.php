...
final class DoctrineAnnotationArrayAssignmentFixer extends \PhpCsFixer\AbstractDoctrineAnnotationFixer
{
    ...
    protected function fixAnnotations(\PhpCsFixer\Doctrine\Annotation\Tokens $doctrineAnnotationTokens) : void
    {
        ...
        foreach ($doctrineAnnotationTokens as $token) {
            ...
            if ($token->isType(\ECSPrefix20220501\Doctrine\Common\Annotations\DocLexer::T_OPEN_CURLY_BRACES)) {
                $scopes[] = 'array';
                continue;
            }
            ...
            if ('array' === \end($scopes) && $token->isType([\ECSPrefix20220501\Doctrine\Common\Annotations\DocLexer::T_EQUALS, \ECSPrefix20220501\Doctrine\Common\Annotations\DocLexer::T_COLON])) {
