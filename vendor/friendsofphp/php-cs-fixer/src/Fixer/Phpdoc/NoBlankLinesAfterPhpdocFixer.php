...
')]);
    ...
    {
        static $forbiddenSuccessors = [\T_BREAK, \T_COMMENT, \T_CONTINUE, \T_DECLARE, \T_DOC_COMMENT, \T_GOTO, \T_INCLUDE, \T_INCLUDE_ONCE, \T_NAMESPACE, \T_REQUIRE, \T_REQUIRE_ONCE, \T_RETURN, \T_THROW, \T_USE, \T_WHITESPACE];
