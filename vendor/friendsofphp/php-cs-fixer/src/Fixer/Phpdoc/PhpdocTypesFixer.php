...
final class PhpdocTypesFixer extends AbstractPhpdocTypesFixer implements ConfigurableFixerInterface
{
     ...
     */
    private const POSSIBLE_TYPES = ['simple' => ['array', 'bool', 'callable', 'float', 'int', 'iterable', 'null', 'object', 'string'], 'alias' => ['boolean', 'double', 'integer'], 'meta' => ['$this', 'false', 'mixed', 'parent', 'resource', 'scalar', 'self', 'static', 'true', 'void']];
...
', ['groups' => ['simple', 'alias']])]);
    ...
    {
        return Preg::replaceCallback('/(\\b|(?=\\$|\\\\))(\\$|\\\\)?' . TypeExpression::REGEX_IDENTIFIER . '(?!\\\\|\\h*:)/', function (array $matches) : string {
