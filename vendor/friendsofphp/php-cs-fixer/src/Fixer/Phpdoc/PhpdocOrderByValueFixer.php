...
use ECSPrefix202402\Symfony\Component\OptionsResolver\Options;
/**
...
', ['annotations' => ['author']])]);
    ...
    protected function createConfigurationDefinition() : FixerConfigurationResolverInterface
    {
        ...
        return new FixerConfigurationResolver([(new FixerOptionBuilder('annotations', 'List of annotations to order, e.g. `["covers"]`.'))->setAllowedTypes(['array'])->setAllowedValues([new AllowedValueSubset($allowedValues)])->setNormalizer(static function (Options $options, array $value) : array {
            $normalized = [];
