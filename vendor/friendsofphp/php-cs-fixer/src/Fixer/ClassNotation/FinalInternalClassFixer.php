...
final class FinalInternalClassFixer extends \PhpCsFixer\AbstractFixer implements \PhpCsFixer\Fixer\ConfigurableFixerInterface
{
    ...
    protected function createConfigurationDefinition() : \PhpCsFixer\FixerConfiguration\FixerConfigurationResolverInterface
    {
        ...
        $annotationsNormalizer = static function (\ECSPrefix20210525\Symfony\Component\OptionsResolver\Options $options, array $value) {
            $newValue = [];
