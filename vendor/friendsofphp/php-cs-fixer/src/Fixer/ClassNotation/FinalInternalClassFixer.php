...
final class FinalInternalClassFixer extends \PhpCsFixer\AbstractFixer implements \PhpCsFixer\Fixer\ConfigurableFixerInterface
{
    ...
    protected function createConfigurationDefinition()
    {
        ...
        $annotationsNormalizer = static function (\ECSPrefix20210510\Symfony\Component\OptionsResolver\Options $options, array $value) {
            $newValue = [];
