...
{
    private const DEFAULTS = ['include' => ['internal'], 'exclude' => ['final', 'Entity', 'ECSPrefix202306\\ORM\\Entity', 'ECSPrefix202306\\ORM\\Mapping\\Entity', 'ECSPrefix202306\\Mapping\\Entity', 'Document', 'ECSPrefix202306\\ODM\\Document']];
    /**
     * @var bool
     */
    ...
    private function isClassCandidate(TokensAnalyzer $tokensAnalyzer, Tokens $tokens, int $index) : bool
    {
        ...
        $decisions = [];
        $currentIndex = $index;
        $acceptTypes = [CT::T_ATTRIBUTE_CLOSE, \T_DOC_COMMENT, \T_COMMENT];
        ...
        return \in_array(\true, $decisions, \true) || [] === $decisions && $this->configuration['consider_absent_docblock_as_internal_class'];
    }
