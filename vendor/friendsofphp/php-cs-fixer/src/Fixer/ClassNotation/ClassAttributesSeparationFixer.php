...
', new VersionSpecification(80000), ['elements' => ['property' => self::SPACING_ONLY_IF_META]])]);
    ...
    {
        return new FixerConfigurationResolver([(new FixerOptionBuilder('elements', 'Dictionary of `const|method|property|trait_import|case` => `none|one|only_if_meta` values.'))->setAllowedTypes(['string[]'])->setAllowedValues([static function (array $option) : bool {
