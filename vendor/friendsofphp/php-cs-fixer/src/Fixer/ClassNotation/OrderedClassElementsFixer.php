...
- `method:*`: specify a single method name (e.g. `method:__invoke`) to set the order of that specific method.');
    ...
    protected function createConfigurationDefinition() : FixerConfigurationResolverInterface
    {
        ...
        return new FixerConfigurationResolver([(new FixerOptionBuilder('order', 'List of strings defining order of elements.'))->setAllowedTypes(['array'])->setAllowedValues([static function (array $values) use($builtIns) : bool {
    ...
    private function sortElements(array $elements) : array
    {
        ...
        return Utils::stableSort(
             ...
             */
            static function (array $element) use($getPositionType) : array {
                return ['element' => $element, 'position' => $getPositionType($element)];
            },
            /**
