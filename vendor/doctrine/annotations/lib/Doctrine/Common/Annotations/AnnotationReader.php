...
namespace ECSPrefix20210711\Doctrine\Common\Annotations;

use ECSPrefix20210711\Doctrine\Common\Annotations\Annotation\IgnoreAnnotation;
use ECSPrefix20210711\Doctrine\Common\Annotations\Annotation\Target;
use ReflectionClass;
 ...
 */
class AnnotationReader implements \ECSPrefix20210711\Doctrine\Common\Annotations\Reader
{
    /**
     ...
     */
    private static $globalImports = ['ignoreannotation' => \ECSPrefix20210711\Doctrine\Common\Annotations\Annotation\IgnoreAnnotation::class];
    /**
     ...
     */
    private static $globalIgnoredNames = \ECSPrefix20210711\Doctrine\Common\Annotations\ImplicitlyIgnoredAnnotationNames::LIST;
    /**
     * A list with annotations that are not causing exceptions when not resolved to an annotation class.
     *
     * The names are case sensitive.
    ...
    public function __construct($parser = null)
    {
        if (\extension_loaded('Zend Optimizer+') && (\ini_get('zend_optimizerplus.save_comments') === '0' || \ini_get('opcache.save_comments') === '0')) {
            throw \ECSPrefix20210711\Doctrine\Common\Annotations\AnnotationException::optimizerPlusSaveComments();
        }
        if (\extension_loaded('Zend OPcache') && \ini_get('opcache.save_comments') === 0) {
            throw \ECSPrefix20210711\Doctrine\Common\Annotations\AnnotationException::optimizerPlusSaveComments();
        }
        // Make sure that the IgnoreAnnotation annotation is loaded
        \class_exists(\ECSPrefix20210711\Doctrine\Common\Annotations\Annotation\IgnoreAnnotation::class);
        $this->parser = $parser ?: new \ECSPrefix20210711\Doctrine\Common\Annotations\DocParser();
        $this->preParser = new \ECSPrefix20210711\Doctrine\Common\Annotations\DocParser();
        $this->preParser->setImports(self::$globalImports);
        $this->preParser->setIgnoreNotImportedAnnotations(\true);
        $this->preParser->setIgnoredAnnotationNames(self::$globalIgnoredNames);
        $this->phpParser = new \ECSPrefix20210711\Doctrine\Common\Annotations\PhpParser();
    }
    /**
     * {@inheritDoc}
    ...
    {
        $this->parser->setTarget(\ECSPrefix20210711\Doctrine\Common\Annotations\Annotation\Target::TARGET_CLASS);
    ...
    public function getPropertyAnnotations($property)
    {
        ...
        $this->parser->setTarget(\ECSPrefix20210711\Doctrine\Common\Annotations\Annotation\Target::TARGET_PROPERTY);
    ...
    public function getMethodAnnotations($method)
    {
        ...
        $this->parser->setTarget(\ECSPrefix20210711\Doctrine\Common\Annotations\Annotation\Target::TARGET_METHOD);
    ...
    public function getFunctionAnnotations($function) : array
    {
        ...
        $this->parser->setTarget(\ECSPrefix20210711\Doctrine\Common\Annotations\Annotation\Target::TARGET_FUNCTION);
    ...
    private function collectParsingMetadata($reflection)
    {
        ...
        foreach ($annotations as $annotation) {
            if (!$annotation instanceof \ECSPrefix20210711\Doctrine\Common\Annotations\Annotation\IgnoreAnnotation) {
                continue;
            }
