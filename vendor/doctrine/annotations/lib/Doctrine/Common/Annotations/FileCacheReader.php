 ...
 */
class FileCacheReader implements \ECSPrefix20220522\Doctrine\Common\Annotations\Reader
{
    /** @var Reader */
    private $reader;
    /** @var string */
     ...
     */
    public function __construct(\ECSPrefix20220522\Doctrine\Common\Annotations\Reader $reader, $cacheDir, $debug = \false, $umask = 02)
    {
        if (!\is_int($umask)) {
