 ...
 */
class SimpleAnnotationReader implements \ECSPrefix20211107\Doctrine\Common\Annotations\Reader
{
    /** @var DocParser */
    private $parser;
    /**
    ...
    {
        $this->parser = new \ECSPrefix20211107\Doctrine\Common\Annotations\DocParser();
