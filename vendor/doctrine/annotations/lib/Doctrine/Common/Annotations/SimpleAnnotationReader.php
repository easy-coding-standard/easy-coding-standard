 ...
 */
class SimpleAnnotationReader implements \ECSPrefix20211121\Doctrine\Common\Annotations\Reader
{
    /** @var DocParser */
    private $parser;
    /**
    ...
    {
        $this->parser = new \ECSPrefix20211121\Doctrine\Common\Annotations\DocParser();
