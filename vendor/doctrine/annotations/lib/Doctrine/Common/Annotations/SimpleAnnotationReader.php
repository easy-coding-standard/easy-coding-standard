 ...
 */
class SimpleAnnotationReader implements \ECSPrefix20210927\Doctrine\Common\Annotations\Reader
{
    /** @var DocParser */
    private $parser;
    /**
    ...
    {
        $this->parser = new \ECSPrefix20210927\Doctrine\Common\Annotations\DocParser();
