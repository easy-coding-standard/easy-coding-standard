 ...
 */
class SimpleAnnotationReader implements \ECSPrefix20211122\Doctrine\Common\Annotations\Reader
{
    /** @var DocParser */
    private $parser;
    /**
    ...
    {
        $this->parser = new \ECSPrefix20211122\Doctrine\Common\Annotations\DocParser();
