 ...
 */
class SimpleAnnotationReader implements \ECSPrefix20211120\Doctrine\Common\Annotations\Reader
{
    /** @var DocParser */
    private $parser;
    /**
    ...
    {
        $this->parser = new \ECSPrefix20211120\Doctrine\Common\Annotations\DocParser();
