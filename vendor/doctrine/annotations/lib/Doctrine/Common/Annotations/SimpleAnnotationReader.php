 ...
 */
class SimpleAnnotationReader implements \ECSPrefix20211125\Doctrine\Common\Annotations\Reader
{
    /** @var DocParser */
    private $parser;
    /**
    ...
    {
        $this->parser = new \ECSPrefix20211125\Doctrine\Common\Annotations\DocParser();
