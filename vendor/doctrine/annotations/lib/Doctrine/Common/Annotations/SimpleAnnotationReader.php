 ...
 */
class SimpleAnnotationReader implements \ECSPrefix20211203\Doctrine\Common\Annotations\Reader
{
    /** @var DocParser */
    private $parser;
    /**
    ...
    {
        $this->parser = new \ECSPrefix20211203\Doctrine\Common\Annotations\DocParser();
