 ...
 */
class SimpleAnnotationReader implements \ECSPrefix20210818\Doctrine\Common\Annotations\Reader
{
    /** @var DocParser */
    private $parser;
    /**
    ...
    {
        $this->parser = new \ECSPrefix20210818\Doctrine\Common\Annotations\DocParser();
