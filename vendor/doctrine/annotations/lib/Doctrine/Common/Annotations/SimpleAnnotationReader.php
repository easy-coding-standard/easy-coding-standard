 ...
 */
class SimpleAnnotationReader implements \ECSPrefix20210822\Doctrine\Common\Annotations\Reader
{
    /** @var DocParser */
    private $parser;
    /**
    ...
    {
        $this->parser = new \ECSPrefix20210822\Doctrine\Common\Annotations\DocParser();
