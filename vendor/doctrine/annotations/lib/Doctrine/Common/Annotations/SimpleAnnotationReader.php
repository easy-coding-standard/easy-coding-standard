 ...
 */
class SimpleAnnotationReader implements \ECSPrefix20210823\Doctrine\Common\Annotations\Reader
{
    /** @var DocParser */
    private $parser;
    /**
    ...
    {
        $this->parser = new \ECSPrefix20210823\Doctrine\Common\Annotations\DocParser();
