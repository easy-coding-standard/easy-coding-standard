 ...
 */
class SimpleAnnotationReader implements \ECSPrefix20210819\Doctrine\Common\Annotations\Reader
{
    /** @var DocParser */
    private $parser;
    /**
    ...
    {
        $this->parser = new \ECSPrefix20210819\Doctrine\Common\Annotations\DocParser();
