 ...
 */
class SimpleAnnotationReader implements \ECSPrefix20210902\Doctrine\Common\Annotations\Reader
{
    /** @var DocParser */
    private $parser;
    /**
    ...
    {
        $this->parser = new \ECSPrefix20210902\Doctrine\Common\Annotations\DocParser();
