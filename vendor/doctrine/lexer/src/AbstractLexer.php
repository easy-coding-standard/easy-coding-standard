...
namespace ECSPrefix202306\Doctrine\Common\Lexer;
...
abstract class AbstractLexer
{
     ...
     *
     * @param int|string|\UnitEnum $type
     *
     * @return bool
     *
     ...
     *
     * @param int|string|\UnitEnum $type The token type to skip until.
     *
     * @return void
     */
     ...
     *
     * @return bool
     * @param int|string|\UnitEnum $token
     */
     ...
     * @param-out V $value
     */
    protected abstract function getType(string &$value);
}
