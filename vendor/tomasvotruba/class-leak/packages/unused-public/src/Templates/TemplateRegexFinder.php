...
use ECSPrefix202609\TomasVotruba\UnusedPublic\Finder\TemplateFilesFinder;
...
final class TemplateRegexFinder
{
    ...
    public function find(array $directories, string $fileSuffix, array $innerRegexes, string $targetRegex): array
    {
        ...
        $templateFilesContents = array_map(static function (string $templateFilePath): string {
