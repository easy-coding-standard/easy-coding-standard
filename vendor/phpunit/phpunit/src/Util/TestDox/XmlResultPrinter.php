 ...
 */
final class XmlResultPrinter extends \ECSPrefix20210804\PHPUnit\Util\Printer implements \ECSPrefix20210804\PHPUnit\Framework\TestListener
{
    /**
     * @var DOMDocument
     */
    ...
    {
        if (!$test instanceof \ECSPrefix20210804\PHPUnit\Framework\TestCase || $test instanceof \ECSPrefix20210804\PHPUnit\Framework\WarningTestCase) {
            return;
        }
        ...
        $inlineAnnotations = \ECSPrefix20210804\PHPUnit\Util\Test::getInlineAnnotations(\get_class($test), $test->getName(\false));
        ...
        if ($this->exception !== null) {
            if ($this->exception instanceof \ECSPrefix20210804\PHPUnit\Framework\Exception) {
