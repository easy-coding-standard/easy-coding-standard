 ...
 */
final class InvokedAtMostCount extends \ECSPrefix20210804\PHPUnit\Framework\MockObject\Rule\InvocationOrder
{
    /**
     * @var int
     */
    ...
    public function verify() : void
    {
        ...
        if ($count > $this->allowedInvocations) {
            throw new \ECSPrefix20210804\PHPUnit\Framework\ExpectationFailedException('Expected invocation at most ' . $this->allowedInvocations . ' times but it occurred ' . $count . ' time(s).');
        }
    }
