...
use ECSPrefix20210803\PHPUnit\Framework\InvalidParameterGroupException;
use ECSPrefix20210803\PHPUnit\Framework\MockObject\Invocation as BaseInvocation;
/**
 * @internal This class is not covered by the backward compatibility promise for PHPUnit
 */
final class ConsecutiveParameters implements \ECSPrefix20210803\PHPUnit\Framework\MockObject\Rule\ParametersRule
{
    /**
     * @var array
     */
    ...
    public function __construct(array $parameterGroups)
    {
        foreach ($parameterGroups as $index => $parameters) {
            if (!\is_iterable($parameters)) {
                throw new \ECSPrefix20210803\PHPUnit\Framework\InvalidParameterGroupException(\sprintf('Parameter group #%d must be an array or Traversable, got %s', $index, \gettype($parameters)));
            }
     ...
     * @throws ExpectationFailedException
     */
    private function verifyInvocation(\ECSPrefix20210803\PHPUnit\Framework\MockObject\Invocation $invocation, $callIndex) : void
    {
        ...
        if (\count($invocation->getParameters()) < \count($parameters)) {
            throw new \ECSPrefix20210803\PHPUnit\Framework\ExpectationFailedException(\sprintf('Parameter count for invocation %s is too low.', $invocation->toString()));
        }
