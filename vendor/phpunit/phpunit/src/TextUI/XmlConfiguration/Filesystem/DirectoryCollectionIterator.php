...
final class DirectoryCollectionIterator implements \Countable, \Iterator
{
     ...
     */
    private $position;
    public function __construct(\ECSPrefix20210804\PHPUnit\TextUI\XmlConfiguration\DirectoryCollection $directories)
    {
    ...
    public function current() : \ECSPrefix20210804\PHPUnit\TextUI\XmlConfiguration\Directory
    {
