...
final class FileCollectionIterator implements \Countable, \Iterator
{
     ...
     */
    private $position;
    public function __construct(\ECSPrefix20210804\PHPUnit\TextUI\XmlConfiguration\FileCollection $files)
    {
    ...
    public function current() : \ECSPrefix20210804\PHPUnit\TextUI\XmlConfiguration\File
    {
