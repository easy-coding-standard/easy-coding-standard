 ...
 */
final class MoveWhitelistExcludesToCoverage implements \ECSPrefix20210803\PHPUnit\TextUI\XmlConfiguration\Migration
{
    /**
    ...
    public function migrate(\DOMDocument $document) : void
    {
        ...
        $excludeNodes = \ECSPrefix20210803\PHPUnit\Util\Xml\SnapshotNodeList::fromNodeList($whitelist->getElementsByTagName('exclude'));
        ...
        foreach ($excludeNodes as $excludeNode) {
            ...
            foreach (\ECSPrefix20210803\PHPUnit\Util\Xml\SnapshotNodeList::fromNodeList($excludeNode->childNodes) as $child) {
            ...
            if ($excludeNode->getElementsByTagName('*')->count() !== 0) {
                throw new \ECSPrefix20210803\PHPUnit\TextUI\XmlConfiguration\MigrationException('Dangling child elements in exclude found.');
            }
