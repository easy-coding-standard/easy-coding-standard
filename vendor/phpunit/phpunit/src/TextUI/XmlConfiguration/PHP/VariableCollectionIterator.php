...
final class VariableCollectionIterator implements \Countable, \Iterator
{
     ...
     */
    private $position;
    public function __construct(\ECSPrefix20210804\PHPUnit\TextUI\XmlConfiguration\VariableCollection $variables)
    {
    ...
    public function current() : \ECSPrefix20210804\PHPUnit\TextUI\XmlConfiguration\Variable
    {
