 ...
 */
namespace ECSPrefix20210803\SebastianBergmann\FileIterator;
...
class Facade
{
    ...
    public function getFilesAsArray($paths, $suffixes = '', $prefixes = '', array $exclude = [], bool $commonPath = \false) : array
    {
        ...
        $iterator = (new \ECSPrefix20210803\SebastianBergmann\FileIterator\Factory())->getFileIterator($paths, $suffixes, $prefixes, $exclude);
        $files = [];
