...
use ECSPrefix20210803\SebastianBergmann\CodeCoverage\Node\AbstractNode as Node;
 ...
 */
final class Directory extends \ECSPrefix20210803\SebastianBergmann\CodeCoverage\Report\Html\Renderer
{
    ...
    private function renderItem(\ECSPrefix20210803\SebastianBergmann\CodeCoverage\Node\AbstractNode $node, bool $total = \false) : string
    {
        ...
        return $this->renderItemTemplate(new \ECSPrefix20210803\SebastianBergmann\Template\Template($templateName, '{{', '}}'), $data);
    }
}
