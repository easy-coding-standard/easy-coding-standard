 ...
 */
final class PcovDriver extends \ECSPrefix20210804\SebastianBergmann\CodeCoverage\Driver\Driver
{
    /**
     * @var Filter
     */
    ...
    public function __construct(\ECSPrefix20210804\SebastianBergmann\CodeCoverage\Filter $filter)
    {
        if (!\extension_loaded('pcov')) {
            throw new \ECSPrefix20210804\SebastianBergmann\CodeCoverage\Driver\PcovNotAvailableException();
        }
        $this->filter = $filter;
    }
    ...
    public function stop() : \ECSPrefix20210804\SebastianBergmann\CodeCoverage\RawCodeCoverageData
    {
        ...
        \pcov\clear();
        return \ECSPrefix20210804\SebastianBergmann\CodeCoverage\RawCodeCoverageData::fromXdebugWithoutPathCoverage($collect);
    }
