...
use ECSPrefix20210804\PhpParser\Node\Stmt\Break_;
use ECSPrefix20210804\PhpParser\Node\Stmt\Case_;
use ECSPrefix20210804\PhpParser\Node\Stmt\Catch_;
use ECSPrefix20210804\PhpParser\Node\Stmt\Continue_;
use ECSPrefix20210804\PhpParser\Node\Stmt\Do_;
use ECSPrefix20210804\PhpParser\Node\Stmt\Echo_;
use ECSPrefix20210804\PhpParser\Node\Stmt\Else_;
use ECSPrefix20210804\PhpParser\Node\Stmt\ElseIf_;
use ECSPrefix20210804\PhpParser\Node\Stmt\Expression;
use ECSPrefix20210804\PhpParser\Node\Stmt\Finally_;
use ECSPrefix20210804\PhpParser\Node\Stmt\For_;
use ECSPrefix20210804\PhpParser\Node\Stmt\Foreach_;
use ECSPrefix20210804\PhpParser\Node\Stmt\Goto_;
use ECSPrefix20210804\PhpParser\Node\Stmt\If_;
use ECSPrefix20210804\PhpParser\Node\Stmt\Return_;
use ECSPrefix20210804\PhpParser\Node\Stmt\Switch_;
use ECSPrefix20210804\PhpParser\Node\Stmt\Throw_;
use ECSPrefix20210804\PhpParser\Node\Stmt\TryCatch;
use ECSPrefix20210804\PhpParser\Node\Stmt\Unset_;
use ECSPrefix20210804\PhpParser\Node\Stmt\While_;
use ECSPrefix20210804\PhpParser\NodeVisitorAbstract;
/**
 * @internal This class is not covered by the backward compatibility promise for phpunit/php-code-coverage
 */
final class ExecutableLinesFindingVisitor extends \ECSPrefix20210804\PhpParser\NodeVisitorAbstract
{
    /**
     * @psalm-var list<int>
     */
    private $executableLines = [];
    public function enterNode(\ECSPrefix20210804\PhpParser\Node $node) : void
    {
