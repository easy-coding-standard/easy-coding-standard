 ...
 */
final class ParsingUncoveredFileAnalyser implements \ECSPrefix20210803\SebastianBergmann\CodeCoverage\StaticAnalysis\UncoveredFileAnalyser
{
    public function executableLinesIn(string $filename) : array
    {
        ...
        try {
            ...
            $visitor = new \ECSPrefix20210803\SebastianBergmann\CodeCoverage\StaticAnalysis\ExecutableLinesFindingVisitor();
