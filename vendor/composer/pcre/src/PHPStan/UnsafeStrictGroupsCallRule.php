...
use ECSPrefix202505\PhpParser\Node;
use ECSPrefix202505\PhpParser\Node\Expr\StaticCall;
use ECSPrefix202505\PhpParser\Node\Name\FullyQualified;
use ECSPrefix202505\PHPStan\Analyser\Scope;
use ECSPrefix202505\PHPStan\Analyser\SpecifiedTypes;
use ECSPrefix202505\PHPStan\Rules\Rule;
use ECSPrefix202505\PHPStan\Rules\RuleErrorBuilder;
use ECSPrefix202505\PHPStan\TrinaryLogic;
use ECSPrefix202505\PHPStan\Type\ObjectType;
