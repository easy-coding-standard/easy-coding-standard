...
use ECSPrefix202505\PHPStan\Analyser\SpecifiedTypes;
use ECSPrefix202505\PHPStan\Analyser\TypeSpecifier;
use ECSPrefix202505\PHPStan\Analyser\TypeSpecifierAwareExtension;
use ECSPrefix202505\PHPStan\Analyser\TypeSpecifierContext;
...
use ECSPrefix202505\PHPStan\Type\StaticMethodTypeSpecifyingExtension;
...
final class PregMatchTypeSpecifyingExtension implements StaticMethodTypeSpecifyingExtension, TypeSpecifierAwareExtension
{
    ...
    public function specifyTypes(MethodReflection $methodReflection, StaticCall $node, Scope $scope, TypeSpecifierContext $context) : SpecifiedTypes
    {
        ...
        if (\method_exists('ECSPrefix202505\\PHPStan\\Analyser\\SpecifiedTypes', 'setRootExpr')) {
