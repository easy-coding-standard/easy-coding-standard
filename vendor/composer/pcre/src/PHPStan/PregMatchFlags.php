...
use ECSPrefix202508\PHPStan\Type\ArrayType;
use ECSPrefix202508\PHPStan\Type\Constant\ConstantArrayType;
use ECSPrefix202508\PHPStan\Type\Constant\ConstantIntegerType;
use ECSPrefix202508\PHPStan\Type\IntersectionType;
use ECSPrefix202508\PHPStan\Type\TypeCombinator;
use ECSPrefix202508\PHPStan\Type\Type;
use ECSPrefix202508\PhpParser\Node\Arg;
use ECSPrefix202508\PHPStan\Type\Php\RegexArrayShapeMatcher;
use ECSPrefix202508\PHPStan\Type\TypeTraverser;
use ECSPrefix202508\PHPStan\Type\UnionType;
