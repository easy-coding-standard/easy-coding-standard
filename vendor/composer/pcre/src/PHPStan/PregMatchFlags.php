...
use ECSPrefix202507\PHPStan\Type\ArrayType;
use ECSPrefix202507\PHPStan\Type\Constant\ConstantArrayType;
use ECSPrefix202507\PHPStan\Type\Constant\ConstantIntegerType;
use ECSPrefix202507\PHPStan\Type\IntersectionType;
use ECSPrefix202507\PHPStan\Type\TypeCombinator;
use ECSPrefix202507\PHPStan\Type\Type;
use ECSPrefix202507\PhpParser\Node\Arg;
use ECSPrefix202507\PHPStan\Type\Php\RegexArrayShapeMatcher;
use ECSPrefix202507\PHPStan\Type\TypeTraverser;
use ECSPrefix202507\PHPStan\Type\UnionType;
