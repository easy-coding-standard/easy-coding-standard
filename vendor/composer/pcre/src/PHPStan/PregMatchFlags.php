...
use ECSPrefix202501\PHPStan\Type\ArrayType;
use ECSPrefix202501\PHPStan\Type\Constant\ConstantArrayType;
use ECSPrefix202501\PHPStan\Type\Constant\ConstantIntegerType;
use ECSPrefix202501\PHPStan\Type\IntersectionType;
use ECSPrefix202501\PHPStan\Type\TypeCombinator;
use ECSPrefix202501\PHPStan\Type\Type;
use ECSPrefix202501\PhpParser\Node\Arg;
use ECSPrefix202501\PHPStan\Type\Php\RegexArrayShapeMatcher;
use ECSPrefix202501\PHPStan\Type\TypeTraverser;
use ECSPrefix202501\PHPStan\Type\UnionType;
