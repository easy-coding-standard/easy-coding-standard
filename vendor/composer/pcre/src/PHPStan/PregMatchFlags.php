...
use ECSPrefix202504\PHPStan\Type\ArrayType;
use ECSPrefix202504\PHPStan\Type\Constant\ConstantArrayType;
use ECSPrefix202504\PHPStan\Type\Constant\ConstantIntegerType;
use ECSPrefix202504\PHPStan\Type\IntersectionType;
use ECSPrefix202504\PHPStan\Type\TypeCombinator;
use ECSPrefix202504\PHPStan\Type\Type;
use ECSPrefix202504\PhpParser\Node\Arg;
use ECSPrefix202504\PHPStan\Type\Php\RegexArrayShapeMatcher;
use ECSPrefix202504\PHPStan\Type\TypeTraverser;
use ECSPrefix202504\PHPStan\Type\UnionType;
