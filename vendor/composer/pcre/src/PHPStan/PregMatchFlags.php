...
use ECSPrefix202503\PHPStan\Type\ArrayType;
use ECSPrefix202503\PHPStan\Type\Constant\ConstantArrayType;
use ECSPrefix202503\PHPStan\Type\Constant\ConstantIntegerType;
use ECSPrefix202503\PHPStan\Type\IntersectionType;
use ECSPrefix202503\PHPStan\Type\TypeCombinator;
use ECSPrefix202503\PHPStan\Type\Type;
use ECSPrefix202503\PhpParser\Node\Arg;
use ECSPrefix202503\PHPStan\Type\Php\RegexArrayShapeMatcher;
use ECSPrefix202503\PHPStan\Type\TypeTraverser;
use ECSPrefix202503\PHPStan\Type\UnionType;
