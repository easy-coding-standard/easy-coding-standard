...
use ECSPrefix202410\PHPStan\Type\ArrayType;
use ECSPrefix202410\PHPStan\Type\Constant\ConstantArrayType;
use ECSPrefix202410\PHPStan\Type\Constant\ConstantIntegerType;
use ECSPrefix202410\PHPStan\Type\IntersectionType;
use ECSPrefix202410\PHPStan\Type\TypeCombinator;
use ECSPrefix202410\PHPStan\Type\Type;
use ECSPrefix202410\PhpParser\Node\Arg;
use ECSPrefix202410\PHPStan\Type\Php\RegexArrayShapeMatcher;
use ECSPrefix202410\PHPStan\Type\TypeTraverser;
use ECSPrefix202410\PHPStan\Type\UnionType;
