 ...
 */
namespace ECSPrefix20220111\Composer\Pcre;
...
class Preg
{
    ...
    public static function match($pattern, $subject, &$matches = null, $flags = 0, $offset = 0)
    {
        ...
        if ($result === \false) {
            throw \ECSPrefix20220111\Composer\Pcre\PcreException::fromFunction('preg_match', $pattern);
        }
        return $result;
    }
    /**
    ...
    public static function matchAll($pattern, $subject, &$matches = null, $flags = 0, $offset = 0)
    {
        ...
        if ($result === \false || $result === null) {
            throw \ECSPrefix20220111\Composer\Pcre\PcreException::fromFunction('preg_match_all', $pattern);
        }
        return $result;
    }
    /**
    ...
    public static function replace($pattern, $replacement, $subject, $limit = -1, &$count = null)
    {
        ...
        if ($result === null) {
            throw \ECSPrefix20220111\Composer\Pcre\PcreException::fromFunction('preg_replace', $pattern);
        }
        return $result;
    }
    /**
    ...
    public static function replaceCallback($pattern, $replacement, $subject, $limit = -1, &$count = null, $flags = 0)
    {
        ...
        if ($result === null) {
            throw \ECSPrefix20220111\Composer\Pcre\PcreException::fromFunction('preg_replace_callback', $pattern);
        }
        return $result;
    }
    /**
    ...
    public static function replaceCallbackArray(array $pattern, $subject, $limit = -1, &$count = null, $flags = 0)
    {
        ...
        if ($result === null) {
            ...
            throw \ECSPrefix20220111\Composer\Pcre\PcreException::fromFunction('preg_replace_callback_array', $pattern);
        }
        return $result;
    }
    /**
    ...
    public static function split($pattern, $subject, $limit = -1, $flags = 0)
    {
        ...
        if ($result === \false) {
            throw \ECSPrefix20220111\Composer\Pcre\PcreException::fromFunction('preg_split', $pattern);
        }
        return $result;
    }
    /**
    ...
    public static function grep($pattern, array $array, $flags = 0)
    {
        ...
        if ($result === \false) {
            throw \ECSPrefix20220111\Composer\Pcre\PcreException::fromFunction('preg_grep', $pattern);
        }
        return $result;
    }
    /**
