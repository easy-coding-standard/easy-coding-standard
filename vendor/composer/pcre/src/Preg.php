 ...
 */
namespace ECSPrefix20220520\Composer\Pcre;
...
class Preg
{
    ...
    public static function match(string $pattern, string $subject, ?array &$matches = null, int $flags = 0, int $offset = 0) : int
    {
        ...
        if ($result === \false) {
            throw \ECSPrefix20220520\Composer\Pcre\PcreException::fromFunction('preg_match', $pattern);
        }
        return $result;
    }
    /**
    ...
    public static function matchAll(string $pattern, string $subject, ?array &$matches = null, int $flags = 0, int $offset = 0) : int
    {
        ...
        if ($result === \false || $result === null) {
            throw \ECSPrefix20220520\Composer\Pcre\PcreException::fromFunction('preg_match_all', $pattern);
        }
        return $result;
    }
    /**
    ...
    public static function replace($pattern, $replacement, $subject, int $limit = -1, int &$count = null) : string
    {
        ...
        if ($result === null) {
            throw \ECSPrefix20220520\Composer\Pcre\PcreException::fromFunction('preg_replace', $pattern);
        }
        return $result;
    }
    /**
    ...
    public static function replaceCallback($pattern, callable $replacement, $subject, int $limit = -1, int &$count = null, int $flags = 0) : string
    {
        ...
        if ($result === null) {
            throw \ECSPrefix20220520\Composer\Pcre\PcreException::fromFunction('preg_replace_callback', $pattern);
        }
        return $result;
    }
    /**
    ...
    public static function replaceCallbackArray(array $pattern, $subject, int $limit = -1, int &$count = null, int $flags = 0) : string
    {
        ...
        if ($result === null) {
            ...
            throw \ECSPrefix20220520\Composer\Pcre\PcreException::fromFunction('preg_replace_callback_array', $pattern);
        }
        return $result;
    }
    /**
    ...
    public static function split(string $pattern, string $subject, int $limit = -1, int $flags = 0) : array
    {
        ...
        if ($result === \false) {
            throw \ECSPrefix20220520\Composer\Pcre\PcreException::fromFunction('preg_split', $pattern);
        }
        return $result;
    }
    /**
    ...
    public static function grep(string $pattern, array $array, int $flags = 0) : array
    {
        ...
        if ($result === \false) {
            throw \ECSPrefix20220520\Composer\Pcre\PcreException::fromFunction('preg_grep', $pattern);
        }
        return $result;
    }
    /**
