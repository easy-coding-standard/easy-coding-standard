...
class Regex
{
    ...
    {
        return (bool) \ECSPrefix20220115\Composer\Pcre\Preg::match($pattern, $subject, $matches, 0, $offset);
    }
    /**
     * @param string $pattern
     * @param string $subject
    ...
    public static function match($pattern, $subject, $flags = 0, $offset = 0)
    {
        ...
        $count = \ECSPrefix20220115\Composer\Pcre\Preg::match($pattern, $subject, $matches, $flags, $offset);
        return new \ECSPrefix20220115\Composer\Pcre\MatchResult($count, $matches);
    }
    /**
    ...
    {
        $count = \ECSPrefix20220115\Composer\Pcre\Preg::matchWithOffsets($pattern, $subject, $matches, $flags, $offset);
        return new \ECSPrefix20220115\Composer\Pcre\MatchWithOffsetsResult($count, $matches);
    }
    /**
     * @param string $pattern
     * @param string $subject
    ...
    public static function matchAll($pattern, $subject, $flags = 0, $offset = 0)
    {
        ...
        $count = \ECSPrefix20220115\Composer\Pcre\Preg::matchAll($pattern, $subject, $matches, $flags, $offset);
        return new \ECSPrefix20220115\Composer\Pcre\MatchAllResult($count, $matches);
    }
    /**
    ...
    {
        $count = \ECSPrefix20220115\Composer\Pcre\Preg::matchAllWithOffsets($pattern, $subject, $matches, $flags, $offset);
        return new \ECSPrefix20220115\Composer\Pcre\MatchAllWithOffsetsResult($count, $matches);
    }
    /**
    ...
    {
        $result = \ECSPrefix20220115\Composer\Pcre\Preg::replace($pattern, $replacement, $subject, $limit, $count);
        return new \ECSPrefix20220115\Composer\Pcre\ReplaceResult($count, $result);
    }
    /**
     * @param string|string[] $pattern
    ...
    {
        $result = \ECSPrefix20220115\Composer\Pcre\Preg::replaceCallback($pattern, $replacement, $subject, $limit, $count, $flags);
        return new \ECSPrefix20220115\Composer\Pcre\ReplaceResult($count, $result);
    }
    /**
    ...
    {
        $result = \ECSPrefix20220115\Composer\Pcre\Preg::replaceCallbackArray($pattern, $subject, $limit, $count, $flags);
        return new \ECSPrefix20220115\Composer\Pcre\ReplaceResult($count, $result);
    }
}
