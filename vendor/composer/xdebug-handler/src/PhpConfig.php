 ...
 */
namespace ECSPrefix20210526\Composer\XdebugHandler;
...
class PhpConfig
{
    ...
    {
        if ($data = \ECSPrefix20210526\Composer\XdebugHandler\XdebugHandler::getRestartSettings()) {
    ...
    {
        \ECSPrefix20210526\Composer\XdebugHandler\Process::setEnv($name, \false !== $value ? $value : null);
    }
}
