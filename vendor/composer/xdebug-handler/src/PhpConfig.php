 ...
 */
namespace ECSPrefix20210802\Composer\XdebugHandler;
...
class PhpConfig
{
    ...
    {
        if ($data = \ECSPrefix20210802\Composer\XdebugHandler\XdebugHandler::getRestartSettings()) {
    ...
    {
        \ECSPrefix20210802\Composer\XdebugHandler\Process::setEnv($name, \false !== $value ? $value : null);
    }
}
