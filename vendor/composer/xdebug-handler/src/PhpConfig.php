 ...
 */
namespace ECSPrefix20210728\Composer\XdebugHandler;
...
class PhpConfig
{
    ...
    {
        if ($data = \ECSPrefix20210728\Composer\XdebugHandler\XdebugHandler::getRestartSettings()) {
    ...
    {
        \ECSPrefix20210728\Composer\XdebugHandler\Process::setEnv($name, \false !== $value ? $value : null);
    }
}
