 ...
 */
namespace ECSPrefix20210520\Composer\XdebugHandler;
...
class PhpConfig
{
    ...
    {
        if ($data = \ECSPrefix20210520\Composer\XdebugHandler\XdebugHandler::getRestartSettings()) {
    ...
    {
        \ECSPrefix20210520\Composer\XdebugHandler\Process::setEnv($name, \false !== $value ? $value : null);
    }
}
