 ...
 */
namespace ECSPrefix20211008\Composer\XdebugHandler;
...
class PhpConfig
{
    ...
    {
        if ($data = \ECSPrefix20211008\Composer\XdebugHandler\XdebugHandler::getRestartSettings()) {
    ...
    {
        \ECSPrefix20211008\Composer\XdebugHandler\Process::setEnv($name, \false !== $value ? $value : null);
    }
}
