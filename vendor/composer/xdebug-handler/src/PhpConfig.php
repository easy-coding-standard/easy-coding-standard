...
class PhpConfig
{
    ...
    {
        $data = \ECSPrefix20220117\Composer\XdebugHandler\XdebugHandler::getRestartSettings();
        if ($data !== null) {
    ...
    {
        \ECSPrefix20220117\Composer\XdebugHandler\Process::setEnv($name, \false !== $value ? $value : null);
    }
}
