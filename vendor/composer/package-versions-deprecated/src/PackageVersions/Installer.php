...
use ECSPrefix20210509\Composer\Composer;
use ECSPrefix20210509\Composer\Config;
use ECSPrefix20210509\Composer\EventDispatcher\EventSubscriberInterface;
use ECSPrefix20210509\Composer\IO\IOInterface;
use ECSPrefix20210509\Composer\Package\AliasPackage;
use ECSPrefix20210509\Composer\Package\Locker;
use ECSPrefix20210509\Composer\Package\PackageInterface;
use ECSPrefix20210509\Composer\Package\RootPackageInterface;
use ECSPrefix20210509\Composer\Plugin\PluginInterface;
use ECSPrefix20210509\Composer\Script\Event;
use ECSPrefix20210509\Composer\Script\ScriptEvents;
use Generator;
...
final class Installer implements \ECSPrefix20210509\Composer\Plugin\PluginInterface, \ECSPrefix20210509\Composer\EventDispatcher\EventSubscriberInterface
{
...
PHP;
    public function activate(\ECSPrefix20210509\Composer\Composer $composer, \ECSPrefix20210509\Composer\IO\IOInterface $io)
    {
        // Nothing to do here, as all features are provided through event listeners
    }
    public function deactivate(\ECSPrefix20210509\Composer\Composer $composer, \ECSPrefix20210509\Composer\IO\IOInterface $io)
    {
        // Nothing to do here, as all features are provided through event listeners
    }
    public function uninstall(\ECSPrefix20210509\Composer\Composer $composer, \ECSPrefix20210509\Composer\IO\IOInterface $io)
    {
        // Nothing to do here, as all features are provided through event listeners
    }
    /**
    ...
    {
        return [\ECSPrefix20210509\Composer\Script\ScriptEvents::POST_AUTOLOAD_DUMP => 'dumpVersionsClass'];
    }
    /**
     * @throws RuntimeException
     */
    public static function dumpVersionsClass(\ECSPrefix20210509\Composer\Script\Event $composerEvent)
    {
     ...
     * @throws RuntimeException
     */
    private static function writeVersionClassToFile(string $versionClassSource, \ECSPrefix20210509\Composer\Composer $composer, \ECSPrefix20210509\Composer\IO\IOInterface $io)
    {
     ...
     * @throws RuntimeException
     */
    private static function locateRootPackageInstallPath(\ECSPrefix20210509\Composer\Config $composerConfig, \ECSPrefix20210509\Composer\Package\RootPackageInterface $rootPackage) : string
    {
    ...
    private static function getRootPackageAlias(\ECSPrefix20210509\Composer\Package\RootPackageInterface $rootPackage) : \ECSPrefix20210509\Composer\Package\PackageInterface
    {
        $package = $rootPackage;
        while ($package instanceof \ECSPrefix20210509\Composer\Package\AliasPackage) {
     ...
     */
    private static function getVersions(\ECSPrefix20210509\Composer\Package\Locker $locker, \ECSPrefix20210509\Composer\Package\RootPackageInterface $rootPackage) : \Generator
    {
