...
\class_exists(\ECSPrefix20210507\Composer\InstalledVersions::class);
/**
...
final class Versions
{
    ...
    {
        if (!\class_exists(\ECSPrefix20210507\Composer\InstalledVersions::class, \false) || !\ECSPrefix20210507\Composer\InstalledVersions::getRawData()) {
            return self::ROOT_PACKAGE_NAME;
        }
        return \ECSPrefix20210507\Composer\InstalledVersions::getRootPackage()['name'];
    }
    /**
    ...
    {
        if (\class_exists(\ECSPrefix20210507\Composer\InstalledVersions::class, \false) && \ECSPrefix20210507\Composer\InstalledVersions::getRawData()) {
            return \ECSPrefix20210507\Composer\InstalledVersions::getPrettyVersion($packageName) . '@' . \ECSPrefix20210507\Composer\InstalledVersions::getReference($packageName);
        }
