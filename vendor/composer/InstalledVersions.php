 ...
 */
namespace ECSPrefix202303\Composer;

use ECSPrefix202303\Composer\Autoload\ClassLoader;
use ECSPrefix202303\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('ECSPrefix202303\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
