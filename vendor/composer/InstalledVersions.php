 ...
 */
namespace ECSPrefix20220611\Composer;

use ECSPrefix20220611\Composer\Autoload\ClassLoader;
use ECSPrefix20220611\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('ECSPrefix20220611\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
