 ...
 */
namespace ECSPrefix202302\Composer;

use ECSPrefix202302\Composer\Autoload\ClassLoader;
use ECSPrefix202302\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('ECSPrefix202302\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
