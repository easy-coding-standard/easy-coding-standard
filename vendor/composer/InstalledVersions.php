...
class InstalledVersions
{
    ...
    public static function satisfies(\ECSPrefix20210508\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('ECSPrefix20210508\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
        if (self::$canGetVendors) {
            foreach (\ECSPrefix20210508\Composer\Autoload\ClassLoader::getRegisteredLoaders() as $vendorDir => $loader) {
...
\class_alias('ECSPrefix20210508\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
