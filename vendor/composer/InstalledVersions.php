 ...
 */
namespace ECSPrefix202206\Composer;

use ECSPrefix202206\Composer\Autoload\ClassLoader;
use ECSPrefix202206\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('ECSPrefix202206\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
