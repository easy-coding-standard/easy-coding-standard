...
namespace ECSPrefix20210511\Composer;

use ECSPrefix20210511\Composer\Autoload\ClassLoader;
use ECSPrefix20210511\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    public static function satisfies(\ECSPrefix20210511\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('ECSPrefix20210511\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
        if (self::$canGetVendors) {
            foreach (\ECSPrefix20210511\Composer\Autoload\ClassLoader::getRegisteredLoaders() as $vendorDir => $loader) {
