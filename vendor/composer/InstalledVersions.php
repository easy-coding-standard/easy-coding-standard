 ...
 */
namespace ECSPrefix20220613\Composer;

use ECSPrefix20220613\Composer\Autoload\ClassLoader;
use ECSPrefix20220613\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('ECSPrefix20220613\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
