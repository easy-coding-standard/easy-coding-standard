 ...
 */
namespace ECSPrefix20220610\Composer;

use ECSPrefix20220610\Composer\Autoload\ClassLoader;
use ECSPrefix20220610\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('ECSPrefix20220610\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
