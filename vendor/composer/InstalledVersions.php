 ...
 */
namespace ECSPrefix202305\Composer;

use ECSPrefix202305\Composer\Autoload\ClassLoader;
use ECSPrefix202305\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('ECSPrefix202305\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
