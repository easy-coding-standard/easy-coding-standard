 ...
 */
namespace ECSPrefix202309\Composer;

use ECSPrefix202309\Composer\Autoload\ClassLoader;
use ECSPrefix202309\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('ECSPrefix202309\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
