 ...
 */
namespace ECSPrefix202308\Composer;

use ECSPrefix202308\Composer\Autoload\ClassLoader;
use ECSPrefix202308\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('ECSPrefix202308\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
