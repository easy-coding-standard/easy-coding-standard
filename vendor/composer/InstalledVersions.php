 ...
 */
namespace ECSPrefix202208\Composer;

use ECSPrefix202208\Composer\Autoload\ClassLoader;
use ECSPrefix202208\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('ECSPrefix202208\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
