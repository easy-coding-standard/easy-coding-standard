...
class Interval
{
    ...
    /** @var Constraint */
    private $end;
    public function __construct(\ECSPrefix20210508\Composer\Semver\Constraint\Constraint $start, \ECSPrefix20210508\Composer\Semver\Constraint\Constraint $end)
    {
        $this->start = $start;
        $this->end = $end;
    }
    ...
    public static function fromZero()
    {
        static $zero;
        if (null === $zero) {
            $zero = new \ECSPrefix20210508\Composer\Semver\Constraint\Constraint('>=', '0.0.0.0-dev');
        }
        return $zero;
    }
    /**
    ...
    public static function untilPositiveInfinity()
    {
        ...
        if (null === $positiveInfinity) {
            $positiveInfinity = new \ECSPrefix20210508\Composer\Semver\Constraint\Constraint('<', \PHP_INT_MAX . '.0.0.0');
        }
