 ...
 */
class Constraint implements \ECSPrefix20220524\Composer\Semver\Constraint\ConstraintInterface
{
     ...
     * @return bool
     */
    public function matchSpecific(\ECSPrefix20220524\Composer\Semver\Constraint\Constraint $provider, $compareBranches = \false)
    {
    ...
    private function extractBounds()
    {
        ...
        // Branches
        if (\strpos($this->version, 'dev-') === 0) {
            $this->lowerBound = \ECSPrefix20220524\Composer\Semver\Constraint\Bound::zero();
            $this->upperBound = \ECSPrefix20220524\Composer\Semver\Constraint\Bound::positiveInfinity();
            return;
        }
        switch ($this->operator) {
            case self::OP_EQ:
                $this->lowerBound = new \ECSPrefix20220524\Composer\Semver\Constraint\Bound($this->version, \true);
                $this->upperBound = new \ECSPrefix20220524\Composer\Semver\Constraint\Bound($this->version, \true);
                break;
            case self::OP_LT:
                $this->lowerBound = \ECSPrefix20220524\Composer\Semver\Constraint\Bound::zero();
                $this->upperBound = new \ECSPrefix20220524\Composer\Semver\Constraint\Bound($this->version, \false);
                break;
            case self::OP_LE:
                $this->lowerBound = \ECSPrefix20220524\Composer\Semver\Constraint\Bound::zero();
                $this->upperBound = new \ECSPrefix20220524\Composer\Semver\Constraint\Bound($this->version, \true);
                break;
            case self::OP_GT:
                $this->lowerBound = new \ECSPrefix20220524\Composer\Semver\Constraint\Bound($this->version, \false);
                $this->upperBound = \ECSPrefix20220524\Composer\Semver\Constraint\Bound::positiveInfinity();
                break;
            case self::OP_GE:
                $this->lowerBound = new \ECSPrefix20220524\Composer\Semver\Constraint\Bound($this->version, \true);
