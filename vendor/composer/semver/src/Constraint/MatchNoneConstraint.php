 ...
 */
class MatchNoneConstraint implements \ECSPrefix20210521\Composer\Semver\Constraint\ConstraintInterface
{
    /** @var string|null */
    ...
    {
        return new \ECSPrefix20210521\Composer\Semver\Constraint\Bound('0.0.0.0-dev', \false);
    }
    /**
     * {@inheritDoc}
     */
