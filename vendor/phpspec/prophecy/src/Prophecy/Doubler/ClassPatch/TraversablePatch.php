 ...
 */
class TraversablePatch implements \ECSPrefix20210803\Prophecy\Doubler\ClassPatch\ClassPatchInterface
{
    /**
    ...
    public function apply(\ECSPrefix20210803\Prophecy\Doubler\Generator\Node\ClassNode $node)
    {
        ...
        $node->addMethod(new \ECSPrefix20210803\Prophecy\Doubler\Generator\Node\MethodNode('current'));
        $node->addMethod(new \ECSPrefix20210803\Prophecy\Doubler\Generator\Node\MethodNode('key'));
        $node->addMethod(new \ECSPrefix20210803\Prophecy\Doubler\Generator\Node\MethodNode('next'));
        $node->addMethod(new \ECSPrefix20210803\Prophecy\Doubler\Generator\Node\MethodNode('rewind'));
        $node->addMethod(new \ECSPrefix20210803\Prophecy\Doubler\Generator\Node\MethodNode('valid'));
    }
    /**
