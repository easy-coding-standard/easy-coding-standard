 ...
 */
class CallbackPrediction implements \ECSPrefix20210803\Prophecy\Prediction\PredictionInterface
{
    private $callback;
    /**
    ...
    public function __construct($callback)
    {
        if (!\is_callable($callback)) {
            throw new \ECSPrefix20210803\Prophecy\Exception\InvalidArgumentException(\sprintf('Callable expected as an argument to CallbackPrediction, but got %s.', \gettype($callback)));
        }
