...
use ECSPrefix202507\PhpParser\Modifiers;
use ECSPrefix202507\PhpParser\Node\Expr\ArrayDimFetch;
use ECSPrefix202507\PhpParser\Node\Expr\Assign;
use ECSPrefix202507\PhpParser\Node\Expr\ConstFetch;
use ECSPrefix202507\PhpParser\Node\Expr\PropertyFetch;
use ECSPrefix202507\PhpParser\Node\Expr\Variable;
use ECSPrefix202507\PhpParser\Node\Identifier;
use ECSPrefix202507\PhpParser\Node\Name;
use ECSPrefix202507\PhpParser\Node\Param;
use ECSPrefix202507\PhpParser\Node\Scalar\String_;
use ECSPrefix202507\PhpParser\Node\Stmt\ClassMethod;
use ECSPrefix202507\PhpParser\Node\Stmt\Expression;
use ECSPrefix202507\PhpParser\Node\Stmt\If_;
use ECSPrefix202507\PhpParser\Node\Stmt\Return_;
use ECSPrefix202507\PhpParser\PrettyPrinter\Standard;
