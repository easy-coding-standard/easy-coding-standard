...
use ECSPrefix202504\PhpParser\Modifiers;
use ECSPrefix202504\PhpParser\Node\Expr\ArrayDimFetch;
use ECSPrefix202504\PhpParser\Node\Expr\Assign;
use ECSPrefix202504\PhpParser\Node\Expr\ConstFetch;
use ECSPrefix202504\PhpParser\Node\Expr\PropertyFetch;
use ECSPrefix202504\PhpParser\Node\Expr\Variable;
use ECSPrefix202504\PhpParser\Node\Identifier;
use ECSPrefix202504\PhpParser\Node\Name;
use ECSPrefix202504\PhpParser\Node\Param;
use ECSPrefix202504\PhpParser\Node\Scalar\String_;
use ECSPrefix202504\PhpParser\Node\Stmt\ClassMethod;
use ECSPrefix202504\PhpParser\Node\Stmt\Expression;
use ECSPrefix202504\PhpParser\Node\Stmt\If_;
use ECSPrefix202504\PhpParser\Node\Stmt\Return_;
use ECSPrefix202504\PhpParser\PrettyPrinter\Standard;
