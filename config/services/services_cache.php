...
return static function (\ECSPrefix20210524\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) {
    ...
    $services->set(\ECSPrefix20210524\Nette\Caching\Cache::class)->factory([\ECSPrefix20210524\Symfony\Component\DependencyInjection\Loader\Configurator\service(\Symplify\EasyCodingStandard\Caching\NetteCacheFactory::class), 'create']);
};
