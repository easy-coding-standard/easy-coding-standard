...
use ECSPrefix20220527\Symplify\PackageBuilder\Console\Style\SymfonyStyleFactory;
use ECSPrefix20220527\Symplify\PackageBuilder\Yaml\ParametersMerger;
use ECSPrefix20220527\Symplify\SmartFileSystem\FileSystemFilter;
use ECSPrefix20220527\Symplify\SmartFileSystem\FileSystemGuard;
use ECSPrefix20220527\Symplify\SmartFileSystem\Finder\FinderSanitizer;
use ECSPrefix20220527\Symplify\SmartFileSystem\Finder\SmartFinder;
use ECSPrefix20220527\Symplify\SmartFileSystem\SmartFileSystem;
...
return static function (\Symplify\EasyCodingStandard\Config\ECSConfig $ecsConfig) : void {
    ...
    $services->set(\Symplify\EasyCodingStandard\Caching\Cache::class)->factory([\ECSPrefix20220527\Symfony\Component\DependencyInjection\Loader\Configurator\service(\Symplify\EasyCodingStandard\Caching\CacheFactory::class), 'create']);
    $services->set(\ECSPrefix20220527\Symfony\Component\Console\Terminal::class);
    $services->set(\ECSPrefix20220527\Symplify\SmartFileSystem\FileSystemGuard::class);
    $services->set(\ECSPrefix20220527\Symplify\SmartFileSystem\Finder\FinderSanitizer::class);
    $services->set(\ECSPrefix20220527\Symplify\SmartFileSystem\SmartFileSystem::class);
    $services->set(\ECSPrefix20220527\Symplify\SmartFileSystem\Finder\SmartFinder::class);
    $services->set(\ECSPrefix20220527\Symplify\SmartFileSystem\FileSystemFilter::class);
    $services->set(\ECSPrefix20220527\Symplify\PackageBuilder\Console\Style\SymfonyStyleFactory::class);
    $services->set(\ECSPrefix20220527\Symfony\Component\Console\Style\SymfonyStyle::class)->factory([\ECSPrefix20220527\Symfony\Component\DependencyInjection\Loader\Configurator\service(\ECSPrefix20220527\Symplify\PackageBuilder\Console\Style\SymfonyStyleFactory::class), 'create']);
    $services->set(\ECSPrefix20220527\Symplify\PackageBuilder\Yaml\ParametersMerger::class);
    $services->set(\Symplify\EasyCodingStandard\Console\Style\EasyCodingStandardStyle::class)->factory([\ECSPrefix20220527\Symfony\Component\DependencyInjection\Loader\Configurator\service(\Symplify\EasyCodingStandard\Console\Style\EasyCodingStandardStyleFactory::class), 'create']);
    $services->set(\PhpCsFixer\WhitespacesFixerConfig::class)->factory([\ECSPrefix20220527\Symfony\Component\DependencyInjection\Loader\Configurator\service(\Symplify\EasyCodingStandard\FixerRunner\WhitespacesFixerConfigFactory::class), 'create']);
    // code sniffer
