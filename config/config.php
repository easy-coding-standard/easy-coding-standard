...
return ECSConfig::configure()->withSpacing(indentation: Option::INDENTATION_SPACES, lineEnding: \PHP_EOL)->withCache(directory: $cacheDirectory, namespace: $cacheNamespace)->withFileExtensions(['php'])->withSkip([])->withPaths([]);
